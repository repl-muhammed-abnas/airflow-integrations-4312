...
def create_child_dag(config):
    with rail.create_airflow_dag(
        ...
        is_any_manual_timeoff_present = rail.IfOperator(
            ...
            test=lambda: bool(rail.result('get_time_off_booking_details')),
        ...
        catch_and_log_errors = rail.WriteLogOperator(
            ...
            properties=lambda dag_run: {
                ...
                "hours": dag_run.conf["hours"],
                "booking_id": dag_run.conf["booking_id"],
                'action': '{{ "Update" if result("get_time_off_booking_details") | is_truthy else "Add" }}',
                "status": "Error",
        ...
        is_timeoff_type_present >> rail.Label(
            "Yes") >> delete_time_entries >> get_time_off_booking_details >> is_any_manual_timeoff_present

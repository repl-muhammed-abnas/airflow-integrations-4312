import rail
from bearingpoint.project_import_v1.utils.request_payload import does_wbs_exist
...
def get_child_conf(dag_run):
    return {
        ** dag_run.conf,
        ...
        "restrict_time_posting_udf_uri": rail.result("get_project_custom_field_details"),
        ...
        "employee_type_uris": rail.result("get_all_employee_types"),
        "project_permission_set": rail.result("get_project_permission_set"),
    }

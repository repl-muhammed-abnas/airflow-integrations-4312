...
sftp_conn_id = "sftp_useast2" # For uat sftp connection is not required, this connection is kept because it is used in post_h4s4/s4hc file.
...
tenant_email = 'SuvasreeSantra@deltek.com,vchintapenta@deltek.com'

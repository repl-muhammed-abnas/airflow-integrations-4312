...
import pendulum
import rail
from cie_wipro.ireland_absconding_employee_notification.utils import request_payload, python_callable_method
...
def create_dag(config):
    ...
    with rail.create_airflow_dag(
        ...
        get_to_report_details >> run_report_to >> get_timeoff_report_data >> final_list_has_data >> rail.Label("Yes") >> gpo_and_hr_manager_empid >>\

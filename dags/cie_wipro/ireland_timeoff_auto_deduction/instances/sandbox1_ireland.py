...
from cie_wipro.ireland_timeoff_auto_deduction.config import *
...
time_off_name1 = "IE - Annual leave"
time_off_name2 = "IE - Annual leave Assignee"
time_off_name3 = "IE - Leave Without Pay (LWOP)"
booking_day = 10
minimum_efforts = 4

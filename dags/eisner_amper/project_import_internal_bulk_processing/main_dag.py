...
import rail
from eisner_amper.project_import_internal_bulk_processing.utils.response_filter import get_project_type_tag_uris, get_project_profile_tag_uris
...
def create_main_airflow_dag(config):
    with rail.create_airflow_dag(
        ...
        send_bad_file_format_email = rail.EmailOperator(
            ...
            subject='{{ get_company_key() }} | Replicon EisnerAmper Project Import (BULK Processing) for internal sync - skipped {{ current_time_in_specified_tz() }}',
        ...
        archive_file = rail.SFTPMoveFileOperator(
            ...
            "/archive_{{ result('new_file_sensor') | file_name }}"
        )
        ...
        is_client_available = rail.IfOperator(
            ...
            test=lambda: bool(rail.result('load_project_import_data')['payload']['A_EnterpriseProjectType']),
        ...
        process_each_client = rail.TriggerDagRunForEachItemOperator(
            ...
            items=lambda: [rail.result("load_project_import_data")['payload']['A_EnterpriseProjectType']] if isinstance(
                rail.result("load_project_import_data")['payload']['A_EnterpriseProjectType'], (dict)) else rail.result(
                    "load_project_import_data")['payload']['A_EnterpriseProjectType'],
        ...
        new_file_sensor >> is_json >> rail.Label(
        ...
        download_file >> load_project_import_data >> is_client_available >> rail.Label(
        ...
        gather_client_logs >> gather_each_project_logs >> process_log_generation >> can_fail_dag >> rail.Label('Yes') >> fail_dagrun

    ...
    for idx in range(0, config.BATCH_COUNT):
        ...
        with rail.create_airflow_dag(
            ...
            put_user_notification = rail.RepliconServiceOperator(
                ...
                data=lambda: request_payload.put_user_notification_preferences_payload(rail.result('create_user'))
            )
            ...
            login_status_present >> rail.Label("No") >> update_to_log >> catch_and_log_errors

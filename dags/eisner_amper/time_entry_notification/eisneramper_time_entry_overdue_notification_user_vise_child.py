...
def create_child_dag(config):
    ...
    with rail.create_airflow_dag(
        dag_id=f'eisneramper_missing_time_entry_notification_user_vise_child_{config.instance}',
        description=f'eisneramper_time_entry_notification_user_vise_child_{config.instance}',
        ...
        get_final_payload = rail.PythonOperator(
            ...
            op_args=[
                "{{ dag_run.conf.user_first_name }} {{ dag_run.conf.user_last_name }}",

...
import rail
from eisner_amper.timeoff_import_workday.utils import custom_methods
...
def create_child_dag(config):
    ...
    with rail.create_airflow_dag(
        ...
        description=f'Eisner Amper Workday TimeOff Import Child - Process Log Generation',
        ...
        render_logs_csv = rail.WriteCSVFileOperator(
            ...
            source=lambda: rail.load_json_artifact(rail.result('format_logs')['logs']),
            header=[
        ...
        send_import_complete_email = rail.EmailOperator(
            ...
            bcc="{%- if result('format_logs').error_count == 0 -%}\
                ...
                {%- else -%}\
                    "+config.alert_email+"\
                {%- endif -%}",
            subject='{{ get_company_key() + " | Replicon Workday TimeOff Import is " }} \
        ...
        format_logs >> render_logs_csv >> get_email_log_details >> generate_download_link >> upload_log_to_sftp >> send_import_complete_email >> batch_end

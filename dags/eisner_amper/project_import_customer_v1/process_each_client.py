...
def create_child_dag_wbs(config):
    with rail.create_airflow_dag(
        dag_id=f'eisner_amper_project_import_customer_records_process_each_client_{config.instance}',
        ...
        process_each_project =  rail.TriggerDagRunForEachItemOperator(
            ...
            trigger_dag_id= f'eisner_amper_project_import_customer_records_process_each_project_{config.instance}',

...
from eisner_amper.time_export_s4hc_v1.utils import request_payload, custom_methods
import json
null = None
...
def create_main_airflow_dag(config):
    with rail.create_airflow_dag(
        dag_id=f'eisner_amper_time_export_master_s4hc_v1_{config.instance}',
        description='Eisner Amper Time Export Master S4HC V1',
        ...
        process_time_export = rail.TriggerDagRunForEachItemOperator(
            ...
            retries=0,
            trigger_dag_id=f'eisner_amper_time_export_child_s4hc_v1_{config.instance}',
        ...
        is_report_failed >> rail.Label("No") >> report_has_data >> rail.Label(
            "Yes") >> load_report_data >> create_time_data_collection >> query_valid_time_entry_records >> \

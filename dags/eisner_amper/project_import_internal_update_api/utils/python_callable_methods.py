...
def get_tasks_to_add_update():
    ...
    # Get incoming tasks from payload - Internal uses YY1_ActivityTypeSet/YY1_ActivityType
    tasks_to_process = []
    if dag_run.conf['item']['YY1_ActivityTypeSet'] and dag_run.conf['item']['YY1_ActivityTypeSet']['YY1_ActivityType']:
        work_items = dag_run.conf['item']['YY1_ActivityTypeSet']['YY1_ActivityType']

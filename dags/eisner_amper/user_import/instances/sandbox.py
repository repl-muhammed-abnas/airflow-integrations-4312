...
replicon_conn_id = "eisnerampersandbox_repliconint.userimport"
...
log_filepath = "/Sandbox/User Import/Log"
...
tenant_email = "ap.alert.replicon@eisneramper.com,ashwin.ns@infosys.com"
...
internal_user_log_path = '/Sandbox/User Import/Log'

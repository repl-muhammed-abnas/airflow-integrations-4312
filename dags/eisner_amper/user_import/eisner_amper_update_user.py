    ...
    for idx in range(0, config.BATCH_COUNT):
        ...
        with rail.create_airflow_dag(
            ...
            put_user_notification_preferences = rail.RepliconServiceOperator(
                ...
                data=lambda dag_run: request_payload.put_user_notification_preferences_payload(
                    dag_run.conf['uri'])
            )
            ...
            is_notification_equals_to_yes >> rail.Label(
                "No") >> sapid_not_present
            ...
            is_notification_equals_to_no >> rail.Label(
                "No") >> sapid_not_present
            ...
            if_worklocation_uri_present >> rail.Label(
                "No") >> if_role_uri_present
            ...
            schedule_not_equal_displaytext >> rail.Label(
                "No") >> log_add_user_log

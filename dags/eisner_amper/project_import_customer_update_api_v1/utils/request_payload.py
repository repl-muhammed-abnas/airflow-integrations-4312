...
def get_add_tasks_payload():
    """Get payload for adding new tasks - using Mammoet API structure with Eisner Amper mappings"""
    ...
    for task in tasks_to_add:
        task_data = {
            ...
            "taskModificationToApply": {
                "name": task['TaskCode'] + " " + task['TaskName'],  # Eisner Amper format: code + name
                "codeToApply": {
                    "value": task['TaskCode']  # Eisner Amper task code
                },
                "isClosed": "false",
                "timeEntryStartDateToApply": null,
                "timeEntryEndDateToApply": null,
...
def get_update_tasks_payload():
    """Get payload for updating existing tasks - using Mammoet API structure with Eisner Amper mappings"""

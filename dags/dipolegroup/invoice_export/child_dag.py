...
import rail
from dipolegroup.invoice_export import request_payload
...
def create_dag(config):
    with rail.create_airflow_dag(
        dag_id=f"dipole_group_invoice_export_child_dag_{config.instance}",
        description=f'Xero Connector  Invoice Export Child Dag {config.instance}',

...
def create_dag(config):
    ...
    with rail.create_airflow_dag(
        dag_id=f'vp_ukgpro_employee_sync_router_{config.instance}',
        ...
        def build_employee_conf(operation_type):
            ...
            result = {
                **combined_data,
                ...
                'payRate': (
                    weekly_pay_rate if pay_period == 'W'
                    else hourly_pay_rate if pay_period == 'H'
                    else None
                ),
        ...
        trigger_employee_update = rail.TriggerDagRunOperator(
            ...
            retries=0,
            trigger_dag_id=(
                f'vp_ukgpro_employee_sync_update_{config.instance}'
            ),
        ...
        trigger_employee_create = rail.TriggerDagRunOperator(
            ...
            retries=0,
            trigger_dag_id=(
                f'vp_ukgpro_employee_sync_create_{config.instance}'
            ),

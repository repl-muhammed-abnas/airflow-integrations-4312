...
from unisys.project_import_v2.utils import custom_method
    ...
    with rail.create_airflow_dag(
        ...
        get_all_permission_sets = rail.RepliconServiceOperator(
            ...
            data_handler= lambda resp: {
                ...
                'resource_management_permission_set_uri': rail.find_first_by_attr_and_get_attr(
                    resp, 'displayText', 'Resource Manager (for PM)', 'uri', '')
            }
        )
        ...
        process_projects = rail.trigger_parallel_dagrun(
            ...
            conf=lambda item: {
                ...
                'resource_management_permission_set_uri': rail.result("get_all_permission_sets")['resource_management_permission_set_uri']
            }
        )

...
import pendulum
import rail
from unisys.time_export.utils.data_processing import get_report_payload, get_yesterdays_date
from unisys.time_export.utils import custom_methods
    ...
    with rail.create_airflow_dag(
        ...
        run_details = rail.PythonOperator(
            ...
            python_callable=lambda: {
                ...
                'log_filename': f"FUSION_{config.instance.upper()}_UNISYS_TS_"+ pendulum.now().strftime("%m%d%Y%H%M%S") + ".csv"
            }
        )
        ...
        # Task 8: Generate Timesheet Period report batch
        ...
        # Task 31: Trigger export generation child DAG
        ...
        gather_entries_logs >> export_generation

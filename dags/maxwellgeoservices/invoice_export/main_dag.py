...
from maxwellgeoservices.invoice_export.request_payload import get_queuedforsync_invoice


def create_main_dag(config):
    with rail.create_airflow_dag(
        dag_id=f"{config.company_key}_xero_connector_{config.region.replace('-', '_')}_invoice_export_{config.instance}",

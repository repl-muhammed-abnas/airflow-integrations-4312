"""D365 Internal Contact webhook — triggers internal contact sync child DAG."""
import rail


def create_dag(config):
    with rail.create_airflow_dag(
        dag_id=config.internal_contact_webhook_dag_id,
        description='D365 PIM Internal Contact webhook endpoint',
        ...
        trigger_child = rail.TriggerDagRunOperator(
            ...
            trigger_dag_id=config.internal_contact_sync_child_dag_id,

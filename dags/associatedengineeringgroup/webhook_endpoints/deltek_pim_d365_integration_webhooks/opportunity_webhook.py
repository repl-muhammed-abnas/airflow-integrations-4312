"""D365 Opportunity webhook — triggers opportunity sync child DAG."""
import rail


def create_dag(config):
    with rail.create_airflow_dag(
        dag_id=config.opportunity_webhook_dag_id,
        description='D365 PIM Opportunity webhook endpoint',
        ...
        trigger_child = rail.TriggerDagRunOperator(
            task_id='trigger_opportunity_sync',
            trigger_dag_id=config.opportunity_sync_child_dag_id,

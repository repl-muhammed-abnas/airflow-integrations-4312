"""D365 Lead webhook — triggers lead sync child DAG."""
import rail


def create_dag(config):
    with rail.create_airflow_dag(
        dag_id=config.lead_webhook_dag_id,
        description='D365 PIM Lead webhook endpoint',
        ...
        trigger_child = rail.TriggerDagRunOperator(
            task_id='trigger_lead_sync',
            trigger_dag_id=config.lead_sync_child_dag_id,

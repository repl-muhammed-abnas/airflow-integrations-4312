"""D365 External Organisation webhook — triggers external org sync child DAG."""
import rail


def create_dag(config):
    with rail.create_airflow_dag(
        dag_id=config.external_org_webhook_dag_id,
        description='D365 PIM External Organisation webhook endpoint',
        ...
        trigger_child = rail.TriggerDagRunOperator(
            ...
            trigger_dag_id=config.external_org_sync_child_dag_id,

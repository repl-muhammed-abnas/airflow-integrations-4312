...
def create_dag(config):
    ...
    with rail.create_airflow_dag(
        dag_id=f'kla_user_import_usa_cost_center_department_check_v2_{config.instance}',
        description=f'kla_user_import_usa_cost_center_department_check v2 {config.instance}',

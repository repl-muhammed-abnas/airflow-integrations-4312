...
def create_dag(config):
    ...
    with rail.create_airflow_dag(
        dag_id=f'kla_user_import_usa_add_user_{config.instance}',
        description=f'KLATencor User Sync Add {config.instance}',
        ...
        get_put_user_param = rail.PythonOperator(
            ...
            python_callable=lambda: {
                ...
                if get_conf()['pdrcountry'] and 'USA' in get_conf()['pdrcountry'] else
        ...
        has_udf_returnto_work_date_uri >> rail.Label(
            'Yes') >> update_returnto_work_date_udf >> has_firstdayofleave_udfuri
        has_udf_returnto_work_date_uri >> rail.Label(

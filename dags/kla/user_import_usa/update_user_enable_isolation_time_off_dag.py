...
def create_dag(config):
    ...
    with rail.create_airflow_dag(
        dag_id=f'kla_user_import_usa_update_user_enable_isolation_time_off_{config.instance}',
        description=f'USA KLATencor Update User - enable_Isolation_Time Off {config.instance}',

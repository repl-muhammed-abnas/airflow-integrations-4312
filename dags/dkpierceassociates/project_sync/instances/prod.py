from dkpierceassociates.project_sync.config import *
...
# DAG IDs
master_dag_id = f'dkpierceassociates_project_sync_master_{instance}'
process_opportunity_dag_id = f'dkpierceassociates_project_sync_child_{instance}'
...
last_sync_time_variable = 'standard_dkpierceassociates_projectSync_last_sync_time'

...
region = 'eu-central-1'
instance = "production_weekly"
environment = 'production'
company_key = 'pwcfr'

replicon_conn_id = 'pwcfr_replicon_admin'

log_file_path = 'PWCFR/timeoffrecal/pwc_weekly_timeoffrecal_logs'
new_file_path = 'PWCFR/timeoffrecal/timesheetreapprove_weekly_logs'

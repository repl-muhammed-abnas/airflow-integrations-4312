...
internal_logs_email = "PIEReplicon@deltek.com"
...
toil_extract_file_name = 'TOIL_Hours_Extract_{0}_SWE'
timestamp = '%Y%m%d%H%M%S'
s3_output_filepath = "PwCQA/Toil_Extract/Output/"

reference_file_name = "Toil_Reference_Sweden"
...
location = 'Sweden'
dag_id_post_fix = "_".join('Sweden'.split()) # location name to display in dag id(without spaces and special characters)
toil_to_types = ['SWE_Time off in lieu(TOIL)']

prev_period_in_months = 3
report_config = {
    "timesheet_day_template_report_name": "***TOIL Extract TS Day Report - SWE",
    "timeoff_transaction_report_name": "***TOIL Extract TO Transaction Report - SWE",
    "user_template_report_name": "***TOIL Extract User Template Report - SWE",
}
report_sep = ","

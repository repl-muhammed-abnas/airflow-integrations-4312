...
report_config = {
    "timesheet_day_template_report_name": "***TOIL Extract TS Day Report - NLD",
    "timeoff_transaction_report_name": "***TOIL Extract TO Transaction Report - NLD",
    "user_template_report_name": "***TOIL Extract User Template Report - NLD",
}
report_sep = ","

...
toil_extract_file_name = 'TOIL_Hours_Extract_{0}_NLD'
timestamp = '%Y%m%d%H%M%S'
s3_output_filepath = "PwCQA_Test/Toil_Extract/Output/"
...
s3_reference_filepath = "PwCQA_Test/Toil_Extract/Reference/"
s3_reference_archive_filepath = "PwCQA_Test/Toil_Extract/Reference/Archive/"

sftp_conn_id = 'replicon.CIE_sftp'

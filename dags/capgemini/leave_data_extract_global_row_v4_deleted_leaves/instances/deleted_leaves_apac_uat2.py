...
input_filepath = "/Outbound/CancelledLeaveRequestsUAT2/Input"
s3_upload_filepath = "CapgeminiUAT/Outbound/CancelledLeaveRequestsUAT2/Input"
filename_prefix = f"Uat2_{location.replace(' ', '')}_LeaveRequestsCancelled"

report_name = "GTM INT007 LeaveRequestsDeleted APAC"

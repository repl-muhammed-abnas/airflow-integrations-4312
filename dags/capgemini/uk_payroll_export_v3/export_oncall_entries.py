...
def create_child_dag(config):
    with rail.create_airflow_dag(
        ...
        description=f"Capgemini UK Payroll Export On-Call Entries Child {config.instance} V3",
        ...
        send_export_complete_email = rail.EmailOperator(
            ...
            subject='{{ get_company_key() }} | Replicon on-call payroll export for "{{ dag_run.conf.cost_center_group_name }}" group (United Kingdom)'

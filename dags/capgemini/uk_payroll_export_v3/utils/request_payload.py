...
def get_create_payrun_batch_payload_multi_costcenter(dag_run, time_zone):
    """
    Modified version of get_create_payrun_batch_payload to handle multiple cost centers
    This replaces the single cost center version for group-based exports
    """
    current_time = pendulum.now(time_zone)
    get_cost_center_uri = rail.result("get_cost_center_uri")  # This will be a list of URIs
            ...
            "rightExpression": {
                "leftExpression": {
                    ...
                    "rightExpression": {
                        ...
                        "rightExpression": {
                            "value": {
                                # *** KEY CHANGE: Multiple URIs instead of single URI ***
                                "uris": get_cost_center_uri  # List of URIs from get_cost_center_uris task
                            }
                        }
                    }
                },

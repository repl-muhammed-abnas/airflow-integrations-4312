...
filename_prefix = f"Sit_{location.replace(' ', '')}_LeaveRequestsApproved"

report_name = "GTM INT007 LeaveRequestsApproved APAC"
...
previous_day_leave_export_master_dag_id = f'capgemini_leave_data_extract_global_for_previous_day_master_approved_leaves_{export_region}_region_{instance}_{version}'
current_day_leave_export_master_dag_id = f'capgemini_leave_data_extract_global_master_approved_leaves_{export_region}_region_{instance}_{version}'

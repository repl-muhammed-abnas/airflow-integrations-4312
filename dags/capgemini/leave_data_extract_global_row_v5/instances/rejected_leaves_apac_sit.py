...
from capgemini.leave_data_extract_global_row_v5.config import *
...
s3_upload_filepath = "CapgeminiSIT/Outbound/LeaveRequests/Input"
filename_prefix = f"Sit_{location.replace(' ', '')}_LeaveRequestsRejected"

report_name = "GTM INT007 LeaveRequestsRejected APAC"
...
previous_day_leave_export_master_dag_id = f'capgemini_leave_data_extract_global_for_previous_day_master_rejected_leaves_{export_region}_region_{instance}_{version}'
current_day_leave_export_master_dag_id = f'capgemini_leave_data_extract_global_master_rejected_leaves_{export_region}_region_{instance}_{version}'

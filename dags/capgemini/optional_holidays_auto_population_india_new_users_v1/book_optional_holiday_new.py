...
from capgemini.optional_holidays_auto_population_india_new_users_v1.utils import request_payload, custom_methods
from capgemini.optional_holidays_auto_population_india_new_users_v1.utils.response_filter import get_user_timeoff_bookings, get_timeoff_booking_uri, get_user_current_holiday_calendar
...
def create_child_dag(config):
    with rail.create_airflow_dag(
        dag_id=config.booking_child_dagid,
        description=f'Capgemini Auto Population of Optional Holidays India Child V1 {config.instance}',

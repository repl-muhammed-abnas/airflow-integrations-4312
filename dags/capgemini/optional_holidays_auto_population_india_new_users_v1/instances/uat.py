...
replicon_conn_id = 'capgeminiuat_replicon_optional_holiday_admin'
sftp_conn_id = 'sftp_capgemini_502546_CapgeminiUAT'

log_filepath = "/Internal/Optional_Holiday_Booking/Logs"
s3_log_filepath = "CapgeminiUAT/Internal/Optional_Holiday_Booking/Logs"
...
old_tenant_log = f"artifact:CapgeminiUAT:log:{old_tenant_wide_log}"

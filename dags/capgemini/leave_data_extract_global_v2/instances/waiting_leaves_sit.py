...
previous_day_leave_export_master_dag_id = f'capgemini_leave_data_extract_for_previous_day_global_master_leaves_waiting_for_approval_leaves_india_{instance}_v2'
current_day_leave_export_master_dag_id = f'capgemini_leave_data_extract_global_master_leaves_waiting_for_approval_leaves_india_{instance}_v2'

...
filename_prefix = "Uat_IND_LeaveRequestsRejected_TODate"

report_name = "GTM INT007 LeaveRequestsRejected IND TimeOffDate"
...
previous_day_leave_export_master_dag_id = f'capgemini_leave_data_extract_global_for_previous_day_master_rejected_leaves_timeoffdate_india_{instance}'
current_day_leave_export_master_dag_id = f'capgemini_leave_data_extract_global_master_rejected_leaves_timeoffdate_india_{instance}'

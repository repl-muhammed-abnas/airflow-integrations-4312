...
from capgemini.leave_data_extract_global_india_timeoff_date.config import *
...
filename_prefix = "Uat_IND_LeaveRequestsWaiting_TODate"

report_name = "GTM INT007 LeaveRequestsWaiting IND TimeOffDate"
...
previous_day_leave_export_master_dag_id = f'capgemini_leave_data_extract_global_for_previous_day_master_waiting_for_approval_leaves_timeoffdate_india_{instance}'
current_day_leave_export_master_dag_id = f'capgemini_leave_data_extract_global_master_waiting_for_approval_leaves_timeoffdate_india_{instance}'

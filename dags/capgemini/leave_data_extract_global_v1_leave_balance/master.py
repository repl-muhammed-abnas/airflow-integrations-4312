...
import pendulum
from capgemini.leave_data_extract_global_v1_leave_balance.utils import custom_methods
...
def create_dag(config):
    ...
    with rail.create_airflow_dag(
        dag_id=f'capgemini_leave_data_extract_global_master_v1_{leave_status}_{config.instance}',

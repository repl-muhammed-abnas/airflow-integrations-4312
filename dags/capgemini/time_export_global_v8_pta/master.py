...
import pendulum
from capgemini.time_export_global_v8_pta.tasks.time_data_export import time_data_export
from capgemini.time_export_global_v8_pta.tasks.update_export_status import cancel_time_export
from capgemini.time_export_global_v8_pta.utils import custom_methods
from capgemini.time_export_global_v8_pta.utils import request_payload
...
def create_dag(config):
    with rail.create_airflow_dag(
        ...
        description=f'Capgemini Time export global V8 PTA Master {config.instance}',

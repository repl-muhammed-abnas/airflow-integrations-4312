...
from capgemini.time_export_global_v8.tasks.time_data_export import time_data_export
from capgemini.time_export_global_v8.tasks.update_export_status import cancel_time_export
...
def create_child_dag(config):
    with rail.create_airflow_dag(
        ...
        description=f'Capgemini Time Export Global Create Export Child {config.instance} V8',
        ...
        can_run_batch_task = rail.IfOperator(
            ...
            yes_task='batch_task',
            no_task='get_time_download_script'
        )

        batch_task = rail.BatchTaskRunOperator(
            task_id='batch_task',
            start_task='get_time_download_script',
        ...
        can_run_batch_task >> rail.Label('No') >> get_time_download_script >> time_export_batch_start

...
from capgemini.leave_data_extract_global_row_timeoff_date.config import *
...
export_columns = ['Leave Request ID', 'Employee ID', 'Local Employee Number', 'Time Off Type',
                  ...
                  'Modified On', 'In Lieu Date', 'Reason for Special Leave', 'Reason (PL)', '01 - Booking Day (Start Day)', '02 - Booking Day (End Day)', 'Row Number']

input_filepath = "/Outbound/LeaveRequests_TimeOffDate/Input"
s3_upload_filepath = "CapgeminiUAT/Outbound/LeaveRequests_TimeOffDate/Input"
filename_prefix = f"Uat_{location.replace(' ', '')}_LeaveRequestsWaiting_TODate"

report_name = "GTM INT007 LeaveRequestsWaiting ROW TimeOffDate"
...
previous_day_leave_export_master_dag_id = f'capgemini_leave_data_extract_global_for_previous_day_master_waiting_for_approval_leaves_timeoffdate_{export_region}_region_{instance}'
current_day_leave_export_master_dag_id = f'capgemini_leave_data_extract_global_master_waiting_for_approval_leaves_timeoffdate_{export_region}_region_{instance}'

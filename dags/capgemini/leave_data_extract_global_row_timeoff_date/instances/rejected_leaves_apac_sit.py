...
filename_prefix = f"Sit_{location.replace(' ', '')}_LeaveRequestsRejected_TODate"

report_name = "GTM INT007 LeaveRequestsRejected APAC TimeOffDate"
...
previous_day_leave_export_master_dag_id = f'capgemini_leave_data_extract_global_for_previous_day_master_rejected_leaves_timeoffdate_{export_region}_region_{instance}'
current_day_leave_export_master_dag_id = f'capgemini_leave_data_extract_global_master_rejected_leaves_timeoffdate_{export_region}_region_{instance}'

...
def create_child_dag(config):
    with rail.create_airflow_dag(
        ...
        description=f"Capgemini UK Payroll Export On-Call Entries Child {config.instance} V1",
        ...
        send_export_complete_email = rail.EmailOperator(
            ...
            subject='{{ get_company_key() }} | Replicon Payroll Export of oncall entries of {{ dag_run.conf.cost_center_name }} cost center for United Kingdom'

...
filename_prefix = "Sit_ROW_LeaveRequestsApproved"
...
previous_day_leave_export_master_dag_id = f'capgemini_leave_data_extract_for_previous_day_global_master_approved_leaves_rest_of_world_{instance}_v3'
current_day_leave_export_master_dag_id = f'capgemini_leave_data_extract_global_master_approved_leaves_rest_of_world_{instance}_v3'

...
from capgemini.leave_data_extract_global_row_v3.config import *
...
filename_prefix = "Sit_ROW_LeaveRequestsWaiting"

report_name = "GTM INT007 LeaveRequestsWaitingForApproval ROW"
...
previous_day_leave_export_master_dag_id = f'capgemini_leave_data_extract_for_previous_day_global_master_leaves_waiting_for_approval_leaves_rest_of_world_{instance}_v3'
current_day_leave_export_master_dag_id = f'capgemini_leave_data_extract_global_master_leaves_waiting_for_approval_leaves_rest_of_world_{instance}_v3'

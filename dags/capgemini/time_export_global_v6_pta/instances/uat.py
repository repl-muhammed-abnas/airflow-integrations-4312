...
from capgemini.time_export_global_v6_pta.config import *
...
can_send_time_export_downstream = f'capgemini_time_export_global_pta_send_downstream_{instance}_v6'
can_run_batch_task_var_name = f'capgemini_time_export_global_v6_pta_can_run_batch_task_{instance}'

master_dagid = f'capgemini_time_export_global_v6_pta_master_{instance}'

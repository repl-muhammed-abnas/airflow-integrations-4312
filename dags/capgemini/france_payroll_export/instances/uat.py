...
gfs_pgp_conn_id = 'pgp_capgeminiuat'

input_filepath_sopra = "/Outbound/France_Payroll_Export_SOPRA/Input"
s3_upload_filepath_sopra = "CapgeminiUAT/Outbound/France_Payroll_Export_SOPRA/Input"
input_filepath_gfs = "/Outbound/France_Payroll_Export_GFS/Input"
s3_upload_filepath_gfs = "CapgeminiUAT/Outbound/France_Payroll_Export_GFS/Input"
filename_prefix = "UAT"

...
import pendulum
from capgemini.time_export_v2.utils import custom_methods
from capgemini.time_export_v2.utils import request_payload
from capgemini.time_export_v2.tasks.time_data_export import time_data_export
from capgemini.time_export_v2.tasks.update_export_status import cancel_time_export
...
def create_dag(config):
    ...
    with rail.create_airflow_dag(
        dag_id=f'capgemini_time_export_master_{config.instance}_v2',
        description=f'Capgemini Time export Master {config.instance} V2',
        ...
        can_send_downstream >> rail.Label("Yes") >> get_export_creation_datetime >> write_time_data_to_csv >> upload_time_export_to_s3 \
            >> encrypt_time_export_data_csv >> upload_time_export_to_sftp >> set_export_filename >> send_valid_export_complete_email \
                >> log_to_sumo_time_export >> get_filename

...
from capgemini.time_export_global_v2.tasks.time_data_export import time_data_export
from capgemini.time_export_global_v2.tasks.update_export_status import cancel_time_export
from capgemini.time_export_global_v2.utils import custom_methods
from capgemini.time_export_global_v2.utils import request_payload
...
def create_child_dag(config):
    with rail.create_airflow_dag(
        dag_id=f'capgemini_time_export_global_create_export_child_{config.instance}_v2',
        description=f'Capgemini Time export global create export child {config.instance} V2',
        ...
        upload_blank_time_export_to_s3 = rail.S3UploadFileOperator(
            task_id='upload_blank_time_export_to_s3',
        ...
        time_export_batch_end >> get_export_creation_datetime >> create_timeexport_collection >> has_data
        ...
        can_send_downstream >> rail.Label("Yes") >> write_time_data_to_csv >> upload_time_export_to_s3 \
            >> encrypt_time_export_data_csv >> upload_time_export_to_sftp >> send_valid_export_complete_email \
                >> log_to_sumo_time_export >> dagrun_log_to_sumo
        ...
        has_data >> rail.Label("No") >> update_export_name_to_no_data >> write_blank_time_data_to_csv \
            >> upload_blank_time_export_to_s3 >> encrypt_blank_time_export_data_csv >> upload_blank_time_export_to_sftp \

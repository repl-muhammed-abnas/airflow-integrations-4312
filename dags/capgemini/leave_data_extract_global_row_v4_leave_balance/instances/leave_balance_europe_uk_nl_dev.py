...
location = 'Europe'
region_identifier = 'uk_nl'  # Set 2: UNITED KINGDOM, NETHERLANDS (22,378 users)
...
filename_prefix = f"Dev_{location.replace(' ', '')}_LeaveBalance"
filename_seconds_suffix = "10"

report_name = "GTM INT007 FSD LeaveHeader(ISG DB) - EU - UK_NL"

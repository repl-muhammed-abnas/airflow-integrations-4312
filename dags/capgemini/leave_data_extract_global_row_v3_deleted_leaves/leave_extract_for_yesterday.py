...
import pendulum
from capgemini.leave_data_extract_global_row_v3_deleted_leaves.utils import custom_methods
from capgemini.leave_data_extract_global_row_v3_deleted_leaves.tasks.get_tenant_wide_logs import get_tenant_wide_logs
...
def create_dag(config):
    with rail.create_airflow_dag(
        ...
        description=f'Capgemini Leave Data Export Global Master for Previous Day {config.leave_status} {config.location} {config.instance} V3',

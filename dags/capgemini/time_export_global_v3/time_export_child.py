...
from capgemini.time_export_global_v3.tasks.time_data_export import time_data_export
from capgemini.time_export_global_v3.tasks.update_export_status import cancel_time_export
from capgemini.time_export_global_v3.utils import custom_methods
from capgemini.time_export_global_v3.utils import request_payload
...
def create_child_dag(config):
    with rail.create_airflow_dag(
        ...
        description=f'Capgemini Time Export Global Create Export Child {config.instance} V3',

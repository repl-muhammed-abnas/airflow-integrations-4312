...
filename_prefix = "Uat2_LeaveRequestsApproved"
...
previous_day_leave_export_master_dag_id = f'capgemini_leave_data_extract_for_previous_day_global_master_approved_leaves_india_{instance}_{version}'
current_day_leave_export_master_dag_id = f'capgemini_leave_data_extract_global_master_approved_leaves_india_{instance}_{version}'

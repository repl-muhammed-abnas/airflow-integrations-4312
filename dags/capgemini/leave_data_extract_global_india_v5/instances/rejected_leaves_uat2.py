...
from capgemini.leave_data_extract_global_india_v5.config import *
...
input_filepath = "/Outbound/LeaveRequestsUAT2/Input"
s3_upload_filepath = "CapgeminiUAT/Outbound/LeaveRequestsUAT2/Input"
filename_prefix = "Uat2_LeaveRequestsRejected"

report_name = "GTM INT007 LeaveRequestsRejected"
...
previous_day_leave_export_master_dag_id = f'capgemini_leave_data_extract_for_previous_day_global_master_rejected_leaves_india_{instance}_{version}'
current_day_leave_export_master_dag_id = f'capgemini_leave_data_extract_global_master_rejected_leaves_india_{instance}_{version}'

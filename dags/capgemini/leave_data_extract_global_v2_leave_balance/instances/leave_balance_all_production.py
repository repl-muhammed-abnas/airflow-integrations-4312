...
from capgemini.leave_data_extract_global_v2_leave_balance.config import *

instance = 'production_all'
...
filename_prefix = "Prod_IND_ALL_LeaveBalance"

report_name = "GTM INT007 FSD LeaveHeader(ISG DB) - India(All)"
...
leave_balance_export_master_dag_id = f'capgemini_leave_data_extract_global_master_leave_balance_india_all_{instance}_v2'

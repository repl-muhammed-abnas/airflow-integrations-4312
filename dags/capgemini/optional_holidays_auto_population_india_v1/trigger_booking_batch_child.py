...
def create_child_dag(config):
    with rail.create_airflow_dag(
        dag_id=config.trigger_booking_batch_childs_dagid,
        ...
        def get_trigger_id(dag_run):
            ...
            if batch_num == 0:
                return config.booking_child_dagid
            return f'capgemini_auto_population_of_optional_holidays_book_optional_holiday_child_batch_{batch_num}_{config.instance}_v1'

...
import pendulum
from capgemini.optional_holidays_auto_population_india_v1.utils import custom_methods
...
def create_dag(config):
    with rail.create_airflow_dag(
        dag_id=config.existing_user_master_dagid,
        ...
        logging_details = rail.PythonOperator(
            ...
            op_args=[config.time_zone, config.states_optional_holiday_calendars, "existing_user"]
        )
        ...
        process_optional_holidays = rail.TriggerDagRunForEachItemOperator(
            ...
            trigger_dag_id=config.process_esisting_users_dagid,

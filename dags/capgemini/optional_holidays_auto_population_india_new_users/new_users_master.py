...
import pendulum
from capgemini.optional_holidays_auto_population_india_new_users.tasks.send_logs import get_send_logs
from capgemini.optional_holidays_auto_population_india_new_users.utils import custom_methods, request_payload
...
def create_dag(config):
    with rail.create_airflow_dag(
        dag_id=f'capgemini_auto_population_of_optional_holidays_india_new_users_master_{config.instance}_v0',
        description=f'Capgemini Auto Population of Optional Holidays India for New Users Master v0 {config.instance}',
        ...
        process_new_users = rail.trigger_parallel_dagrun(
            ...
            trigger_dag_id=f'capgemini_auto_population_of_optional_holidays_india_process_new_users_{config.instance}_v0',
            conf=lambda item: {

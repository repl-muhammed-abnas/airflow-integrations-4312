...
from capgemini.optional_holidays_auto_population_india_new_users.utils import response_filter
from capgemini.optional_holidays_auto_population_india_new_users.utils import request_payload
from capgemini.optional_holidays_auto_population_india_new_users.utils import python_callable
...
def create_child_dag(config):
    with rail.create_airflow_dag(
        dag_id=f'capgemini_auto_population_of_optional_holidays_india_process_new_users_{config.instance}_v0',
        description=f'Capgemini Auto Population of Optional Holidays India for New Users process v0 {config.instance}',
        ...
        book_optional_holiday = rail.TriggerDagRunOperator(
            ...
            trigger_dag_id=f'capgemini_auto_population_of_optional_holidays_india_book_optional_holiday_child_new_user_{config.instance}_v0',
            conf=lambda dag_run: {
                "properties": {

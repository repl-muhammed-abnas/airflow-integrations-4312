...
replicon_conn_id = 'capgemini_replicon_optional_holiday_admin'
sftp_conn_id = 'sftp_capgemini_502546_Capgemini'

log_filepath = "/Internal/Optional_Holiday_Booking/Logs"
s3_log_filepath = "Capgemini/Internal/Optional_Holiday_Booking/Logs"
...
old_tenant_log = f"artifact:Capgemini:log:{old_tenant_wide_log}"

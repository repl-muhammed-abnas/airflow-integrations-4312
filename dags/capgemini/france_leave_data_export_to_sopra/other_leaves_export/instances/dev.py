...
from capgemini.france_leave_data_export_to_sopra.other_leaves_export.config import *
...
expected_approved_report_columns = "Employee ID;Booking Start Date;Booking End Date;Time Off Type;Booking Day;Time Off Hrs;Approval Status;Booking Uri"
...
approved_leaves_report_name = "France 032A Other Leaves - Approved"
...
master_dag_id = f'capgemini_france_leave_data_extract_to_sopra_other_leaves_master_{instance}'

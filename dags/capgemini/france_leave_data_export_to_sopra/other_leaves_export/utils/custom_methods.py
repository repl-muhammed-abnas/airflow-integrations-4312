...
import pendulum
from capgemini.france_leave_data_export_to_sopra.other_leaves_export.mapper.timeoff_codes import timeoff_codes_list
import rail
null = None
...
def get_approved_leave_data_rows(item):
    return [
        ...
        item["booking_day"] if item["booking_day"] == "Afternoon" else "",
        item["booking_day"] if item["booking_day"] == "Morning" else "",

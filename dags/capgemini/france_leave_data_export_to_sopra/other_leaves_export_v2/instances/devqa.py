...
from capgemini.france_leave_data_export_to_sopra.other_leaves_export_v2.config import *
from capgemini.deleted_timeoff_booking_webhook_logging.instances.dev import tenant_wide_log_list as twl_list
from capgemini.france_leave_data_export_to_sopra.other_leaves_export_v2.mapper.timeoff_codes_devqa import timeoff_codes
...
s3_upload_filepath = "CapgeminiDev/Outbound/FRA_Sopra_OtherLeaves/Input"
filename_prefix = "Replicon_DEV_Other_Leaves_FRA"

approved_leaves_report_name = "France 032A Other Leaves - Approved_V2 QA"
deleted_leaves_report_name = "France 032A Other Leaves - Deleted QA"
...
master_dag_id = f'capgemini_france_leave_data_extract_to_sopra_other_leaves_master_{instance}_v2'

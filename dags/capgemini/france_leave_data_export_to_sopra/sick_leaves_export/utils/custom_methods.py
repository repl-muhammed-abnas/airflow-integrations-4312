...
import pendulum
from capgemini.france_leave_data_export_to_sopra.sick_leaves_export.mapper.timeoff_codes import timeoff_codes_list
import rail
null = None
...
def get_approved_leave_data_rows(item):
    return [
        ...
        "Creation",
        "",
        item["initial_or_extension"],
        item["worked_on_start_date"]
    ]

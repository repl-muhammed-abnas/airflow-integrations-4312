...
from capgemini.france_leave_data_export_to_sopra.sick_leaves_export.config import *
...
s3_upload_filepath = "CapgeminiUAT/Outbound/FRA_Sopra_SickLeaves/Input"
filename_prefix = "Replicon_UAT_Sick_Leaves_FRA"
...
master_dag_id = f'capgemini_france_leave_data_extract_to_sopra_sick_leaves_master_{instance}'

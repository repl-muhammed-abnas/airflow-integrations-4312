...
import pendulum
from capgemini.france_leave_data_export_to_sopra.sick_leaves_export.utils import custom_methods, request_payload
...
def create_dag(config):
    with rail.create_airflow_dag(
        ...
        logging_details >> can_run_deleted_leaves_batch_task >> rail.Label("Yes") \

...
filename_prefix = f"Sit_{location.replace(' ', '')}_LeaveRequestsWaiting"

report_name = "GTM INT007 LeaveRequestsWaiting APAC"
...
previous_day_leave_export_master_dag_id = f'capgemini_leave_data_extract_global_for_previous_day_master_waiting_for_approval_leaves_{export_region}_region_{instance}_v4'
current_day_leave_export_master_dag_id = f'capgemini_leave_data_extract_global_master_waiting_for_approval_leaves_{export_region}_region_{instance}_v4'

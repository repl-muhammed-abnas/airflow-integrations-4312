...
import pendulum
from capgemini.leave_data_extract_global.utils import custom_methods
...
def create_dag(config):
    if config.leave_status != 'leave balance':
        ...
        with rail.create_airflow_dag(
            dag_id=f'capgemini_leave_data_extract_for_previous_day_global_master_{leave_status}_{config.instance}',
            description=f'Capgemini Leave Data Export Global Master for Previous Day {leave_status} {config.instance}',

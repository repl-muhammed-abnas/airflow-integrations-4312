...
def do_format_logs():
    ...
    logs = (rail.result("gather_process_approved_timeoffs_logs") if rail.result("gather_process_approved_timeoffs_logs") else []) + \
        (rail.result("gather_process_deleted_timeoffs_logs") if rail.result("gather_process_deleted_timeoffs_logs") else [])

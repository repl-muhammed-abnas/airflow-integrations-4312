...
from capgemini.france_sellback_leaves_transfer_v2.utils import request_payload
from capgemini.france_sellback_leaves_transfer_v2.tasks.send_logs import get_send_logs
import rail
...
def create_dag(config):
    with rail.create_airflow_dag(
        ...
        description=f'Capgemini France Sellback Leaves Transfer Master {config.instance} V2',
        ...
        trigger_assign_policy_to_user = rail.trigger_parallel_dagrun(
            ...
            conf=lambda item: {
                ...
                "transfer_bal_to_timeoff": config.timeoff_types_mapper.get(item["timeofftype"]),

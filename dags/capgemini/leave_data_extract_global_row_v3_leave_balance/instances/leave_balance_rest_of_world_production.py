...
from capgemini.leave_data_extract_global_row_v3_leave_balance.config import *
...
filename_prefix = "Prod_ROW_LeaveBalance"
...
leave_balance_export_master_dag_id = f'capgemini_leave_data_extract_global_master_leave_balance_rest_of_world_{instance}_v3'

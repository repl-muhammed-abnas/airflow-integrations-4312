...
from capgemini.time_export_global_v3_pta.config import *
...
can_send_time_export_downstream = "capgeminiuat_time_export_global_v3_pta_send_downstream"
can_run_batch_task_var_name = f'capgemini_time_export_global_v3_pta_can_run_batch_task_{instance}'

master_dagid = f'capgemini_time_export_global_v3_pta_master_{instance}'

...
def create_child_dag(config):
    with rail.create_airflow_dag(
        ...
        description=f"Capgemini UK Payroll Export Overtime Entries Child {config.instance} V2",
        ...
        send_export_complete_email = rail.EmailOperator(
            ...
            subject='{{ get_company_key() }} | Replicon overtime payroll export for "{{ dag_run.conf.cost_center_name }}" cost center (United Kingdom)'

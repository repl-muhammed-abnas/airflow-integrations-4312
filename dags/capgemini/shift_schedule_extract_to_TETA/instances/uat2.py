...
pgp_conn_id = 'pgp_shift_schedule_extract_teta_capgeminiuat2'

input_filepath = "/Outbound/TETA_ShiftUAT2/Input"
s3_upload_filepath = "CapgeminiUAT/Outbound/TETA_ShiftUAT2/Input"

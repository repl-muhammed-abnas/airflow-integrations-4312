...
from capgemini.optional_holidays_auto_population_india.tasks.send_logs import get_send_logs
...
def create_child_dag(config):
    with rail.create_airflow_dag(
        dag_id=f'capgemini_process_existing_users_optional_holidays_child_{config.instance}',
        ...
        book_optional_holiday = rail.TriggerDagRunForEachItemOperator(
            ...
            trigger_dag_id=f"capgemini_book_optional_holiday_trigger_booking_batch_child_{config.instance}",

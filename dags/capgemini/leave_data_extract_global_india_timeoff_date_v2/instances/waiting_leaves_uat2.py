...
from capgemini.leave_data_extract_global_india_timeoff_date_v2.config import *
...
input_filepath = "/Outbound/LeaveRequests_TimeOffDateUAT2/Input"
s3_upload_filepath = "CapgeminiUAT/Outbound/LeaveRequests_TimeOffDateUAT2/Input"
filename_prefix = "Uat2_IND_LeaveRequestsWaiting_TODate"
...
previous_day_leave_export_master_dag_id = f'capgemini_leave_data_extract_global_for_previous_day_master_waiting_for_approval_leaves_timeoffdate_india_{instance}_{version}'
current_day_leave_export_master_dag_id = f'capgemini_leave_data_extract_global_master_waiting_for_approval_leaves_timeoffdate_india_{instance}_{version}'

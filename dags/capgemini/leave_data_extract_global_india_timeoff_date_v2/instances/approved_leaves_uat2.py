...
filename_prefix = "Uat2_IND_LeaveRequestsApproved_TODate"
...
previous_day_leave_export_master_dag_id = f'capgemini_leave_data_extract_global_for_previous_day_master_approved_leaves_timeoffdate_india_{instance}_{version}'
current_day_leave_export_master_dag_id = f'capgemini_leave_data_extract_global_master_approved_leaves_timeoffdate_india_{instance}_{version}'

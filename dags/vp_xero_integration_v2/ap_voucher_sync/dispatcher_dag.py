# dags/vp_xero_integration_v2/ap_voucher_sync/dispatcher_dag.py
"""Dispatcher DAG for VP -> Xero AP Voucher Sync (V2 IPA GitSync architecture).
...
import rail
from vp_xero_integration_v2.ap_voucher_sync.config import (
...
def create_dag(config):
    """Per-tenant dispatcher: poll PSALedger, fan out to per-voucher create DAG."""
    ...
    with rail.create_airflow_dag(
        ...
        def build_processor_dag_conf(item):
            ...
            return {
                ...
                'CFG_VoucherStatusSubmitted': (
                    ...
                    or (config.extras or {}).get('CFG_VoucherStatusSubmitted', '')
                ),
        ...
        # from vp_xero_integration_v2.common reads this exact XCom key.
        ...
        # Main spine
        prepare_timestamps >> get_changed_psaledger_ap_rows >> extract_ap_vouchers >> check_if_ap_vouchers_exist

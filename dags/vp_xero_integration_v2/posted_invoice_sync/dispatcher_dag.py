"""
Dispatcher DAG for VP PSA -> Xero Posted Invoices Sync (V2 IPA GitSync architecture).
...
import rail
from vp_xero_integration_v2.posted_invoice_sync.config import (
...
def create_dag(config):
    ...
    # V2: inject connections and customerId from instance config (not dag_run.conf).

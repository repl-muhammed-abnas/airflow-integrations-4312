# dags/vp_xero_integration_v2/posted_unit_transaction_sync/journal_export_create_dag.py
"""
Journal Export Create DAG for VP -> Xero Posted Unit Transaction Sync (V2).
...
def create_dag(config):
    ...
    with rail.create_airflow_dag(
        ...
        # execution time. Narration is the deterministic "UN {Period} {PostSeq}"
        ...
        search_existing_manual_journal = rail.XeroManualJournalOperator(
            ...
            operation='search',
            where=(
                'Narration=="UN {{ dag_run.conf.Period }} '

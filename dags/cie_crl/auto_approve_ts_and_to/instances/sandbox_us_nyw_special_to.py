...
holiday_calender_name = "Timesheet Approval - US - Weekly (Exception)"
...
ts_report_name = "TS_TO_autoapproval - US Weekly"
to_report_name = "TimeOff Booking Details - US Weekly"

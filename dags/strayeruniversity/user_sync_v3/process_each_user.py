...
def create_dag(config):
    ...
    with rail.create_airflow_dag(
        dag_id=f'strayeruniversity_usersync_proecss_each_user_child_v3_{config.instance}',
        description=f'strayeruniversity_usersync_proecss_each_user_child_v3_{config.instance}',
        ...
        process_disable_user = rail.TriggerDagRunOperator(
            ...
            trigger_dag_id=f'strayeruniversity_usersync_disable_user_child_v3_{config.instance}',
        ...
        process_update_user = rail.TriggerDagRunOperator(
            ...
            trigger_dag_id=f'strayeruniversity_usersync_update_user_child_v3_{config.instance}',
        ...
        process_add_user = rail.TriggerDagRunOperator(
            ...
            trigger_dag_id=f'strayeruniversity_usersync_add_user_child_v3_{config.instance}',

...
import rail
from strayeruniversity.user_sync_v3.utils.request_payload import get_customfield_dropdown_option_uris


def create_dag(config):
    # pylint: disable=too-many-statements, line-too-long
    with rail.create_airflow_dag(
        dag_id=f'strayeruniversity_managementlevel_customfield_check_child_v3_{config.instance}',
        description=f'strayeruniversity_managementlevel_customfield_check_child_v3_{config.instance}',

import rail
from strayeruniversity.user_sync_v3.utils.request_payload import get_put_timeoffpolicywithinitialbalance
from strayeruniversity.user_sync_v3.utils.python_callable import construct_policyschedule


def create_dag(config):
    # pylint: disable=too-many-statements, line-too-long
    with rail.create_airflow_dag(
        dag_id=f'strayeruniversity_usersync_assign_0_balance_timeoff_child_v3_{config.instance}',
        description=f'strayeruniversity_usersync_assign_0_balance_timeoff_child_v3_{config.instance}',

...
from strayeruniversity.user_sync_v3.utils.python_callable import get_today, get_current_data, get_substitueUserUris, get_substitueUser_fromsearch
from strayeruniversity.user_sync_v3.utils.request_payload import get_today_dateformat_payload
...
def create_dag(config):
    ...
    with rail.create_airflow_dag(
        dag_id=f'strayeruniversity_usersync_update_user_child_v3_{config.instance}',
        description=f'strayeruniversity_usersync_update_user_child_v3_{config.instance}',

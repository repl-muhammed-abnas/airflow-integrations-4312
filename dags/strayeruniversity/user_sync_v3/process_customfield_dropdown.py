...
import rail
from strayeruniversity.user_sync_v3.utils.request_payload import get_customfield_dropdown_option


def create_dag(config):
    # pylint: disable=too-many-statements, line-too-long
    with rail.create_airflow_dag(
        dag_id=f'strayeruniversity_process_customfield_for_dropdown_child_v3_{config.instance}',
        description=f'strayeruniversity_process_customfield_for_dropdown_child_v3_{config.instance}',

...
def create_dag(config):
    ...
    with rail.create_airflow_dag(
        dag_id=f'strayeruniversity_usersync_assign_substitute_user_child_v3_{config.instance}',
        description=f'strayeruniversity_usersync_assign_substitute_user_child_v3_{config.instance}',

...
import rail
from strayeruniversity.user_sync_v4.utils import python_callable, request_payload
...
def create_dag(config):
    ...
    with rail.create_airflow_dag(
        dag_id=config.child_remove_future_time_off_bookings_dag_id,
        description=f'strayeruniversity_usersync_remove_future_time_off_bookings_child',

...
def create_dag(config):
    ...
    with rail.create_airflow_dag(
        ...
        description=f'strayeruniversity_usersync_disable_user_child',
        ...
        trigger_assign_0_balance_timeoff = rail.TriggerDagRunForEachItemOperator(
            ...
            trigger_dag_id=config.child_assign_0_balance_timeoff_dag_id,
        ...
        trigger_remove_future_time_off_bookings = rail.TriggerDagRunOperator(
            ...
            trigger_dag_id=config.child_remove_future_time_off_bookings_dag_id,
            execution_timeout=timedelta(days=config.execution_timeout_days),
            conf=lambda dag_run: {
                "useruri": dag_run.conf['useruri'],
                "terminationdate": dag_run.conf['termdate']

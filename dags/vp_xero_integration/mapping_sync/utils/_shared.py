...
from vp_xero_integration.common.python_callable_method import build_customer_variable_key
...
def apply_premapping_state():
    ...
    CFG_UpgradeDataSync is not applicable to vp_xero_integration. The

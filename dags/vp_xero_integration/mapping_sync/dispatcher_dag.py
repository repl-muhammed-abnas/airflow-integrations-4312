"""
Dispatcher DAG for VP Xero Mapping Sync.
...
per-step content-aware premapping, triggers the four mapping_sync child DAGs
in priority order, gathers any child errors, and either fails the run or posts a
...
def create_dag(config):
    ...
    with rail.create_airflow_dag(
        ...
        description='Per-customer mapping population dispatcher (orchestrates 4 child DAGs)',

"""
Dispatcher DAG for VP -> Xero Posted Journal Entry Sync.
...
from vp_xero_integration.posted_journal_sync.utils.python_callable_method import (  # noqa: E501
...
def create_dag(config):
    ...
    with rail.create_airflow_dag(
        ...
        # Mirrors Workato disabled-account-property convention. Variable:
        # CFG_DisableJournalXeroIntegration_{instance}.
        ...
        log_no_records = rail.PythonOperator(
            ...
            python_callable=lambda: print(
                'No new/updated PSA journal-entry records in this poll '
                'window.'
            )
        )

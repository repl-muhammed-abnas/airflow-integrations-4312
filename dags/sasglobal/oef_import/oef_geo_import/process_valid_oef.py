from sasglobal.oef_import.oef_geo_import.utils import custom_methods
from sasglobal.oef_import.oef_geo_import.tasks.update_status import update_oef_status_task
from sasglobal.oef_import.oef_geo_import.utils import request_payload
import rail
...
def create_main_dag(config):
    with rail.create_airflow_dag(
        dag_id=f'sasglobal_oef_geo_import_process_valid_oef_child_{config.instance}',
        description=f'SaSGlobal OEF GEO Import Process Valid OEF Child DAG {config.instance}',
        ...
        create_oef_draft = rail.RepliconServiceOperator(
            ...
            data={
                "objectExtensionTagDefinitionUri": "{{ dag_run.conf.geo_oef_uri }}"
            }
        )

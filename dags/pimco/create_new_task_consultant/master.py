...
from pimco.create_new_task_consultant.utils import python_callable
...
def create_dag(config):
    with rail.create_airflow_dag(
        dag_id=f'pimco_add_new_task_to_consultant_project_master_dag_{config.instance}',
        description=f'PIMCO Add new task to consultant project master dag {config.instance}',
        ...
        process_task_levels = rail.TriggerDagRunForEachItemOperator(
            ...
            trigger_dag_id=f'pimco_consultant_process_task_levels_child_dag_{config.instance}',

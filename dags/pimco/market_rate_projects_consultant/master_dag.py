...
import rail
from pimco.market_rate_projects_consultant.utils import request_payload
from pimco.market_rate_projects_consultant.utils import response_filter
from pimco.market_rate_projects_consultant.utils import python_callable_method

# pylint: disable=too-many-statements
def create_main_airflow_dag(config):
    with rail.create_airflow_dag(
        dag_id=f'pimco_market_rate_consultant_project_master_{config.instance}',
        description='PIMCO_Market_Rate_consultant_Project_Automation Master',
        ...
        process_market_rate_update_child = rail.trigger_parallel_dagrun(
            ...
            trigger_dag_id=f'pimco_market_rate_consultant_project_child_{config.instance}',

...
def create_dag(config):
    ...
    with rail.create_airflow_dag(
        dag_id=f'ge_user_sync_ge_netherlands_schedule_add_master_v1_0_{config.instance}',
        ...
        trigger_dag_run_ge_user_sync_netherlands_ge_netherlands_child_schedule_add_v1_020 = rail.TriggerDagRunForEachItemOperator(
            ...
            trigger_dag_id=f'ge_user_sync_ge_netherlands_child_schedule_add_v1_0_{config.instance}',

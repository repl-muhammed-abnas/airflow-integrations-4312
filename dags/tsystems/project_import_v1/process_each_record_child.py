...
import rail
from tsystems.project_import_v1.utils import request_payload, custom_methods
...
def create_process_each_record_dag(config):
    ...
    with rail.create_airflow_dag(
        ...
        # Version 1.6: Check if restriction-based team eligibility is required
        # Runs when assign_from_department_uris OR assign_from_employee_type_uris are present
        ...
        has_team_assignment >> rail.Label("Yes") >> assign_team_members_to_project >> log_project_success

...
import rail
from tsystems.timeoff_import_india.utils import custom_methods, request_payload, response_filter
...
def create_child_dag(config):
    with rail.create_airflow_dag(
        ...
        is_transaction_id_available >> rail.Label('No') >> create_time_off_draft >> put_timeoff_entry
        put_timeoff_entry >> publish_time_off_draft >> put_timeoff_transaction_id_oef_value >> get_time_off_approval_status >> is_timeoff_approved

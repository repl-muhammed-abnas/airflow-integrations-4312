...
input_filepath = '/TEST/IN/Activity Type Import Integration/INPUT'
archive_filepath = '/TEST/IN/Activity Type Import Integration/ARCHIVE'
log_filepath = '/TEST/IN/Activity Type Import Integration/LOGS'

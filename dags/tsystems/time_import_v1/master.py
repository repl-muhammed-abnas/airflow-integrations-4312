...
# Import utilities
from tsystems.time_import_v1.utils import custom_methods, request_payload
from tsystems.time_import_v1.task.get_prereqs import get_prereqs_task_group
...
def create_dag(config):
    ...
    with rail.create_airflow_dag(
        ...
        process_records >> [store_valid_records, store_invalid_records] >> log_invalid_records >> has_valid_records

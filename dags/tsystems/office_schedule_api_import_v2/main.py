...
import rail
from tsystems.office_schedule_api_import_v2.utils import custom_methods
...
def create_dag(config):
    ...
    with rail.create_airflow_dag(
        ...
        foreach_create_holiday_calendars_end >> get_all_updated_holiday_calendars >> trigger_assign_schedule_to_employee >> wait_for_assign_schedule_to_employee >> gather_assignment_logs >>\
        format_logs

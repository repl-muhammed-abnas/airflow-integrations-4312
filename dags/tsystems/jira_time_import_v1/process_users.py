...
from tsystems.jira_time_import_v1.utils import request_payload, custom_methods, response_filters
...
def create_child_dag(config):
    ...
    with rail.create_airflow_dag(
        ...
        if_user_uri_present >> rail.Label("Yes") >> if_activity_assigned_to_user

...
log_filepath = '/LOGS/'
sftp_conn_id = "sftp_tsystems_Replicon_TS_Masterdata"

# REPLICON SFTP ACCOUNT
reference_filepath = '/TSystems PROD/Replicon_TS_Masterdata/reference/'
reference_archive_filepath = '/TSystems PROD/Replicon_TS_Masterdata/reference/archive'

...
def create_users_payload_from_variable(item, config):
    ...
    # Get the groups data
    # Note: Variable name 'orgstsructure_group_data' contains a typo but is kept for consistency with v1 production code
...
def get_error_message():
    ...
    except:  # Bare except is intentional - safely return default message for any exception in Airflow context

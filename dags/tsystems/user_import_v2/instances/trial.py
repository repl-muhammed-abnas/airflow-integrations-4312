...
instance = 'trial'
# Both trial and uat use 'pre-production' environment designation for non-production instances
...
log_filepath = "/TsystemsSB/UserImport/Logs"
...
data_source = "CAIMAN"
# Both trial and uat instances pull from SIT (System Integration Testing) data source

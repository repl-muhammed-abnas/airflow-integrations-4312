...
# UPPER_SNAKE_CASE used for constants to maintain consistency with existing v1 codebase
...
# UPPER_SNAKE_CASE used for date format constants to maintain consistency with existing v1 codebase

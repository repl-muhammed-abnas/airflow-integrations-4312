from tsystems.user_import_v2.utils import response_filters, custom_methods, request_payload
from airflow.models import Variable
import rail

null = None

# Country and City of Employment OEF tags are user profile attributes stored in Replicon.
# These fields are used for user reporting, filtering, and organizational grouping independent of Holiday Calendar.
# The OEF tags must exist before users can be assigned these attribute values during import.

...
import rail
from tsystems.project_import_file_based_v3.utils import request_payload, custom_methods
    ...
    with rail.create_airflow_dag(
        ...
        has_restrictions = rail.IfOperator(
            ...
            test=lambda dag_run: bool(
                ...
                dag_run.conf.get('team_departments', {}).get('assign_from_cost_center_uris', [])  # Version 1.7
            ),
        ...
        # Version 1.7: uris contains both service center URIs (from Department assignment)
        # and cost center URIs (from Cost Center assignment — col 4 in mapper CSV)

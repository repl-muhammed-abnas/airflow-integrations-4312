...
import rail
from tsystems.project_import_file_based_v3.config import STATUS_MAPPING
from tsystems.project_import_file_based_v3.utils import request_payload

_MOJIBAKE_CANDIDATE_ENCODINGS = ('mac_roman', 'cp1252', 'latin-1')

def fix_text_encoding(value):
    """Reverse legacy-encoding mojibake if detected; return input unchanged otherwise."""
...
def normalize_project_data(item, team_assignment_mapper):
    ...
    # Version 1.7: Extract Profit Center and Cost Center codes from relatedUnit
    ...
    return {
        ...
        'client_name': item.get('client_name', ''),  # Version 1.7
        ...
        'profit_center_code': profit_center_code,  # Version 1.7
        'project_cost_center_code': project_cost_center_code,  # Version 1.7
...
def get_team_departments_for_assignment(accounting_area, cost_center, profit_center_code, project_cost_center_code, team_assignment_mapper, employee_type_groups):
    ...
    assign_from_cost_center_uris = []  # Version 1.7
    ...
    for mapping in mappings:
        ...
        # Version 1.7: Check profit center and cost center if specified in mapper
    ...
    if matched_mapping:
        ...
        # Version 1.7: Cost Center based restriction
    ...
    return {
        ...
        'codes': code_list,
        'should_assign_team': bool(all_assignment_uris),
        'assign_from_department_uris': assign_from_department_uris,
        'assign_from_employee_type_uris': assign_from_employee_types,
        'assign_from_cost_center_uris': assign_from_cost_center_uris  # Version 1.7: RESTRICTION scope
    }
    ...
    for event_obj in json_objects:
        try:
            ...
            project_record = {
                ...
                "profit_center": extract_related_unit(costobject, "Profit Center"),  # Version 1.7
                "project_cost_center": extract_related_unit(costobject, "Cost Center"),  # Version 1.7
                "client_code": extract_related_party_id(costobject, "End Customer"),
                "client_name": fix_text_encoding(extract_related_party_name(costobject, "End Customer")),  # Version 1.7

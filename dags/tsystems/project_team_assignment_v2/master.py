...
from tsystems.project_team_assignment_v2.utils.python_callable import check_both_tasks_failed
...
def create_main_dag(config):
    ...
    with rail.create_airflow_dag(
        ...
        process_log_generation = rail.TriggerDagRunOperator(
            ...
            conf=lambda dag_run:{
                'childlogs': rail.result('gather_each_event_logs'),
                'log_filename': rail.result('get_process_info')['log_filename'],

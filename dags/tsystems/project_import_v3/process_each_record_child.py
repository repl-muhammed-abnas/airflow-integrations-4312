...
import rail
from tsystems.project_import_v3.utils import request_payload, custom_methods
...
def create_process_each_record_dag(config):
    ...
    with rail.create_airflow_dag(
        ...
        # Version 1.6: Check if team assignment is required based on team_departments
        # Runs only when team department URIs are found (should_assign_team is True)
        ...
        # Version 1.6: Team assignment branch - assign team members if team_departments URIs exist

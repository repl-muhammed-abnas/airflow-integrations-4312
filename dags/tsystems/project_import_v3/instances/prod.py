"""
Production environment configuration for T-Systems Project Import integration - Version 3
"""
from tsystems.project_import_v3.config import *
from tsystems.project_import_v3.mapper.team_assigment_mapper import TEAM_ASSIGNMENT_MAPPING

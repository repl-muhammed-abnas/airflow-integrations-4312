from tsystems.timeoff_import_india_v1.config import *
from tsystems.timeoff_import_india_v1.mapper.timeoff_mapper import timeoff_mapper
...
# SFTP Configuration
input_filepath = '/TEST/Time Off Import Integration - India/INPUT'
archive_filepath = '/TEST/Time Off Import Integration - India/ARCHIVE'
log_filepath = '/TEST/Time Off Import Integration - India/LOGS'

"""
Custom methods for T-Systems Germany/Iberia Time Off Import
"""
...
def is_time_off_changed(dag_run):
...
def get_email_details(timezone, log_file_path):
    ...
    filename = rail.render_template("{{ dag_run.conf.webhook_data.FileName }}")
    return {

"""
Production environment configuration for T-Systems Project Import integration - Version 4
"""
from tsystems.project_import_v4.config import *
from tsystems.project_import_v4.mapper.team_assigment_mapper import TEAM_ASSIGNMENT_MAPPING

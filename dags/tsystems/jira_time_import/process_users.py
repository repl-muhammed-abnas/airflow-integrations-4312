...
from tsystems.jira_time_import.utils import request_payload, custom_methods, response_filters
...
def create_child_dag(config):
    ...
    with rail.create_airflow_dag(
        ...
        reopen_timesheets >> get_unique_entry_date_for_user >> trigger_process_each_entry >> \

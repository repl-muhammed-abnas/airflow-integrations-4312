from tsystems.project_import_file_based_v4.config import *
from tsystems.project_import_file_based_v4.mapper.team_assigment_mapper import TEAM_ASSIGNMENT_MAPPING

...
import itertools
from tsystems.user_import_v1.tasks.process_user_groups_data import get_all_groups_data
from tsystems.user_import_v1.utils import custom_methods, request_payload, response_filters
from tsystems.user_import_v1.tasks.process_user_prerequisites import get_all_prerequisites_data
            ...
            conf=lambda item: {
                ...
                **custom_methods.create_users_payload_from_variable(item, config),
                ...
                "holiday_calendar_uri": rail.find_first_by_attr_and_get_attr(
                    custom_methods.get_cached_result("get_all_holiday_calendars") or [],
                    "displayText",

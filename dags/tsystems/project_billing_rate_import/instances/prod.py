"""
PROD environment configuration for T-Systems Project Billing Rate Import integration.

This configuration defines the PROD environment settings including connection IDs,
...
sftp_log_filepath = '/PROD/Project Billing Rate Import'

"""
Trial environment configuration for T-Systems Project Billing Rate Import integration.

This configuration defines the trial environment settings including connection IDs,
file paths, email addresses, and other environment-specific parameters.
"""

from tsystems.project_billing_rate_import.config import *
...
sftp_log_filepath = "tsystems/project_billing_rate_import/trial/logs"
...
api_master_dag_id = f"tsystems_project_billing_rate_assignment_import_api_master_{instance}"

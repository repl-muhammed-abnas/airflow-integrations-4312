...
from tsystems.time_export_to_sap_v1 import config
import uuid
import time
    ...
    if len(rail.result('get_oef_field_values')) == 0 and len(rail.result('get_required_companycode_uris')) == 0:
        return {
            ...
            "filterExpression": {
                ...
                "rightExpression": {
                    "leftExpression": {
                        "filterDefinitionUri": dag_run.conf['project_type_filter_uri']
                    },
                    "operatorUri": "urn:replicon:filter-operator:not-in",
                    "rightExpression": {
                        "value": {
                            "uris": dag_run.conf['non_sap_project_type_oef_uri']
                        }
                    }
                }
            }
        ...
        if len(rail.result('get_oef_field_values')) == 0:
            ...
            filter_def_uri = dag_run.conf['legal_unit_filter_uri']
                        ...
                        "leftExpression": {
                            "leftExpression": {
                                "leftExpression": {
                                    "leftExpression": {
                                        "leftExpression": {
                                            "filterDefinitionUri": dag_run.conf['legal_unit_filter_uri']
                                        },
                                        "operatorUri": "urn:replicon:filter-operator:in",
                                        "rightExpression": {
                                            "value": {

...
from tsystems.office_schedule_file_import.config import *
...
master_dag_id = f'tsystems_office_schedule_file_import_master_{instance}'
schedule_add_dag_id = f'tsystems_office_schedule_file_import_add_schedule_child_{instance}'
assign_schedule_dag_id = f'tsystems_office_schedule_file_import_assign_schedule_child_{instance}'

...
import rail
from tsystems.office_schedule_file_import_v1.utils import custom_methods
...
def create_dag(config):
    ...
    with rail.create_airflow_dag(
        ...
        wait_for_create_new_schedules >> get_all_updated_office_schedules >> trigger_assign_schedule_to_employee >> wait_for_assign_schedule_to_employee >> gather_assignment_logs >> format_logs

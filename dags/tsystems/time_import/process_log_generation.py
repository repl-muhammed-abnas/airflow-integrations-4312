...
import rail
from tsystems.time_import.utils import custom_methods
...
def create_child_dag(config):
    ...
    with rail.create_airflow_dag(
        ...
        format_logs >> render_logs_csv >> generate_download_link >> get_email_details >> upload_log_to_sftp >> send_import_complete_email

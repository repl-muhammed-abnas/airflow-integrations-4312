...
import rail
from tsystems.project_import.utils import custom_methods
...
def put_eligible_project_team_member(dag_run):
    ...
    return {
        ...
        "teamMemberDataAccessScopes": [
            {
                "locations": [],  # Not used in this integration
                "divisions": [],  # Not used in this integration  
                "costCenters": [],  # Not used in this integration
                # Grant access to users in these service centers
                "serviceCenters": [
                    {
                        "uri": item,
                    } for item in dag_run.conf['team_departments']['uris']
                ] if dag_run.conf['team_departments']['should_assign_team'] else [],
                "employeeTypeGroups": []  # Not used in this integration
            }
        ]
    }

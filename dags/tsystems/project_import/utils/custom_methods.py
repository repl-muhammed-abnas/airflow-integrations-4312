...
import rail
from tsystems.project_import.config import STATUS_MAPPING
from tsystems.project_import.utils import request_payload
...
def normalize_project_data(item, team_assignment_mapper):
    ...
    accounting_area = item.get('accounting_area', '')
    ...
    team_departments = get_team_departments_for_assignment(accounting_area, cost_center, team_assignment_mapper)
    ...
    return {
        ...
        'delivery_cost_center': item.get('delivery_cost_center', ''),
...
def get_team_departments_for_assignment(accounting_area, cost_center, team_assignment_mapper):
    """
    ...
    the combination of accounting area and cost center from the payload.
    
    Args:
        accounting_area: Accounting area code from payload
        cost_center: Cost center code from payload  
        
    Returns:
        dict: Team assignment information including URIs, codes, and assignment flag
    """

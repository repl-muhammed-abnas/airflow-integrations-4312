...
def create_dag(config):
    ...
    with rail.create_airflow_dag(
        dag_id=f'centricbrands_user_import_add_user_{config.instance}_v2',
        description=f'Live|CentricBrands_Add_User {config.instance}_v2',
        ...
        trigger_child_to_add_user_timeoff = rail.TriggerDagRunOperator(
            ...
            retries=0,
            trigger_dag_id=f'centricbrands_user_import_add_user_time_off_{config.instance}_v2',
        ...
        add_final_log_for_user >> centricbrands_trial_user_import_logs_add_entry_157 >> finish >> log_to_sumo

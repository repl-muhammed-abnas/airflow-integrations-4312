...
def create_dag(config):
    ...
    with rail.create_airflow_dag(
        dag_id=f'centricbrands_user_import_put_0_balance_{config.instance}_v2',
        description=f'CentricBrands put 0 balance {config.instance}_v2',
        ...
        if_policyschedule_present >> rail.Label(
            'No') >> catch_error_and_return_response >> log_to_sumo

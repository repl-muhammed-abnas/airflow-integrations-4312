...
def create_dag(config):
    ...
    with rail.create_airflow_dag(
        dag_id=f'centricbrands_user_import_cost_centers_locations_add_{config.instance}_v2',
        description=f'Live|Centric_Brands_Cost Centers(Locations)_Add {config.instance}_v2',
        ...
        foreach_new_costcenter_to_create >> foreach_new_costcenter_to_create_end >> catch_and_log_error >> log_to_sumo

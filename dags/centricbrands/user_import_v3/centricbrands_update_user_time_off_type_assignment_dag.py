...
def create_dag(config):
    ...
    with rail.create_airflow_dag(
        dag_id=config.child_update_user_time_off_type_assignment_dag_id,
        description=f'CentricBrands_Update User - Time Off Type assignment child',
        ...
        trigger_child_updateuser_timeoffpolicy_assignment = rail.TriggerDagRunOperator(
            ...
            retries=0,
            trigger_dag_id=config.child_update_user_time_off_policy_assignment_dag_id,
        ...
        trigger_child_put_balance_as0 = rail.TriggerDagRunForEachItemOperator(
            ...
            trigger_dag_id=config.child_put_0_balance_dag_id,
            execution_timeout=timedelta(days=config.execution_timeout_days),
        ...
        if_timeoffype_present >> rail.Label('No') >> catch_error

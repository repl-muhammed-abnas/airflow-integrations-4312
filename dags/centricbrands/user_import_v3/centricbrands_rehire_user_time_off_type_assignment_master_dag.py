...
def create_dag(config):
    ...
    with rail.create_airflow_dag(
        dag_id=config.child_rehire_user_time_off_type_assignment_dag_id,
        description=f'CentricBrands Rehire User - Time Off Type assignment Child',
        ...
        trigger_child_rehire_user_timeoffpolicy_assignment = rail.TriggerDagRunForEachItemOperator(
            ...
            items=lambda: rail.result('get_timeofftypes_to_assign_with_uri')[
                'timeoffs'],
            trigger_dag_id=config.child_rehire_user_time_off_policy_assignment_dag_id,

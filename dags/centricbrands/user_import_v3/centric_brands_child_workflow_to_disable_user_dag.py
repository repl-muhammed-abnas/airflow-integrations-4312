...
def create_dag(config):
    ...
    with rail.create_airflow_dag(
        dag_id=config.child_disable_user_dag_id,
        description=f'CentricBrands User Import Workflow to disable user Child',
        ...
        wait_for_child_to_put_0_balance >> gather_results_from_put_0_balance_child >> log_user_disabled_successfully >> catch_log_error

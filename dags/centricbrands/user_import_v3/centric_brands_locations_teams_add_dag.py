...
def create_dag(config):
    ...
    with rail.create_airflow_dag(
        dag_id=config.child_locations_teams_add_dag_id,
        description=f'CentricBrands User import Locations(Teams) Add child',
        ...
        foreach_new_location_to_create >> foreach_new_location_to_create_end >> catch_and_log_error

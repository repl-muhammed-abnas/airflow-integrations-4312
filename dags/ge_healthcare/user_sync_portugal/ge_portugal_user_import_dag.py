...
from ge_healthcare.user_sync_portugal.portugal_master_mapper import portugal_master_mapper
import rail
...
def create_dag(config):
    ...
    with rail.create_airflow_dag(
        dag_id=f'gehealthcare_portugal_user_import_master_{config.instance}',
        description=f'GE portugal User Import Master {config.instance}',
        ...
        send_mail_send_emailfor_incorrect_fileformat_4 = rail.EmailOperator(
            ...
            subject='''{{ get_company_key() }} | portugal Republic User import - file processing is skipped - {{ current_time_in_specified_tz("US/Pacific", "%m/%d/%YT%H:%M:%S") }} ''',
        ...
        if_parse_csv_10_10_lines_less_than_1_11 = rail.IfOperator(
            ...
            no_task="trigger_dag_run_ge_user_sync_suspend_assignment_category_custom_field_check16",
        )
        ...
        trigger_dag_run_ge_user_sync_suspend_assignment_category_custom_field_check16 = rail.TriggerDagRunForEachItemOperator(
            task_id='trigger_dag_run_ge_user_sync_suspend_assignment_category_custom_field_check16',
            retries=0,
            items=[1],
            trigger_dag_id=f'gehealthcare_user_sync_portugal_suspend_assignment_category_custom_field_check_{config.instance}',
        ...
        wait_for_completion_trigger_dag_run_ge_user_portugal_suspend_assignment_category_custom_field_check16 = rail.WaitForDagRunsSensor(
            task_id='wait_for_completion_trigger_dag_run_ge_user_portugal_suspend_assignment_category_custom_field_check16',
            execution_timeout=timedelta(days=14),
            dag_runs='{{ result("trigger_dag_run_ge_user_sync_suspend_assignment_category_custom_field_check16") }}'
        )
        ...
        portugal_master_mapper_search_entries_19 = rail.PythonOperator(
            task_id='portugal_master_mapper_search_entries_19',
            python_callable=lambda:  list(
                filter(lambda x: x['type'] == "Department", portugal_master_mapper))
        )

        log_required_department_name_20 = rail.PythonOperator(
            task_id='log_required_department_name_20',
            python_callable=lambda: rail.find_first_by_attr_and_get_attr(rail.result(
                'portugal_master_mapper_search_entries_19'), 'type', 'Department', 'value', "")
        )

        log_required_department_uri_21 = rail.PythonOperator(
            task_id='log_required_department_uri_21',
            python_callable=lambda:  rail.find_first_by_attr_and_get_attr(rail.result(
                '_adhoc_http_action_17'), 'name', rail.result('log_required_department_name_20'), 'uri', "")
            if rail.result('_adhoc_http_action_17') else None
        )
        ...
        process_user_22 = rail.TriggerDagRunForEachItemOperator(
            ...
            trigger_dag_id=f'gehealthcare_portugal_process_each_user_dag_{config.instance}',
            conf=lambda item: {
            ...
            for supervisor_info in supervisor_log_informations:
                if supervisor_info['properties']:
                    supervisor_details.append({
                        ...
                        "foreignsupervisordepartmenturi": rail.result('log_required_department_uri_21')
                    })
        ...
        if_ge_supervisor_assignment_table_search_entries_41_entries_greater_than_0_42 = rail.IfOperator(
            ...
            no_task="trigger_dag_run_ge_user_sync_portugal_ge_portugal_child_add_supervisor_v1_0async_53",
        )
        ...
        trigger_dag_run_ge_user_sync_portugal_ge_portugal_child_add_foreign_supervisor_v1_049 = rail.TriggerDagRunForEachItemOperator(
            task_id='trigger_dag_run_ge_user_sync_portugal_ge_portugal_child_add_foreign_supervisor_v1_049',
            retries=0,
            items=get_foreign_super_info,
            trigger_dag_id=f'gehealthcare_user_sync_portugal_child_add_foreign_supervisor_v1_0_{config.instance}',
            execution_timeout=timedelta(days=14),
            accumulate_result=True,
            conf={
        ...
        wait_for_completion_trigger_dag_run_ge_user_sync_portugal_ge_portugal_child_add_foreign_supervisor_v1_049 = rail.WaitForDagRunsSensor(
            task_id='wait_for_completion_trigger_dag_run_ge_user_sync_portugal_ge_portugal_child_add_foreign_supervisor_v1_049',
            execution_timeout=timedelta(days=14),
            dag_runs='{{ result("trigger_dag_run_ge_user_sync_portugal_ge_portugal_child_add_foreign_supervisor_v1_049") }}'
        )

        trigger_dag_run_ge_user_sync_portugal_ge_portugal_child_add_supervisor_v1_0async_53 = rail.TriggerDagRunForEachItemOperator(
            task_id='trigger_dag_run_ge_user_sync_portugal_ge_portugal_child_add_supervisor_v1_0async_53',
            retries=0,
            items="{{ result('ge_supervisor_assignment_table_search_entries_41') | to_json }}",
            trigger_dag_id=f'gehealthcare_portugal_child_add_supervisor_v1_0_{config.instance}',
            execution_timeout=timedelta(days=14),
            accumulate_result=True,
            conf={
        ...
        wait_for_completion_trigger_dag_run_ge_user_sync_portugal_ge_portugal_child_add_supervisor_v1_0async_53 = rail.WaitForDagRunsSensor(
            task_id='wait_for_completion_trigger_dag_run_ge_user_sync_portugal_ge_portugal_child_add_supervisor_v1_0async_53',
            execution_timeout=timedelta(days=14),
            dag_runs='{{ result("trigger_dag_run_ge_user_sync_portugal_ge_portugal_child_add_supervisor_v1_0async_53") }}'
        )

        def do_format_logs():
            context = get_master_log_artifact_name(rail.get_current_context())
            user_import_log = rail.load_all_records(context)
            print('user_import_log', user_import_log)
            unique_users = list(
        ...
        if_parse_csv_10_10_lines_less_than_1_11 >> rail.Label('No') >> \
            trigger_dag_run_ge_user_sync_suspend_assignment_category_custom_field_check16 >> \
            wait_for_completion_trigger_dag_run_ge_user_portugal_suspend_assignment_category_custom_field_check16 >> \
            _adhoc_http_action_17 >> portugal_master_mapper_search_entries_19 >> \
            log_required_department_name_20 >> log_required_department_uri_21 >> \
            supervisor_processing_log >> process_user_22 >> \
            wait_for_completion_process_user_22 >> ge_supervisor_assignment_table_search_entries_41 >> \
        ...
        if_ge_supervisor_assignment_table_search_entries_41_entries_greater_than_0_42 >> rail.Label('Yes') >> declare_list_dag_runs_43 >> \
            log_getalltheuniqsupervisor_43 >> trigger_dag_run_ge_user_sync_portugal_ge_portugal_child_add_foreign_supervisor_v1_049 >> \
            wait_for_completion_trigger_dag_run_ge_user_sync_portugal_ge_portugal_child_add_foreign_supervisor_v1_049 >> \
            trigger_dag_run_ge_user_sync_portugal_ge_portugal_child_add_supervisor_v1_0async_53
        if_ge_supervisor_assignment_table_search_entries_41_entries_greater_than_0_42 >> rail.Label('No') >> \
            trigger_dag_run_ge_user_sync_portugal_ge_portugal_child_add_supervisor_v1_0async_53 >> \
            wait_for_completion_trigger_dag_run_ge_user_sync_portugal_ge_portugal_child_add_supervisor_v1_0async_53 >> \

...
def create_dag(config):
    ...
    with rail.create_airflow_dag(
        dag_id=f'gehealthcare_portugal_child_add_supervisor_v1_0_{config.instance}',
        description=f'GE_portugal_Child_Add Supervisor V1.0 {config.instance}',
        ...
        def is_permission_present():
            if rail.result('log_checkifthe_supervisor_permissionisassigned_19') is None \
                or rail.result('log_checkifthe_user_permissionisassigned_20') is None \
                    or rail.result('log_checkifthe_supervisor_permissionisassigned_19') not in rail.result('log_supervisor_permissiontobeassigned_17') \

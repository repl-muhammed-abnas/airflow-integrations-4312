...
def create_dag(config):
    ...
    with rail.create_airflow_dag(
        dag_id=f'gehealthcare_portugal_child_workflow_to_add_timeoff_type_for_new_user_v1_0_{config.instance}',
        description=f'GE_portugal_Child Workflow to add timeoff type for new user v1.0 {config.instance}',
        ...
        if_first_displaytext_present_4 = rail.IfOperator(
            ...
            yes_task="ge_portugal_user_sync_master_mapper_search_entries_5",
        ...
        def get_entity_from_mapper(LegalEntity, to_type):
            emp_types = list(filter(
                ...
                and x['type'] == to_type, portugal_master_mapper))
            return [emp_type['value'] for emp_type in emp_types]

        ge_portugal_user_sync_master_mapper_search_entries_5 = rail.PythonOperator(
            task_id='ge_portugal_user_sync_master_mapper_search_entries_5',
        ...
        if_entry_col1_blank_6 = rail.IfOperator(
            ...
            test='''{{ result('ge_portugal_user_sync_master_mapper_search_entries_5') | is_falsy }}''',
        ...
        def get_final_set_timeoff_info():
            timeoff_uris = []
            missing_timeoffs = []
            for mapper_to_info in rail.result('ge_portugal_user_sync_master_mapper_search_entries_5'):
        ...
        trigger_dag_run_ge_portugal_child_workflow_to_add_timeoff_policy_for_new_user_v1_16 = rail.TriggerDagRunForEachItemOperator(
            task_id='trigger_dag_run_ge_portugal_child_workflow_to_add_timeoff_policy_for_new_user_v1_16',
            retries=0,
            items=lambda: rail.result('log_final_set_timeoff_uris_13')[
                'timeoff_uris'],
            trigger_dag_id=f'gehealthcare_portugal_child_add_to_policy_new_user_v1_0_{config.instance}',
        ...
        wait_for_completion_trigger_dag_run_ge_portugal_child_workflow_to_add_timeoff_policy_for_new_user_v1_16 = rail.WaitForDagRunsSensor(
            task_id='wait_for_completion_trigger_dag_run_ge_portugal_child_workflow_to_add_timeoff_policy_for_new_user_v1_16',
            execution_timeout=timedelta(days=14),
            dag_runs='{{ result("trigger_dag_run_ge_portugal_child_workflow_to_add_timeoff_policy_for_new_user_v1_16") }}'
        )
        ...
        if_first_displaytext_present_4 >> rail.Label(
            'Yes') >> ge_portugal_user_sync_master_mapper_search_entries_5 >> if_entry_col1_blank_6
        ...
        if_log_12_present_14 >> rail.Label(
            ...
            trigger_dag_run_ge_portugal_child_workflow_to_add_timeoff_policy_for_new_user_v1_16 >> \
            wait_for_completion_trigger_dag_run_ge_portugal_child_workflow_to_add_timeoff_policy_for_new_user_v1_16 >> dummy_operator_1 >> add_timeoff_type_logs
        if_log_12_present_14 >> rail.Label(

...
from ge_healthcare.timesheet_email_notification_poland.tasks.send_notification_email import send_notification

def create_child_dag(config):
    # pylint: disable=too-many-statements line-too-long
    with rail.create_airflow_dag(
        dag_id=f'gehealthcare_timesheet_email_notification_poland_send_email_notification_child_{config.instance}',

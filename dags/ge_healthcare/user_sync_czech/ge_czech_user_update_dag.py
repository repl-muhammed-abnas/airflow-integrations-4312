...
def create_dag(config):
    ...
    with rail.create_airflow_dag(
        dag_id=f'gehealthcare_czech_user_update_{config.instance}',
        ...
        trigger_dag_run_ge_user_sync_czech_ge_czech_add_v1_0async_callrecipeforrehire_32 = rail.TriggerDagRunForEachItemOperator(
            ...
            retries=0,
            items=[1],
            trigger_dag_id=f'gehealthcare_czech_add_v1_0_{config.instance}',
        ...
        trigger_dag_run_czech_time_off_policy_update_cz_compensation_207 = rail.TriggerDagRunForEachItemOperator(
            ...
            retries=0,
            items=[1],
            trigger_dag_id=f'gehealthcare_czech_time_off_policy_update_cz_compensation_time_{config.instance}',
            execution_timeout=timedelta(days=14),
            accumulate_result=True,
            conf=lambda dag_run: {
                "useruri": dag_run.conf['UserURI'],

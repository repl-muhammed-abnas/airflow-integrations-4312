...
def create_dag(config):
    ...
    with rail.create_airflow_dag(
        dag_id=f'gehealthcare_czech_add_v1_0_{config.instance}',
        description=f'GE Czech Add V1.0 {config.instance}',
        ...
        if_log_20_present_conditiontocheckifrequiredfieldsexistin_inputfile_5 = rail.IfOperator(
            ...
            no_task="czech_master_mapper_search_entries_8",
        )
        ...
        if_first_id_blank_9 = rail.IfOperator(
            ...
            test='''{{ result('czech_master_mapper_search_entries_8') | is_falsy }}''',
        ...
        def get_employe_type_from_mapper(dag_run):
            emp_types = list(filter(
                lambda x: x['legal_entity'] == dag_run.conf['LegalEntity'] and x['type'] == "Employee Type", czech_master_mapper))
        ...
        def get_entity_uri_from_mapper(dag_run, entity_type):
            emp_types = list(filter(
                lambda x: x['legal_entity'] == dag_run.conf['LegalEntity'] and x['type'] == entity_type, czech_master_mapper))
            return emp_types[0]['default__uri'] if emp_types else {}
        ...
        def get_mapper_licenses(dag_run, typeval):
            employee_licenses = list(filter(
                lambda x: x['legal_entity'] == dag_run.conf['LegalEntity']
                and x['type'] == typeval, czech_master_mapper))
            licenses = [licenses['default__uri']
        ...
        def get_super_user_permissions(dag_run, entity_type_1, entity_type_2):
            emp_types = list(filter(
                ...
                and x['identifier__1__(_legal_entity_code/_type/_timeoff_type)'] == entity_type_2, czech_master_mapper))
        ...
        if_declare_list_131_list_items_greater_than_0_135 = rail.IfOperator(
            ...
            no_task="trigger_dag_run_live_ge_czech_child_workflow_to_add_timeoff_type_for_new_user_v1_0138",
        )
        ...
        trigger_dag_run_live_ge_czech_child_workflow_to_add_timeoff_type_for_new_user_v1_0138 = rail.TriggerDagRunForEachItemOperator(
            task_id='trigger_dag_run_live_ge_czech_child_workflow_to_add_timeoff_type_for_new_user_v1_0138',
            retries=0,
            items=[1],
            trigger_dag_id=f'gehealthcare_czech_child_workflow_to_add_timeoff_type_for_new_user_v1_0_{config.instance}',
            execution_timeout=timedelta(days=14),
        ...
        wait_for_completion_trigger_dag_run_live_ge_czech_child_workflow_to_add_timeoff_type_for_new_user_v1_0138 = rail.WaitForDagRunsSensor(
            task_id='wait_for_completion_trigger_dag_run_live_ge_czech_child_workflow_to_add_timeoff_type_for_new_user_v1_0138',
            execution_timeout=timedelta(days=14),
            dag_runs='{{ result("trigger_dag_run_live_ge_czech_child_workflow_to_add_timeoff_type_for_new_user_v1_0138") }}'
        )
        ...
        if_log_20_present_conditiontocheckifrequiredfieldsexistin_inputfile_5 >> rail.Label(
            'No') >> czech_master_mapper_search_entries_8 >> if_first_id_blank_9
        ...
        if_declare_list_131_list_items_greater_than_0_135 >> rail.Label(
            'Yes') >> put_activity_assignments_for_user_137 >> trigger_dag_run_live_ge_czech_child_workflow_to_add_timeoff_type_for_new_user_v1_0138
        if_declare_list_131_list_items_greater_than_0_135 >> rail.Label(
            'No') >> trigger_dag_run_live_ge_czech_child_workflow_to_add_timeoff_type_for_new_user_v1_0138 >> \
            wait_for_completion_trigger_dag_run_live_ge_czech_child_workflow_to_add_timeoff_type_for_new_user_v1_0138 >> \

...
def create_dag(config):
    ...
    with rail.create_airflow_dag(
        dag_id=f'gehealthcare_netherlands_child_workflow_to_add_timeoff_type_for_update_user_v1_0_{config.instance}',
        description=f'GE_Netherlands_Child Workflow to add timeoff type for update user v1.0 {config.instance}',
        ...
        trigger_dag_run_ge_netherlands_child_workflow_to_add_timeoff_policy_for_new_user_v1_16 = rail.TriggerDagRunForEachItemOperator(
            ...
            items=lambda: rail.result('log_final_set_timeoff_uris_21')[
                'timeoffstoassign'],
            trigger_dag_id=f'gehealthcare_netherlands_child_add_to_policy_update_user_v1_0_{config.instance}',
        ...
        catch_66_66_66 = rail.EmptyOperator(
            task_id='catch_66_66_66',
        ...
        can_run_batch_task >> rail.Label('Yes') >> batch_task >> catch_66_66_66
        ...
        if_log_12_present_22 >> rail.Label('No') >> catch_66_66_66
        if_log_12_present_22 >> rail.Label(
            'Yes') >> put_time_off_type_assignments_for_user_23 >> trigger_dag_run_ge_netherlands_child_workflow_to_add_timeoff_policy_for_new_user_v1_16 >> \
            wait_for_completion_trigger_dag_run_ge_netherlands_child_workflow_to_add_timeoff_policy_for_new_user_v1_16 >> catch_66_66_66
        if_first_displaytext_present_4 >> rail.Label(
            'No') >> catch_66_66_66 >> log_to_sumo

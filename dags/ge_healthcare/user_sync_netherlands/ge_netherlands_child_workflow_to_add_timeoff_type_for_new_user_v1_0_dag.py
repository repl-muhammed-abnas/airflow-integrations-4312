...
def create_dag(config):
    ...
    with rail.create_airflow_dag(
        dag_id=f'gehealthcare_user_sync_netherlands_child_workflow_to_add_timeoff_type_for_new_user_v1_0_{config.instance}',
        ...
        trigger_dag_run_ge_netherlands_child_workflow_to_add_timeoff_policy_for_new_user_v1_16 = rail.TriggerDagRunForEachItemOperator(
            ...
            items=lambda: rail.result('log_final_set_timeoff_uris_21')[
                'timeoffstoassign'],
            trigger_dag_id=f'gehealthcare_netherlands_child_add_to_policy_new_user_v1_0_{config.instance}',

...
def create_dag(config):
    ...
    with rail.create_airflow_dag(
        dag_id=f'gehealthcare_user_sync_ge_netherlands_schedule_add_master_v1_0_{config.instance}',
        description=f'GE_netherlands Schedule Add Master V1.0 {config.instance}',
        ...
        ge_netherlands_user_sync_master_mapper_v2_0_search_entries_8 = rail.PythonOperator(
            task_id='ge_netherlands_user_sync_master_mapper_v2_0_search_entries_8',
            python_callable=lambda: list(
                filter(lambda x: x['type'] == 'Default Schedule', netherlands_master_mapper))
        )

        def get_value_from_mapper(entity_type):
            emp_types = list(filter(
                lambda x: x['type'] == entity_type, netherlands_master_mapper))
        ...
        trigger_dag_run_ge_user_sync_netherlands_ge_netherlands_child_schedule_add_v1_020 = rail.TriggerDagRunForEachItemOperator(
            task_id='trigger_dag_run_ge_user_sync_netherlands_ge_netherlands_child_schedule_add_v1_020',
            retries=0,
            items="{{ result('query_list_get_distinct_schedulewhereno_uriisfound_18') }}",
            trigger_dag_id=f'gehealthcare_user_sync_ge_netherlands_child_schedule_add_v1_0_{config.instance}',
        ...
        wait_for_completion_trigger_dag_run_ge_user_sync_netherlands_ge_netherlands_child_schedule_add_v1_020 = rail.WaitForDagRunsSensor(
            task_id='wait_for_completion_trigger_dag_run_ge_user_sync_netherlands_ge_netherlands_child_schedule_add_v1_020',
            execution_timeout=timedelta(days=14),
            dag_runs='{{ result("trigger_dag_run_ge_user_sync_netherlands_ge_netherlands_child_schedule_add_v1_020") }}'
        )
        ...
        can_run_batch_task >> rail.Label('No') >> _adhoc_http_action_6 >> ge_netherlands_user_sync_master_mapper_v2_0_search_entries_8 >> \
            create_list_17 >> query_list_get_distinct_schedulewhereno_uriisfound_18 >> \
            trigger_dag_run_ge_user_sync_netherlands_ge_netherlands_child_schedule_add_v1_020 >> \
            wait_for_completion_trigger_dag_run_ge_user_sync_netherlands_ge_netherlands_child_schedule_add_v1_020 >> \

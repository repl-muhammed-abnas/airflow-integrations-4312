...
def create_dag(config):
    ...
    with rail.create_airflow_dag(
        dag_id=f'gehealthcare_netherlands_user_import_master_{config.instance}',
        ...
        trigger_dag_run_ge_user_sync_netherlands_schedule_add_master_v1_019 = rail.TriggerDagRunForEachItemOperator(
            ...
            retries=0,
            items=[1],
            trigger_dag_id=f'gehealthcare_user_sync_ge_netherlands_schedule_add_master_v1_0_{config.instance}',
        ...
        trigger_dag_run_ge_user_sync_netherlands_suspend_assignment_category_custom_field_021 = rail.TriggerDagRunForEachItemOperator(
            ...
            retries=0,
            items=[1],
            trigger_dag_id=f'gehealthcare_user_sync_netherlands_suspend_assignment_category_custom_fieldv1_{config.instance}',
            execution_timeout=timedelta(days=14),
            accumulate_result=True,
            conf={
                "inputdata": '''{{ result('load_csv_create_list_from_csv_10') }}'''
        ...
        process_user_22 = rail.TriggerDagRunForEachItemOperator(
            ...
            trigger_dag_id=f'gehealthcare_netherlands_process_each_user_dag_{config.instance}',
            conf=lambda item: {
        ...
        trigger_dag_run_ge_user_sync_netherlands_ge_netherlands_child_add_foreign_supervisor_v1_049 = rail.TriggerDagRunForEachItemOperator(
            ...
            trigger_dag_id=f'gehealthcare_netherlands_child_add_foreign_supervisor_v1_0_{config.instance}',
            execution_timeout=timedelta(days=14),
            accumulate_result=True,
            conf={
                "OHRID": "{{ item.OHRID }}",
        ...
        trigger_dag_run_ge_user_sync_netherlands_ge_netherlands_child_add_supervisor_v1_0async_53 = rail.TriggerDagRunForEachItemOperator(
            ...
            trigger_dag_id=f'gehealthcare_netherlands_child_add_supervisor_v1_0_{config.instance}',
            execution_timeout=timedelta(days=14),
            accumulate_result=True,
            conf={

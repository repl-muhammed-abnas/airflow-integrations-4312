...
def create_dag(config):
    ...
    with rail.create_airflow_dag(
        dag_id=f'gehealthcare_user_sync_denmark_ge_denmark_child_schedule_add_v1_0_{config.instance}',
        description=f'GE_Denmark Child Schedule add V1.0 {config.instance}',

...
def create_dag(config):
    ...
    with rail.create_airflow_dag(
        dag_id=f'gehealthcare_user_sync_denmark_suspend_assignment_category_custom_fieldv1_{config.instance}',
        description=f'GE_Denmark Suspend Assignment Category Custom field check V1.0 {config.instance}',

...
def create_dag(config):
    ...
    with rail.create_airflow_dag(
        dag_id=f'gehealthcare_greece_user_import_master_{config.instance}',
        description=f'GE greece User Import Master {config.instance}',
        ...
        send_mail_send_emailfor_incorrect_fileformat_4 = rail.EmailOperator(
            ...
            subject='''{{ get_company_key() }} | greece Republic User import - file processing is skipped - {{ current_time_in_specified_tz("US/Pacific", "%m/%d/%YT%H:%M:%S") }} ''',
        ...
        trigger_dag_run_ge_user_sync_suspend_assignment_category_custom_field_check16 = rail.TriggerDagRunForEachItemOperator(
            ...
            retries=0,
            items=[1],
            trigger_dag_id=f'gehealthcare_user_sync_greece_suspend_assignment_category_custom_field_check_{config.instance}',
        ...
        wait_for_completion_trigger_dag_run_ge_user_greece_suspend_assignment_category_custom_field_check16 = rail.WaitForDagRunsSensor(
            task_id='wait_for_completion_trigger_dag_run_ge_user_greece_suspend_assignment_category_custom_field_check16',
            execution_timeout=timedelta(days=14),
        ...
        greece_master_mapper_search_entries_19 = rail.PythonOperator(
            task_id='greece_master_mapper_search_entries_19',
            python_callable=lambda:  list(
                filter(lambda x: x['type'] == "Department", greece_master_mapper))
        )

        log_required_department_name_20 = rail.PythonOperator(
            task_id='log_required_department_name_20',
            python_callable=lambda: rail.find_first_by_attr_and_get_attr(rail.result(
                'greece_master_mapper_search_entries_19'), 'type', 'Department', 'value', "")
        )
        ...
        process_user_22 = rail.TriggerDagRunForEachItemOperator(
            ...
            trigger_dag_id=f'gehealthcare_greece_process_each_user_dag_{config.instance}',
            conf=lambda item: {
        ...
        if_ge_supervisor_assignment_table_search_entries_41_entries_greater_than_0_42 = rail.IfOperator(
            ...
            no_task="trigger_dag_run_ge_user_sync_greece_ge_greece_child_add_supervisor_v1_0async_53",
        )
        ...
        trigger_dag_run_ge_user_sync_greece_ge_greece_child_add_foreign_supervisor_v1_049 = rail.TriggerDagRunForEachItemOperator(
            task_id='trigger_dag_run_ge_user_sync_greece_ge_greece_child_add_foreign_supervisor_v1_049',
            retries=0,
            items=get_foreign_super_info,
            trigger_dag_id=f'gehealthcare_greece_child_add_foreign_supervisor_v1_0_{config.instance}',
            execution_timeout=timedelta(days=14),
            accumulate_result=True,
            conf={
                "OHRID": "{{ item.OHRID }}",
        ...
        wait_for_completion_trigger_dag_run_ge_user_sync_greece_ge_greece_child_add_foreign_supervisor_v1_049 = rail.WaitForDagRunsSensor(
            task_id='wait_for_completion_trigger_dag_run_ge_user_sync_greece_ge_greece_child_add_foreign_supervisor_v1_049',
            execution_timeout=timedelta(days=14),
            dag_runs='{{ result("trigger_dag_run_ge_user_sync_greece_ge_greece_child_add_foreign_supervisor_v1_049") }}'
        )

        trigger_dag_run_ge_user_sync_greece_ge_greece_child_add_supervisor_v1_0async_53 = rail.TriggerDagRunForEachItemOperator(
            task_id='trigger_dag_run_ge_user_sync_greece_ge_greece_child_add_supervisor_v1_0async_53',
            retries=0,
            items="{{ result('ge_supervisor_assignment_table_search_entries_41') | to_json }}",
            trigger_dag_id=f'gehealthcare_greece_child_add_supervisor_v1_0_{config.instance}',
            execution_timeout=timedelta(days=14),
            accumulate_result=True,
            conf={
        ...
        wait_for_completion_trigger_dag_run_ge_user_sync_greece_ge_greece_child_add_supervisor_v1_0async_53 = rail.WaitForDagRunsSensor(
            task_id='wait_for_completion_trigger_dag_run_ge_user_sync_greece_ge_greece_child_add_supervisor_v1_0async_53',
            execution_timeout=timedelta(days=14),
            dag_runs='{{ result("trigger_dag_run_ge_user_sync_greece_ge_greece_child_add_supervisor_v1_0async_53") }}'
        )
        ...
        if_parse_csv_10_10_lines_less_than_1_11 >> rail.Label('No') >> \
            ...
            wait_for_completion_trigger_dag_run_ge_user_greece_suspend_assignment_category_custom_field_check16 >> \
            _adhoc_http_action_17 >> greece_master_mapper_search_entries_19 >> \
        ...
        if_ge_supervisor_assignment_table_search_entries_41_entries_greater_than_0_42 >> rail.Label('Yes') >> declare_list_dag_runs_43 >> \
            log_getalltheuniqsupervisor_43 >> trigger_dag_run_ge_user_sync_greece_ge_greece_child_add_foreign_supervisor_v1_049 >> \
            wait_for_completion_trigger_dag_run_ge_user_sync_greece_ge_greece_child_add_foreign_supervisor_v1_049 >> \
            trigger_dag_run_ge_user_sync_greece_ge_greece_child_add_supervisor_v1_0async_53
        if_ge_supervisor_assignment_table_search_entries_41_entries_greater_than_0_42 >> rail.Label('No') >> \
            trigger_dag_run_ge_user_sync_greece_ge_greece_child_add_supervisor_v1_0async_53 >> \
            wait_for_completion_trigger_dag_run_ge_user_sync_greece_ge_greece_child_add_supervisor_v1_0async_53 >> \

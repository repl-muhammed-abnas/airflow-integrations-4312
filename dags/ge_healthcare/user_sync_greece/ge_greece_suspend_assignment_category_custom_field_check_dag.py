...
def create_dag(config):
    ...
    with rail.create_airflow_dag(
        dag_id=f'gehealthcare_user_sync_greece_suspend_assignment_category_custom_field_check_{config.instance}',
        description=f'GE_Greece Suspend Assignment Category Custom field check {config.instance}',

...
def create_dag(config):
    ...
    with rail.create_airflow_dag(
        dag_id=f'gehealthcare_slovakia_add_v1_0_{config.instance}',
        ...
        trigger_dag_run_live_ge_slovakia_child_workflow_to_add_timeoff_type_for_new_user_v1_0138 = rail.TriggerDagRunForEachItemOperator(
            ...
            retries=0,
            items=[1],
            trigger_dag_id=f'gehealthcare_slovakia_child_workflow_to_add_timeoff_type_for_new_user_v1_0_{config.instance}',
            execution_timeout=timedelta(days=14),

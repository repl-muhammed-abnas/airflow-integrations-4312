...
def create_dag(config):
    ...
    with rail.create_airflow_dag(
        dag_id=f'gehealthcare_slovakia_user_update_{config.instance}',
        description=f'GE slovakia User Update {config.instance}',
        ...
        trigger_dag_run_ge_user_sync_slovakia_ge_slovakia_add_v1_0async_callrecipeforrehire_32 = rail.TriggerDagRunForEachItemOperator(
            task_id='trigger_dag_run_ge_user_sync_slovakia_ge_slovakia_add_v1_0async_callrecipeforrehire_32',
            retries=0,
            items=[1],
            trigger_dag_id=f'gehealthcare_slovakia_add_v1_0_{config.instance}',
        ...
        wait_for_completion_trigger_dag_run_ge_user_sync_slovakia_ge_slovakia_add_v1_0async_callrecipeforrehire_32 = rail.WaitForDagRunsSensor(
            task_id='wait_for_completion_trigger_dag_run_ge_user_sync_slovakia_ge_slovakia_add_v1_0async_callrecipeforrehire_32',
            execution_timeout=timedelta(days=14),
            dag_runs='{{ result("trigger_dag_run_ge_user_sync_slovakia_ge_slovakia_add_v1_0async_callrecipeforrehire_32") }}'
        )
        ...
        log_latesteffectivedate_49 = rail.PythonOperator(
            ...
            python_callable=lambda: (max(
                datetime.strptime(x['date'], '%d/%m/%Y') for x in rail.result('log_costcenterschedule_38'))).strftime('%d/%m/%Y')
        )
        ...
        if_request_hireeffectivedate_blank_58 = rail.IfOperator(
            ...
            no_task="trigger_dag_run_ge_user_sync_slovakia_ge_slovakia_add_v1_0async_callrecipefor_transfer_61",
        )
        ...
        trigger_dag_run_ge_user_sync_slovakia_ge_slovakia_add_v1_0async_callrecipefor_transfer_61 = rail.TriggerDagRunForEachItemOperator(
            task_id='trigger_dag_run_ge_user_sync_slovakia_ge_slovakia_add_v1_0async_callrecipefor_transfer_61',
            retries=0,
            items=[1],
            trigger_dag_id=f'gehealthcare_slovakia_add_v1_0_{config.instance}',
            execution_timeout=timedelta(days=14),
        ...
        wait_for_completion_trigger_dag_run_ge_user_sync_slovakia_ge_slovakia_add_v1_0async_callrecipefor_transfer_61 = rail.WaitForDagRunsSensor(
            task_id='wait_for_completion_trigger_dag_run_ge_user_sync_slovakia_ge_slovakia_add_v1_0async_callrecipefor_transfer_61',
            execution_timeout=timedelta(days=14),
            dag_runs='{{ result("trigger_dag_run_ge_user_sync_slovakia_ge_slovakia_add_v1_0async_callrecipefor_transfer_61") }}'
        )
        ...
        def is_current_supervisor(dag_run):
            if rail.result('log_currentsupervisorloginname_118') is None or rail.result('log_currentsupervisorloginname_118') != dag_run.conf['SupervisorSSOID']:
                return True
            return False

        if_log_currentsupervisorloginname_118_blank_119 = rail.IfOperator(
            task_id='if_log_currentsupervisorloginname_118_blank_119',
            test=is_current_supervisor,
        ...
        log_jobpositiontitle_valuetocompareinthelookuptable_153 = rail.PythonOperator(
            ...
            python_callable=lambda dag_run: dag_run.conf['JobPositionTitle'] if dag_run.conf['JobPositionTitle'] in [
                'Field Engineer', 'Field Service Engineer Czech Republic',
                'Senior Field Engineer'] else "NA"
        )

        def get_values_from_mapper(dag_run, entity_type1, entity_type2):
            entity_types = list(filter(
                lambda x: x['legal_entity'] == dag_run.conf['LegalEntity'] and x['type'] == entity_type1
        ...
        log_timesheet_templatenamefrommapper_154 = rail.PythonOperator(
            ...
            python_callable=lambda dag_run: get_values_from_mapper(dag_run, "Timesheet Template", rail.result(
                'log_jobpositiontitle_valuetocompareinthelookuptable_153'))
        )

        if_log_timesheet_templatenamefrommapper_not_equals_to_users3_6_timesheettemplatedisplaytext_155 = rail.IfOperator(
            task_id='if_log_timesheet_templatenamefrommapper_not_equals_to_users3_6_timesheettemplatedisplaytext_155',
        ...
        def get_value_from_mapper(dag_run, entity_type, identifier):
            entity_types = list(filter(
                ...
                x['type'] == entity_type and
                x['identifier_1_(_legal_entity_code/_type/_timeoff_type)'] == identifier, slovakia_master_mapper))
            entity_values = [entity['value'] for entity in entity_types]
            return rail.smartjoin_by_delim(entity_values, '')
        ...
        def get_entity_from_mapper(dag_run, activity, job_position):
            entity_types = list(filter(
                ...
                and x['type'] == activity
                and x['identifier_1_(_legal_entity_code/_type/_timeoff_type)'] == job_position, slovakia_master_mapper))
        ...
        trigger_dag_run_slovakia_time_off_policy_update_cz_compensation_207 = rail.TriggerDagRunForEachItemOperator(
            task_id='trigger_dag_run_slovakia_time_off_policy_update_cz_compensation_207',
            retries=0,
            items=[1],
            trigger_dag_id=f'gehealthcare_slovakia_time_off_policy_update_cz_compensation_time_{config.instance}',
            execution_timeout=timedelta(days=14),
            accumulate_result=True,
            conf=lambda dag_run: {
                "useruri": dag_run.conf['UserURI'],
        ...
        wait_for_completion_trigger_dag_run_slovakia_time_off_policy_update_cz_compensation_207 = rail.WaitForDagRunsSensor(
            task_id='wait_for_completion_trigger_dag_run_slovakia_time_off_policy_update_cz_compensation_207',
            execution_timeout=timedelta(days=14),
            dag_runs='{{ result("trigger_dag_run_slovakia_time_off_policy_update_cz_compensation_207") }}'
        )
        ...
        declare_list_2 >> declare_list_3 >> declare_variable_4 >> bulk_get_users3_6 >> log_startdate_7 >> slovakia_master_mapper_search_entries_8 >> if_entry_col5_blank_9
        ...
        if_enddate_year_present_29 >> rail.Label(
            'Yes') >> log_enddate_30 >> updateloginname_31 >> trigger_dag_run_ge_user_sync_slovakia_ge_slovakia_add_v1_0async_callrecipeforrehire_32 >> \
            wait_for_completion_trigger_dag_run_ge_user_sync_slovakia_ge_slovakia_add_v1_0async_callrecipeforrehire_32 >> ey_user_import_logs_add_entry_210
        if_enddate_year_present_29 >> rail.Label(
        ...
        if_request_hireeffectivedate_blank_58 >> rail.Label(
            'No') >> trigger_dag_run_ge_user_sync_slovakia_ge_slovakia_add_v1_0async_callrecipefor_transfer_61 >> \
            wait_for_completion_trigger_dag_run_ge_user_sync_slovakia_ge_slovakia_add_v1_0async_callrecipefor_transfer_61 >> ey_user_import_logs_add_entry_210
        if_log_latesteffective_legal_entity_name_50_blank_52 >> rail.Label(
        ...
        if_declare_variable_4_value_equals_to_yes_152 >> rail.Label(
            ...
            if_log_timesheet_templatenamefrommapper_not_equals_to_users3_6_timesheettemplatedisplaytext_155
        if_log_timesheet_templatenamefrommapper_not_equals_to_users3_6_timesheettemplatedisplaytext_155 >> rail.Label(
        ...
        if_declare_list_198_list_items_greater_than_0_202 >> rail.Label(
            ...
            trigger_dag_run_slovakia_time_off_policy_update_cz_compensation_207 >> \
            wait_for_completion_trigger_dag_run_slovakia_time_off_policy_update_cz_compensation_207 >> \

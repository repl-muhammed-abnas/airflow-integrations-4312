...
def create_dag(config):
    ...
    with rail.create_airflow_dag(
        dag_id=f'gehealthcare_slovakia_child_add_supervisor_v1_0_{config.instance}',
        description=f'GE_slovakia_Child_Add Supervisor V1.0 {config.instance}',
        ...
        def get_mapper_permissions(mapper_type, identifier_1):
            ...
            print('employee_permissions', employee_permissions)
            permissions = []
        ...
        def is_permission_present():
            if rail.result('log_checkifthe_user_permissionisassigned_20') is None or \
                    rail.result('log_checkifthe_supervisor_permissionisassigned_19') is None or \

...
def create_dag(config):
    ...
    with rail.create_airflow_dag(
        dag_id=f'gehealthcare_slovakia_child_workflow_to_add_timeoff_type_for_new_user_v1_0_{config.instance}',
        description=f'GE_slovakia_Child Workflow to add timeoff type for new user v1.0 {config.instance}',
        ...
        if_first_displaytext_present_5 = rail.IfOperator(
            ...
            yes_task="slovakia_master_mapper_search_entries_6",
        ...
        def get_entity_from_mapper(LegalEntity, to_type):
            emp_types = list(filter(
                ...
                and x['type'] == to_type, slovakia_master_mapper))
            return [emp_type['value'] for emp_type in emp_types]

        slovakia_master_mapper_search_entries_6 = rail.PythonOperator(
            task_id='slovakia_master_mapper_search_entries_6',
        ...
        if_entry_col1_blank_7 = rail.IfOperator(
            ...
            test='''{{ result('slovakia_master_mapper_search_entries_6') | is_falsy }}''',
        ...
        def get_final_set_timeoff_info():
            timeoff_info = []
            for mapper_to_info in rail.result('slovakia_master_mapper_search_entries_6'):
        ...
        log_timeoffurifor_c_z_compensation_time_20 = rail.PythonOperator(
            ...
            python_callable=lambda: rail.find_first_by_attr_and_get_attr(rail.result(
                'log_final_set_timeoff_info_12'), 'name', "SK_Compensation Time", 'uri', '')
        )
        ...
        log_timeoffurifor_c_z_vacation_27 = rail.PythonOperator(
            ...
            python_callable=lambda: rail.find_first_by_attr_and_get_attr(
                rail.result('log_final_set_timeoff_info_12'), 'name', "SK_Vacation", 'uri')
        )
        ...
        if_first_displaytext_present_5 >> rail.Label(
            'Yes') >> slovakia_master_mapper_search_entries_6 >> if_entry_col1_blank_7

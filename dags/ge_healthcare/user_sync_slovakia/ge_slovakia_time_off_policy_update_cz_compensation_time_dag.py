...
def create_dag(config):
    ...
    with rail.create_airflow_dag(
        dag_id=f'gehealthcare_slovakia_time_off_policy_update_cz_compensation_time_{config.instance}',
        description=f'GE slovakia Time Off policy update - CZ_Compensation Time {config.instance}',

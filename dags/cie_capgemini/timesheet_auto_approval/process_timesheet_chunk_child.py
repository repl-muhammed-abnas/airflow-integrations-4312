...
import rail
from cie_capgemini.timesheet_auto_approval.utils import request_payload, python_callable
...
def create_child_dag_wbs(config):
    ...
    with rail.create_airflow_dag(
        ...
        get_latest_recalc_ts_uris >> create_timesheet_batch >> approve_timesheet >> create_timesheet_batch_retries >> approve_timesheet_retries >> check_for_log

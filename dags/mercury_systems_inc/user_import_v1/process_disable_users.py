...
def create_child_dag(config):
    with rail.create_airflow_dag(
        ...
        is_enddate_greater_than_start_date = rail.IfOperator(
            ...
            yes_task="update_end_date_and_disable_login",
        ...
        update_end_date_and_disable_login = rail.RepliconServiceOperator(
            task_id='update_end_date_and_disable_login',
            endpoint="/services/ImportService2.svc/CreateUserOrApplyModifications",
            data=lambda dag_run: request_payload.disable_and_update_end_date_payload(
                dag_run, config),
        )
        ...
        is_enddate_greater_than_start_date >> rail.Label(
            "Yes") >> update_end_date_and_disable_login >> log_existing_timeoff_policies_for_disable_user

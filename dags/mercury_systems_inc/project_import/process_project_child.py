...
import rail
from mercury_systems_inc.project_import.utils import request_payload, custom_method, response_filter
...
def create_child_dag_wbs(config):
    ...
    for idx in range(0, config.PROJECT_BATCH_COUNT):
        ...
        with rail.create_airflow_dag(
            ...
            can_run_batch_task >> rail.Label(
                'No') >> get_project_data_from_query >> get_project_details >> create_or_update_project >> is_project_manager_is_present

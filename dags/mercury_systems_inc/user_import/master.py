...
from mercury_systems_inc.user_import.task_groups.pre_requisites import pre_requisites_task_group
    ...
    with rail.create_airflow_dag(
        ...
        create_csv_lines_input = rail.WriteCSVFileOperator(
            ...
            header=[
                ...
                'Time_Off_Types', 'Holiday_Calendar', 'Pay_Rule', 'Office_Schedule', 'Work_Week'
            ],

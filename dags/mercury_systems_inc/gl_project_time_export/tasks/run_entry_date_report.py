null=None
import rail
def run_entry_date_project_time_report(config):
        
    with rail.TaskGroup(
            group_id="run_entry_date_project_time",
        ...
        end_report= rail.CreateCollectionOperator(
            ...
            source=[],
            name="cost_data",
            columns=["full_name", "employee_id","uses_activity", "union_code",
                    "job_code", "pay_type", "week_ending","bu",
                    "department", "activity_pay_Code", "weekly_hours", "weekly_earnings","time_in"]
        )
        ...
        load_report_data = rail.LoadCSVFileOperator(
            ...
            headers=["full_name", "employee_id","uses_activity", "union_code",
                    "job_code", "pay_type", "week_ending","bu",
                    "department", "activity_pay_Code", "weekly_hours", "weekly_earnings","time_in"]
        )

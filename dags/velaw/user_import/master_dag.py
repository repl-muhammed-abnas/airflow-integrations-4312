...
from velaw.user_import.task.generate_report_batch import report_batch
...
def create_dag(config):
    ...
    with rail.create_airflow_dag(
        dag_id=f'velaw_user_import_velawg3_user_import_v2_0_{config.instance}',
        ...
        trigger_dag_run_velaw_user_import_velawg3_child_groups_update_v2_020 = rail.TriggerDagRunOperator(
            ...
            retries=0,
            trigger_dag_id=f'velaw_user_import_velawg3_child_groups_update_v2_0_{config.instance}',
        ...
        trigger_dag_run_velaw_user_import_velawg3_drop_down_udf_custom_field_check_v2_056 = rail.TriggerDagRunForEachItemOperator(
            ...
            retries=0,
            items=[0],
            trigger_dag_id=f'velaw_user_import_velawg3_drop_down_udf_custom_field_check_v2_0_{config.instance}',
            execution_timeout=timedelta(days=config.execution_timeout_days),
            conf=lambda: {
                "filepath": rail.result('download_9'),
        ...
        trigger_dag_run_velaw_user_import_velawg3_child_workflow_to_disable_user_v2_0async_90 = rail.TriggerDagRunForEachItemOperator(
            ...
            trigger_dag_id=f'velaw_user_import_velawg3_child_workflow_to_disable_user_v2_0_{config.instance}',
            execution_timeout=timedelta(days=config.execution_timeout_days),
        ...
        trigger_dag_run_velaw_user_import_velawg3_child_add_user_v2_0async_115 = rail.TriggerDagRunForEachItemOperator(
            ...
            trigger_dag_id=f'velaw_user_import_velawg3_child_add_user_v2_0_{config.instance}',
            execution_timeout=timedelta(days=config.execution_timeout_days),
            conf=lambda item: {
                "loginname": item['loginname'],
        ...
        trigger_dag_run_velawg3_user_update_v2_0async_137 = rail.TriggerDagRunForEachItemOperator(
            ...
            trigger_dag_id=f'velaw_user_import_velawg3_user_update_v2_0_{config.instance}',
            execution_timeout=timedelta(days=config.execution_timeout_days),
            conf=lambda item: {
                "loginname": item['loginname'],
                "lastname": item['lastname'],
        ...
        trigger_dag_run_velaw_user_import_velawg3_child_supervisor_assignment_v2_0async_147 = rail.TriggerDagRunForEachItemOperator(
            ...
            trigger_dag_id=f'velaw_user_import_velawg3_child_supervisor_assignment_v2_0_{config.instance}',
            execution_timeout=timedelta(days=config.execution_timeout_days),
            conf=lambda item: {
                "loginname": item['loginname'],
                "username": item['username'],
        ...
        trigger_user_import_log_generation = rail.TriggerDagRunOperator(
            ...
            execution_timeout=timedelta(
                days=config.execution_timeout_days),
            trigger_dag_id=f'velaw_user_import_velawg3_child_loggeneration_{config.instance}',
            conf=lambda dag_run: {

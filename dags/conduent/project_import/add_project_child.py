...
def create_dag(config):
    with rail.create_airflow_dag(
        ...
        if_project_type_overhead = rail.IfOperator(
            ...
            no_task='add_log_project_add_successful'
        )
        ...
        if_project_type_overhead >> rail.Label(
            'Yes') >> put_eligibleprojectteammember_dataaccessscopes >> add_log_project_add_successful
        if_project_type_overhead >> rail.Label(
            'No') >> add_log_project_add_successful >> finish
        if_has_cost_center_uri >> rail.Label(

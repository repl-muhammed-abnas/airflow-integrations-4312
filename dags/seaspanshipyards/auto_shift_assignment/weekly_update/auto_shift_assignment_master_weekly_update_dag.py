...
from seaspanshipyards.auto_shift_assignment.weekly_update.utils import request_payload

def create_dag(config):
    # pylint: disable=too-many-statements
    with rail.create_airflow_dag(
        dag_id=f'seaspanshipyards_weekly_shift_assignment_master_{config.instance}',
        description=f'Seaspanshipyards_Weekly shift assignment_master {config.instance}',
        ...
        process_shifts = rail.TriggerDagRunForEachItemOperator(
            ...
            trigger_dag_id=f'seaspanshipyards_weekly_shift_assignment_per_existing_user_V3.0_{config.instance}',

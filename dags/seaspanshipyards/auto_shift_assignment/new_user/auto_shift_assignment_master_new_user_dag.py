...
from seaspanshipyards.auto_shift_assignment.new_user.utils import request_payload

def create_dag(config):
    # pylint: disable=too-many-statements
    with rail.create_airflow_dag(
        dag_id=f'seaspanshipyards_assign_shift_to_new_users_master_V3.0_{config.instance}',
        description=f'Seaspanshipyards_assign shift to new users_master V3.0 {config.instance}',
        ...
        default_args={
            'sftp_conn_id': config.seaspanshipyards_sftp_conn_id,
        },
    ) as dag:
        ...
        process_shifts = rail.TriggerDagRunForEachItemOperator(
            ...
            trigger_dag_id=f'seaspanshipyards_default_shift_assignment_per_new_user_V3.0_{config.instance}',

...
from seaspanshipyards.timesheet_auto_submission.tasks import recalculated_timesheets_report_batch
from seaspanshipyards.timesheet_auto_submission.tasks import timesheets_report_batch
...
def create_dag(config):
    with rail.create_airflow_dag(
        dag_id=f"seaspanshipyards_timesheet_auto_submission_time_punch_master_dag_{config.instance}",
        description=f"SeaspanShipyards Timesheet Auto Submission Time Punch Master {config.instance}",
        ...
        recalculate_timesheet = rail.TriggerDagRunForEachItemOperator(
            ...
            trigger_dag_id=f'seaspanshipyards_recalculate_timesheets_child_dag_{config.instance}',
        )
        ...
        automatic_timesheet_submission = rail.TriggerDagRunForEachItemOperator(
            ...
            execution_timeout=timedelta(days=config.execution_timeout_days),
            trigger_dag_id=f'seaspanshipyards_automatic_timesheets_submission_child_dag_{config.instance}',
            conf=lambda item: {

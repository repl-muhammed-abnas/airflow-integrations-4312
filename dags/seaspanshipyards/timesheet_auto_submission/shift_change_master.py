...
def create_dag(config):
    with rail.create_airflow_dag(
        dag_id=f"seaspanshipyards_timesheet_auto_submission_shift_change_master_{config.instance}",
        description=f"SeaspanShipyards Timesheet Auto Submission Shift Change Master {config.instance}",

...
max_active_runs = 1
recalculate_max_active_runs = 10
timesheet_submission_child_max_active_runs = 10
...
timesheet_submission_mapper_var = 'seaspanshipyards_timesheet_submission_warning_messages_mapper'

schedule_interval = "0 2,8,17 * * *"

...
def create_dag(config):
    with rail.create_airflow_dag(
        dag_id=f"seaspanshipyards_auto_timesheet_generation_main_dag_{config.instance}",
        description=f"SeaspanShipyards Auto Timesheet Generation {config.instance}",
        ...
        generate_timesheets = rail.TriggerDagRunForEachItemOperator(
            ...
            trigger_dag_id=f'seaspanshipyards_generate_timesheets_child_dag_{config.instance}',

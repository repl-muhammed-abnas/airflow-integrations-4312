...
from seaspanshipyards.users_supervisor_details_export.utils import request_payload
...
def create_dag(config):
    with rail.create_airflow_dag(
        ...
        description=f'SeaspanShipyards Users Supervisor Details Export Master {config.instance}',

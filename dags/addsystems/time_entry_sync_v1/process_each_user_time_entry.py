...
def create_child_dag(config):
    ...
    with rail.create_airflow_dag(
        dag_id=f"addsystems_time_data_process_each_user_time_record_child_{config.instance}_v1",
        ...
        process_each_time_records = rail.TriggerDagRunForEachItemOperator(
            ...
            trigger_dag_id=f"addsystems_time_data_process_each_time_record_child_{config.instance}_v1",

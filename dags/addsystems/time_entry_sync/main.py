...
from addsystems.time_entry_sync.utils import request_payload


def create_main_dag(config):

    with rail.create_airflow_dag(
        dag_id=f'addsystems_time_sync_master_{config.instance}',
        ...
        process_each_time_records = rail.TriggerDagRunForEachItemOperator(
            ...
            trigger_dag_id=f"addsystems_time_data_process_each_user_time_record_child_{config.instance}",

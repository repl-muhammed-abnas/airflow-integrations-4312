...
def create_dag(config):
    ...
    with rail.create_airflow_dag(
        dag_id=f'ge_timesheet_email_notification_master_{config.instance}',
        ...
        trigger_send_email_notifications = rail.TriggerDagRunForEachItemOperator(
            ...
            trigger_dag_id=f'ge_timesheet_email_notification_poland_send_email_notification_child_{config.instance}',

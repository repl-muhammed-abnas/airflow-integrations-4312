...
def create_dag(config):
    ...
    with rail.create_airflow_dag(
        dag_id=f'ge_netherlands_child_add_to_policy_update_user_v1_0_{config.instance}',
        ...
        trigger_dag_run_ge_user_sync_netherlands_child_timeoff_type_proration_assignment_for_default_v1_038 = rail.TriggerDagRunForEachItemOperator(
            ...
            retries=0,
            items=[-1],
            trigger_dag_id=f'ge_netherlands_child_timeoff_type_proration_assignment_for_default_v1_0_{config.instance}',
        ...
        trigger_dag_run_timeoff_type_proration_assignment_for_06_nl_wedding_leave_v1_042 = rail.TriggerDagRunForEachItemOperator(
            ...
            retries=0,
            items=[-1],
            trigger_dag_id=f'ge_netherlands_child_timeoff_type_proration_assignment_for_06_nl_wedding_leave_v1_0_{config.instance}',
            execution_timeout=timedelta(days=14),
            accumulate_result=True,
            conf=lambda dag_run: {
                "userloginname": dag_run.conf['userloginname'],
        ...
        trigger_dag_run_child_timeoff_type_proration_assignment_for_04_nl_seniority_days_44 = rail.TriggerDagRunForEachItemOperator(
            ...
            retries=0,
            items=[-1],
            trigger_dag_id=f'ge_netherlands_child_timeoff_type_proration_assignment_for_04_nl_seniority_days_start_date_v1_0{config.instance}',
            execution_timeout=timedelta(days=14),
            accumulate_result=True,
            conf=lambda dag_run: {
                "userloginname": dag_run.conf['userloginname'],
        ...
        trigger_dag_run_ge_timeoff_type_proration_assignment_for_01_nl_legal_holidays_v1_046 = rail.TriggerDagRunForEachItemOperator(
            ...
            retries=0,
            items=[-1],
            trigger_dag_id=f'ge_user_sync_netherlands_child_timeoff_type_proration_assignment_for_01_nl_legal_holidays_v1_0_{config.instance}',
            execution_timeout=timedelta(days=14),
            accumulate_result=True,
            conf=lambda dag_run: {
                "userloginname": dag_run.conf['userloginname'],
        ...
        trigger_dag_run_ge_child_timeoff_type_proration_assignment_for_02_nl_extra_holidays_v1_048 = rail.TriggerDagRunForEachItemOperator(
            ...
            retries=0,
            items=[-1],
            trigger_dag_id=f'ge_user_sync_netherlands_child_timeoff_type_proration_assignment_for_02_nl_extra_holidays_v1_0_{config.instance}',
            execution_timeout=timedelta(days=14),
            accumulate_result=True,
            conf=lambda dag_run: {
                "userloginname": dag_run.conf['userloginname'],
        ...
        trigger_dag_run_ge_user_sync_netherlands_timeoff_type_proration_assignment_for_03_nl_atv_v1_049 = rail.TriggerDagRunForEachItemOperator(
            ...
            retries=0,
            items=[-1],
            trigger_dag_id=f'ge_user_sync_ge_netherlands_child_timeoff_type_proration_assignment_for_03_nl_atv_v1_0_{config.instance}',
            execution_timeout=timedelta(days=14),
            accumulate_result=True,
            conf=lambda dag_run: {
                "userloginname": dag_run.conf['userloginname'],

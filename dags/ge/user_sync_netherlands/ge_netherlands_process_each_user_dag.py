...
def create_dag(config):
    ...
    with rail.create_airflow_dag(
        dag_id=f'ge_netherlands_process_each_user_dag_{config.instance}',
        description=f'GE netherlands Process Each User {config.instance}',
        ...
        if_log_useruriiftheprofileexists_31_present_update_user_32 = rail.IfOperator(
            ...
            yes_task="trigger_dag_run_live_ge_netherlands_user_updateasync_33",
            no_task="trigger_dag_run_ge_user_sync_netherlands_ge_netherlands_add_v1_0async_35",
        )

        trigger_dag_run_live_ge_netherlands_user_updateasync_33 = rail.TriggerDagRunForEachItemOperator(
            task_id='trigger_dag_run_live_ge_netherlands_user_updateasync_33',
            retries=0,
            items=[1],
            trigger_dag_id=f'ge_netherlands_user_update_{config.instance}',
            ...
            conf=lambda dag_run: {
                ...
                "WorkLocation": dag_run.conf['Work'],
        ...
        wait_for_completion_trigger_dag_run_live_ge_netherlands_user_updateasync_33 = rail.WaitForDagRunsSensor(
            task_id='wait_for_completion_trigger_dag_run_live_ge_netherlands_user_updateasync_33',
            execution_timeout=timedelta(days=14),
            dag_runs='{{ result("trigger_dag_run_live_ge_netherlands_user_updateasync_33") }}'
        )

        trigger_dag_run_ge_user_sync_netherlands_ge_netherlands_add_v1_0async_35 = rail.TriggerDagRunForEachItemOperator(
            task_id='trigger_dag_run_ge_user_sync_netherlands_ge_netherlands_add_v1_0async_35',
            retries=0,
            items=[1],
            trigger_dag_id=f'ge_netherlands_add_v1_0_{config.instance}',
            execution_timeout=timedelta(days=14),
            accumulate_result=True,
            conf=lambda dag_run: {
        ...
        wait_for_completion_trigger_dag_run_ge_user_sync_netherlands_ge_netherlands_add_v1_0async_35 = rail.WaitForDagRunsSensor(
            task_id='wait_for_completion_trigger_dag_run_ge_user_sync_netherlands_ge_netherlands_add_v1_0async_35',
            execution_timeout=timedelta(days=14),
            dag_runs='{{ result("trigger_dag_run_ge_user_sync_netherlands_ge_netherlands_add_v1_0async_35") }}'
        )
        ...
        if_log_useruriiftheprofileexists_31_present_update_user_32 >> rail.Label('No') >> \
            trigger_dag_run_ge_user_sync_netherlands_ge_netherlands_add_v1_0async_35 >> wait_for_completion_trigger_dag_run_ge_user_sync_netherlands_ge_netherlands_add_v1_0async_35 >> process_users
        if_log_useruriiftheprofileexists_31_present_update_user_32 >> rail.Label('Yes') >> \
            trigger_dag_run_live_ge_netherlands_user_updateasync_33 >> \
            wait_for_completion_trigger_dag_run_live_ge_netherlands_user_updateasync_33 >> \

...
def create_dag(config):
    ...
    with rail.create_airflow_dag(
        dag_id=f'ge_greece_child_workflow_to_add_timeoff_type_for_new_user_v1_0_{config.instance}',
        ...
        trigger_dag_run_ge_greece_child_workflow_to_add_timeoff_policy_for_new_user_v1_16 = rail.TriggerDagRunForEachItemOperator(
            ...
            trigger_dag_id=f'ge_greece_child_add_to_policy_new_user_v1_0_{config.instance}',

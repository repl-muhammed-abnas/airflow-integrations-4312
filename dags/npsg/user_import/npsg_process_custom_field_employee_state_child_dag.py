...
def create_dag(config):
    with rail.create_airflow_dag(
        dag_id=f'npsg_user_import_process_custom_field_employee_state_child_{config.instance}',
        description=f'NPSG_Process Custom field (employee state)- Child V1.0 {config.instance}',

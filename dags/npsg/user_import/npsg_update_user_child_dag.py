...
def create_dag(config):
    ...
    with rail.create_airflow_dag(
        dag_id=f'npsg_user_import_update_user_child_{config.instance}',
        description=f'NPSG_update_user V1.0 {config.instance}',
        ...
        if_request_enddate_present_10 = rail.IfOperator(
            ...
            yes_task="get_terminate_date",
            no_task="get_effective_user_group_membership_15",
        )

        get_terminate_date = rail.PythonOperator(
            task_id = 'get_terminate_date',
        ...
        apply_user_modifications2_updatestartdate_12 = rail.RepliconServiceOperator(
            ...
            data={
                ...
                "dateRange": {
                    ...
                    "endDate":  {
                        "year": "{{ result('get_terminate_date').year }}",
                        "month": "{{ result('get_terminate_date').month }}",
                        "day": "{{ result('get_terminate_date').day }}"
                    },
                    "relativeDateRangeUri": null,
                    "relativeDateRangeAsOfDate": null
                }
        ...
        get_today_date_object = rail.PythonOperator(
            ...
            python_callable=lambda: get_date_object(datetime.now().strftime("%m/%d/%Y"))
        )
        ...
        bulk_get_users3_4 >> get_startdate_object >> if_userdetails_isenabled_is_not_true_6
        ...
        if_request_enddate_present_10 >> rail.Label(
            'Yes') >> get_terminate_date >> apply_user_modifications2_updatestartdate_12 >> get_effective_user_group_membership_15
        if_request_enddate_present_10 >> rail.Label(
            'No') >> get_effective_user_group_membership_15
        if_userdetails_isenabled_is_true_9 >> rail.Label(
            'No') >> get_effective_user_group_membership_15 >> get_today_date_object >> if_request_email_present_21
        ...
        if_log_checkifsupervisorpermissionsetisassigned_63_present_64 >> rail.Label(
            'Yes') >> update_supervisor_assignment_schedule_over_date_range_65 >> npsg_user_import_logs_add_entry_98
        if_log_checkifsupervisorpermissionsetisassigned_63_present_64 >> rail.Label(
            'No') >> get_all_permission_sets_67 >> assign_permission_set_to_user_69 >> update_supervisor_assignment_schedule_over_date_range_70
        update_supervisor_assignment_schedule_over_date_range_70 >> npsg_user_import_logs_add_entry_98
        if_log_checkifuserexist_55_not_equals_to_dataloggerlog_current_supervisor_uri_58message_61 >> rail.Label(
            'No') >> npsg_user_import_logs_add_entry_98
        if_log_checkifuserexist_55_present_60 >> rail.Label(
            'No') >> npsg_supervisor_check_add_entry_72 >> npsg_user_import_logs_add_entry_98
        if_log_current_supervisor_uri_58_present_currentsupervisorisassigned_59 >> rail.Label(
        ...
        update_supervisor_assignment_schedule_over_date_range_83 >> npsg_user_import_logs_add_entry_98
        if_log_checkifuserexist_55_present_74 >> rail.Label(
            'No') >> if_request_supervisorid_present_85
        if_request_supervisorid_present_85 >> rail.Label(
            'Yes') >> npsg_supervisor_check_add_entry_86 >> npsg_user_import_logs_add_entry_98
        if_request_supervisorid_present_85 >> rail.Label(
            'No') >> npsg_user_import_logs_add_entry_98
        if_log_checkifuserexist_55_present_56 >> rail.Label(
            'No') >> npsg_user_import_logs_add_entry_98
        if_request_supervisorid_present_53 >> rail.Label(
            'No') >> npsg_user_import_logs_add_entry_98
        npsg_user_import_logs_add_entry_98 >> catch_and_log_error >> log_to_sumo

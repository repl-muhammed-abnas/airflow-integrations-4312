...
def create_dag(config):
    ...
    with rail.create_airflow_dag(
        dag_id=f'npsg_user_import_create_user_child_{config.instance}',
        description=f'NPSG_create_user {config.instance}',
        ...
        if_output_enabled_is_not_true_14 = rail.IfOperator(
            ...
            test=lambda: not(rail.result('search_users_11')['enabled']),
            yes_task="trigger_dag_run_live_npsg_update_user_v1_015",
            no_task="search_user_by_loginname",
        )

        trigger_dag_run_live_npsg_update_user_v1_015 = rail.TriggerDagRunOperator(
            task_id='trigger_dag_run_live_npsg_update_user_v1_015',
            retries=0,
        ...
        wait_for_completion_trigger_dag_run_live_npsg_update_user_v1_015 = rail.WaitForDagRunsSensor(
            task_id='wait_for_completion_trigger_dag_run_live_npsg_update_user_v1_015',
            execution_timeout=timedelta(days=config.execution_timeout_days),
            dag_runs='{{ result("trigger_dag_run_live_npsg_update_user_v1_015") }}'
        )
        ...
        if_output_enabled_is_not_true_14 >> rail.Label(
            'Yes') >> trigger_dag_run_live_npsg_update_user_v1_015 >> wait_for_completion_trigger_dag_run_live_npsg_update_user_v1_015
        wait_for_completion_trigger_dag_run_live_npsg_update_user_v1_015 >> catch_and_log_error
        if_output_enabled_is_not_true_14 >> rail.Label(
        ...
        if_request_enddate_present_23 >> rail.Label(
            'No') >> get_startdate_object >> put_user2_27 >> if_request_locationuri_present_28
        ...
        if_request_license_present_51 >> rail.Label(
            'Yes') >> put_product_assignments_for_user_52 >> if_request_permissions_present_56
        if_request_license_present_51 >> rail.Label(

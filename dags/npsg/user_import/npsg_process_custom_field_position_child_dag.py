...
def create_dag(config):
    with rail.create_airflow_dag(
        dag_id=f'npsg_user_import_process_custom_field_position_child_{config.instance}',
        description=f'NPSG_Process Custom field (Position)- Child V1.0 {config.instance}',

...
def create_main_dag(config):
    with rail.create_airflow_dag(
        dag_id=f'nttdata_payroll_hours_this_month_report_to_sftp_master_{config.instance}',
        description=f'nttdata_payroll_hours_this_month_report_to_sftp_master {config.instance}',
        ...
        upload_reportdata_to_sftp = rail.SFTPUploadFileOperator(
            ...
            remote_filepath=config.filepath + "Payroll_Hours_This_Month"

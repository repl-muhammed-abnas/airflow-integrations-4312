...
def create_main_dag(config):
    with rail.create_airflow_dag(
        dag_id=f'nttdata_ot_eligibility_feed_report_to_sftp_master_{config.instance}',
        description=f'nttdata_ot_eligibility_feed_report_to_sftp_master {config.instance}',
        ...
        upload_reportdata_to_sftp = rail.SFTPUploadFileOperator(
            ...
            remote_filepath=config.filepath + "Replicon_OT_SAP_"
        ...
        log_to_sumo = rail.DagRunLogToSumoOperator(
            ...
            extra_info={
                "exportfile_name": config.filepath + "Replicon_OT_SAP_"
                '{{ current_time_in_specified_tz("America/Chicago","%Y_%m_%d_%H_%M") }}' + ".csv"
            }
        )

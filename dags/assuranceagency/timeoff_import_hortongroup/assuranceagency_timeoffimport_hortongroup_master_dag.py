...
def create_dag(config):
    ...
    with rail.create_airflow_dag(
        dag_id=f'assuranceagency_timeoff_import_hortongroup_master_{config.instance}',
        description=f'Assuranceagency Horton Group timeoffimport - Master {config.instance}',
        ...
        send_mail_3=rail.EmailOperator(
            ...
            subject='''{{get_company_key()}} | Replicon timeoff import for Horton Group is skipped -{{ current_time() }} ''',
        ...
        trigger_dag_process_bookings_child_35=rail.TriggerDagRunForEachItemOperator(
            ...
            trigger_dag_id=f'assuranceagency_timeoffimport_hortongroup_process_bookings_child_{config.instance}',
        ...
        trigger_dag_process_reopenedtimesheets_child37=rail.TriggerDagRunOperator(
            ...
            retries=0,
            trigger_dag_id=f'assuranceagency_timeoffimport_hortongroup_process_reopenedtimesheets_child_{config.instance}',
            execution_timeout=timedelta(days=config.execution_timeout_days),
            conf={
        ...
        send_mail_with_cshare_46=rail.EmailOperator(
            ...
            subject='''{{get_company_key()}} | Replicon timeoff import for Horton Group is completed with failed records -{{ current_time() }} ''',
        ...
        send_mail_with_cshare_48=rail.EmailOperator(
            ...
            to=config.tenant_email,
            bcc=config.internal_logs_email,
            subject='''{{get_company_key()}} | Replicon timeoff import for Horton Group is completed successfully -{{ current_time() }} ''',

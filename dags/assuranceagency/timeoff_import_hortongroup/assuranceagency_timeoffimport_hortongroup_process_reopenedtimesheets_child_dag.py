...
def create_dag(config):
    ...
    with rail.create_airflow_dag(
        dag_id=f'assuranceagency_timeoffimport_hortongroup_process_reopenedtimesheets_child_{config.instance}',
        description=f'Assuranceagency Horton group timeoffimport - Process Reopenedtimesheets - Child{config.instance}',

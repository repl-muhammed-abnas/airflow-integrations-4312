...
import rail
from assuranceagency.user_import.utils.python_callable import get_today, get_current_data
...
def create_dag(config):
    with rail.create_airflow_dag(
        dag_id=f'assuranceagency_user_import_update_user_child_{config.instance}',
        description=f'assuranceagency_user_import_update_user_child_{config.instance}',
        ...
        if_location_mismatch >> rail.Label("No") >> timesheet_template_variable

        if_location_uri_present >> rail.Label("Yes") >> update_location >> timesheet_template_variable
        if_location_uri_present >> rail.Label("No") >> log_location_exception >> timesheet_template_variable

...
import rail
from assuranceagency.user_import.utils.request_payload import get_today_date_format
from assuranceagency.user_import.utils.python_callable import get_exceptions
...
def create_dag(config):
    with rail.create_airflow_dag(
        dag_id=f'assuranceagency_user_import_update_supervisor_from_logs_child_{config.instance}',
        description=f'assuranceagency_user_import_update_supervisor_from_logs_child_{config.instance}',

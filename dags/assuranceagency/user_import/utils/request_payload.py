...
from assuranceagency.user_import.utils.python_callable import get_today
from assuranceagency.user_import.mappers.assuranceagency_timezone_mapper import timezone_mapper
from assuranceagency.user_import.mappers.assuranceagency_timeofftype_mapper import timeoff_type_mapper
from assuranceagency.user_import.mappers.assuranceagency_employeetype_mapper import employee_type_mapper
from assuranceagency.user_import.mappers.assuranceagency_workweek_mapper import workweek_mapper
...
def user_import_csv_data(item):
    return [
        ...
        md5(",".join([item['Login Name'],item['First Name'],item['Last Name'],item['Employee Type'],item['Department'],
                     ...
                     item['Worker Category'],item['Manager']]).encode()).hexdigest()
    ]

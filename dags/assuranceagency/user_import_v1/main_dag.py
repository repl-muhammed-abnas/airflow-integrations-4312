...
from assuranceagency.user_import_v1.utils.python_callable import get_ref_file_name
...
def create_dag(config):
    with rail.create_airflow_dag(
        ...
        description=f'assuranceagency_user_import_master_{config.instance}_v1',
        ...
        process_each_supervisor_log_data = rail.TriggerDagRunForEachItemOperator(
            ...
            trigger_dag_id=config.update_supervisor_child_dag_id,

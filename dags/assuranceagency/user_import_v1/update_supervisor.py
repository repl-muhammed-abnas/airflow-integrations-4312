...
import rail
from assuranceagency.user_import_v1.utils.request_payload import get_today_date_format
from assuranceagency.user_import_v1.utils.python_callable import get_exceptions
...
def create_dag(config):
    with rail.create_airflow_dag(
        dag_id=config.update_supervisor_child_dag_id,
        description=f'assuranceagency_user_import_update_supervisor_from_logs_child_{config.instance}_v1',

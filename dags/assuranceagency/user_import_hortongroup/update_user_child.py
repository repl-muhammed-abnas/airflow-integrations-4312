...
import rail
from assuranceagency.user_import_hortongroup.utils.python_callable import get_today, get_current_data
...
def create_dag(config):
    with rail.create_airflow_dag(
        dag_id=f'assuranceagency_user_import_hortongroup_update_user_child_{config.instance}',
        description=f'assuranceagency_user_import_hortongroup_update_user_child_{config.instance}',

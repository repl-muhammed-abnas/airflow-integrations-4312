...
def create_dag(config):
    with rail.create_airflow_dag(
        dag_id=f'assuranceagency_user_import_hortongroup_add_user_child_{config.instance}',
        description=f'assuranceagency_user_import_hortongroup_add_user_child_{config.instance}',

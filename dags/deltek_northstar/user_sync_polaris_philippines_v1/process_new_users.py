...
import rail
from deltek_northstar.user_sync_polaris_philippines_v1.utils import request_payload, response_filter
from deltek_northstar.user_sync_polaris_philippines_v1.tasks.process_supervisor import process_supervisor_assignment_task_group
...
def create_child_dag(config):
    with rail.create_airflow_dag(
        ...
        add_new_user >> update_license_for_user >> is_supervisor_in_api_response

...
def create_child_dag(config):
    with rail.create_airflow_dag(
        ...
        if_setup_new_profile_is_no = rail.IfOperator(
            ...
            yes_task='update_existing_user_profile_date',
            no_task='needs_to_update_the_existing_profile'
        )

        update_existing_user_profile_date = rail.RepliconServiceOperator(
            task_id='update_existing_user_profile_date',
        ...
        if_setup_new_profile_is_no >> rail.Label('Yes') >> update_existing_user_profile_date >> get_timesheet_details >> process_update_user >> wait_for_process_update_user >> catch_and_log_errors

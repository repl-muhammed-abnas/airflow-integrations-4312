...
import rail
from deltek_northstar.user_sync_polaris.utils import request_payload, response_filter
from deltek_northstar.user_sync_polaris.tasks.process_supervisor import process_supervisor_assignment_task_group
...
def create_child_dag(config):
    with rail.create_airflow_dag(
        ...
        can_run_batch_task = rail.IfOperator(
            ...
            yes_task='batch_task',
            no_task='get_cost_rate_by_emp_id'
        )
        ...
        batch_task = rail.BatchTaskRunOperator(
            ...
            start_task='get_cost_rate_by_emp_id',
            end_task='catch_and_log_errors',
        )

        #https://tcmobile-dev.deltek.com/CPWeb/cprestfulws/cpwwsgenericexport.cps?system=CP7DEV1&company=USA
        get_cost_rate_by_emp_id = rail.DeltekCostPointServiceOperator(
            task_id='get_cost_rate_by_emp_id',
            ...
            data=request_payload.get_cost_rate_by_emp_id,
            data_handler=response_filter.filter_cost_rate_response
        )
        ...
        update_license_for_user = rail.RepliconServiceOperator(
            ...
            data=lambda dag_run: {
                ...
                "productUris": dag_run.conf['licences']
            }
        )
        ...
        can_run_batch_task >> rail.Label('No') >> get_cost_rate_by_emp_id

        get_cost_rate_by_emp_id >> add_new_user >> update_license_for_user >> is_supervisor_in_api_response

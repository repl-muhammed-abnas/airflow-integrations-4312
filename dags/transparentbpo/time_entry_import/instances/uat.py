...
input_filepath = '/UAT/Timesheet Feed Files'
archive_filepath = '/UAT/Timesheet Feed Archive'
log_filepath = '/UAT/Timesheet Feed Logs'
...
sftp_conn_id = "sftp_transparentbpo_662208_UAT"

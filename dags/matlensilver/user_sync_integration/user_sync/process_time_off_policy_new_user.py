...
def create_child_dag_wbs(config):
    with rail.create_airflow_dag(
        dag_id=f'matlen_silver_user_sync_child_process_time_off_policy_new_user_{config.instance}',
        description='Matlen_Silver User Sync Process Time off Policy New User',
        ...
        get_default_time_off_policy_schedule >> policy_to_assign >> is_policy_present

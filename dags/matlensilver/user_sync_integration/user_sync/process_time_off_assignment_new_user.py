...
def create_child_dag_wbs(config):
    with rail.create_airflow_dag(
        dag_id=f'matlen_silver_user_sync_child_process_time_off_assignment_new_user_{config.instance}',
        description='Matlen_Silver User Sync Process Time off assignment New User',
        ...
        process_time_off_policy_new_user = rail.TriggerDagRunForEachItemOperator(
            ...
            trigger_dag_id=f'matlen_silver_user_sync_child_process_time_off_policy_new_user_{config.instance}',
        ...
        is_timeoff_available >> rail.Label('No') >> log_timeoff_not_available >> catch_and_log_errors

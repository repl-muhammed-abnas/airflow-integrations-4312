...
def create_main_dag(config):
    with rail.create_airflow_dag(
        dag_id=f'matlen_silver_user_sync_disable_user_master_{config.instance}',
        description='Matlen_Silver User Sync Disable User Master',
        ...
        disable_user_child = rail.TriggerDagRunForEachItemOperator(
            ...
            trigger_dag_id=f'matlen_silver_user_sync_disable_user_child_{config.instance}',
            conf=lambda item: {
                'user': item['user'],
                'uri': item['uri'],
        ...
        users_to_disable >> rail.Label(
            'Yes') >> disable_user_child >> wait_for_disable_user_child >> gather_disable_user_errors

...
def create_child_dag_wbs(config):
    with rail.create_airflow_dag(
        ...
        is_location_not_in_canada_usa = rail.IfOperator(
            ...
            test=lambda dag_run:dag_run.conf['location'] not in ['USA','CAN'],
        ...
        disable_user >> is_location_not_in_canada_usa >> rail.Label('Yes') >> remove_timeoff_template >> is_status_ignore_zero_accrual

...
from crl.user_import_canada_v6.utils import request_payload, python_callable_methods, response_filter
...
def create_child_dag(config):
    with rail.create_airflow_dag(
        ...
        is_status_updaid_or_paid_leave >> rail.Label('Yes') >> is_reason_available_in_mapper_and_code_10_in_payload >> rail.Label('No') >> is_logging_required
        is_reason_available_in_mapper_and_code_10_in_payload >> rail.Label('Yes') >> is_reason_or_reasoncode_updated >> rail.Label('No') >> is_logging_required
        ...
        put_user_timeoff_policy_schedule_blank_policy >> is_logging_required >> rail.Label("Yes") >> log_unpaid_leave_complete >> catch_and_log_errors

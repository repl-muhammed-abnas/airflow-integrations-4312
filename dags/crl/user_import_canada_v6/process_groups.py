...
from crl.user_import_canada_v6.utils import response_filter
...
def create_child_dag(config):
    with rail.create_airflow_dag(
        ...
        description='CRL - User Import Process Groups',
        ...
        query_valid_delta_records_company_code = rail.QueryCollectionOperator(
            ...
            query="""SELECT DISTINCT company_code FROM valid_records WHERE emp_status!='Terminated'"""
        )
        ...
        query_distinct_location_full_path_from_valid_records = rail.QueryCollectionOperator(
            ...
            query="""SELECT DISTINCT location_full_path FROM valid_records WHERE emp_status!='Terminated'"""
        )
        ...
        query_distinct_buisness_unit_full_path_from_valid_records = rail.QueryCollectionOperator(
            ...
            query="""SELECT DISTINCT buisness_unit_full_path, buisness_unit_label FROM valid_records WHERE emp_status!='Terminated'"""
        )
        ...
        query_distinct_cost_center_full_path_from_valid_records = rail.QueryCollectionOperator(
            ...
            query="""SELECT DISTINCT cost_center_full_path, cost_center_label FROM valid_records WHERE emp_status!='Terminated'"""
        )

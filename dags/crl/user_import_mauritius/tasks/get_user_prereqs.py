    ...
    with rail.TaskGroup(group_id='get_user_prereqs', prefix_group_id=False) as get_user_prereqs:
        ...
        get_user_udfs = rail.RepliconServiceOperator(
            ...
            data_handler=lambda udfs: {
                ...
                'staff_category_def_uri': rail.find_first_by_attr_and_get_attr(udfs, 'displayText', 'Staff Category', 'uri'),
                'functional_sub_segment_def_uri': rail.find_first_by_attr_and_get_attr(udfs, 'displayText', 'Functional Sub Segment', 'uri')
            },
        )

        get_staff_category_dropdown_values = rail.RepliconServiceOperator(
            task_id="get_staff_category_dropdown_values",
            endpoint="/services/CustomFieldService1.svc/GetAllCustomFieldDropDownOptions",
            data=lambda:{
                    "customFieldUri": rail.result('get_user_udfs')['staff_category_def_uri']
                },
        ...
        get_user_udfs >> get_staff_category_dropdown_values

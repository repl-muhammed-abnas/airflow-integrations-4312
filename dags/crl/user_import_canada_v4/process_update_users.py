...
from crl.user_import_canada_v4.utils import request_payload, response_filter
from crl.user_import_canada_v4.tasks.process_supervisor import process_supervisor_assignment_task_group
...
def create_child_dag(config):
    ...
    for idx in range(0, config.BATCH_COUNT):
        ...
        with rail.create_airflow_dag(
            ...
            is_status_active >> rail.Label("Yes") >> is_contingent_or_usa_user >> rail.Label('No') >> is_previously_unpaid_leave_or_suspended

...
from crl.user_import_canada_v4.utils import request_payload, python_callable_methods
from crl.user_import_canada_v4.utils.response_filter import get_filtered_time_off_types, assigned_timeoffs_types_to_user, get_policy_to_assign_for_timeoff
...
def create_child_dag(config):
    ...
    for idx in range(0, config.BATCH_COUNT):
        ...
        with rail.create_airflow_dag(
            ...
            for_each_time_off_type_policy >> get_historical_policy_to_assign_list >> get_default_time_off_policy_schedule >> get_all_policy_to_assign

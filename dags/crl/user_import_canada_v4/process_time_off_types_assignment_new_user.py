...
from crl.user_import_canada_v4.utils.response_filter import get_filtered_time_off_types, get_policy_to_assign
from crl.user_import_canada_v4.utils.python_callable_methods import get_required_time_off_type_details
...
def create_child_dag(config):
    ...
    for idx in range(0, config.BATCH_COUNT):
        ...
        with rail.create_airflow_dag(
            ...
            is_montreal_vacation >> rail.Label('No') >> get_default_time_off_policy_schedule
            ...
            wait_for_process_time_off_types_montreal_vacation_new_user >> is_any_timeoff_type_to_assign_not_available

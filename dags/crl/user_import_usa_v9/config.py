...
SICK_PAYOUT_SALARIED_LOCATIONS = [
    "BETHSDA9", "BETHSNIAID", "BETHSNICHD", "BETHNICHD4", "BETHSNINDS",
    "HMLTNNIAID", "POOLESVLE3", "POOLSVL08", "POOLSNIAID", "ROCKVNIAID", "BETHSVRCNIAID"
]

LEAVE_STATUSES = ["Paid Leave", "Unpaid Leave"]

ENABLE_SICK_PAYOUT_LEAVE_RETURN = False
...
REGULAR_USER_TIME_OFF_TYPES = ["[USA] Voting Leave","[USA] Bereavement",
    "[USA] Veterans Day","[USA] Facility Closure","[USA] Workers Comp Pay"]

GLOBAL_TIME_OFF_TYPES = ['[USA] Unpaid Absence',"[USA] Jury Duty"]
...
CARRY_OVER_EXCEPTION_LOCATIONS_FLOATING_HOLIDAY = ["California", "Colorado", "Montana", "Nebraska"]

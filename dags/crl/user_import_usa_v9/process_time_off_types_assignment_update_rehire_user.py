...
from crl.user_import_usa_v9.utils.response_filter import get_filtered_time_off_types, assigned_timeoffs_types_to_user, get_policy_to_assign_for_timeoff
    ...
    for idx in range(0, config.BATCH_COUNT):
        ...
        with rail.create_airflow_dag(
            ...
            get_all_policy_to_assign = rail.PythonOperator(
                ...
                python_callable= lambda dag_run: python_callable_methods.get_all_policy_to_assign_update(dag_run)
            )

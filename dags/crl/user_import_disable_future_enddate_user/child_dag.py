...
from crl.user_import_disable_future_enddate_user.utils import request_payload, python_callable_methods, response_filter
...
def create_child_dag_wbs(config):
    with rail.create_airflow_dag(
        ...
        remove_all_permissions = rail.RepliconServiceOperator(
            task_id="remove_all_permissions",
        ...
        is_location_not_in_canada_usa = rail.IfOperator(
            task_id="is_location_not_in_canada_usa",
            test=lambda dag_run: bool(dag_run.conf['location'] not in ['USA','CAN']),
            yes_task="remove_timeoff_template",
            no_task="is_status_ignore_zero_accrual"
        )
        ...
        is_contingent_or_non_live_user = rail.IfOperator(
            ...
            test=lambda dag_run: dag_run.conf['employee_type']=="Contingent Worker",
            yes_task="catch_disable_user_error",
        ...
        disable_user >> remove_all_permissions>> is_location_not_in_canada_usa
        is_location_not_in_canada_usa >> rail.Label('Yes') >> remove_timeoff_template >> is_status_ignore_zero_accrual
        is_location_not_in_canada_usa >> rail.Label('No') >> is_status_ignore_zero_accrual
        is_status_ignore_zero_accrual >> rail.Label('Yes') >> catch_disable_user_error

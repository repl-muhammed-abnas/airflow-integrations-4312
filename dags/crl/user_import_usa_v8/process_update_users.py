...
from crl.user_import_usa_v8.utils import request_payload, response_filter, python_callable_methods
    ...
    for idx in range(0, config.BATCH_COUNT):
        ...
        with rail.create_airflow_dag(
            ...
            apply_user_modifications = rail.RepliconServiceOperator(
                ...
                endpoint='/services/ImportService1.svc/ApplyUserModifications3',
                data=lambda dag_run: request_payload.apply_user_modifications_payload(dag_run, config.PAI_EMPLOYEES_LOCATION_LVL_3),
            )

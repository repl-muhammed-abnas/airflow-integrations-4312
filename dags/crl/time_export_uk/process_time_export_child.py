...
import pendulum
import rail
from crl.time_export_uk.utils import custom_methods, request_payload
from crl.time_export_uk.tasks.time_export_task import time_data_export
...
def create_main_dag(config):
    with rail.create_airflow_dag(
        ...
        description="CRL UK Time Export process time export",
        ...
        send_no_data_email = rail.EmailOperator(
            ...
            subject='{{ get_company_key() }} | Replicon UK Time Data Export - No records to export - {{ current_time_in_specified_tz() }}',
        ...
        send_invalid_records_email = rail.EmailOperator(
            ...
            to=config.tenant_email,
            bcc=config.internal_email,
            subject='{{ get_company_key() }} | Replicon UK Time Data Export - Invalid records found - {{ current_time_in_specified_tz() }}',
        ...
        send_success_email = rail.EmailOperator(
            ...
            to=config.tenant_email,
            bcc=config.internal_email,
            subject='{{ get_company_key() }} | Replicon UK Time Data Export - Completed Successfully - {{ current_time_in_specified_tz() }}',

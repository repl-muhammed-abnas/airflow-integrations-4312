...
from crl.time_export_can_v2.config import *
...
time_export_master_dag_id = f"crl_time_export_master_v2_{instance}"
time_export_process_export_dag_id = f"crl_time_export_process_time_export_child_v2_{instance}"

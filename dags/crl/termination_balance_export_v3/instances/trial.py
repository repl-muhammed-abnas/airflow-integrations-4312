...
from crl.termination_balance_export_v3.config import *
from crl.termination_balance_export_v3.mapper.payroll_calendar_mapper import CANADA_PAYROLL_CALENDER_MAPPER
...
output_filepath = '/CRL/termination_export/output/'
secondary_encrypted_output_filepath = '/CRL/termination_export/secondary/'
log_filepath = '/CRL/termination_export/logs/'

...
from crl.timeoff_balance_export_us_v1.mapper.time_off_balance_mapper import Time_off_mappper, sicked_timeoff_names
...
def get_file_name(config):
    file_name = "P" + config.adp_gv_system + config.gv_system_number + "476" + \
            "_" + now(config.time_zone).strftime("%Y%m%d%H%M%S") + "_" + "USTIME_HRMD04_DUT8G2I"

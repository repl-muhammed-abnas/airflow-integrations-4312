...
from crl.user_import_united_kingdom.utils.request_payload import get_add_cost_center_payload
...
def create_child_dag(config):
    with rail.create_airflow_dag(
        ...
        description='CRL User Import United Kingdom- Process Cost Center',

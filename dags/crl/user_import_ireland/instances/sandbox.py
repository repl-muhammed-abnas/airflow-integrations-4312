...
from crl.user_import_ireland.config import *
from crl.user_import_ireland.mappers.user_import_mapper import user_import_mapper
from crl.user_import_ireland.mappers.timeoff_mapper import timeoff_type_mapper

instance = "sandbox"
environment = "pre-production"

dagid_suffix = f"_{instance}" # for new versions add _v1, _v2, _v3 etc at the end of the instance name

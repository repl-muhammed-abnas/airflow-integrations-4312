...
from crl.user_import_ireland.utils import request_payload, response_filter, python_callable_methods
from crl.user_import_ireland.tasks.process_supervisor import process_supervisor_assignment_task_group
    ...
    for idx in range(0, config.BATCH_COUNT):
        ...
        with rail.create_airflow_dag(
            ...
            get_time_off_types_to_assign = rail.PythonOperator(
                ...
                python_callable= lambda: python_callable_methods.get_time_off_to_be_assigned(config)
            )
            ...
            has_any_error_or_exceptions_present_update_rehire_user = rail.IfOperator(
                ...
                no_task='log_error_or_exceptions_present_update_rehire_user'
            )
            ...
            has_any_error_or_exceptions_present_update_rehire_user >> log_user_completion

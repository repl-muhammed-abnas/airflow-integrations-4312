...
from crl.user_import_ireland.utils import request_payload, python_callable_methods
from crl.user_import_ireland.utils.response_filter import get_filtered_time_off_types, assigned_timeoffs_types_to_user, get_policy_to_assign_for_timeoff
    ...
    for idx in range(0, config.BATCH_COUNT):
        ...
        with rail.create_airflow_dag(
            ...
            get_default_time_off_policy_schedule = rail.RepliconServiceOperator(
                ...
                data=lambda:request_payload.get_default_timeoff_policy_set_schedule_for_timeofftype('for_each_time_off_type_policy'),

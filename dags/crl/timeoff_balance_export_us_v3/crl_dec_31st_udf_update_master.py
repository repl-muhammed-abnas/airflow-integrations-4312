...
import rail
from crl.timeoff_balance_export_us_v3.utils import python_callable, response_filter
...
def create_main_dag(config):
    with rail.create_airflow_dag(
        ...
        process_start_time >> get_report_details >> get_as_of_date >> run_report_entry

...
as_of_date_filter_name = "AsOfDateFilter"
...
# Daily export blackout period (Dec 28 - Jan 24)
daily_export_blackout_start_month = 12
daily_export_blackout_start_day = 28
daily_export_blackout_end_month = 1
daily_export_blackout_end_day = 24

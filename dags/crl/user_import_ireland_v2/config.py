...
MANNUAL_TIMEOFF_TYPES = ["[IRE] Carry Forward Leave"]
...
APPLICABLE_TIME_OFF_TYPES = [
    ...
    "[IRE] Parents Leave",
    "[IRE] Paternity Leave",
    "[IRE] Personal Flex Hours",
    "[IRE] Parental Leave",
    "[IRE] Sick Leave",
    "[IRE] Study Leave - PAID",
    "[IRE] Sick - unpaid",
    "[IRE] Time Off in Lieu",
...
PLACEHOLDER_BASED_TIMEOFF_TYPES = ["[IRE] Annual Leave","[IRE] Personal Flex Hours", "[IRE] Sick Leave"]

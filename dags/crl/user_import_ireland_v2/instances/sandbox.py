...
from crl.user_import_ireland_v2.config import *
from crl.user_import_ireland_v2.mappers.user_import_mapper_v1 import user_import_mapper
from crl.user_import_ireland_v2.mappers.annual_leave_placeholder_mapper_v1 import annual_leave_placeholder_timeoff_types
from crl.user_import_ireland_v2.mappers.sick_leave_placeholder_mapper_v1 import sick_leave_placeholder_timeoff_types
from crl.user_import_ireland_v2.mappers.personal_leave_placeholder_mapper_v1 import personal_leave_placeholder_timeoff_types

instance = "sandbox"
environment = "pre-production"

dagid_suffix = f"_{instance}_v2" # for new versions add _v2, _v2, _v3 etc at the end of the instance name

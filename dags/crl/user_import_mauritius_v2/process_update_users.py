...
from crl.user_import_mauritius_v2.utils import request_payload, response_filter, python_callable_methods
        ...
        with rail.create_airflow_dag(
            ...
            process_user_disable= rail.TriggerDagRunOperator(
                ...
                conf=lambda dag_run:{
                    ...
                    "timeoff_template_uri": dag_run.conf['timeoff_template_uri']
                },

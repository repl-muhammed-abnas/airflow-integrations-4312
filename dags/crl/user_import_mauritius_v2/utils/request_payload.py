...
def get_udfs(user_status, dag_run):
    ...
    if user_status =='adduser':
        ...
        add_udf_field_values(definitionuri = dag_run.conf['reg_to_temp_bal_export_eff_date_def_uri'], date= '')
...
def update_policy_set(dag_run):
    """
    Assigns timesheet template with effective date based on Monday week start for Mauritius.

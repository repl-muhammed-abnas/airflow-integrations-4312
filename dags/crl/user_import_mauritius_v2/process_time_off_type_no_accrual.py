...
from crl.user_import_mauritius_v2.utils import request_payload, python_callable_methods, response_filter
...
def create_child_dag(config):
    with rail.create_airflow_dag(
        ...
        description='CRL User Import Mauritius- Process TIme Off Type No Accrual',
        ...
        get_all_time_off_types >> get_user_time_off_policy_summary >> for_each_time_off_type_no_accural >> get_balance_summary_for_user >>  \
            get_historical_policy_to_assign_list_disable_user

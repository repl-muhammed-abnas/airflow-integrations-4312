...
from crl.user_import_mauritius_v2.utils import request_payload
...
def create_child_dag(config):
    with rail.create_airflow_dag(
        ...
        description='CRL User Import Mauritius - Process Disable Users',
        ...
        remove_all_permissions >> remove_timeoff_template >> is_status_ignore_zero_accrual
        is_status_ignore_zero_accrual >> rail.Label('Yes') >> log_user_disablement
        is_status_ignore_zero_accrual >> rail.Label('No') >> process_time_off_type_no_accrual

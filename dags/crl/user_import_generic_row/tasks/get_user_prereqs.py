...
from crl.user_import_generic_row.utils import request_payload, response_filter, python_callable_methods
...
def get_user_prereqs_task_group(config):
    ...
    with rail.TaskGroup(group_id='get_user_prereqs', prefix_group_id=False) as get_user_prereqs:
        ...
        get_user_udfs >> get_term_exported_dropdown_values>> get_project_user_dropdown_values >> get_all_activity

...
from crl.user_import_generic_row.utils import request_payload, python_callable_methods, response_filter
...
def create_child_dag(config):
    with rail.create_airflow_dag(
        ...
        description=f'CRL User Import {config.COUNTRY_NAME} - Process TIme Off Type No Accrual',

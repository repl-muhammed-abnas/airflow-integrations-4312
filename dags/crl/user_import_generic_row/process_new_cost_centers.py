...
from crl.user_import_generic_row.utils.request_payload import get_add_cost_center_payload
...
def create_child_dag(config):
    with rail.create_airflow_dag(
        ...
        description=f'CRL User Import {config.COUNTRY_NAME} - Process Cost Center',

...
from crl.user_import_mauritius_v1.utils.response_filter import get_filtered_time_off_types, assigned_timeoffs_types_to_user, get_policy_to_assign_for_timeoff
...
def create_child_dag(config):
    ...
    for idx in range(0, config.BATCH_COUNT):
        ...
        with rail.create_airflow_dag(
            ...
            description='CRL User Import Mauritius - Process TIme Off Type Assignment- Update User',
            ...
            get_default_time_off_policy_schedule = rail.RepliconServiceOperator(
                ...
                data=lambda : request_payload.get_default_timeoff_policy_set_schedule_for_timeofftype(
                    'for_each_time_off_type_policy'),

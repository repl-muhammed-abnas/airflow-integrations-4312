...
from crl.user_import_mauritius_v1.utils.python_callable_methods import do_format_logs
...
def create_child_dag(config):
    with rail.create_airflow_dag(
        ...
        format_logs >> render_logs_csv >> upload_log_to_sftp >> generate_downloadable_link >> process_end_time >> send_import_complete_email

...
from crl.user_import_mauritius_v1.utils import request_payload, response_filter, python_callable_methods
from crl.user_import_mauritius_v1.tasks.process_supervisor import process_supervisor_assignment_task_group
...
def create_child_dag(config):
    ...
    for idx in range(0, config.BATCH_COUNT):
        ...
        with rail.create_airflow_dag(
            ...
            description='CRL User Import Mauritius Process Update Users',
            ...
            is_status_active = rail.IfOperator(
                ...
                yes_task="is_previously_suspended_leave_or_non_live_transfer_employee",
            ...
            is_status_unpaid_leave >> rail.Label("Yes") >> update_required_udfs_and_timesheet_period >> catch_and_log_errors

            process_user_disable >> wait_for_process_user_disable >> catch_and_log_errors
            is_status_active >> rail.Label("Yes") >> is_previously_suspended_leave_or_non_live_transfer_employee
            ...
            get_current_udf_values >> get_current_oef_values >> get_effective_user_groupmembership >> get_assigned_policy_to_user >> apply_user_modifications

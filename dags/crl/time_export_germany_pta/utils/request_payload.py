...
# PTA Export: Jan 1 of current year to 5 weeks before today
# Spec section 10: "looks for adjustments up to 1st Jan of the current year from current date"
PTA_EXPORT_END_LOOKBACK_DAYS = 35
...
def get_time_export_date_range(dag_run, config):
    ...
    start_date = today.start_of('year')

    # End 5 weeks before today (avoids overlap with the regular weekly export window)

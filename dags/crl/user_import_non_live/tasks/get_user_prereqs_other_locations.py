...
from crl.user_import_non_live.utils import response_filter
...
def get_user_prereqs_task_group():
    ...
    with rail.TaskGroup(group_id='get_user_prereqs', prefix_group_id=False) as get_user_prereqs:
        ...
        get_location_grps = rail.RepliconServiceOperator(
            task_id="get_location_grps",
        ...
        dummy_get_user_prereqs >> [get_location_grps, get_all_office_schedules, get_all_holiday_calenders, get_timesheet_approval_paths,
            get_all_permission_set, get_all_payrule_scripts, get_all_policy_sets, get_all_timezones,
            get_timeoff_balance_event_script_uri, get_timeoff_balance_validation_script, get_user_udfs]

        get_user_udfs >> get_us_flsa_status_dropdown_values >> get_project_user_dropdown_values

...
from crl.adhoc_payroll_us.payroll_export_us_adhoc_v1.utils import python_callable
...
def create_main_dag(config):
    with rail.create_airflow_dag(
        ...
        description=f"CRL Payroll Export Weeekly Master USA Adhoc {config.instance}",
        ...
        create_payroll_download_batch = rail.RepliconServiceOperator(
            ...
            data=lambda dag_run: request_payload.get_create_payroll_download_batch_payload(dag_run,"WEEKLY")
        )
        ...
        create_payrun_batch = rail.RepliconServiceOperator(
            ...
            data=lambda dag_run: request_payload.get_create_payrun_batch_payload(dag_run,"WEEKLY")
        )

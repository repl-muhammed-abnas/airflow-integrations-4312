...
import rail
from crl.adhoc_payroll_us.payroll_balance_export_us_adhoc_v1.utils import request_payload
...
def create_main_dag(config):
    with rail.create_airflow_dag(
        ...
        description=f'CRL payroll balance_biweekly_usa adhoc {config.instance}',
        ...
        fail_export = rail.FailOperator(
            task_id="fail_export",
            message="payroll balance export file export has failed"
        )

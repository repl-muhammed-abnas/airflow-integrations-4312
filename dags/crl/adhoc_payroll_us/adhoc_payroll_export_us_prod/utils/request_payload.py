...
def get_create_payroll_download_batch_payload(dag_run, time_zone, export_type):
    end_date = dag_run.conf['end_date']   # get_export_end_date(time_zone, export_type)
    start_date = dag_run.conf['start_date'] # get_export_start_date(end_date) if end_date else None
    return {
        "columnUris": [],
        "filterExpression": {
            "leftExpression": {
...
def get_create_payrun_batch_payload(dag_run, time_zone, export_type):
    end_date = dag_run.conf['end_date']   # get_export_end_date(time_zone, export_type)
    start_date = dag_run.conf['start_date'] # get_export_start_date(end_date) if end_date else None
    return {
        "columnUris": [],

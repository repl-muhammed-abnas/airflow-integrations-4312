...
from crl.adhoc_payroll_us.adhoc_payroll_export_us_prod.config import *
from crl.adhoc_payroll_us.adhoc_payroll_export_us_prod.mapper.payroll_calendar_mapper import USA_PAYROLL_CALENDER_MAPPER_BIWEEKLY, USA_PAYROLL_CALENDER_MAPPER_WEEKLY
from crl.adhoc_payroll_us.adhoc_payroll_export_us_prod.mapper.regular_time_employee_types import REGULAR_TIME_EMPLOYEE_TYPES
...
biweekly_dag_id = f"crl_adhoc_payroll_export_usa_biweekly_master_{instance}"
child_dag_id = f"crl_adhoc_payroll_export_create_object_usa_child_{instance}"
weekly_dag_id = f"crl_adhoc_payroll_export_usa_weekly_master_{instance}"

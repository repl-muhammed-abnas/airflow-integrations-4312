...
from crl.user_import_brazil_v1.utils import request_payload
from crl.user_import_brazil_v1.utils.response_filter import get_filtered_time_off_types, get_policy_to_assign
from crl.user_import_brazil_v1.utils.python_callable_methods import get_required_time_off_type_details
...
def create_child_dag(config):
    ...
    for idx in range(0, config.BATCH_COUNT):
        with rail.create_airflow_dag(
            ...
            # drop out of the allowed set = disabled.
            has_time_off_types_to_disable = rail.IfOperator(
                task_id='has_time_off_types_to_disable',
                test=lambda dag_run: bool(request_payload.get_time_off_type_uris_to_disable(dag_run)),
                yes_task='disable_time_off_types',
            ...
            disable_time_off_types = rail.RepliconServiceOperator(
                ...
                endpoint="/services/TimeOffService1.svc/PutTimeOffTypeAssignmentsForUser",
                data=request_payload.put_timeoff_assignment_enabled_only
            )
            ...
            for_each_time_off_assign_default_policy_end >> has_time_off_types_to_disable
            has_time_off_types_to_disable >> rail.Label('Yes') >> disable_time_off_types >> is_any_timeoff_type_to_assign_not_available
            has_time_off_types_to_disable >> rail.Label('No') >> is_any_timeoff_type_to_assign_not_available

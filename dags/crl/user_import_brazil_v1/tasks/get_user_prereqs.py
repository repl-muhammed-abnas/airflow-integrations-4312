...
from crl.user_import_brazil_v1.utils import request_payload, response_filter, python_callable_methods
...
def get_user_prereqs_task_group(config):
    ...
    with rail.TaskGroup(group_id='get_user_prereqs', prefix_group_id=False) as get_user_prereqs:
        ...
        get_sell_back_approval_path_dropdown_values = rail.RepliconServiceOperator(
            task_id='get_sell_back_approval_path_dropdown_values',
            endpoint='/services/TimeOffBalancePayoutApprovalService1.svc/GetAllApprovalPaths',
        )
        ...
        get_user_udfs = rail.RepliconServiceOperator(
            ...
            data_handler=lambda udfs: {
                ...
                'cost_center_label_def_uri': rail.find_first_by_attr_and_get_attr(udfs, 'displayText', 'Cost Center Code', 'uri'),
                'home_location_def_uri': rail.find_first_by_attr_and_get_attr(udfs, 'displayText', 'Home Location', 'uri'),
                'pay_scale_grp_def_uri': rail.find_first_by_attr_and_get_attr(udfs, 'displayText', 'Pay Scale Group', 'uri'),
                'job_level_grp_def_uri': rail.find_first_by_attr_and_get_attr(udfs, 'displayText', 'Job Level', 'uri'),
                'ot_eligible_def_uri': rail.find_first_by_attr_and_get_attr(udfs, 'displayText', 'OT Eligible', 'uri'),
        ...
        get_ot_eligible_dropdown_values = rail.RepliconServiceOperator(
            task_id="get_ot_eligible_dropdown_values",
            endpoint="/services/CustomFieldService1.svc/GetAllCustomFieldDropDownOptions",
            data=lambda:{
                    "customFieldUri": rail.result('get_user_udfs')['ot_eligible_def_uri']
                },
            data_handler=response_filter.get_all_drop_down_options_filter
        )
        ...
        dummy_get_user_prereqs >> [get_updated_location_grps,get_updated_department_grps, get_updated_company_code, get_updated_cost_center_grps,
            get_updated_buisness_unit_grps, get_all_office_schedules,get_all_employee_types_grp, get_all_holiday_calenders, get_timesheet_approval_paths, get_sell_back_approval_path_dropdown_values,
        ...
        get_user_udfs >> get_project_user_dropdown_values >> get_ot_eligible_dropdown_values >> get_all_activity

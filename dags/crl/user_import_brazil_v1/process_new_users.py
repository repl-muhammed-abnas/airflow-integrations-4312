...
def create_child_dag(config):
    ...
    for idx in range(0, config.BATCH_COUNT):
        with rail.create_airflow_dag(
            ...
            description='CRL - User Import Brazil- Process New Users',
            ...
            add_contingent_user = rail.RepliconServiceOperator(
                ...
                data=lambda dag_run:request_payload.get_put_contingent_payload(dag_run)
            )
            ...
            add_new_user >> remove_timeoff_assignments >> has_sell_back_approval_path
            has_sell_back_approval_path >> rail.Label('Yes') >> update_sell_back_approval_path >> is_hrbp_yes
            has_sell_back_approval_path >> rail.Label('No') >> is_hrbp_yes
            ...
            is_remote_worker >> rail.Label('No')  >> impersonate_and_create_interactive_session

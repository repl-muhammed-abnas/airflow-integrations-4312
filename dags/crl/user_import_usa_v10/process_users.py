...
def create_child_dag(config):
    with rail.create_airflow_dag(
        ...
        description='CRL User Import USA- User Import Process Users',
        ...
        log_invalid_data = rail.WriteLogOperator(
            ...
            message=lambda dag_run: request_payload.get_invalid_fields_message(dag_run,config.instance),
            severity='Exception',
            properties=lambda dag_run: {
                ...
                "action": "Validation",
                "status": "Exception",
                'details':  request_payload.get_invalid_fields_message(dag_run, config.instance),
            }
        )

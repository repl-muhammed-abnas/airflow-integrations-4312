...
from crl.user_import_ireland_v1.utils import request_payload, python_callable_methods
from crl.user_import_ireland_v1.utils.response_filter import get_filtered_time_off_types, assigned_timeoffs_types_to_user, get_policy_to_assign_for_timeoff
...
def create_child_dag(config):
    ...
    for idx in range(0, config.BATCH_COUNT):
        ...
        with rail.create_airflow_dag(
            ...
            description='CRL User Import Ireland - Process TIme Off Type Assignment- Update User',
            ...
            time_off_types_to_be_assigned = rail.PythonOperator(
                ...
                python_callable=python_callable_methods.time_off_types_to_be_assigned_update
            )
            ...
            get_default_time_off_policy_schedule = rail.RepliconServiceOperator(
                ...
                data=lambda dag_run:request_payload.get_default_timeoff_policy_set_schedule_for_timeofftype(dag_run,config,'for_each_time_off_type_policy'),
            ...
            for_each_time_off_policy_end >> is_any_timeoff_type_to_assign_not_available

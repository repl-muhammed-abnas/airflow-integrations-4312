...
from crl.user_import_ireland_v1.utils import request_payload, python_callable_methods, response_filter
...
def create_child_dag(config):
    with rail.create_airflow_dag(
        ...
        description='CRL User Import Ireland- Process TIme Off Type No Accrual',
        ...
        get_historical_policy_to_assign_list_disable_user = rail.PythonOperator(
            ...
            python_callable=lambda dag_run: python_callable_methods.get_historical_policy_to_assign_list(
                dag_run,'disable','for_each_time_off_type_no_accural')
        )
        ...
        get_all_time_off_types >> get_user_time_off_policy_summary >> for_each_time_off_type_no_accural >> get_balance_summary_for_user >> get_historical_policy_to_assign_list_disable_user
        ...
        for_each_time_off_type_no_accural_end >> catch_and_log_errors

...
def create_child_dag(config):
    with rail.create_airflow_dag(
        ...
        description='CRL User Import Ireland - Process Disable Users',
        ...
        can_remove_permission = rail.IfOperator(
            task_id = "can_remove_permission",
            test= config.instance in ["trial","sandbox","prod"],
            yes_task="remove_all_permissions",
        ...
        is_enddate_in_future >> rail.Label('No') >> disable_login >> can_remove_permission
        can_remove_permission >> rail.Label("No") >> is_status_ignore_zero_accrual
        can_remove_permission >> rail.Label("Yes") >> remove_all_permissions >> is_status_ignore_zero_accrual

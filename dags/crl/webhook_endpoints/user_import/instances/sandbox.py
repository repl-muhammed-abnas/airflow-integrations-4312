...
process_brazil_location_records_dagid = f"crl_user_import_brazil_process_each_payload_child_{instance}_v1"
...
NON_LIVE_COUNTRIES_QUERY = "(Location NOT LIKE 'CAN%' and Location NOT LIKE 'USA%' and Location NOT LIKE 'Mauritius%' and Location NOT LIKE 'IRL%' and Location NOT LIKE 'GBR%' and Location NOT LIKE 'BRA%' and Location NOT LIKE 'ISR%' and Location NOT LIKE 'CHE%')"

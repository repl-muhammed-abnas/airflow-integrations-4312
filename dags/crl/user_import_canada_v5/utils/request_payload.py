...
def get_process_users_conf(item, user_mapper, active_status, batch_count):
    ...
    return {
        ...
        **{
            ...
            "holiday_calendar": user_details_based_on_mapper[0]['holiday_calendar'] if user_details_based_on_mapper else null,
            ...
            'payrule_name': user_details_based_on_mapper[0]['payrule_name']
                    if user_details_based_on_mapper and user_details_based_on_mapper[0]['payrule_name'] and item['work_schedule'] not in ['WX3000', 'WX4000']

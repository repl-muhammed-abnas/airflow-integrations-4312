...
def create_child_dag(config):
    with rail.create_airflow_dag(
        dag_id=config.process_timeoff_type_assignment_service_anniversary_new_user_dagid,
        description='CRL User Import- Process TIme Off Type Service Anniversary',
        ...
        get_default_time_off_policy_schedule = rail.RepliconServiceOperator(
            ...
            data_handler=lambda response,dag_run: response_filter.get_policy_to_assign_for_service_anniversary_add(response,dag_run)
        )

...
from crl.user_import_canada_v5.tasks.get_user_prereqs import get_user_prereqs_task_group
...
def create_child_dag(config):
    with rail.create_airflow_dag(
        ...
        process_disable_users = rail.trigger_parallel_dagrun(
            ...
            conf= lambda item: request_payload.get_process_users_conf(item, config.USER_MAPPER, config.ACTIVE_STATUS,config.BATCH_COUNT),
            execution_timeout=timedelta(days=config.execution_timeout_days),
        )

...
import rail
from crl.time_export_us_pta.utils import custom_methods, request_payload
from crl.time_export_us_pta.tasks.time_export_task import time_data_export
...
def create_main_dag(config):
    with rail.create_airflow_dag(
        ...
        get_company_codes_to_ignore = rail.RepliconServiceOperator(
            ...
            data_handler=lambda res: rail.find_first_by_attr_and_get_attr(res,'displayText',config.division_to_ignore,'uri','')
        )
        ...
        create_log >> logging_job_start_time >> get_allowed_location_uris >> get_company_codes_to_ignore >> time_export_download_script

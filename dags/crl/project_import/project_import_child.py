    ...
    with rail.create_airflow_dag(
        ...
        create_collection_input_data = rail.CreateCollectionOperator(
            ...
            columns= {
                ...
                "NETWORK_ACTIVITY_STATUS": "projectstatus",
        ...
        query_distict_projects = rail.QueryCollectionOperator(
            ...
            query="""SELECT DISTINCT projectcode,record_id from validwbsdata GROUP BY projectcode"""
        )
        ...
        get_all_costcenters = rail.RepliconServiceOperator(
            ...
            data_handler= response_filter.get_all_costcenters
        )

        get_business_area_custom_field = rail.RepliconServiceOperator(
            task_id='get_business_area_custom_field',
        ...
        process_projects = rail.trigger_parallel_dagrun(
            ...
            conf=lambda item: {
                ...
                'businessarea_customfield': rail.result("get_business_area_custom_field"),
                'exception_log': rail.result("create_exception_log"),
                'cost_centers_data': rail.result("get_all_costcenters")
            }
        )
        ...
        has_valid_projects >> rail.Label(
            "Yes") >> query_distict_clients >> process_clients >> wait_for_process_clients >>\
                query_distict_projects >> get_all_costcenters >> get_business_area_custom_field >> process_projects

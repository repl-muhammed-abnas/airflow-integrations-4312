...
def create_child_dag(config):
    with rail.create_airflow_dag(
        ...
        description='CRL User Import Process Disable Users',
        ...
        is_contingent_or_usa_user = rail.IfOperator(
            ...
            test=lambda dag_run: dag_run.conf['is_contingent'] == 'Y' or dag_run.conf['country_name'] == 'USA',
            yes_task="log_user_disablement",
        ...
        is_contingent_or_usa_user >> rail.Label('Yes') >> log_user_disablement
        is_enddate_in_future >> rail.Label('No') >> disable_login >> remove_all_permissions
        remove_all_permissions>> is_status_ignore_zero_accrual
        is_status_ignore_zero_accrual >> rail.Label('Yes') >> log_user_disablement
        is_status_ignore_zero_accrual >> rail.Label('No') >> is_contingent_or_usa_user
        is_contingent_or_usa_user >> rail.Label('No') >> process_time_off_type_no_accrual

...
from crl.termination_balance_export_us.config import *
from crl.termination_balance_export_us.mapper.payroll_calendar_mapper import USA_PAYROLL_CALENDER_MAPPER
from crl.termination_balance_export_us.mapper.time_off_mapper import USA_TIMEOFF_TYPE_MAPPER
...
udf_child_dag_id =f"crl_termination_balance_udf_update_usa_child_{instance}"
child_dag_id= f"crl_terminationbalance_usa_child_{instance}"
master_dag_id = f"crl_termination_balance_dag_usa_master_{instance}"
master_dag_daily_id = f"crl_termination_balance_dag_usa_daily_master_{instance}"

...
termination_column = "User Name,Time Off Type,Time Off Balance,Employee ID,User Start Date,User End Date,useruri,Employee Status,Location (Current) (Full Path)"

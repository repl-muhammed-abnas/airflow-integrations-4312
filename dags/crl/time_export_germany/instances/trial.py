...
from crl.time_export_germany.config import *
from crl.time_export_germany.mapper.paycode_mapper import GERMANY_PAY_CODE_MAPPER
...
time_export_master_dag_id = f"crl_time_export_germany_master_{instance}"
time_export_process_export_dag_id = f"crl_time_export_germany_process_child_{instance}"

...
def create_main_dag(config):
    with rail.create_airflow_dag(
        ...
        query_report_data = rail.QueryCollectionOperator(
            ...
            query="""SELECT * FROM sickandbanedtimeoffdetails WHERE (sick_eligible='Yes' OR banked_eligible='Yes') AND (NULLIF(empid, '') IS NOT NULL OR empid!="")"""
        )
        ...
        get_sick_payout_udf_option_uris >> get_banked_payout_udf_option_uris >> is_users_not_eligible_but_have_udf_yes >> rail.Label(

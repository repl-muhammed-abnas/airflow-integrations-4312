...
from crl.user_import_usa_v7.utils import request_payload, response_filter, python_callable_methods
from crl.user_import_usa_v7.tasks.process_supervisor import process_supervisor_assignment_task_group
    ...
    for idx in range(0, config.BATCH_COUNT):
        ...
        with rail.create_airflow_dag(
            ...
            is_contingent_user = rail.IfOperator(
                ...
                no_task="is_previously_suspended_leave"
            )
            ...
            is_previously_suspended_leave = rail.IfOperator(
                task_id="is_previously_suspended_leave",
                test=request_payload.validate_previous_suspended_leave,
            ...
            is_status_active >> rail.Label("Yes") >> is_contingent_user >> rail.Label('No') >> is_previously_suspended_leave

            is_previously_suspended_leave >> rail.Label("Yes") >> enable_login
            is_previously_suspended_leave >> rail.Label("No") >> is_rehire_user

...
from crl.user_import_usa_v1.utils import request_payload, python_callable_methods, response_filter
...
def create_child_dag(config):
    with rail.create_airflow_dag(
        ...
        is_special_timeoff_type_assigned_to_user = rail.IfOperator(
            ...
            test=lambda dag_run: bool(list(filter(lambda x: x['timeoff_type_name'] == dag_run.conf['timeoff_type_name'],
        ...
        time_off_type_to_be_updated = rail.PythonOperator(
            ...
            python_callable=python_callable_methods.time_off_type_to_be_updated
        )
        ...
        is_contingent_user >> rail.Label('Yes') >> catch_and_log_errors
        ...
        is_reason_available_in_mapper_and_code_10_in_payload >> rail.Label('No') >> catch_and_log_errors
        ...
        check_update_required >> rail.Label('No') >> catch_and_log_errors

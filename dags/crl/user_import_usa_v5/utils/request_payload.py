...
from crl.user_import_usa_v5.utils.python_callable_methods import get_placeholder_time_off_to_be_assigned
...
def get_process_users_conf(item, config):
    ...
    def get_payrule_name_based_on_mapper():
        mapper_to_consider_for_payrule = user_mapper_values if item['remote_worker']!="Y" else user_mapper_values_for_payrule_based_on_home_location

        if mapper_to_consider_for_payrule and mapper_to_consider_for_payrule['payrule_name']:

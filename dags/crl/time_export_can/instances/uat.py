...
from crl.time_export_can.config import *
...
time_export_master_dag_id = f"crl_time_export_master_v1_{instance}"
time_export_process_export_dag_id = f"crl_time_export_process_time_export_child_v1_{instance}"

...
import itertools
import rail
from crl.project_import_v1.utils import request_payload,custom_method
...
def create_child_dag_wbs(config):
    with rail.create_airflow_dag(
        ...
        get_wc_company_code_custom_field = rail.RepliconServiceOperator(
            task_id='get_wc_company_code_custom_field',
        ...
        process_projects = rail.trigger_parallel_dagrun(
            ...
            conf=lambda item: {
                ...
                'wc_company_code_customfield': rail.result("get_wc_company_code_custom_field"),
                'exception_log': rail.result("create_exception_log")
            }
        )
        ...
        has_valid_projects >> rail.Label(
            "Yes") >> query_distict_clients >> process_clients >> wait_for_process_clients >>\
                query_distict_projects >> get_wc_company_code_custom_field >> process_projects

...
from crl.time_export_us_pta_v2.config import *
from crl.time_export_us_pta_v2.mapper.paycode_mapper import PAY_CODE_MAPPER
from crl.time_export_us_pta_v2.mapper.employee_types_mapper import EMPLOYEE_TYPE_MAPPER, PROJECT_EMPLOYEE_TYPE_MAPPER
...
time_export_process_export_dag_id = f"crl_pta_us_time_export_master_{instance}_v2"

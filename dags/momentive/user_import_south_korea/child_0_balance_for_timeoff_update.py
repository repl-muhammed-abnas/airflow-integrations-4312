...
def create_dag(config):
    with rail.create_airflow_dag(
        dag_id=f'momentive_userimport_0_balance_for_timeoff_update_child_{config.instance}',
        description=f'momentive_userimport_0_balance_for_timeoff_update_child_{config.instance}',
        company_key=config.company_key,
        replicon_conn_id=config.replicon_conn_id,
        max_active_runs=config.balance_0_for_timeoff_update_child_dag_active_runs,
        default_args={
        ...
        put_remaining_balance_for_payout_as_0 = rail.TriggerDagRunOperator(
            ...
            conf=request_payload.put_remainig_balance_for_payout_parameter,
        ...
        foreach_policiesby_timeofftype_end >> catch_and_log_error

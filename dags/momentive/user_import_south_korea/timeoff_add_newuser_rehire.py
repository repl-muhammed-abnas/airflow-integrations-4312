...
def create_dag(config):
    with rail.create_airflow_dag(
        dag_id=f'momentive_userimport_timeoff_add_newuser_rehire_child_{config.instance}',
        description=f'momentive_userimport_timeoff_add_newuser_rehire_child_{config.instance}',
        company_key=config.company_key,
        replicon_conn_id=config.replicon_conn_id,
        max_active_runs=config.timeoff_add_newuser_rehire_child_dag_active_runs,
        default_args={
        ...
        if_timeofftype_equals_KOR_monthlyleave_and_serviceyrs_less_than_2 = rail.IfOperator(
            ...
            test="{{ dag_run.conf.timeofftypes == 'KOR_Monthly Leave 월차휴가' and \
                rresult('get_years_of_service') < 2 }}",
        ...
        if_timeoffuri_is_present >> rail.Label('No') >> catch_and_log_error
        ...
        if_timeofftype_equals_KOR_monthlyleave_and_serviceyrs_less_than_2 >> rail.Label('No') >> catch_and_log_error
        ...
        final_policy >> put_user_time_off_account_policy_set_schedule >> catch_and_log_error

...
from momentive.user_import_france.config import *
...
input_filepath_for_trial = '/Momentive/UserSync/France/input'
log_filepath = '/Momentive/UserSync/France/logs'
archive_filepath = '/Momentive/UserSync/France/archive'
...
# This master's own DAG + per-user routing DAG.
momentive_france_user_sync_master_dag_id = f'momentive_france_user_sync_master_{instance}'
momentive_france_user_sync_process_each_user_dag_id = f'momentive_france_user_sync_process_each_user_{instance}'
can_run_batch_task_var_name = f'momentive_user_import_france_can_run_batch_task_{instance}'

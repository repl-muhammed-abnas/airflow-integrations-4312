...
from momentive.common_recipes_userimport.utils.python_callable import get_details_for_employeetype_and_departmentygrpuri_not_exist

def create_dag(config):
    with rail.create_airflow_dag(
        dag_id=config.momentive_othercountries_user_sync_add_user_child_dag_id,
        description=f'momentive_othercountries_user_sync_add_user_child_{config.instance}',
        ...
        trigger_timeoff_add_new_user = rail.TriggerDagRunOperator(
            ...
            trigger_dag_id=config.momentive_othercountries_user_sync_timeoff_new_user_child_dag_id,

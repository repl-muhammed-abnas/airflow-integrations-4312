...
from sigroup.payroll_export_singapore.config import *
...
tenant_email = 'Singapore.HRIS@siigroup.com'
...
can_run_batch_task = f'sigroup_payroll_export_singapore_can_run_batch_task_{instance}'
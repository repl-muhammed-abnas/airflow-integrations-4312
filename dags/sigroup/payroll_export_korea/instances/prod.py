...
from sigroup.payroll_export_korea.config import *
...
tenant_email = 'South-Korea.HRIS@siigroup.com'
...
can_run_batch_task = f'sigroup_payroll_export_korea_can_run_batch_task_{instance}'

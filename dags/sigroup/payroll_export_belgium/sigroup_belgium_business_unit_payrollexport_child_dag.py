...
def create_dag(config):
    ...
    with rail.create_airflow_dag(
        dag_id=f'sigroup_payroll_export_belgium_business_unit_child_{config.instance}',
        description=f'SiGroup - Belgium Business Unit Payroll Export_Child {config.instance}',
        ...
        update_pay_run_name=rail.RepliconServiceOperator(
            ...
            data={
              ...
              "name": "Belgium_{{ result('log_required_filename') }}"
            }
        )
        ...
        trigger_child_per_payroll_id=rail.TriggerDagRunForEachItemOperator(
            ...
            trigger_dag_id=f'sigroup_payroll_export_belgium_per_payroll_id_child_{config.instance}',
        ...
        if_query_distinct_payrollid_has_no_data=rail.IfOperator(
            ...
            test='''{{ result('query_distinct_payrollid','length') < 1 }}''',
        ...
        create_collection_finalpayrolldata >> query_list_final_data >> get_user_details_report
        ...
        if_timeoffreportdata_has_records >> rail.Label('No') >> query_distinct_payrollid >> trigger_child_per_payroll_id

...
from sigroup.payroll_export_belgium.config import *
...
tenant_email = 'Belgium.HRIS@siigroup.com'
...
can_run_batch_task = f'sigroup_payroll_export_belgium_can_run_batch_task_{instance}'

...
from sigroup.payroll_export_uk.config import *
...
tenant_email = 'UK.HRIS@siigroup.com'
...
can_run_batch_task = f'sigroup_payroll_export_uk_can_run_batch_task_{instance}'

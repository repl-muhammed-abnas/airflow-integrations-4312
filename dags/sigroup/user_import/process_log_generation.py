...
from sigroup.user_import.utils.custom_methods import do_format_logs
...
def create_child_dag(config):
    with rail.create_airflow_dag(
        dag_id=config.sigroup_process_log_generation_dagid,
        description='sigroup user import process log generation',
        ...
        generate_download_link >> upload_log_to_sftp >>\

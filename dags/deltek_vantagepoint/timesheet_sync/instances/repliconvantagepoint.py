from deltek_vantagepoint.initial_setup.instances.repliconvantagepoint import oefs, replicon_export_file_format_name, groups
from deltek_vantagepoint.timesheet_sync.config import *
region = 'us-east-1'
environment = 'pre-production'
instance = "repliconvantagepoint"
company_key = 'repliconvantagepoint'

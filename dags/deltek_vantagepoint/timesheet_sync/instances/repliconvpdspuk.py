from deltek_vantagepoint.initial_setup.instances.repliconvpdspuk import oefs, replicon_export_file_format_name, groups
from deltek_vantagepoint.timesheet_sync.config import *
region = 'us-east-1'
environment = 'pre-production'
instance = "repliconvpdspuk"
company_key = 'repliconvpdspuk'

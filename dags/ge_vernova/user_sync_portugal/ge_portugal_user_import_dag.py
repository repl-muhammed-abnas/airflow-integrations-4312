...
from ge_vernova.user_sync_portugal.portugal_master_mapper import portugal_master_mapper
import rail
...
def create_dag(config):
    ...
    with rail.create_airflow_dag(
        dag_id=f'ge_portugal_user_import_master_{config.instance}',
        ...
        trigger_dag_run_ge_user_sync_suspend_assignment_category_custom_field_check16 = rail.TriggerDagRunForEachItemOperator(
            ...
            retries=0,
            items=[1],
            trigger_dag_id=f'ge_user_sync_portugal_suspend_assignment_category_custom_field_check_{config.instance}',
        ...
        process_user_22 = rail.TriggerDagRunForEachItemOperator(
            ...
            trigger_dag_id=f'ge_portugal_process_each_user_dag_{config.instance}',
            conf=lambda item: {
        ...
        trigger_dag_run_ge_user_sync_portugal_ge_portugal_child_add_foreign_supervisor_v1_049 = rail.TriggerDagRunForEachItemOperator(
            ...
            trigger_dag_id=f'ge_user_sync_portugal_child_add_foreign_supervisor_v1_0_{config.instance}',
            execution_timeout=timedelta(days=14),
            accumulate_result=True,
            conf={
        ...
        trigger_dag_run_ge_user_sync_portugal_ge_portugal_child_add_supervisor_v1_0async_53 = rail.TriggerDagRunForEachItemOperator(
            ...
            trigger_dag_id=f'ge_portugal_child_add_supervisor_v1_0_{config.instance}',
            execution_timeout=timedelta(days=14),
            accumulate_result=True,
            conf={

...
def create_dag(config):
    ...
    with rail.create_airflow_dag(
        dag_id=f'ge_netherlands_user_update_{config.instance}',
        ...
        def is_legal_entity_changes(dag_run):
            if dag_run.conf['LegalEntity']:
                ...
                existing_legal_entity = rail.result('bulk_get_users3_6')[
                    0]['costCenterSchedule'][0]['costCenter']['displayText'] if rail.result('bulk_get_users3_6')[0]['costCenterSchedule'] else null
        ...
        trigger_dag_run_ge_user_sync_netherlands_child_update_to_v1_0284 = rail.TriggerDagRunForEachItemOperator(
            ...
            retries=0,
            items=[-1],
            trigger_dag_id=f'ge_netherlands_child_workflow_to_add_timeoff_type_for_update_user_v1_0_{config.instance}',
            execution_timeout=timedelta(days=14),
            accumulate_result=True,
            conf=lambda dag_run: {

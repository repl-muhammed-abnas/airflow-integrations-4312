...
def create_dag(config):
    ...
    with rail.create_airflow_dag(
        dag_id=f'ge_denmark_user_import_master_{config.instance}',
        ...
        new_file_sensor = rail.SFTPAnyFileSensor(
            ...
            poke_interval = 1800,
            soft_fail_timeout=timedelta(seconds=60)
        )
        ...
        trigger_dag_run_ge_user_sync_denmark_schedule_add_master_v1_019 = rail.TriggerDagRunForEachItemOperator(
            ...
            retries=0,
            items=[1],
            trigger_dag_id=f'ge_user_sync_denmark_ge_denmark_schedule_add_master_v1_0_{config.instance}',
        ...
        trigger_dag_run_ge_user_sync_denmark_suspend_assignment_category_custom_field_021 = rail.TriggerDagRunForEachItemOperator(
            ...
            retries=0,
            items=[1],
            trigger_dag_id=f'ge_user_sync_denmark_suspend_assignment_category_custom_fieldv1_{config.instance}',
            execution_timeout=timedelta(days=14),
            accumulate_result=True,
            conf={
                "inputdata": '''{{ result('load_csv_create_list_from_csv_10') }}'''
        ...
        process_user_22 = rail.TriggerDagRunForEachItemOperator(
            ...
            trigger_dag_id=f'ge_denmark_process_each_user_dag_{config.instance}',
            conf=lambda item: {
        ...
        trigger_dag_run_ge_user_sync_denmark_ge_denmark_child_add_foreign_supervisor_v1_049 = rail.TriggerDagRunForEachItemOperator(
            ...
            trigger_dag_id=f'ge_denmark_child_add_foreign_supervisor_v1_0_{config.instance}',
            execution_timeout=timedelta(days=14),
            accumulate_result=True,
            conf={
                "OHRID": "{{ item.OHRID }}",
        ...
        trigger_dag_run_ge_user_sync_denmark_ge_denmark_child_add_supervisor_v1_0async_53 = rail.TriggerDagRunForEachItemOperator(
            ...
            trigger_dag_id=f'ge_denmark_child_add_supervisor_v1_0_{config.instance}',
            execution_timeout=timedelta(days=14),
            accumulate_result=True,
            conf={
        ...
        log_to_sumo = rail.EmptyOperator(
            task_id='log_to_sumo'
        )

...
from ge.user_sync_greece.greece_master_mapper import greece_master_mapper
import rail
...
def create_dag(config):
    ...
    with rail.create_airflow_dag(
        dag_id=f'ge_user_sync_greece_user_update_v1_0_{config.instance}',
        description=f'GE_Greece User Update V1.0 {config.instance}',
        ...
        batch_task = rail.BatchTaskRunOperator(
            ...
            end_task='ey_user_import_logs_ey_add_entry_173',
        ...
        ge_greece_user_sync_master_mapper_search_entries_7 = rail.PythonOperator(
            task_id='ge_greece_user_sync_master_mapper_search_entries_7',
            python_callable=lambda dag_run:  list(
                filter(lambda x: x['legal_entity'] == dag_run.conf['LegalEntity'], greece_master_mapper))
        )
        ...
        def get_entity_mapper(entity_type, legal_entity):
            entity_types = list(filter(
                ...
                and x['type'] == legal_entity, greece_master_mapper))
        ...
        trigger_dag_run_ge_user_sync_greece_ge_greece_add_v1_0async_callrecipeforlegalentitychange_32 = rail.TriggerDagRunForEachItemOperator(
            task_id='trigger_dag_run_ge_user_sync_greece_ge_greece_add_v1_0async_callrecipeforlegalentitychange_32',
            retries=0,
            items=[1],
            trigger_dag_id=f'ge_greece_add_v1_0_{config.instance}',
        ...
        wait_for_completion_trigger_dag_run_ge_greece_add_v1_0async_callrecipeforlegalentitychange_32 = rail.WaitForDagRunsSensor(
            task_id='wait_for_completion_trigger_dag_run_ge_greece_add_v1_0async_callrecipeforlegalentitychange_32',
            execution_timeout=timedelta(days=14),
            dag_runs='{{ result("trigger_dag_run_ge_user_sync_greece_ge_greece_add_v1_0async_callrecipeforlegalentitychange_32") }}'
        )
        ...
        if_enddate_day_blank_46 = rail.IfOperator(
            ...
            test='''{{ result('bulk_get_users3_5')[0].userDetails.employmentDateRange.endDate.day | is_falsy }}''',
        ...
        updateloginname_50 = rail.RepliconServiceOperator(
            ...
            data={
                "userUri": "{{ dag_run.conf.useruri }}",
                "loginName": "{{ result('bulk_get_users3_5')[0].securityConfiguration.loginName }}{{ result('bulk_get_users3_5')[0].userDetails.employmentDateRange.endDate.day }}{{ result('bulk_get_users3_5')[0].userDetails.employmentDateRange.endDate.month }}{{ result('log_enddate_49') }}"
            }
        )

        trigger_dag_run_ge_user_sync_greece_ge_greece_add_v1_0async_callrecipeforrehire_51 = rail.TriggerDagRunForEachItemOperator(
            task_id='trigger_dag_run_ge_user_sync_greece_ge_greece_add_v1_0async_callrecipeforrehire_51',
            retries=0,
            items=[1],
            trigger_dag_id=f'ge_greece_add_v1_0_{config.instance}',
            execution_timeout=timedelta(days=14),
        ...
        wait_for_completion_trigger_dag_run_ge_user_sync_greece_ge_greece_add_v1_0async_callrecipeforrehire_51 = rail.WaitForDagRunsSensor(
            task_id='wait_for_completion_trigger_dag_run_ge_user_sync_greece_ge_greece_add_v1_0async_callrecipeforrehire_51',
            execution_timeout=timedelta(days=14),
            dag_runs='{{ result("trigger_dag_run_ge_user_sync_greece_ge_greece_add_v1_0async_callrecipeforrehire_51") }}'
        )
        ...
        if_request_employeeemailaddress_present_67 = rail.IfOperator(
            ...
            no_task="log_requiredtimesheettemplatename_70",
        )
        ...
        def get_value_from_mapper(dag_run, entity_type1, entity_type2):
            emp_types = list(filter(
                ...
                and x['identifier__1__(_legal_entity_code/_type/_timeoff_type)'] == entity_type2, greece_master_mapper))
            return emp_types[0]['value'] if emp_types else None

        def get_timesheet_template(dag_run):
            specialworkschedule = dag_run.conf['SpecialWorkSchedule']
            legalentity = dag_run.conf['LegalEntity']
            identifier_1 = "All" if legalentity == 'AL7128' else specialworkschedule
            ts_template = get_value_from_mapper(
                dag_run, 'Timesheet Template', identifier_1)
            return ts_template if ts_template else ""

        log_requiredtimesheettemplatename_70 = rail.PythonOperator(
            task_id='log_requiredtimesheettemplatename_70',
            python_callable=get_timesheet_template
        )

        def validate_timesheet_template():
            required_timesheettemplatename = rail.result(
                'log_requiredtimesheettemplatename_70')
            existing_user_info = rail.result('bulk_get_users3_5')[
                0]['timesheetTemplate'] if rail.result('bulk_get_users3_5') else None
            current_timesheet_template = existing_user_info['name'].lower(
            ) if existing_user_info else None
            if required_timesheettemplatename and required_timesheettemplatename.lower() != current_timesheet_template:
                return True
            return False

        if_log_requiredtimesheettemplatename_70_present_71 = rail.IfOperator(
            task_id='if_log_requiredtimesheettemplatename_70_present_71',
            test=validate_timesheet_template,
            yes_task="get_all_policy_sets_72",
            no_task="log_valuefor_job_position_title_79",
        )

        get_all_policy_sets_72 = rail.RepliconServiceOperator(
            task_id='get_all_policy_sets_72',
            endpoint="/services/PolicySetService1.svc/GetAllPolicySets",
        )

        log_timesheettemplateuri_73 = rail.PythonOperator(
            task_id='log_timesheettemplateuri_73',
            python_callable=lambda: rail.find_first_by_attr_and_get_attr(rail.result(
                'get_all_policy_sets_72'), 'displayText', rail.result('log_requiredtimesheettemplatename_70'), 'uri')
        )

        if_log_timesheettemplateuri_73_present_74 = rail.IfOperator(
            task_id='if_log_timesheettemplateuri_73_present_74',
            test='''{{ result('log_timesheettemplateuri_73') | is_truthy }}''',
            yes_task="assign_policy_set_to_user_timesheettemplate_75",
            no_task="insert_to_list_78",
        )

        assign_policy_set_to_user_timesheettemplate_75 = rail.RepliconServiceOperator(
            task_id='assign_policy_set_to_user_timesheettemplate_75',
            endpoint="/services/PolicySetService1.svc/AssignPolicySetToUser",
            data={
                "userUri": "{{ dag_run.conf.useruri }}",
                "policySetUri": "{{ result('log_timesheettemplateuri_73') }}"
            }
        )
        ...
        insert_to_list_78 = rail.SetVariableOperator(
            ...
            value={
                "value": "Timesheet template not updated as it is not available in mapper"
            }
        )
        ...
        def get_entity_types_from_mapper(dag_run, entity_type, identifier1):
            entity_types = list(filter(
                ...
                and x['identifier__1__(_legal_entity_code/_type/_timeoff_type)'] == identifier1, greece_master_mapper))
        ...
        def get_super_user_permissions(dag_run, entity_type_1, entity_type_2):
            super_permissions = list(filter(
                ...
                and x['identifier__1__(_legal_entity_code/_type/_timeoff_type)'] == entity_type_2, greece_master_mapper))
        ...
        def get_division_cost_schedules(dag_run):
            ...
            division_schedules = rail.result('bulk_get_users3_5')[
                0]['divisionSchedule']
            for costcenter_schedule in division_schedules:
                print("costcenter_schedule", costcenter_schedule)
                if costcenter_schedule['effectiveDate']:
                    effective_date = get_datetime_obj(
                        costcenter_schedule['effectiveDate'])
                    ...
                    if effective_date.date() < current_date.date():
                        derived_industryfocus_schedules.append({
                            "uri": costcenter_schedule['division']['uri'],
                            "name": costcenter_schedule['division']['displayText'],
                            "date": effective_date.strftime('%d/%m/%Y')
                        })
        ...
        log_max_effectivedate_159 = rail.PythonOperator(
            ...
            python_callable=lambda: (max(
                datetime.strptime(x['date'], '%d/%m/%Y') for x in rail.result('log_industry_focus_group_divisionschedule_145')['industry_focus_schedules'])).strftime('%d/%m/%Y')
            if rail.result('log_industry_focus_group_divisionschedule_145')['industry_focus_schedules'] else None
        )
        ...
        can_run_batch_task >> rail.Label('Yes') >> batch_task >> ey_user_import_logs_ey_add_entry_173
        can_run_batch_task >> rail.Label('No') >> declare_list_2
        declare_list_2 >> declare_list_3 >> bulk_get_users3_5 >> log_startdate_6 >> \
            ge_greece_user_sync_master_mapper_search_entries_7 >> if_request_legalentity_present_dataworkato_servicereceive_requestrequestsupervisorssoid_8
        ...
        if_log_current_legal_entitycostcentername_26_blank_28 >> rail.Label(
            ...
            trigger_dag_run_ge_user_sync_greece_ge_greece_add_v1_0async_callrecipeforlegalentitychange_32 >> \
            wait_for_completion_trigger_dag_run_ge_greece_add_v1_0async_callrecipeforlegalentitychange_32 >> \
        ...
        if_enddate_day_blank_46 >> rail.Label(
            ...
            ey_user_import_logs_ey_add_entry_173
        if_enddate_day_blank_46 >> rail.Label(
            'No') >> log_enddate_49 >> updateloginname_50 >> trigger_dag_run_ge_user_sync_greece_ge_greece_add_v1_0async_callrecipeforrehire_51 >> \
            wait_for_completion_trigger_dag_run_ge_user_sync_greece_ge_greece_add_v1_0async_callrecipeforrehire_51 >> \
            ey_user_import_logs_ey_add_entry_173
        if_userdetails_isenabled_is_not_true_rehire_42 >> rail.Label(
        ...
        if_request_employeeemailaddress_present_67 >> rail.Label(
            'Yes') >> update_email_68 >> insert_to_list_69 >> log_requiredtimesheettemplatename_70
        if_request_employeeemailaddress_present_67 >> rail.Label(
            'No') >> log_requiredtimesheettemplatename_70 >> if_log_requiredtimesheettemplatename_70_present_71
        if_log_requiredtimesheettemplatename_70_present_71 >> rail.Label(
            'Yes') >> get_all_policy_sets_72 >> log_timesheettemplateuri_73 >> if_log_timesheettemplateuri_73_present_74
        if_log_timesheettemplateuri_73_present_74 >> rail.Label(
            'Yes') >> assign_policy_set_to_user_timesheettemplate_75 >> insert_to_list_76 >> log_valuefor_job_position_title_79
        if_log_timesheettemplateuri_73_present_74 >> rail.Label(
            'No') >> insert_to_list_78 >> log_valuefor_job_position_title_79
        if_log_requiredtimesheettemplatename_70_present_71 >> rail.Label(
            'No') >> log_valuefor_job_position_title_79 >> if_request_jobpositiontitle_present_80
        ...
        if_request_industryfocusgroup_present_dataworkato_servicereceive_requestrequestsupervisorssoid_142 >> rail.Label(
            'Yes') >> declare_list_143 >> declare_list_144 >> log_industry_focus_group_divisionschedule_145 >> if_first_uri_present_158

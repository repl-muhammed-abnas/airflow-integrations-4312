...
def create_dag(config):
    ...
    with rail.create_airflow_dag(
        dag_id=f'ge_greece_user_import_master_{config.instance}',
        ...
        is_healthcare_invalid_file = rail.IfOperator(
            ...
            test="{{ get_company_key().lower() == 'getrial' }}",
        ...
        trigger_dag_run_ge_user_sync_suspend_assignment_category_custom_field_check16 = rail.TriggerDagRunForEachItemOperator(
            ...
            retries=0,
            items=[1],
            trigger_dag_id=f'ge_user_sync_greece_suspend_assignment_category_custom_field_check_{config.instance}',
        ...
        process_user_22 = rail.TriggerDagRunForEachItemOperator(
            ...
            trigger_dag_id=f'ge_greece_process_each_user_dag_{config.instance}',
            conf=lambda item: {
        ...
        trigger_dag_run_ge_user_sync_greece_ge_greece_child_add_foreign_supervisor_v1_049 = rail.TriggerDagRunForEachItemOperator(
            ...
            trigger_dag_id=f'ge_greece_child_add_foreign_supervisor_v1_0_{config.instance}',
            execution_timeout=timedelta(days=14),
            accumulate_result=True,
            conf={
                "OHRID": "{{ item.OHRID }}",
        ...
        trigger_dag_run_ge_user_sync_greece_ge_greece_child_add_supervisor_v1_0async_53 = rail.TriggerDagRunForEachItemOperator(
            ...
            trigger_dag_id=f'ge_greece_child_add_supervisor_v1_0_{config.instance}',
            execution_timeout=timedelta(days=14),
            accumulate_result=True,
            conf={

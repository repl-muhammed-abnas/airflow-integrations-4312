...
def create_dag(config):
    ...
    with rail.create_airflow_dag(
        dag_id=f'ge_user_sync_czech_ge_czech_user_import_master_{config.instance}',
        ...
        process_user_22 = rail.TriggerDagRunForEachItemOperator(
            ...
            trigger_dag_id=f'ge_czech_process_each_user_dag_{config.instance}',
            conf=lambda item: {
        ...
        trigger_dag_run_ge_user_sync_czech_ge_czech_child_add_foreign_supervisor_v1_049 = rail.TriggerDagRunForEachItemOperator(
            ...
            trigger_dag_id=f'ge_czech_child_add_foreign_supervisor_v1_0_{config.instance}',
            execution_timeout=timedelta(days=14),
        ...
        trigger_dag_run_ge_user_sync_czech_ge_czech_child_add_supervisor_v1_0async_53 = rail.TriggerDagRunForEachItemOperator(
            ...
            trigger_dag_id=f'ge_czech_child_add_supervisor_v1_0_{config.instance}',
            execution_timeout=timedelta(days=14),
            accumulate_result=True,
            conf={

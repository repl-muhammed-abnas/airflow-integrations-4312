...
def create_child_dag_wbs(config):
    with rail.create_airflow_dag(
        dag_id=f'avenu_user_sync_delete_time_off_for_user_{config.instance}_child',
        ...
        can_run_batch_task = rail.IfOperator(
            ...
            yes_task="batch_task",
            no_task= "get_data_forall_timeoff_after_the_enddate"
        )
        ...
        get_data_forall_timeoff_after_the_enddate = rail.RepliconServiceOperator(
            ...
            data=request_payload.get_data_for_all_timeoff_after_the_enddate,
        ...
        can_run_batch_task >> rail.Label("No") >> get_data_forall_timeoff_after_the_enddate \
        ...
        if_time_off_present >> rail.Label("No") >> catch_and_log_errors
    return dag

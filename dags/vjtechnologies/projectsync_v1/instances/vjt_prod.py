...
input_filepath = '/Replicon/Project Sync/VJT/Input'
reference_filepath = '/Replicon/Project Sync/VJT/Reference/'
log_filepath = '/Replicon/Project Sync/VJT/Logs/'
archive_filepath = '/Replicon/Project Sync/VJT/Archive/'

schedule_interval = '30 0 * * *'
can_run_batch_task = f'vjtechnologies_projectsync_vjt_can_run_batch_task_{instance}'

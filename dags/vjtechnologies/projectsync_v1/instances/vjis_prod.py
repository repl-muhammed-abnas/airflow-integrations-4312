...
input_filepath = '/Replicon/Project Sync/VJIS/Input'
reference_filepath = '/Replicon/Project Sync/VJIS/Reference/'
log_filepath = '/Replicon/Project Sync/VJIS/Logs/'
archive_filepath = '/Replicon/Project Sync/VJIS/Archive/'

schedule_interval = '30 0 * * *'

can_run_batch_task = f'vjtechnologies_projectsync_vjis_can_run_batch_task_{instance}'

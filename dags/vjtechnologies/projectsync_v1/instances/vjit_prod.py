...
input_filepath = '/Replicon/Project Sync/VJIT/Input'
reference_filepath = '/Replicon/Project Sync/VJIT/Reference/'
log_filepath = '/Replicon/Project Sync/VJIT/Logs/'
archive_filepath = '/Replicon/Project Sync/VJIT/Archive/'

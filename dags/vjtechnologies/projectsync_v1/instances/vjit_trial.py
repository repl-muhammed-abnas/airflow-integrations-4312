...
input_filepath = '/Replicon UAT/Project Sync/VJIT/Input'
reference_filepath = '/Replicon UAT/Project Sync/VJIT/Reference/'
log_filepath = '/Replicon UAT/Project Sync/VJIT/Logs/'
archive_filepath = '/Replicon UAT/Project Sync/VJIT/Archive/'

schedule_interval = '0 3 * * *'
can_run_batch_task = f'vjtechnologies_projectsync_vjit_can_run_batch_task_{instance}'

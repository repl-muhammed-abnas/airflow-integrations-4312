...
input_filepath = '/Replicon/Project Sync/VJS/Input'
reference_filepath = '/Replicon/Project Sync/VJS/Reference/'
log_filepath = '/Replicon/Project Sync/VJS/Logs/'
archive_filepath = '/Replicon/Project Sync/VJS/Archive/'

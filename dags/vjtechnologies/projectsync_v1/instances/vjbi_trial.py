...
input_filepath = '/Replicon UAT/Project Sync/VJBI/Input'
reference_filepath = '/Replicon UAT/Project Sync/VJBI/Reference/'
log_filepath = '/Replicon UAT/Project Sync/VJBI/Logs/'
archive_filepath = '/Replicon UAT/Project Sync/VJBI/Archive/'

schedule_interval = '30 0 * * *'
can_run_batch_task = f'vjtechnologies_projectsync_vjbi_can_run_batch_task_{instance}'

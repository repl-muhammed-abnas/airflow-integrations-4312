...
input_filepath = '/Replicon/Project Sync/VJBL/Input'
reference_filepath = '/Replicon/Project Sync/VJBL/Reference/'
log_filepath = '/Replicon/Project Sync/VJBL/Logs/'
archive_filepath = '/Replicon/Project Sync/VJBL/Archive/'

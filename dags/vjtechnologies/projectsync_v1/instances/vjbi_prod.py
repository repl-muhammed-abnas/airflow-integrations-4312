...
input_filepath = '/Replicon/Project Sync/VJBI/Input'
reference_filepath = '/Replicon/Project Sync/VJBI/Reference/'
log_filepath = '/Replicon/Project Sync/VJBI/Logs/'
archive_filepath = '/Replicon/Project Sync/VJBI/Archive/'

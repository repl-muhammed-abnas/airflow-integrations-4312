...
input_filepath = '/Replicon UAT/Project Sync/VJBL/Input'
reference_filepath = '/Replicon UAT/Project Sync/VJBL/Reference/'
log_filepath = '/Replicon UAT/Project Sync/VJBL/Logs/'
archive_filepath = '/Replicon UAT/Project Sync/VJBL/Archive/'

schedule_interval = '0 3 * * *'
can_run_batch_task = f'vjtechnologies_projectsync_vjbl_can_run_batch_task_{instance}'

import rail
from mammoet.payroll_export_bel.utils.custom_methods import create_json_payload_callable
    ...
    with rail.create_airflow_dag(
        ...
        query_records_to_post = rail.QueryCollectionOperator(
            ...
            query="""SELECT frd.employee_id as employeeid ,
                        ...
                        REPLACE(frd.entry_date, '/', '-') as startdate,
                        REPLACE(frd.entry_date, '/', '-') as enddate,

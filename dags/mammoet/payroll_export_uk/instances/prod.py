...
from mammoet.payroll_export_uk.config import *
from mammoet.payroll_export_uk.mappers.paycodes_uk import UK_PAYCODES
...
PAYCODES = UK_PAYCODES
PAYROLL_LOCATION_NAME = "United Kingdom"
PAYROLL_FILE_PREFIX = "UK_"
...
time_zone = "CET"
daily_run_schedule_interval = "0 11 1,3-28,29,30,31 * *"
monthly_run_schedule_interval = "30 11 2 * *"

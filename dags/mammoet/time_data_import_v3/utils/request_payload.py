...
import rail
from mammoet.time_data_import_v3.utils import custom_methods
...
def get_time_entry_by_daterange(dag_run):
    return {
        "users": [
            {
...
def get_timeentry_uri():
    ...
    } if rail.result("get_time_entry_data_for_update") else {
...
def add_entry_id_oefs(conf,action):
    ...
    oef_list.append({
        ...
        }) if rail.result("get_time_entry_details_for_update") and attendence_type_details else None

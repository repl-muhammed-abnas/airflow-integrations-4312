...
import rail
from mammoet.payroll_export_mex.utils import request_payload
from mammoet.payroll_export_mex.utils.custom_methods import get_logging_details_callable, EXPORT_DATE_FORMAT, get_log_to_sumo_extra_info, get_can_process_task
from mammoet.payroll_export_mex.utils.response_filters import get_payroll_file_format_details_for_country, get_location_uris
from mammoet.payroll_export_mex.tasks.payroll_export_task import payroll_data_export
...
def create_main_dag(config):
    ...
    with rail.create_airflow_dag(
        ...
        # this is added to avoid the scheduler issue, where
        # the tasks are getting executed out of there schedule
        ...
        can_process_tasks >> rail.Label("Yes") >> get_logging_details
        get_logging_details >> get_all_location_for_parent >> get_payroll_file_format_for_country >> create_payroll
        ...
        has_any_records_to_process >> rail.Label(
            "Yes") >> add_index_to_raw_data >> get_access_token >> post_payroll_data
        post_payroll_data >> wait_for_post_payroll_data >> payroll_data_processing_complete\

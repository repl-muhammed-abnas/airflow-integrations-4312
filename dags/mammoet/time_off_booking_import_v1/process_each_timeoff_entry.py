...
from mammoet.time_off_booking_import_v1.utils import response_filter
from mammoet.time_off_booking_import_v1.utils import request_payload
...
def create_child_dag(config):
    with rail.create_airflow_dag(
        ...
        is_date_valid = rail.IfOperator(
            ...
            test=lambda dag_run:request_payload.validate_dates(dag_run, config.instance),

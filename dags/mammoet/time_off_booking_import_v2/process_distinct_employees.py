...
from mammoet.time_off_booking_import_v2.utils import request_payload, response_filter
...
def create_child_dag(config):
    with rail.create_airflow_dag(
        ...
        process_each_timeoff_entry= rail.TriggerDagRunForEachItemOperator(
            ...
            conf=lambda item, dag_run: request_payload.get_child_conf(item, dag_run, config.instance)
        )

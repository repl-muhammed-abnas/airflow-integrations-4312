...
from mammoet.time_data_import_v1.utils.custom_methods import do_format_logs
...
def create_child_dag_wbs(config):
    with rail.create_airflow_dag(
        ...
        generate_downloadable_link = rail.GeneratePresignedDownloadUrlOperator(
            ...
            output_file_name="Log_file_"+'{{ dag_run.conf.log_filename }}'+".csv",
        ...
        format_logs >> render_logs_csv >> generate_downloadable_link >> upload_log_to_sftp >> send_import_complete_email
    return dag

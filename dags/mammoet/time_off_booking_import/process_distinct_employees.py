...
from mammoet.time_off_booking_import.utils import request_payload, response_filter
...
def create_child_dag(config):
    with rail.create_airflow_dag(
        ...
        process_each_timeoff_entry >> wait_for_process_each_timeoff_entry >>  catch_and_log_errors >> log_to_sumo

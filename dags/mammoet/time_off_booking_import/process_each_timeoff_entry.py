...
from mammoet.time_off_booking_import.utils import response_filter
from mammoet.time_off_booking_import.utils import request_payload
...
def create_child_dag(config):
    with rail.create_airflow_dag(
        ...
        is_date_valid = rail.IfOperator(
            ...
            test=request_payload.validate_dates,
        ...
        is_update_required >> reopen_and_put_timeoff >>  get_time_off_approval_status >> is_timeoff_approved
        is_update_required >> rail.Label('No') >> log_no_update_required >> catch_and_log_errors >> log_to_sumo

...
def create_disable_user_main_dag(config):
    with rail.create_airflow_dag(
        ...
        description=f'Articwolf User Import Disable Master {config.instance}',
        company_key=config.company_key,
        replicon_conn_id=config.replicon_conn_id,
        start_date=datetime(2022, 4, 1, tz=config.est_timezone),
        ...
        is_report_failed >> rail.Label(
            'Yes') >> fail_disable_user_report_generation

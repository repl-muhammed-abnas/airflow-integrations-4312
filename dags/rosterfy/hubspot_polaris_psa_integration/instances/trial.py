...
webhook_renewals_shared_secrete = f"rosterfytrial_webhooks_renewals_secrete_key_{instance}"
webhook_service_shared_secrete = f"rosterfytrial_webhooks_service_secrete_key_{instance}"
webhook_sales_shared_secrete = f"rosterfytrial_webhooks_sales_secrete_key_{instance}"
webhook_update_shared_secrete = f"rosterfytrial_webhooks_update_project_secrete_key_{instance}"
...
can_run_batch_task_var_name = f'rosterfytrial_hubspot_polaris_psa_integration_{instance}_can_run_batch_task'
lookup_log_timestamp_var = f'rosterfytrial_hubspot_polaris_psa_integration_lookup_log_timestamp_{instance}'

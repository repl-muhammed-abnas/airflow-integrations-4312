...
def get_user_prereqs_task_group():
    ...
    with rail.TaskGroup(group_id='get_user_prereqs', prefix_group_id=False) as get_user_prereqs:
        ...
        get_workauthorization_approval_paths = rail.RepliconServiceOperator(
            task_id='get_workauthorization_approval_paths',
        ...
        dummy_get_user_prereqs >> [get_all_locations, get_all_departments, get_all_divisions, get_all_employeetypes, get_all_permission_set,
                                   ...
                                   get_timesheet_approval_paths, get_timeoff_approval_paths, get_workauthorization_approval_paths,
                                   get_user_udfs, get_required_time_off_types, get_all_activities]

        get_user_udfs >> [get_regularshiftuser_udf_dropdown_values,
                          get_employeecategory_udf_dropdown_values]

...
def create_child_dag_wbs(config):
    with rail.create_airflow_dag(
        ...
        filter_user_logs >> search_supervisor_in_replicon >> is_supervisor_exists >> rail.Label('No') >> has_supervisor_details

        has_supervisor_details >> rail.Label('Yes') >> create_spervisor >> get_missing_supervisor_permissions
        has_supervisor_details >> rail.Label('No') >> log_supervisor_not_created >> dummy_filter_user_logs

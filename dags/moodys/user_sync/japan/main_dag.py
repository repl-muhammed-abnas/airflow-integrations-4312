...
from moodys.user_sync.japan.utils import request_payload
from moodys.user_sync.japan.tasks.get_user_prereqs import get_user_prereqs_task_group
...
def create_main_dag(config):
    with rail.create_airflow_dag(
        ...
        send_blank_payload_email = rail.EmailOperator(
            ...
            subject='{{ get_company_key() }} | User Sync - Japan no records in file - {{ current_time_in_specified_tz() }}',

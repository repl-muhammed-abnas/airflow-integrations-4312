...
from moodys.user_sync.united_states_v1.utils import response_filter
...
def create_child_dag(config):
    with rail.create_airflow_dag(
        ...
        query_divisions_to_create >> has_new_divisions >> rail.Label(
            'No') >> finish
        has_new_divisions >> rail.Label(
            'Yes') >> dummy_process_new_divisions >> process_new_divisions >> finish

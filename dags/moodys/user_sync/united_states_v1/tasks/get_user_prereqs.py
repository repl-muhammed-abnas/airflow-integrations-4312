...
def get_user_prereqs_task_group():
    ...
    with rail.TaskGroup(group_id='get_user_prereqs', prefix_group_id=False) as get_user_prereqs:
        ...
        get_location_udf_dropdown_values = rail.RepliconServiceOperator(
            task_id="get_location_udf_dropdown_values",
            endpoint="/services/CustomFieldService1.svc/GetAllCustomFieldDropDownOptions",
            data=lambda: {
                    "customFieldUri": rail.result('get_user_udfs')['locationudfdefinitionuri']
            },
        ...
        get_user_udfs >> [get_location_udf_dropdown_values,

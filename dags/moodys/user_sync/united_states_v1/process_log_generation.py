...
from moodys.user_sync.united_states_v1.utils.python_callable_methods import do_format_logs
...
def create_child_dag(config):
    with rail.create_airflow_dag(
        ...
        description='Moodys User Sync - Process Log Generation',
        ...
        render_logs_csv = rail.WriteCSVFileOperator(
            ...
            row=['{{ item | attr_or_default("countryid", "") }}',
        ...
        send_import_complete_email = rail.EmailOperator(
            ...
            bcc="{%- if result('format_logs', 'error_record_count') == 0 -%}\
                ...
                {%- else -%}\
                    "+config.alert_email+"\
                {%- endif -%}",
            subject='{{ get_company_key() + " | User Sync - United States " }} \

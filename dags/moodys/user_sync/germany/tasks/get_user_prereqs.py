...
from moodys.user_sync.germany.utils import request_payload, response_filter
    ...
    with rail.TaskGroup(group_id='get_user_prereqs', prefix_group_id=False) as get_user_prereqs:
        ...
        get_user_udfs = rail.RepliconServiceOperator(
            ...
            data_handler=lambda udfs: {
                ...
                'statutorylimitdefinitionuri': rail.find_first_by_attr_and_get_attr(udfs, 'displayText', 'Statutory Limit', 'uri'),
                'jobtitledefinitionuri': rail.find_first_by_attr_and_get_attr(udfs, 'displayText', 'Job Title', 'uri'),
            },
        )
        ...
        get_statutorylimit_udf_dropdown_values = rail.RepliconServiceOperator(
            task_id="get_statutorylimit_udf_dropdown_values",
            endpoint="/services/CustomFieldService1.svc/GetAllCustomFieldDropDownOptions",
            data=lambda: {
                    "customFieldUri": rail.result('get_user_udfs')['statutorylimitdefinitionuri']
            },
            data_handler=response_filter.get_all_drop_down_options_filter
        )

        dummy_get_user_prereqs >> [
            get_all_locations, get_all_departments, get_all_divisions, get_all_employeetypes,
            get_all_permission_set, get_all_payrule_scripts, get_all_policy_sets, get_all_timezones,
            get_timesheet_approval_paths, get_timeoff_approval_paths, get_user_udfs,
            get_required_time_off_types, get_all_activities]

        get_user_udfs >> [
            get_regularshiftuser_udf_dropdown_values, get_employeecategory_udf_dropdown_values,
            get_statutorylimit_udf_dropdown_values]

import rail
from tpg.user_import.utils.request_payload import get_supervisor_data_payload, get_today_date
from tpg.user_import.utils.response_filter import map_supervisor_list_data, is_assign_supervisorpermission
    ...
    with rail.TaskGroup(group_id='process_supervisor_assignment_task', prefix_group_id=False):
        ...
        log_supervisor_not_present = rail.WriteLogOperator(
            ...
            properties= lambda dag_run:{
                ...
                'action':'Add' if status == "new_user" else 'Updated',
                'status':'Pending',

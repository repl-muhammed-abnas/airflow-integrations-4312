...
import rail
from wipro.auto_shift_assignment.monthly_assignment.utils import request_payload, response_filter
...
def create_child_dag(config):
    with rail.create_airflow_dag(
        ...
        query_enabled_users_data = rail.QueryCollectionOperator(
            ...
            AND (country != 'Spain' OR (country = 'Spain' AND legal_entity_code = 'W001' AND acquired_company!='INETUM'))""",
        )

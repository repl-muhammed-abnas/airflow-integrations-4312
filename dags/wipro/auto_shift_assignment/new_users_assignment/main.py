...
import rail
from wipro.auto_shift_assignment.new_users_assignment.utils import request_payload
...
def create_main_dag(config):
    with rail.create_airflow_dag(
        ...
        query_enabled_users_data = rail.QueryCollectionOperator(
            ...
            {str(config.country)} or (country = 'Spain' AND legal_entity_code = 'W001' AND acquired_company!='INETUM')"""
        )

...
from wipro.auto_shift_assignment.new_users_assignment.mapper.country_mapper import COUNTRY_MONTH_SHIFT_ASSIGNMENT_MAPPER
...
country = ('Ireland', 'Netherlands', 'Poland', 'Portugal', 'Romania',

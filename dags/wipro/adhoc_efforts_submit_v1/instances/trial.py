...
from wipro.adhoc_efforts_submit_v1.config import *
from wipro.adhoc_efforts_submit_v1.country_mapper.country_mapper_list import country_list_trial
from wipro.adhoc_efforts_submit_v1.country_mapper.query_mapper_for_country import query_mapper_for_contry_trial

instance = "trial"
environment = "pre-production"
company_key = "Wiprosandbox1"

replicon_conn_id = "Wiprosandbox1_replicon_myworkflow.Integration"
sftp_conn_id = "sftp_internal"

alert_mail = '{{ var.value.dagrun_failure_alert_email }}'

log_filepath = "/shivam/wipro/effort_submit/logs"

time_export_for_country = [ "adhoc" ]

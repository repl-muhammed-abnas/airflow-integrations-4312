...
def create_prerequisite_data(config):
    with rail.TaskGroup(
        ...
        get_ireland_parent_location_details = rail.RepliconServiceOperator(
            task_id="get_ireland_parent_location_details",
        ...
        get_ireland_schedule_policy = rail.RepliconServiceOperator(
            task_id="get_ireland_schedule_policy",
        ...
        start_groups >>\
        get_ireland_parent_location_details >>\
            [

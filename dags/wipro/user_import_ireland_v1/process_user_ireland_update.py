from wipro.user_import_ireland_v1.task import update_roles_for_user
...
def create_airflow_child(config):
    with rail.create_airflow_dag(
        ...
        can_run_batch_task >> rail.Label("No") >> get_update_user_details >> get_user_custom_field_values >>\

...
def create_prerequisite_data(config):
    with rail.TaskGroup(
        ...
        get_switzerland_parent_location_details = rail.RepliconServiceOperator(
            task_id="get_switzerland_parent_location_details",
        ...
        get_switzerland_country_uri = rail.RepliconServiceOperator(
            task_id="get_switzerland_country_uri",
        ...
        get_switzerland_schedule_policy = rail.RepliconServiceOperator(
            task_id="get_switzerland_schedule_policy",
        ...
        get_switzerland_punch_policy = rail.RepliconServiceOperator(
            task_id="get_switzerland_punch_policy",
            endpoint="/services/PolicySetService1.svc/GetAllEnabledPolicySetsForPolicy",
            data={
        ...
        start_groups >>\
            get_switzerland_parent_location_details >>\
            [
                ...
                get_switzerland_schedule_policy,
                get_switzerland_punch_policy,
                get_all_departments
            ] >> end_groups

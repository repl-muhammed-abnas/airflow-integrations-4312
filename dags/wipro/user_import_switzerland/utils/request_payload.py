...
from wipro.user_import_switzerland.utils import custom_methods
import rail
...
def get_location_hierarchy_payload():
    return {
        ...
        "parentUri": rail.result("get_switzerland_parent_location_details")
    }
...
def get_update_supervisor_permission_payload(dag_run):
    ...
    permission_set_uris = list(filter(lambda i: i != None, permission_set_uris))
    return {
        "user": {
...
def get_switzerland_create_payload(dag_run):
    ...
    return {
        "user": {
            ...
            "holidayCalendarAssignmentSchedule": null,
            "timeOffPolicy": null,
            "permissionSets": custom_methods.get_switzerland_user_create_permissions(dag_run),
            "policySets": custom_methods.get_switzerland_user_create_policy_sets(dag_run),
            "employeeType": null,
            ...
            "customFieldValues": custom_methods.get_switzerland_user_create_custom_fields(dag_run),
            "assignedActivities": [],
            "timeZone":  {
            ...
            "locationSchedule": custom_methods.get_switzerland_user_create_location(dag_run),
            "divisionSchedule": [
                {
                    "division": {
                        "uri": dag_run.conf["legalentityuri"],
            ...
            "policyDataAccessScopes": custom_methods.get_switzerland_user_create_policy_data_access(dag_run),
            "payRuleScriptSchedule": [
                    ...
                    ] if dag_run.conf["payrule_uri"] else null,
            "displayNameParameter": {
            ...
            "extensionFieldValues": custom_methods.get_switzerland_user_create_oefs(dag_run)
        }
    }
...
def get_update_user_req(dag_run):
    return {
        ...
        "modifications": {
            **custom_methods.get_basic_user_details_update(dag_run),
            "locationSchedule": custom_methods.check_if_switzerland_user_location_update(dag_run),
            "extensionFields": custom_methods.get_extension_field_values_updates(dag_run),
            "customFields": custom_methods.get_switzerland_user_update_custom_fields(dag_run),
            "holidayCalendar": custom_methods.check_if_switzerland_user_location_update(dag_run, holiday_calendar=True),
            "departmentGroupSchedule": custom_methods.get_department_update(dag_run),
        },
        "userModificationOptionUri": "urn:replicon:user-modification-option:save",

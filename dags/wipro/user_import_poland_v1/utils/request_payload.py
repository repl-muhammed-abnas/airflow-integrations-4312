...
from wipro.user_import_poland_v1.utils import custom_methods
import rail
...
def get_location_hierarchy_payload():
    return {
      ...
      "parentUri": rail.result("get_poland_parent_location_details")
    }
...
def get_poland_create_payload(dag_run):
    ...
    return {
        "user": {
            ...
            "holidayCalendarAssignmentSchedule": null,
            "timeOffPolicy": null,
            "permissionSets": custom_methods.get_poland_user_create_permissions(dag_run),
            "policySets": custom_methods.get_poland_user_create_policy_sets(dag_run),
            "employeeType": null,
            ...
            "customFieldValues": custom_methods.get_poland_user_create_custom_fields(dag_run),
            "assignedActivities": [],
            "timeZone":  {
            ...
            "locationSchedule": custom_methods.get_poland_user_create_location(dag_run),
            "divisionSchedule": [
                {
                    "division": {
                        "uri": dag_run.conf["legalentityuri"],
            ...
            "policyDataAccessScopes": custom_methods.get_poland_user_create_policy_data_access(dag_run),
            "payRuleScriptSchedule": custom_methods.get_poland_user_payrule_script(dag_run),
            "displayNameParameter": {
            ...
            "extensionFieldValues": custom_methods.get_poland_user_create_oefs(dag_run)
        }
    }
    ...
    return {
        ...
        "modifications": {
            **get_basic_user_details_update(dag_run)[0],
            "locationSchedule":custom_methods.check_if_poland_user_location_update(dag_run)[0],
            "extensionFields": custom_methods.get_extension_field_values_updates(dag_run)[0],
            "customFields": custom_methods.get_poland_user_update_custom_fields(dag_run)[0],
            ...
            "punchEntryPolicy": custom_methods.get_punch_entry_policy_for_update(dag_run)[0],

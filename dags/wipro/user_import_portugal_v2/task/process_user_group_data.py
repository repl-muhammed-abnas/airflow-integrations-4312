...
def create_prerequisite_data(config):
    with rail.TaskGroup(
        ...
        get_portugal_parent_location_details = rail.RepliconServiceOperator(
            task_id="get_portugal_parent_location_details",
        ...
        get_portugal_schedule_policy = rail.RepliconServiceOperator(
            task_id="get_portugal_schedule_policy",
        ...
        start_groups >>\
            get_portugal_parent_location_details >>\
            [

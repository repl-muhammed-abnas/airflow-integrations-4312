from wipro.user_import_belgium_v1.task import update_roles_for_user
    ...
    with rail.create_airflow_dag(
        ...
        write_supervisor_pending_logs = rail.WriteLogOperator(
            ...
            properties=lambda dag_run: {
                ...
                "Add_Update": "Update",
                "useruri":rail.result('get_update_user_details')["userDetails"]["uri"],
                "supervisor_uri": rail.result('get_effective_supervisor_of_user')["uri"]\
        ...
        write_updated_user_logs = rail.WriteLogOperator(
            ...
            properties=lambda dag_run: {
                ...
                "company_code": dag_run.conf["company_code"],
                "status": "Success",
                "details": "User successfully updated." + rail.result("get_all_update_logs")
            }
        )
        ...
        get_extension_field_values >>  get_hr_manager_belongs_to_belgium >>\
        get_hr_adid_belongs_to_belgium >> get_current_location_for_the_user >> update_user_details >>\
        ...
        enable_user >>\
        if_user_has_end_date >> rail.Label("No") >> update_the_reversal_date

    ...
    with rail.create_airflow_dag(
        ...
        if_project_supervisor_with_permissions = rail.IfOperator(
            ...
            test=lambda: rail.find_first_by_attr_and_get_attr(
                ...
                rail.result("get_project_supervisor_details")["permissionSets"],
                "displayText",
                config.GENERAL_MAPPER["default_user_permission"],
                "uri"),
            yes_task="if_user_not_exists",
        ...
        if_user_not_exists >> rail.Label("Yes") >> start_process_add_user >> process_add_user
        ...
        process_add_user >> wait_for_add_user >> catch_and_log_errors

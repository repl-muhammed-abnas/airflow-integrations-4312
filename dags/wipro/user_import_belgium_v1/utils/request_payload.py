...
from wipro.user_import_belgium_v1.utils import custom_methods
import rail
...
def get_location_hierarchy_payload():
    return {
      ...
      "parentUri": rail.result("get_belgium_parent_location_details")[0]["cells"][0]["uri"]
    }
...
def get_belgium_create_payload(dag_run):
    ...
    return {
        "user": {
            ...
            "schedulePolicySchedule": [{
                "schedulePolicy": {
                    "officeScheduleUri": dag_run.conf["schedule_typeuri"],
                    "name": null,
                    "officeSchedule": null,
            ...
            "holidayCalendarAssignmentSchedule": null,
            "timeOffPolicy": null,
            "permissionSets": custom_methods.get_belgium_user_create_permissions(dag_run),
            "policySets": custom_methods.get_belgium_user_create_policy_sets(dag_run),
            "employeeType": null,
            ...
            "customFieldValues": custom_methods.get_belgium_user_create_custom_fields(dag_run),
            "assignedActivities": [],
            "timeZone":  {
            ...
            "locationSchedule": custom_methods.get_belgium_user_create_location(dag_run),
            "divisionSchedule": [
                {
                    "division": {
                        "uri": dag_run.conf["legalentityuri"],
            ...
            "policyDataAccessScopes": custom_methods.get_belgium_user_create_policy_data_access(dag_run),
            "payRuleScriptSchedule": custom_methods.get_belgium_user_payrule_script(dag_run),
            "displayNameParameter": {
            ...
            "extensionFieldValues": custom_methods.get_belgium_user_create_oefs(dag_run)
        }
    }
...
def get_update_user_req(dag_run):
  ...
  "modifications": {
    **get_basic_user_details_update(dag_run)[0],
    "locationSchedule":custom_methods.check_if_belgium_user_location_update(dag_run)[0],
    "extensionFields": custom_methods.get_extension_field_values_updates(dag_run)[0],
    "customFields": custom_methods.get_belgium_user_update_custom_fields(dag_run)[0],
        ...
        "rightExpression": {
          ...
          "rightExpression": {
            ...
            "rightExpression": {
              ...
              "rightExpression": null,
              "value": {
                "uri": dag_run.conf["netherlands_countryuri"]
              },
              "filterDefinitionUri": null
            },
            "value": null,
...
def get_hr_adid_with_location_payload(dag_run):
    payload = {
      "page": "1",
      "pagesize": "10",
      "columnUris": [

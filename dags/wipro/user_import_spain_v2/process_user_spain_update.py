from wipro.user_import_spain_v2.task import update_roles_for_user
...
def create_airflow_child(config):
    with rail.create_airflow_dag(
        ...
        set_termination_time_off_balance_policy = rail.RepliconServiceOperator(
            ...
            data=request_payload.get_spain_annual_acquistion_terminated_user_payload
        )
        ...
        get_extension_field_values >> get_timesheet_for_date2 >>\
        ...
        update_end_date >> get_user_annual_accrued_leaves >> set_termination_time_off_balance_policy >>\

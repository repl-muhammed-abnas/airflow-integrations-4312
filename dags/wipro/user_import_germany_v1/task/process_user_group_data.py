...
def create_prerequisite_data(config):
    with rail.TaskGroup(
        ...
        get_germany_parent_location_details = rail.RepliconServiceOperator(
            task_id="get_germany_parent_location_details",
        ...
        get_germany_schedule_policy = rail.RepliconServiceOperator(
            task_id="get_germany_schedule_policy",
        ...
        start_groups >> get_germany_parent_location_details>>\
            [
                ...
                get_all_cost_center,
                get_all_enabled_dept_list,
                get_germany_schedule_policy
            ] >> end_groups

from wipro.user_import_germany_v1.task import update_roles_for_user
    ...
    with rail.create_airflow_dag(
        ...
        get_current_location_for_the_user = rail.RepliconServiceOperator(
            ...
            data_handler=lambda response: {
                ...
                if response["departments"] else null
        ...
        update_user_details = rail.RepliconServiceOperator(
            ...
            data=lambda dag_run: request_payload.get_update_user_req(dag_run, config)
        )
        ...
        get_extension_field_values >> get_current_location_for_the_user >> update_user_details >>\
        if_supervisor_details_in_feed >> rail.Label("No") >> if_reversal_date_update
        if_supervisor_details_in_feed >> rail.Label("Yes") >>\
        get_effective_supervisor_of_user >> write_supervisor_pending_logs >> if_reversal_date_update

...
from wipro.user_import_germany_v1.task import set_balance_timeoff_for_user
...
def create_airflow_child(config):
    with rail.create_airflow_dag(
        ...
        if_company_code_changed = rail.IfOperator(
            ...
            yes_task="set_balance_to_for_user",
            no_task="if_reversal_date_present_or_active_user"
        )

        set_balance_to_for_user = rail.EmptyOperator(task_id="set_balance_to_for_user")

        set_balance_for_user = set_balance_timeoff_for_user.set_balance("add")
        ...
        if_new_entity_user >> rail.Label("No") >> process_add_user >> catch_and_log_errors
        ...
        set_balance_to_for_user >>\
        set_balance_for_user >> add_end_date_to_user >>\

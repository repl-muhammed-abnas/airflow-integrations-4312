...
def create_prerequisite_data(config):
    with rail.TaskGroup(
        ...
        get_austria_parent_location_details = rail.RepliconServiceOperator(
            task_id="get_austria_parent_location_details",
            ...
            data_handler=lambda response: response[0]["location"]["uri"]
        )
        ...
        get_education_custom_field_drop_down = rail.RepliconServiceOperator(
            task_id="get_education_custom_field_drop_down",
        ...
        get_austria_country_uri = rail.RepliconServiceOperator(
            task_id="get_austria_country_uri",
            endpoint="/services/ServiceCenterService1.svc/GetPageOfAvailableServiceCentersByTextSearch",
            data={
                    "page": "1",
                    "pageSize": "1",
                    "textSearch": {
            ...
            data_handler=lambda response: response[0]["serviceCenter"]["uri"]
        )
        ...
        get_austria_schedule_policy = rail.RepliconServiceOperator(
            task_id="get_austria_schedule_policy",
        ...
        get_austria_punch_policy = rail.RepliconServiceOperator(
            task_id="get_austria_punch_policy",
            endpoint="/services/PolicySetService1.svc/GetAllEnabledPolicySetsForPolicy",
            data={
        ...
        get_all_activities = rail.RepliconServiceOperator(
            ...
            data_handler=lambda response: list(map(lambda activity: rail.find_first_by_attr_and_get_attr(
                response, "displayText", activity, "uri"), config.GENERAL_MAPPER["activity_list"]))
        )
        ...
        start_groups >>\
            ...
            [
                ...
                get_austria_schedule_policy,
                get_austria_punch_policy,
                get_all_activities,
                get_all_departments
            ] >> end_groups

...
from wipro.user_import_saudi_arabia_v2.utils import custom_methods
import rail
null = None
true = "true"
false = "false"
...
def get_location_hierarchy_payload():
    return {
        ...
        "parentUri": rail.result("get_saudi_arabia_parent_location_details")
    }
...
def get_saudi_arabia_create_payload(dag_run):
    ...
    return {
        "user": {
            ...
            "supervisorAssignmentSchedule": {
                "initialSupervisor": {
                    "uri": dag_run.conf["supervisor_uri"],
                    "loginName": null,
                    "employeeId": null,
                    "parameterCorrelationId": null
                },
            } if dag_run.conf["supervisor_uri"] else null,
            "schedulePolicySchedule": [{
                "schedulePolicy": {
            ...
            "holidayCalendarAssignmentSchedule": null,
            "timeOffPolicy": null,
            "permissionSets": custom_methods.get_saudi_arabia_user_create_permissions(dag_run),
            "policySets": custom_methods.get_saudi_arabia_user_create_policy_sets(dag_run),
            "employeeType": null,
            ...
            "customFieldValues": custom_methods.get_saudi_arabia_user_create_custom_fields(dag_run),
            "assignedActivities": [],
            "timeZone":  {
            ...
            "locationSchedule": custom_methods.get_saudi_arabia_user_create_location(dag_run),
            "divisionSchedule": [
                {
                    "division": {
                        "uri": dag_run.conf["legalentityuri"],
            ...
            "policyDataAccessScopes": custom_methods.get_saudi_arabia_user_create_policy_data_access(dag_run),
            "payRuleScriptSchedule": custom_methods.get_saudi_arabia_user_payrule_script(dag_run) if dag_run.conf["payrule_uri"] else null,
            "displayNameParameter": {
            ...
            "extensionFieldValues": custom_methods.get_saudi_arabia_user_create_oefs(dag_run)
        }
    }
...
def get_update_user_req(dag_run):
  ...
  "modifications": {
    **get_basic_user_details_update(dag_run)[0],
    "locationSchedule":custom_methods.check_if_saudi_arabia_user_location_update(dag_run)[0],
    "extensionFields": custom_methods.get_extension_field_values_updates(dag_run)[0],
    "customFields": custom_methods.get_saudi_arabia_user_update_custom_fields(dag_run)[0],

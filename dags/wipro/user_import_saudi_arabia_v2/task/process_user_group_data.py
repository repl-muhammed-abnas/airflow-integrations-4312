...
def create_prerequisite_data(config):
    with rail.TaskGroup(
        ...
        get_saudi_arabia_parent_location_details = rail.RepliconServiceOperator(
            task_id="get_saudi_arabia_parent_location_details",
        ...
        get_all_ot_approval_paths = rail.RepliconServiceOperator(
            task_id="get_all_ot_approval_paths",
        ...
        get_saudi_arabia_schedule_policy = rail.RepliconServiceOperator(
            task_id="get_saudi_arabia_schedule_policy",
        ...
        start_groups >>\
        get_saudi_arabia_parent_location_details >>\
            [
                ...
                get_saudi_arabia_schedule_policy,
                get_all_departments
            ] >> end_groups

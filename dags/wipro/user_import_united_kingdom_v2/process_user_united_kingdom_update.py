from wipro.user_import_united_kingdom_v2.task import update_roles_for_user
...
def create_airflow_child(config):
    with rail.create_airflow_dag(
        ...
        if_supervisor_details_in_feed >> rail.Label("Yes") >>\
            get_supervisor_details_to_add >> get_effective_supervisor_of_user >> write_supervisor_pending_logs >>\

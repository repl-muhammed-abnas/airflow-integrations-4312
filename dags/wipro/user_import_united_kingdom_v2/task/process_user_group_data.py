...
def create_prerequisite_data(config):
    with rail.TaskGroup(
        ...
        get_united_kingdom_parent_location_details = rail.RepliconServiceOperator(
            task_id="get_united_kingdom_parent_location_details",
        ...
        get_united_kingdom_country_uri = rail.RepliconServiceOperator(
            task_id="get_united_kingdom_country_uri",
        ...
        get_uk_schedule_policy = rail.RepliconServiceOperator(
            task_id="get_uk_schedule_policy",
        ...
        get_all_paycode_data = rail.RepliconServiceOperator(
            task_id="get_all_paycode_data",
        ...
        start_groups >>\
            get_united_kingdom_parent_location_details >>\
            [
                ...
                get_all_policy_sets,
                get_united_kingdom_country_uri,
                ...
                get_uk_schedule_policy,
                get_all_paycode_data,
                get_all_departments
            ] >> end_groups

    ...
    with rail.create_airflow_dag(
        ...
        write_supervisor_employee_id_match_log = rail.WriteLogOperator(
            ...
            properties=lambda dag_run: {
                ...
                "status": "Exception",
                "details": "Supervisor not assigned as employee id same as supervisor id" if dag_run.conf["primary_supervisor_id"] else\
                "Supervisor not assigned as supervisor id is not available in the feed"
            }
        )

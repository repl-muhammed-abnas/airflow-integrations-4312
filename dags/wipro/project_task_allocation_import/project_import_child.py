...
import rail
from wipro.project_task_allocation_import.utils import custom_methods
    ...
    with rail.create_airflow_dag(
        ...
        has_any_valid_users >> rail.Label(
            "Yes") >> map_user_details_with_feed >> create_final_valid_data_collection >> query_distict_projects >>\
                get_project_last_modified_date_udf >> get_all_employeetypes >> process_each_projects >> log_project_details

...
def create_prerequisite_data():
    with rail.TaskGroup(
        ...
        get_netherlands_parent_location_details = rail.RepliconServiceOperator(
            task_id="get_netherlands_parent_location_details",
        ...
        start_groups >>\
        get_netherlands_parent_location_details>>\
            [

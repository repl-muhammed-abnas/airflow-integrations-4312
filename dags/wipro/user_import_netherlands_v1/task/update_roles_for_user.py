...
from wipro.user_import_netherlands_v1.task import put_supervisor_table_settings
import rail
...
def update_user_roles(config):
    with rail.TaskGroup(
        group_id="update_netherlands_user_roles",
        ...
        if_hr_manager_permission_update = rail.IfOperator(
            ...
            dag_run.conf["hr_manager_flg"] == "Y" and
        ...
        if_primary_manager_permission_update = rail.IfOperator(
            ...
            dag_run.conf["primary_manager_flg"] == "Y" and dag_run.conf["project_manager_flg"] != "Y"  and
            not (rail.find_first_by_attr_and_get_attr(
                    rail.result('get_update_user_details')["permissionSets"],
                    "displayText",
        ...
        if_project_manager_permission_update = rail.IfOperator(
            ...
            dag_run.conf["project_manager_flg"] == "Y" and not rail.find_first_by_attr_and_get_attr(
                ...
                "uri") and not rail.find_first_by_attr_and_get_attr(
                rail.result("get_update_user_details")["permissionSets"],
                "displayText",
        ...
        put_table_view_setting_for_user_update_pm = put_supervisor_table_settings.get_put_table_view_setting_supervisor(
            user_uri, "supervisor","Y"
        )
        ...
        if_project_manager_permission_update >> rail.Label("Yes") >>\
            assign_project_manager_permission >> put_table_view_setting_for_user_update_pm >>\
            get_manager_permission >>\
            if_any_manager_update >> rail.Label("Yes") >>\
            assign_manager_permissions >> restrict_hr_manager_policy_access >> user_role_update_end

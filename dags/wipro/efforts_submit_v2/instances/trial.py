...
from wipro.efforts_submit_v2.config import *
from wipro.efforts_submit_v2.country_mapper.country_mapper_list import country_list_trial
from wipro.efforts_submit_v2.country_mapper.query_mapper_for_country import query_mapper_for_contry_trial

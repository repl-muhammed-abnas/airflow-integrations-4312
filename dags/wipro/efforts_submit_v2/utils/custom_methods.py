...
# for trial instance
from wipro.efforts_submit_v2.country_mapper.ot_code_country_mapper import ot_code_country_list_trial
# for prod instnace
from wipro.efforts_submit_v2.country_mapper.ot_code_country_mapper import ot_code_country_list_prod
DEFAULT_PAYLOAD = {
            "Empid": "",
            "Subty": "",
            "Workdate": "",
...
def get_oncall_projects(instance):
    ...
    if instance in ['production']:
        ...
        proj_entry_data["IT_ONCALL1"] = list(map(lambda data: {
                ...
                "Hours": data["report_hours"] if data.get("report_hours") else data["hours_current"],
            }, distinct_projects)
        )

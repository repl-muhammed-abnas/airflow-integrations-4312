...
import rail
from wipro.project_user_assignment_v2.utils.custom_methods import get_dagruns_to_process, do_format_logs
        ...
        send_import_complete_email = rail.EmailOperator(
            ...
            bcc="{%- if result('format_logs', key='error_record_count') == 0 -%}\
                ...
                {%- else -%}\
                    "+config.alert_email+"\
                {%- endif -%}",
            subject='{{ get_company_key() + " | Replicon Project user assignment is - " }} \

...
def create_prerequisite_data(config):
    with rail.TaskGroup(
        ...
        get_spain_parent_location_details = rail.RepliconServiceOperator(
            task_id="get_spain_parent_location_details",
        ...
        get_spain_schedule_policy = rail.RepliconServiceOperator(
            task_id="get_spain_schedule_policy",
        ...
        start_groups >>\
        get_spain_parent_location_details>>\
            [

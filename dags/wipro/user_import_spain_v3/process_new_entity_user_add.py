...
def create_airflow_child(config):
    with rail.create_airflow_dag(
        ...
        create_spain_user = rail.RepliconServiceOperator(
            ...
            data=lambda dag_run:request_payload.get_new_entity_user_create_payload(dag_run, config.USER_TEMPLATE_NAME),
        ...
        end_table_setting >> if_no_gender >> rail.Label(
            "Yes") >> remove_all_time_off_types >> write_added_user_logs

...
def create_aiflow_child(config):
    with rail.create_airflow_dag(
        ...
        if_user_is_enabled = rail.IfOperator(
            ...
            test=lambda:bool(rail.result("get_supervisor_user_details")[0]["userDetails"]["isEnabled"]),
        ...
        start_supervisor_table_settings = rail.EmptyOperator(task_id="start_supervisor_table_settings")

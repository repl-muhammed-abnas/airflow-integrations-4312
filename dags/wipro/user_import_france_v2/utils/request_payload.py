...
def get_location_hierarchy_payload():
    return {
      ...
      "parentUri": rail.result("get_france_parent_location_details")
    }
...
def get_france_create_payload(dag_run):
    ...
    return {
        "user": {
            ...
            "department": null,
            "supervisorAssignmentSchedule": null,
            "schedulePolicySchedule": custom_methods.get_france_user_create_schedule_policy(dag_run),
            ...
            "holidayCalendarAssignmentSchedule": null,
            "timeOffPolicy": null,
            "permissionSets": custom_methods.get_france_user_create_permissions(dag_run),
            "policySets": custom_methods.get_france_user_create_policy_sets(dag_run),
            "employeeType": null,
            ...
            "customFieldValues": custom_methods.get_france_user_create_custom_fields(dag_run),
            "assignedActivities": [],
            "timeZone":  {
            ...
            "locationSchedule": custom_methods.get_france_user_create_location(dag_run),
            "divisionSchedule": [
                {
                    "division": {
                        "uri": dag_run.conf["legalentityuri"],
            ...
            "policyDataAccessScopes": custom_methods.get_france_user_create_policy_data_access(dag_run),
            "payRuleScriptSchedule": custom_methods.get_france_user_payrule_script(dag_run),
            "displayNameParameter": {
            ...
            "extensionFieldValues": custom_methods.get_france_user_create_oefs(dag_run)
        }
    }


def get_france_annual_acquistion_payload(dag_run):
    effective_date = rail.parse_date(
        dag_run.conf["date_of_joining"], "%Y-%m-%d")
    return {
        "timeOffAccount": {
            "userUri": rail.result("create_france_user") or rail.result("get_user_details")["userDetails"]["uri"],
                            ...
                            "additionalParameters": [
                                {
                                    ...
                                    "value": {
                                        "number": balance[dag_run.conf["country"].lower()][str(effective_date["month"])]
                                    }
                                },
                                {
                                    "keyUri": "urn:replicon:script-key:parameter:precedence",
                    ...
                    "timeOffValidationScripts": [
                        {
                            ...
                            "additionalParameters": [
                            {
                                ...
                                "value": {
                                "text": "FR - Congé annuel | Annual Leave"
                                }
                            }
                            ]
                        }
...
def get_france_annual_acquistion_terminated_user_payload(dag_run):
...
def get_add_end_date_to_tranferred_user_payload(dag_run):
    company_code = rail.find_first_by_attr_and_get_attr(
                        ...
                        "uri",
                        rail.result("get_user_details")["divisionSchedule"][0]["division"]["uri"],
                        "code")
    ...
    payload = {
        ...
        "filterExpression": {
            ...
            "rightExpression": {
                ...
                "rightExpression": {
                    "value": {
                        # the country URI will always be of France
                        "uri":  dag_run.conf["countryuri"],
                        "uris": [],
                    },
                    "filterDefinitionUri": null
...
def get_update_user_req(dag_run):
    ...
    "modifications": {
        **get_basic_user_details_update(dag_run)[0],
        "locationSchedule":custom_methods.check_if_france_user_location_update(dag_run)[0],
        "extensionFields": custom_methods.get_extension_field_values_updates(dag_run)[0],
        "customFields": custom_methods.get_france_user_update_custom_fields(dag_run)[0],

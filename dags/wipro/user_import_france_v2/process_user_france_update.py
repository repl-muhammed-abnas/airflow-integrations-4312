...
from wipro.user_import_france_v2.task import update_roles_for_user, set_balance_timeoff_for_user
...
def create_airflow_child(config):
    with rail.create_airflow_dag(
        ...
        get_extension_field_values >>  get_hr_manager_belongs_to_france >>\

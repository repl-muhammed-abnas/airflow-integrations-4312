...
def create_prerequisite_data():
    with rail.TaskGroup(
        ...
        get_france_parent_location_details = rail.RepliconServiceOperator(
            task_id="get_france_parent_location_details",
        ...
        get_france_country_uri = rail.RepliconServiceOperator(
            task_id="get_france_country_uri",
        ...
        start_groups >>\
        get_france_parent_location_details >>\
            [

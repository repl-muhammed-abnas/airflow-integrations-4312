"""
iPipeline JIRA Time Import - PRODUCTION Instance Configuration
"""
# Inherit all default configuration
from ipipeline.time_import_v1.config import *
...
master_dag_interval = "30 1 * * *" # At 01:30 AM EDT every day

...
from ipipeline.user_import.mappers import (input_fields_mapper, permissions_mapper,
                                           oef_custom_mapper, time_off_type_mapper, defaults_mapper, assignment_rules_mapper)
...
# SFTP File Paths - UAT (using uat paths for uat environment)
input_filepath = '/iPipeline/Dev/User Sync'
archive_filepath = '/iPipeline/Dev/User Sync/Archive/'
log_filepath = '/iPipeline/Dev/User Sync/Logs/'

reference_filepath = '/iPipeline/Dev/User Sync/Reference/'
archive_reference_filepath = '/iPipeline/Dev/User Sync/Reference/Archive/'

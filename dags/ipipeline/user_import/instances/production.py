from ipipeline.user_import.config import *
from ipipeline.user_import.mappers import (input_fields_mapper, permissions_mapper, oef_custom_mapper, time_off_type_mapper, defaults_mapper, assignment_rules_mapper)
...
sftp_conn_id = 'sftp_ipipeline_705935'

# SFTP File Paths - Prod (using uat paths for prod environment)
input_filepath = '/iPipeline/Prod/User Sync'
archive_filepath = '/iPipeline/Prod/User Sync/Archive/'
log_filepath = '/iPipeline/Prod/User Sync/Logs/'

reference_filepath = '/iPipeline/Prod/User Sync/Reference/'
archive_reference_filepath = '/iPipeline/Prod/User Sync/Reference/Archive/'

...
import rail
from four_impact.invoice_export import request_payload
...
def create_dag(config):
    with rail.create_airflow_dag(
        dag_id=f"4impact_invoice_export_child_{config.instance}",
        description=f'4Impact Invoice Export Child {config.instance}',

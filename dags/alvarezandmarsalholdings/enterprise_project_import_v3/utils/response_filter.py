...
from alvarezandmarsalholdings.enterprise_project_import_v3.utils.request_payload import get_updated_task_details
    ...
    def add_child_task(child_tasks, parent, parent_taskcode):
        for child_task in child_tasks:
            ...
            if child_task['childTasks']:
                add_child_task(child_task['childTasks'], child_task['task']['full_task_name'], child_task['task']['code'])

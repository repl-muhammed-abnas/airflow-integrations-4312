...
import rail
from alvarezandmarsalholdings.time_export.time_export_s4hc_v1.utils import custom_methods
...
def create_main_dag(config):
    with rail.create_airflow_dag(
        ...
        has_any_blank_emp_id >> rail.Label("No") >> query_valid_records >> trigger_post_to_api >> \

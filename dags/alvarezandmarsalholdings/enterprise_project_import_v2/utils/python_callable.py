...
import uuid
import rail
from alvarezandmarsalholdings.enterprise_project_import_v2.utils.request_payload import MANDATORY_FIELDS, get_updated_task_details
...
def batch_resources(data_dict, batch_size=200):
...
def get_add_remove_resource(dag_run, instance):
    ...
    response['resource_to_add'] = batch_resources(
        resources_to_add, 

...
from alvarezandmarsalholdings.enterprise_project_import_v2.task.process_project_manager import process_project_manager_task_group
from alvarezandmarsalholdings.enterprise_project_import_v2.task.add_update_tasks import get_task_added_or_updated
...
def create_child_dag(config):
    ...
    with rail.create_airflow_dag(
        ...
        process_remove_resource >> wait_process_remove_resource >> process_add_resource
        process_add_resource >> wait_process_add_resource >> get_valid_hierarchy_tasks >> \

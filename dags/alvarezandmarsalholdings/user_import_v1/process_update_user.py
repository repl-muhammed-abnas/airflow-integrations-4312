...
import rail
import json
from alvarezandmarsalholdings.user_import_v1.utils import request_payload, custom_methods
    ...
    for idx in range(0, config.BATCH_COUNT):
        ...
        with rail.create_airflow_dag(
            ...
            if_user_exists_in_replicon = rail.IfOperator(
                ...
                yes_task='if_worker_subtype_is_regular',
            ...
            get_user_details >> if_user_exists_in_replicon >> rail.Label(
                'Yes') >> if_worker_subtype_is_regular

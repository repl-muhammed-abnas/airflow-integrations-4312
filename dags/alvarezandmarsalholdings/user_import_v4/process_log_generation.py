...
import rail
from alvarezandmarsalholdings.user_import_v4.utils.custom_methods import do_format_logs


def create_child_dag(config):
    with rail.create_airflow_dag(
        dag_id=config.process_log_generation_dag_id,
        description=f'{config.company_key} User Import - Process Log Generation',

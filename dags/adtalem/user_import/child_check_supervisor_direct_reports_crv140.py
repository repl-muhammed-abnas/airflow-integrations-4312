...
def create_supervisordirectreport_child_dag(config):
    with rail.create_airflow_dag(
        dag_id=f'adtalem_userimport_check_supervisor_direct_reports_crv14.0_{config.instance}',
        description=f'Adtalem Check Supervisor direct reports_CR14.0 {config.instance}',

...
def create_childdag_put_balance(config):
    with rail.create_airflow_dag(
        dag_id=f'adtalem_userimport_put_0_balance_15days_terminationdate_crv2.0_{config.instance}',
        description=f'Adtalem Put 0 balance (15days+terminationdate) Production CRV2.0 {config.instance}',

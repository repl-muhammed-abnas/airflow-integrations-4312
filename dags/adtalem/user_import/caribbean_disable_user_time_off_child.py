...
def create_disableuser_timeoff_child_dag(config):
    with rail.create_airflow_dag(
        dag_id=f'adtalem_userimport_caribbean_child_disable_user_time_off_{config.instance}',
        description=f'Adtalem Carribean Disable User - Time Off_Prod {config.instance}',
        ...
        is_assignedtimeoffs = rail.IfOperator(
            ...
            no_task='process_terminationdate'
        )
        ...
        trigger_child_put_0_balance_15days_terminationdate_crv20 = rail.TriggerDagRunForEachItemOperator(
            ...
            trigger_dag_id=f'adtalem_userimport_caribbean_child_put_0_balance_15days_terminationdate_{config.instance}',
        ...
        process_terminationdate = rail.EmptyOperator(
            task_id='process_terminationdate',
        )
        ...
        is_assignedtimeoffs >> rail.Label(
            ...
            process_terminationdate
        is_assignedtimeoffs >> rail.Label(
            'No') >> process_terminationdate

        process_terminationdate >> is_terminationdate_present

...
from adtalem.user_import.utils.request_payload import get_put_timeoffpolicywithinitialbalance
...
def create_child_put_0_balance_dag(config):
    with rail.create_airflow_dag(
        dag_id=f'adtalem_userimport_caribbean_child_put_0_balance_{config.instance}',
        description=f'Adtalem Carribean Put 0 balance Prod {config.instance}',

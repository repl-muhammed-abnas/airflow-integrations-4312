...
def create_childdag_put_balance(config):
    with rail.create_airflow_dag(
        dag_id=f'adtalem_userimport_put_0_balance_16days_terminationdate_crv14.0_{config.instance}',
        description=f'Adtalem Put 0 balance (16days+terminationdate)_CR14.0 {config.instance}',

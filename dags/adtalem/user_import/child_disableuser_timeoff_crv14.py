...
def create_disableuser_timeoff_child_dag(config):
    with rail.create_airflow_dag(
        dag_id=f'adtalem_userimport_child_disable_user_timeoff_crv14.0_{config.instance}',
        description=f'Disable User - Time Off CR 14.0 {config.instance}',
        ...
        is_assignedtimeoffs = rail.IfOperator(
            ...
            yes_task='trigger_child_put_0_balance_16days_terminationdate_crv140',
            no_task='is_terminationdate_present'
        )

        trigger_child_put_0_balance_16days_terminationdate_crv140 = rail.TriggerDagRunForEachItemOperator(
            task_id='trigger_child_put_0_balance_16days_terminationdate_crv140',
            retries=0,
            items=lambda: rail.result('get_assigned_timeoffuri_list'),
            trigger_dag_id=f'adtalem_userimport_put_0_balance_16days_terminationdate_crv14.0_{config.instance}',
        ...
        wait_for_completion_trigger_child_put_0_balance_16days_terminationdate_crv140 = rail.WaitForDagRunsSensor(
            task_id='wait_for_completion_trigger_child_put_0_balance_16days_terminationdate_crv140',
            execution_timeout=timedelta(days=config.execution_timeout_days),
            dag_runs='{{ result("trigger_child_put_0_balance_16days_terminationdate_crv140") }}'
        )
        ...
        is_assignedtimeoffs >> rail.Label(
            'Yes') >> trigger_child_put_0_balance_16days_terminationdate_crv140 >> \
            wait_for_completion_trigger_child_put_0_balance_16days_terminationdate_crv140 >> \

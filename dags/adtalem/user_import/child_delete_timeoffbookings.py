...
def create_delete_timeoff_booking(config):
    with rail.create_airflow_dag(
        dag_id=f'adtalem_userimport_child_delete_timeoffbookings_{config.instance}',
        description=f'Adtalem Delete time off bookings Child_V1.0 {config.instance}',
                ...
                "filterExpression": {
                    "leftExpression": {
                        ...
                        "rightExpression": {
                            "value": {
                                "dateRange": {
                                    "startDate": get_datetime_obj(dag_run.conf['enddate'])
                                }
                            }
                        }
                    },
...
rail.for_each_instance(create_delete_timeoff_booking)

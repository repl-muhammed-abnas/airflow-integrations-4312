...
from incyte_biosciences_international_sarl.user_import_v1.utils.python_callable_methods import do_format_logs
...
def create_child_dag(config):
    with rail.create_airflow_dag(
        ...
        description='IBIS - User Import - Process Log Generation',

...
from incyte_biosciences_international_sarl.user_import.tasks.process_supervisor import process_supervisor_assignment_task_group
...
def create_child_dag(config):
    with rail.create_airflow_dag(
        ...
        has_any_error_present_rehire_user = rail.IfOperator(
            task_id="has_any_error_present_rehire_user",
            test="{{ result('gather_time_off_type_error_logs_rehire_user') | is_truthy }}",
            yes_task= 'log_error_present_rehire_user',
            no_task='log_user_completion'
        )

        log_error_present_rehire_user = rail.EmptyOperator(
            task_id='log_error_present_rehire_user'
        )
        ...
        is_supervisor_in_feed_file >> rail.Label('No') >> is_user_rehire
        ...
        wait_for_process_time_off_type_assignment_rehire_user >> gather_time_off_type_error_logs_rehire_user
        gather_time_off_type_error_logs_rehire_user >> has_any_error_present_rehire_user >> rail.Label('No') >> log_user_completion
        has_any_error_present_rehire_user >> rail.Label('Yes') >> log_error_present_rehire_user >> catch_and_log_errors

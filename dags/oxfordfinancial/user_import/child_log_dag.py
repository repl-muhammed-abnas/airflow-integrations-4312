...
def create_child_log(config):
    with rail.create_airflow_dag(
        dag_id=f'oxfordfinancial_user_import_child_log_{config.instance}',
        description=f'OxfordFinancial User Import Log Generation {config.instance}',
        ...
        send_import_complete_email = rail.EmailOperator(
            ...
            files=[
                ('Userimport.csv', "{{ result('render_logs_csv') }}")]
        )
...
rail.for_each_instance(create_child_log)

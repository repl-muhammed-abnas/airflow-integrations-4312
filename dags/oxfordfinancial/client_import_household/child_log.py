...
def create_child_process_log_pregeneration(config):
    with rail.create_airflow_dag(
        dag_id=f'oxfordfinancial_client_import_household_child_log_{config.instance}',
        description=f'OxfordFinancial Client Import Household Log Generation {config.instance}',

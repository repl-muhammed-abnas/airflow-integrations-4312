...
from procore_ce_integration.change_orders_sync.instances.farris import webhook_dag_id as budget_revision_webhook_dag_id, budget_revision_events_key
from procore_ce_integration.ap_invoice_sync.instances.farris import ap_invoice_main_dag_id as ap_invoice_dag_id, ap_invoice_events_key
from procore_ce_integration.vendors_sync.instances.farris import vendor_webhook_dag_id

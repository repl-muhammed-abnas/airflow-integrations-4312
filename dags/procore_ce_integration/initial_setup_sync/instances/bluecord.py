...
from procore_ce_integration.change_orders_sync.instances.bluecord import webhook_dag_id as budget_revision_webhook_dag_id, budget_revision_events_key
from procore_ce_integration.subcontract_change_order_sync.instances.bluecord import webhook_processing_dag_id as change_order_webhook_dag_id, change_order_events_key
from procore_ce_integration.job_structure_sync.instances.bluecord import webhook_processing_dag_id as job_webhook_dag_id, job_structure_events_key
from procore_ce_integration.ap_invoice_sync.instances.bluecord import ap_invoice_main_dag_id as ap_invoice_dag_id, ap_invoice_events_key
from procore_ce_integration.purchase_order_sync.instances.bluecord import webhook_dag_id as purchase_order_dag_id, purchase_order_events_key
from procore_ce_integration.subcontract_sync.instances.bluecord import webhook_processing_dag_id as subcontract_webhook_dag_id, subcontract_events_key

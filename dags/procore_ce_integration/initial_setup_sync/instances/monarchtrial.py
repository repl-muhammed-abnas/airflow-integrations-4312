...
from procore_ce_integration.subcontract_change_order_sync.instances.monarchtrial import webhook_processing_dag_id as change_order_webhook_dag_id, change_order_events_key
from procore_ce_integration.job_structure_sync.instances.monarchtrial import webhook_processing_dag_id as job_webhook_dag_id, job_structure_events_key
from procore_ce_integration.purchase_order_sync.instances.monarchtrial import webhook_dag_id as purchase_order_dag_id, purchase_order_events_key
from procore_ce_integration.vendors_sync.instances.monarchtrial import vendor_webhook_dag_id

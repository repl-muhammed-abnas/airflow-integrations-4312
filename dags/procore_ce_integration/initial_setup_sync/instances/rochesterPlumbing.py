...
from procore_ce_integration.change_orders_sync.instances.rochesterPlumbing import webhook_dag_id as budget_revision_webhook_dag_id, budget_revision_events_key
from procore_ce_integration.subcontract_change_order_sync.instances.rochesterPlumbing import webhook_processing_dag_id as change_order_webhook_dag_id, change_order_events_key
...
webhook_subscriptions = [
    ...
    },
    {
        ...
        'api_version': 'v2',
        'triggers': [
            {'resource_name': 'Change Order Packages', 'event_type': event_type}
            for event_type in ['create', 'update']
        ],

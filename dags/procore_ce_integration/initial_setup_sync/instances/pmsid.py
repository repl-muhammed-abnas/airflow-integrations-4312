...
from procore_ce_integration.change_orders_sync.instances.pmsid import webhook_dag_id as budget_revision_webhook_dag_id, budget_revision_events_key
from procore_ce_integration.subcontract_change_order_sync.instances.pmsid import webhook_processing_dag_id as change_order_webhook_dag_id, change_order_events_key
from procore_ce_integration.job_structure_sync.instances.pmsid import webhook_processing_dag_id as job_webhook_dag_id, job_structure_events_key
from procore_ce_integration.productivity_unit_sync.instances.pmsid import webhook_dag_id as productivity_unit_dag_id, productivity_unit_events_key
from procore_ce_integration.purchase_order_sync.instances.pmsid import webhook_dag_id as purchase_order_dag_id, purchase_order_events_key
from procore_ce_integration.ar_invoice_sync.instances.pmsid import ar_invoice_main_dag_id as ar_invoice_dag_id, ar_invoice_events_key
from procore_ce_integration.ap_invoice_sync_v2.instances.pmsid import webhook_dag_id as ap_invoice_dag_id, ap_invoice_events_key, ap_invoice_failed_events_key
from procore_ce_integration.subcontract_sync.instances.pmsid import webhook_processing_dag_id as subcontract_webhook_dag_id, subcontract_events_key
from procore_ce_integration.vendors_sync.instances.pmsid import vendor_webhook_dag_id
...
webhook_subscriptions = [
    ...
    },
    {
        ...
        's3_files': [ap_invoice_events_key, ap_invoice_failed_events_key]
    },
    {

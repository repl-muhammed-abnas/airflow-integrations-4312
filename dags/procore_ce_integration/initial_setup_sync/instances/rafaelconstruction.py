...
from procore_ce_integration.change_orders_sync.instances.rafaelconstruction import webhook_dag_id as budget_revision_webhook_dag_id, budget_revision_events_key
from procore_ce_integration.purchase_order_sync.instances.rafaelconstruction import webhook_dag_id as purchase_order_dag_id, purchase_order_events_key
from procore_ce_integration.subcontract_change_order_sync.instances.rafaelconstruction import webhook_processing_dag_id as change_order_webhook_dag_id, change_order_events_key
from procore_ce_integration.subcontract_sync.instances.rafaelconstruction import webhook_processing_dag_id as subcontract_webhook_dag_id, subcontract_events_key

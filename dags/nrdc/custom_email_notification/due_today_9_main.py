...
def create_dag(config):
    with rail.create_airflow_dag(
        dag_id=f'nrdc_custom_email_notification_due_today_9am_master_{config.instance}',
        description=f'NRDC Custom Email Notification Due Today 9AM Master {config.instance}',
        company_key=config.company_key,
        replicon_conn_id=config.replicon_conn_id,
        schedule_interval=config.schedule_interval_due_today_9,

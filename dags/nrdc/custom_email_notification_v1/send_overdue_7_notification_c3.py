...
def create_dag(config):
    with rail.create_airflow_dag(
        dag_id=config.overdue_7_send_mail_c3_dagid,
        description=f'NRDC Custom Email Notification Overdue 7 Send mail c3{config.instance}',
        ...
        get_email_body = rail.RenderTemplateOperator(
            ...
            template_file='templates/overdue_7_notification/c3_notification_email.html',
            target='result',
        )

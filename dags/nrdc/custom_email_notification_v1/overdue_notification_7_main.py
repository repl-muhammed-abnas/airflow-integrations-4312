...
def create_dag(config):
    with rail.create_airflow_dag(
        dag_id=config.overdue_7_notification_master_dagid,
        description=f'NRDC Custom Email Notification Overdue 7th Notification Master {config.instance}',
        company_key=config.company_key,
        replicon_conn_id=config.replicon_conn_id,
        schedule_interval=config.schedule_interval_overdue_notification_7,
        start_date=dt(2024, 1, 1, tz=config.et_timezone),
        max_active_runs=config.max_active_run
    ) as dag:

        # Runs on day 3, checks for timesheets due on day 1 of current month
        ...
        trigger_send_overdue_7_notification_c4 = rail.trigger_parallel_dagrun(
            task_id='trigger_send_overdue_7_notification_c4',
            trigger_dag_id=config.overdue_7_send_mail_c4_dagid,
        ...
        trigger_send_overdue_7_notification_c3 = rail.trigger_parallel_dagrun(
            task_id='trigger_send_overdue_7_notification_c3',
            trigger_dag_id=config.overdue_7_send_mail_c3_dagid,
        ...
        create_collection_user_list_replicon >> query_get_unique_list_of_emails_c4 >> trigger_send_overdue_7_notification_c4 >>\
        query_get_unique_list_of_emails_c3 >> trigger_send_overdue_7_notification_c3 >> finish

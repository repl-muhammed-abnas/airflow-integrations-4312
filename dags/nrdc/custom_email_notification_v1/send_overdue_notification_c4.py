...
def create_dag(config):
    with rail.create_airflow_dag(
        dag_id=config.overdue_send_mail_c4_dagid,
        description=f'NRDC Custom Email Notification Overdue Send mail c4{config.instance}',
        ...
        get_email_body = rail.RenderTemplateOperator(
            ...
            template_file='templates/overdue_notification/c4_notification_email.html',
            target='result',
        )

...
from nrdc.user_import_v2.utils.custom_method import c3_c4_supervisors_loginname
null = None
    ...
    with rail.create_airflow_dag(
        ...
        trigger_dag_run_live_nrdc_update_rehire_disable_user_basic_profile26 = rail.TriggerDagRunForEachItemOperator(
            ...
            conf=lambda dag_run: {
                ...
                # "manager": "zakhter",
                "manager": rail.result('c3_c4_supervisors')['c4_supervisor'],
        ...
        if_request_currentprofilecount_equals_to_7_36 = rail.IfOperator(
            ...
            test='{{ dag_run.conf.currentprofilecount == 3 }}',
        ...
        query_list_whereexistingprimaryprofilevalueis_c4or_delegate_47 = rail.QueryCollectionOperator(
            ...
            query="""SELECT * FROM  existinguserdata WHERE existinguserdata.type = 'Lobbying Timesheet' OR existinguserdata.type = 'C4' OR  existinguserdata.type='Delegate'""",
        )
        ...
        def get_primary_user_info(task_name):
            ...
            return primary_profiles[0] if primary_profiles else None
        ...
        query_list_whereexistingprimaryprofilevalueis_delegate_149 = rail.QueryCollectionOperator(
            ...
            query="SELECT * FROM  existinguserdata WHERE existinguserdata.type = 'Lobbying Timesheet' OR existinguserdata.type='Delegate' OR existinguserdata.type = 'C4'",
        )
        ...
        gather_user_uri_184 = rail.GatherResultsFromDagRunsOperator(
            task_id='gather_user_uri_184',
            dag_runs="{{ result('trigger_dag_run_live_nrdc_basic_add_update184')}}",
            dagrun_task_id='log_useruri_71',
            flatten=True
        )
        ...
        gather_user_uri_195 = rail.GatherResultsFromDagRunsOperator(
            task_id='gather_user_uri_195',
            dag_runs="{{ result('trigger_dag_run_live_nrdc_basic_add_update195')}}",
            dagrun_task_id='log_useruri_71',
            flatten=True
        )

        def get_user_uri_basic_add_task_196():
            user_uri_184 = rail.result('gather_user_uri_184')[
                0] if rail.result('gather_user_uri_184') else None
            user_uri_186 = rail.result('log_useruribasedonthesuffix_186')
            user_uri_195 = rail.result('gather_user_uri_195')[
                0] if rail.result('gather_user_uri_195') else None
            return user_uri_184 or user_uri_186 or user_uri_195
        ...
        update_variable_196 = rail.SetVariableOperator(
            ...
            name='{{ result("declare_variable_150").name }}',
            # pylint: disable=line-too-long
            value=get_user_uri_basic_add_task_196
        )
        ...
        def create_c3_c4_list(login_task):
            return [{
                "loginname": rail.result(login_task) if rail.result(login_task).endswith('lt') else rail.result(login_task) + "lt",
                "type": "Lobbying Timesheet",
                "timesheetpolicy": "C3 Lobbying Timesheet",
        ...
        trigger_dag_run_live_nrdc_update_rehire_disable_user_basic_profile221 = rail.TriggerDagRunForEachItemOperator(
            ...
            execution_timeout=timedelta(days=14),
            conf=lambda dag_run: {
                "firstname": rail.result('foreach_declare_list_208_214')['firstname'],
                "lastname": dag_run.conf['displayname'],
                "emailaddress": dag_run.conf['emailaddress'],
                "employeeid": dag_run.conf['employeeid'],
                "empnumber": dag_run.conf['empnumber'],
        ...
        if_log_uriuser_215_blank_228 = rail.IfOperator(
            ...
            test='''{{ result('getuserdata_203')[0].username | matches('Fund') | is_truthy and result('foreach_declare_list_208_214').type == 'Lobbying Timesheet' }}''',
        ...
        if_declare_variable_41_value_equals_to_7_232 = rail.IfOperator(
            ...
            test=lambda: rail.get_dag_run_var(
                rail.result('declare_variable_41')['name']) == 3,
        ...
        gather_user_uri_264 = rail.GatherResultsFromDagRunsOperator(
            task_id='gather_user_uri_264',
            dag_runs="{{ result('trigger_dag_run_live_nrdc_basic_add_update264')}}",
            dagrun_task_id='log_useruri_71',
            flatten=True
        )
        ...
        gather_user_uri_275 = rail.GatherResultsFromDagRunsOperator(
            task_id='gather_user_uri_275',
            dag_runs="{{ result('trigger_dag_run_live_nrdc_basic_add_update275')}}",
            dagrun_task_id='log_useruri_71',
            flatten=True
        )

        def get_user_uri_basic_add_task_276():
            user_uri_264 = rail.result('gather_user_uri_264')[
                0] if rail.result('gather_user_uri_264') else None
            user_uri_266 = rail.result('log_useruribasedonthesuffix_266')
            user_uri_275 = rail.result('gather_user_uri_275')[
                0] if rail.result('gather_user_uri_275') else None
            return user_uri_264 or user_uri_266 or user_uri_275
        ...
        update_variable_276 = rail.SetVariableOperator(
            ...
            name='{{ result("declare_variable_234").name }}',
            # pylint: disable=line-too-long
            value=get_user_uri_basic_add_task_276
        )
        ...
        if_login_name_textvalue_equals_to_datalogger38faa588messagell_335 = rail.IfOperator(
            ...
            test=lambda: is_login_matching_335(),
        ...
        query_list_whereexistingprimaryprofilevalueis_delegate_386 = rail.QueryCollectionOperator(
            ...
            query="""SELECT * FROM  existinguserdata WHERE  existinguserdata.type='Delegate' OR existinguserdata.type='C4' OR existinguserdata.type='Lobbying Timesheet'""",
        )
        ...
        def create_c3_c4_list1(login_task):
            return [{
                "loginname": rail.result(login_task),
                "type": "Lobbying Timesheet",
                "timesheetpolicy": "C3 Lobbying Timesheet",
                "firstname":"C3 Lobbying Timesheet"
            }]
        ...
        get_c3_c4_list_397 = rail.PythonOperator(
            ...
            python_callable=lambda:  create_c3_c4_list1(
        ...
        trigger_dag_run_live_nrdc_update_rehire_disable_user_basic_profile409 = rail.TriggerDagRunForEachItemOperator(
            ...
            conf=lambda dag_run: {
                ...
                "whencreated": dag_run.conf['whencreated'],
                "office": dag_run.conf['office'],
                "logonname": dag_run.conf['logonname']+"lt",
                "accountstatus": dag_run.conf['accountstatus'],
                "department": dag_run.conf['department'],
                "memberof": dag_run.conf['memberof'],
                "manager": dag_run.conf['manager'],
        ...
        trigger_dag_run_live_nrdc_basic_add_update417 = rail.TriggerDagRunForEachItemOperator(
            ...
            execution_timeout=timedelta(days=14),
            conf=lambda dag_run: {
                "firstname": rail.result('foreach_declare_list_396_402')['firstname'],
                "lastname": dag_run.conf['displayname'],
                "emailaddress": dag_run.conf['emailaddress'],
                # pylint: disable=line-too-long
                "empid": dag_run.conf['employeeid'] if dag_run.conf['employeeid'] and not '-' in dag_run.conf['employeeid'] else dag_run.conf['logonname'].split('@')[0],
        ...
        if_first_type_present_delegate_429 = rail.IfOperator(
            ...
            test="{{ result('get_first_records_from_query_429') | is_truthy }}",
        ...
        if_first_type_present_c4_435 = rail.IfOperator(
            ...
            test="{{ result('get_first_records_from_query_434').type | is_truthy and result('log_primaryprofileloginname_427') | is_truthy}}",
        ...
        if_request_currentprofilecount_equals_to_5_only_c4_c3to_c4_c36profiles_438 = rail.IfOperator(
            ...
            # pylint: disable=line-too-long
            test='''{{ dag_run.conf.currentprofilecount == 1  and dag_run.conf.memberof | matches('C4')  and dag_run.conf.memberof | matches('C3')  and dag_run.conf.memberof | matches('Delegate') | is_falsy and result("create_list_14")[0].type | matches('C4') }}''',
        ...
        log_loginnamefromemailprimaryprofile_441 = rail.PythonOperator(
            ...
            # pylint: disable=line-too-long
            python_callable=lambda: get_user_from_list_by_type(
                'Lobbying Timesheet', 'create_list_14')
        )
        ...
        log_loginnameprimaryold_446 = rail.PythonOperator(
            ...
            python_callable=lambda:  rail.result(
                'log_loginnamefromemailprimaryprofile_441') + "af" if rail.result('log_loginnamefromemailprimaryprofile_441') else ""
        )
        ...
        if_search_users_447_users_less_than_1_448 = rail.IfOperator(
            ...
            test="{{result('search_users_447') | length == 0 and result('log_loginnamefromemailprimaryprofile_441') | is_truthy}}",
        ...
        trigger_dag_run_live_nrdc_basic_add_update449 = rail.TriggerDagRunForEachItemOperator(
            ...
            conf=lambda dag_run: {
                ...
                "whencreated": dag_run.conf['whencreated'],
                "office": dag_run.conf['office'],
                "loginname": rail.result('log_loginnamefromemailprimaryprofile_441')+"af",
                "department": dag_run.conf['department'],
                "memberof": dag_run.conf['memberof'],
                "manager": dag_run.conf['manager'],
                "title": dag_run.conf['title'],
        ...
        updatetoprimaryprofile_set_s_s_o_authentication_for_user_455 = rail.RepliconServiceOperator(
            ...
            data={
                ...
                "loginName": "{{ result('log_loginnamefromemailprimaryprofile_441') }}"+"af"
            }
        )
        ...
        if_log_substituteuserassigned_473_blank_474 = rail.IfOperator(
            ...
            test='''{{ result('log_substituteuserassigned_473') | is_truthy  }}''',
        ...
        insert_to_user_dag_run_list_471 = rail.SetVariableOperator(
            ...
            # pylint: disable=line-too-long
            value='{{(result("trigger_dag_run_live_nrdc_assign_substitute_usersv2477"))[0]}}'
        )
        ...
        log_loginnamefromemailprimaryprofile_479 = rail.PythonOperator(
            ...
            # pylint: disable=line-too-long
            python_callable=lambda dag_run:  get_user_from_list_by_type(
                dag_run.conf['currenttype'][0], 'create_list_14')
        )

        log_userurimainprofile_480 = rail.PythonOperator(
            task_id='log_userurimainprofile_480',
            # pylint: disable=line-too-long
            python_callable=lambda dag_run:  get_user_uri_from_list_by_type(
                dag_run.conf['currenttype'][0], 'create_list_14')
        )
        ...
        if_log_userurimainprofile_480_present_482 = rail.IfOperator(
            ...
            test=lambda dag_run: rail.result('log_userurimainprofile_480') and dag_run.conf['currenttype'][0] == 'Lobbying Timesheet',
        ...
        updateuserloginname_set_replicon_authentication_for_user_483 = rail.RepliconServiceOperator(
            ...
            data={
                ...
                "loginName": "{{ result('log_loginnamefromemailprimaryprofile_479') }}" + "lt",
                "password": "Replicon@12",
                "forcePasswordChangeOnLoginOption": "urn:replicon:force-password-change-on-login:enable"
            }
        )
        ...
        log_loginnameprimaryold_488 = rail.PythonOperator(
            ...
            python_callable=lambda:  rail.result(
                'log_loginnamefromemailprimaryprofile_479')
        )
        ...
        if_request_memberof_contains_delegate_only_delegate_505 = rail.IfOperator(
            ...
            test='''{{ dag_run.conf.memberof | matches('Delegate') and result("log_loginnamefromemailprimaryprofile_479") | is_truthy }}''',
        ...
        if_foreach_3157e122_545_type_not_equals_to_federallegislative_546 = rail.IfOperator(
            ...
            test='''{{ result('foreach_accumulate_list_items_16_545').type == 'Lobbying Timesheet' }}''',
        ...
        if_request_currentprofilecount_equals_to_5_c3_c4to_c4_c3and_delegate7profiles_548 = rail.IfOperator(
            ...
            # pylint: disable=line-too-long
            test='''{{ dag_run.conf.currentprofilecount == 1  and dag_run.conf.memberof | matches('C3')  and dag_run.conf.memberof | matches('C4')  and dag_run.conf.memberof | matches('Delegate') }}''',
        ...
        trigger_dag_run_live_nrdc_basic_add_update561 = rail.TriggerDagRunForEachItemOperator(
            ...
            conf=lambda dag_run: {
                ...
                "whencreated": dag_run.conf['whencreated'],
                "office": dag_run.conf['office'],
                "loginname": rail.result('log_loginnameprimarynewd_558'),
                "department": dag_run.conf['department'],
                "memberof": dag_run.conf['memberof'],
                "manager": dag_run.conf['manager'],
                "title": dag_run.conf['title'],
        ...
        gather_user_uri_561 = rail.GatherResultsFromDagRunsOperator(
            task_id='gather_user_uri_561',
            dag_runs="{{ result('trigger_dag_run_live_nrdc_basic_add_update561')}}",
            dagrun_task_id='log_useruri_71',
            flatten=True
        )
        ...
        gather_user_uri_573 = rail.GatherResultsFromDagRunsOperator(
            task_id='gather_user_uri_573',
            dag_runs="{{ result('trigger_dag_run_live_nrdc_basic_add_update573')}}",
            dagrun_task_id='log_useruri_71',
            flatten=True
        )

        def get_user_uri_basic_add_task_574():
            user_uri_561 = rail.result('gather_user_uri_561')[
                0] if rail.result('gather_user_uri_561') else None
            user_uri_563 = rail.result('log_useruribasedonthesuffix_563')
            user_uri_573 = rail.result('gather_user_uri_573')[
                0] if rail.result('gather_user_uri_573') else None
            return user_uri_561 or user_uri_563 or user_uri_573
        ...
        update_variable_primaryprofileuri_574 = rail.SetVariableOperator(
            ...
            # pylint: disable=line-too-long
            value=get_user_uri_basic_add_task_574
        )
        ...
        if_request_currentprofilecount_equals_to_5_delegate_c3to_delegate_c36profiles_601 = rail.IfOperator(
            ...
            # pylint: disable=line-too-long
            test='''{{ dag_run.conf.currentprofilecount == 1  and dag_run.conf.memberof | matches('Delegate')  and dag_run.conf.memberof | matches('C3')  and dag_run.conf.memberof | matches('C4') | is_falsy }}''',
        ...
        updateuserloginname_set_replicon_authentication_for_user_607 = rail.RepliconServiceOperator(
            ...
            data={
                ...
                "loginName": "{{ result('log_loginnameforprimaryprofile_604') }}lt",
                "password": "Replicon@12",
                "forcePasswordChangeOnLoginOption": "urn:replicon:force-password-change-on-login:enable"
            }
        )
        ...
        if_request_currentprofilecount_equals_to_6_only_c4_c3_c4toonly_c41profiles_701 = rail.IfOperator(
            ...
            # pylint: disable=line-too-long
            test='''{{ dag_run.conf.currentprofilecount == 2  and dag_run.conf.memberof | matches('C4')  and dag_run.conf.memberof | matches('C3') | is_falsy }}''',
        ...
        if_request_currentprofilecount_equals_to_6_c3_delegatetoonly_delegate1profiles_707 = rail.IfOperator(
            ...
            # pylint: disable=line-too-long
            test='''{{ dag_run.conf.currentprofilecount == 2  and dag_run.conf.memberof | matches('Delegate')  and dag_run.conf.memberof | matches('C3') | is_falsy }}''',
        ...
        if_request_currentprofilecount_equals_to_6_o_n_l_y_c3_c3_c4to_c35profiles_delegate_c3to_c3_713 = rail.IfOperator(
            ...
            # pylint: disable=line-too-long
            test='''{{ dag_run.conf.currentprofilecount == 2  and dag_run.conf.memberof | matches('C3')  and dag_run.conf.memberof | matches('C4') | is_falsy  and dag_run.conf.memberof | matches('Delegate') | is_falsy }}''',
        ...
        if_foreach_3157e122_720_type_equals_to_federallegislative_731 = rail.IfOperator(
            ...
            test='''{{ result('foreach_accumulate_list_items_16_720').type == 'Lobbying Timesheet' }}''',
        ...
        if_foreach_3157e122_720_type_not_equals_to_federallegislative_735 = rail.IfOperator(
            ...
            # pylint: disable=line-too-long
            test='''{{ result('foreach_accumulate_list_items_16_720').type != 'Lobbying Timesheet'  and result('foreach_accumulate_list_items_16_720').type != 'C4'  and result('foreach_accumulate_list_items_16_720').type != 'Delegate' }}''',
        ...
        insert_to_user_dag_run_list_720 = rail.SetVariableOperator(
            ...
            # pylint: disable=line-too-long
            value='{{ (result("trigger_dag_run_live_nrdc_assign_substitute_usersv2741")[0] if result("trigger_dag_run_live_nrdc_assign_substitute_usersv2741")[0] is not None else []) | to_json }}'
        )
        ...
        wait_for_completion_trigger_dag_run_live_nrdc_assign_substitute_usersv2741 = rail.WaitForDagRunsSensor(
            ...
            execution_timeout=timedelta(days=14),
            dag_runs='{{ result("declare_list_update_dag_runs_720").value | to_json }}'
        )
        ...
        if_request_currentprofilecount_equals_to_7_c3_c4anddelegatetodelegate1profiles_742 = rail.IfOperator(
            ...
            # pylint: disable=line-too-long
            test='''{{ dag_run.conf.currentprofilecount == 3  and dag_run.conf.memberof | matches('Delegate')  and dag_run.conf.memberof | matches('C3') | is_falsy  and dag_run.conf.memberof | matches('C4') | is_falsy }}''',
        ...
        if_request_currentprofilecount_equals_to_7_c3_c4and_delegateto_c35profiles_748 = rail.IfOperator(
            ...
            # pylint: disable=line-too-long
            test='''{{ dag_run.conf.currentprofilecount == 3  and dag_run.conf.memberof | matches('C3')  and dag_run.conf.memberof | matches('C4') | is_falsy  and dag_run.conf.memberof | matches('Delegate') | is_falsy }}''',
        ...
        if_foreach_3157e122_753_type_equals_to_federallegislative_761 = rail.IfOperator(
            ...
            test='''{{ result('foreach_accumulate_list_items_16_753').type == 'Lobbying Timesheet' }}''',
        ...
        if_foreach_3157e122_753_type_not_equals_to_federallegislative_765 = rail.IfOperator(
            ...
            # pylint: disable=line-too-long
            test='''{{ result('foreach_accumulate_list_items_16_753').type != 'Lobbying Timesheet'  and result('foreach_accumulate_list_items_16_753').type != 'Delegate'  and result('foreach_accumulate_list_items_16_753').type != 'C4' }}''',
        ...
        if_request_currentprofilecount_equals_to_7_c4c3and_delegateto_c3_c4profile6profiles_772 = rail.IfOperator(
            ...
            # pylint: disable=line-too-long
            test='''{{ dag_run.conf.currentprofilecount == 3  and dag_run.conf.memberof | matches('C4')  and dag_run.conf.memberof | matches('Delegate') | is_falsy  and dag_run.conf.memberof | matches('C3') }}''',
        ...
        if_first_type_present_delegate_776 = rail.IfOperator(
            ...
            test='''{{ result('get_first_records_from_query_775').type == 'Delegate' }}''',
        ...
        if_request_currentprofilecount_equals_to_7_c4c3and_delegateto_c4profile1profiles_796 = rail.IfOperator(
            ...
            # pylint: disable=line-too-long
            test='''{{ dag_run.conf.currentprofilecount == 3  and dag_run.conf.memberof | matches('C4')  and dag_run.conf.memberof | matches('Delegate') | is_falsy  and dag_run.conf.memberof | matches('C3') | is_falsy }}''',
        ...
        if_request_currentprofilecount_equals_to_7_delegate_c4_c3to_delegate_c3profiles6profiles_814 = rail.IfOperator(
            ...
            # pylint: disable=line-too-long
            test='''{{ dag_run.conf.currentprofilecount == 3  and dag_run.conf.memberof | matches('Delegate')  and dag_run.conf.memberof | matches('C4') | is_falsy  and dag_run.conf.memberof | matches('C3') }}''',
        ...
        if_request_currentprofilecount_equals_to_7_c3_c4anddelegatetodelegateandc42profiles_820 = rail.IfOperator(
            ...
            # pylint: disable=line-too-long
            test='''{{ dag_run.conf.currentprofilecount == 3  and dag_run.conf.memberof | matches('Delegate')  and dag_run.conf.memberof | matches('C3') | is_falsy  and dag_run.conf.memberof | matches('C4') }}''',
        ...
        c3_c4_supervisors >> declare_variable_3 >> if_request_memberof_not_contains_c4_4
        ...
        if_request_department_blank_7 >> rail.Label(
            'Yes') >> nrdc_user_import_logs_add_entry_8 >> stop_9 >> catch_and_log_errors
        if_request_department_blank_7 >> rail.Label(
        ...
        if_search_users_182_users_less_than_1_183 >> rail.Label(
            ...
            wait_for_completion_trigger_dag_run_live_nrdc_basic_add_update184 >> gather_user_uri_184 >> if_search_users_182_users_greater_than_0_185
        if_search_users_182_users_less_than_1_183 >> rail.Label(
        ...
        if_log_useruribasedonthesuffix_186_blank_194 >> rail.Label(
            'Yes') >> trigger_dag_run_live_nrdc_basic_add_update195 >> wait_for_completion_trigger_dag_run_live_nrdc_basic_add_update195 >> gather_user_uri_195 >> update_variable_196
        if_log_useruribasedonthesuffix_186_blank_194 >> rail.Label(
        ...
        if_search_users_262_users_less_than_1_263 >> rail.Label(
            ...
            wait_for_completion_trigger_dag_run_live_nrdc_basic_add_update264 >> gather_user_uri_264 >> if_search_users_262_users_greater_than_0_265
        if_search_users_262_users_less_than_1_263 >> rail.Label(
        ...
        if_log_useruribasedonthesuffix_266_blank_274 >> rail.Label(
            'Yes') >> trigger_dag_run_live_nrdc_basic_add_update275 >> wait_for_completion_trigger_dag_run_live_nrdc_basic_add_update275 >> gather_user_uri_275 >> update_variable_276
        if_log_useruribasedonthesuffix_266_blank_274 >> rail.Label(
        ...
        if_search_users_559_users_less_than_1_560 >> rail.Label(
            ...
            wait_for_completion_trigger_dag_run_live_nrdc_basic_add_update561 >> gather_user_uri_561 >> if_search_users_559_users_greater_than_0_562
        if_search_users_559_users_less_than_1_560 >> rail.Label(
        ...
        if_log_useruribasedonthesuffix_563_blank_572 >> rail.Label(
            ...
            wait_for_completion_trigger_dag_run_live_nrdc_basic_add_update573 >> gather_user_uri_573 >> update_variable_primaryprofileuri_574
        if_log_useruribasedonthesuffix_563_blank_572 >> rail.Label(
        ...
        foreach_accumulate_list_items_16_823 >> foreach_accumulate_list_items_16_823_end >> catch_and_log_errors
        if_declare_variable_41_value_equals_to_2_822 >> rail.Label(

...
import itertools
from nrdc.user_import_v2.utils import custom_method
...
def create_dag(config):
    ...
    with rail.create_airflow_dag(
        ...
        query_list_togettheusercurrentcountifenabled_55 = rail.QueryCollectionOperator(
            ...
            # pylint: disable=line-too-long
            query="SELECT * FROM  userdata WHERE LOWER( userdata.emailnotification)='{{ result('foreach_query_list_userstobe_updated_32_39').emailaddress }}' AND  userdata.userstatus='Enabled' AND userdata.type IN ('Lobbying Timesheet','C4','Delegate')",
        )
        ...
        query_list_togettheusercurrentcountifdisabled_62 = rail.QueryCollectionOperator(
            ...
            # pylint: disable=line-too-long
            query="SELECT * FROM  userdata WHERE LOWER(userdata.emailnotification)='{{ result('foreach_query_list_userstobe_updated_32_39').emailaddress }}' AND  userdata.userstatus='Disabled' AND userdata.type IN ('Lobbying Timesheet','C4','Delegate')",
        )

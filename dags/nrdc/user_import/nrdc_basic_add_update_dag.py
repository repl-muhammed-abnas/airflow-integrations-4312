...
def create_dag(config):
    ...
    with rail.create_airflow_dag(
        dag_id=f'nrdc_basicaddupdate_{config.instance}',
        ...
        can_run_batch_task = rail.IfOperator(
            ...
            yes_task='batch_task',
            no_task='log_startdate_4'
        )

        batch_task = rail.BatchTaskRunOperator(
            task_id='batch_task',
            start_task='log_startdate_4',
        ...
        log_a_u_t_h_t_o_k_e_n_83 = rail.PythonOperator(
            ...
            python_callable=lambda:  list(filter(
                lambda item: item['name'] == "AUTHTOKEN", rail.result('impersonate_and_create_interactive_session_82')))
        )
        ...
        can_run_batch_task >> rail.Label('No') >> log_startdate_4
        log_startdate_4 >> if_request_firstname_blank_5

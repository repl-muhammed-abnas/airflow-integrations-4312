...
def create_dag(config):
    ...
    with rail.create_airflow_dag(
        dag_id=f'nrdc_updaterehiredisableuserbasicprofile_{config.instance}',
        ...
        log_forlookuplogs_21 = rail.PythonOperator(
            ...
            python_callable=lambda dag_run:  "Latname updated to" +
        ...
        log_forlookuplogs_28 = rail.PythonOperator(
            ...
            python_callable=lambda dag_run:  'Employee number updated to' +
        ...
        nrdc_user_import_logs_add_entry_78 = rail.WriteLogOperator(
            ...
            properties={
                ...
                "action": "Update User",
                "status": "Error",
                "details": "User Not Updated #{_('data.catch.catch_77') }}|{{ dag_run_ecid() }}",
                "jobId": "{{ dag_run_ecid() }}"
            }
        )
        ...
        if_userdetails_isenabled_is_true_enabled_66 >> rail.Label(
            'No') >> log_forlogs_73
        if_request_accountstatus_equals_to_disabled_65 >> rail.Label(
            'No') >> log_forlogs_73 >> log_removingblankspaces_74 >> if_log_removingblankspaces_74_present_75

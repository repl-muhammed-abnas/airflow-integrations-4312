...
def create_dag(config):
    ...
    with rail.create_airflow_dag(
        ...
        nrdc_user_import_logs_add_entry_6 = rail.WriteLogOperator(
            ...
            severity="Error",
            properties={
                "user": "{{ dag_run.conf.firstname }}|{{ dag_run.conf.lastname }}",
                "status": "Error",
        ...
        nrdc_user_import_logs_add_entry_9 = rail.WriteLogOperator(
            ...
            properties={
                ...
                "status": "Error",
                "details": "Add User - Email address must be provided",
                "action": "Add",
                "jobId": "{{ dag_run_ecid() }}"
            }
        )
        ...
        nrdc_user_import_logs_add_entry_12 = rail.WriteLogOperator(
            ...
            properties={
                "user": "{{ dag_run.conf.firstname }}|{{ dag_run.conf.lastname }}|{{ dag_run.conf.emailaddress }}",
                "status": "Error",
                "details": "Add User - Department must be provided",
                "action": "Add",
                "jobId": "{{ dag_run_ecid() }}"
            }
        )
        ...
        nrdc_user_import_logs_add_entry_15 = rail.WriteLogOperator(
            ...
            properties={
                "user": "{{ dag_run.conf.firstname }}|{{ dag_run.conf.lastname }}|{{ dag_run.conf.emailaddress }}",
                "status": "Error",
                "details": "Add User - Logon name must be provided",
                "action": "Add",
                "jobId": "{{ dag_run_ecid() }}"
            }
        )
        ...
        nrdc_user_import_logs_add_entry_20 = rail.WriteLogOperator(
            ...
            properties={
                "user": "{{ dag_run.conf.firstname }}|{{ dag_run.conf.lastname }}|{{ dag_run.conf.emailaddress }}",
                "status": "Exception",
                "details": "Login name already exists.",
                "action": "Add",
                "jobId": "{{ dag_run_ecid() }}"
            }
        )
        ...
        insert_to_list_type_61 = rail.SetVariableOperator(
            ...
            value={
                ...
                "dropDownOption": {
                    "name": "{{ dag_run.conf.type if dag_run.conf.type != 'C3' else 'Lobbying Timesheet' }}"
                }
            }
        )
        ...
        put_user2_66 = rail.RepliconServiceOperator(
            ...
            data=lambda dag_run: {
                "user": {
                    ...
                    "emailAddress": dag_run.conf['emailaddress'] if dag_run.conf['is_primary'] else None,
        ...
        put_user2_70 = rail.RepliconServiceOperator(
            ...
            data=lambda dag_run: {
                "user": {
                    ...
                    ] if dag_run.conf['timesheettype'] and dag_run.conf['timesheettype'] not in ("NA", "na", "No Timesheet") else [],
                    "timesheetPeriodTypeUri": null,
                    "costRateSchedule": null,
                    "payrollRateSchedule": null,
                    "defaultBillingRate": null,
        ...
        log_useruri_71 = rail.PythonOperator(
            ...
            python_callable=lambda dag_run: {
                "uri": get_created_user_uri('put_user2_70'),
        ...
        log_forlookuplogs_72 = rail.PythonOperator(
            ...
            python_callable=lambda:  '''User profile created successfully'''
        )
        ...
        if_log_t_y_p_edropdownoption_uri_74_present_75 = rail.IfOperator(
            ...
            test='''{{ result('log_t_y_p_edropdownoption_uri_74') | is_truthy and result('log_useruri_71').uri | is_truthy }}''',
        ...
        update_dropdown_value_76 = rail.RepliconServiceOperator(
            ...
            data={
                "objectUri": "{{ result('log_useruri_71').uri }}",
                "customFieldUri": "{{ result('log_u_d_f_uri_type_32') }}",
        ...
        if_request_locationuri_present_78 = rail.IfOperator(
            ...
            test='''{{ dag_run.conf.locationuri | is_truthy  and dag_run.conf.locationuri | matches('urn') and result('log_useruri_71').uri | is_truthy }}''',
        ...
        put_location_schedule_for_user_79 = rail.RepliconServiceOperator(
            ...
            data={
                "userUri": "{{ result('log_useruri_71').uri }}",
                "scheduleEntries": [
                    {
                        "location": {
                            "uri": "{{ dag_run.conf.locationuri }}",
        ...
        impersonate_and_create_interactive_session_82 = rail.RepliconServiceOperator(
            ...
            data={
                "impersonatedUserUri": "{{ result('log_useruri_71').uri }}"
            }
        )
        ...
        trigger_dag_run_live_nrdc_assign_substitute_usersv284 = rail.TriggerDagRunForEachItemOperator(
            ...
            conf=lambda dag_run: {
                ...
                "actualuri": rail.result('log_useruri_71')['uri'],
        ...
        nrdc_user_import_logs_add_entry_103 = rail.WriteLogOperator(
            ...
            properties={
                ...
                "action": "Add",
                "status": "Success",
                "details": "{{ result('log_forlookuplogs_100') }}",
                "jobId": "{{ dag_run_ecid() }}"
            }
        )
        ...
        if_log_t_y_p_edropdownoption_uri_74_present_75 >> rail.Label(
            'Yes') >> update_dropdown_value_76 >> if_request_locationuri_present_78
        if_log_t_y_p_edropdownoption_uri_74_present_75 >> rail.Label(
            'No') >> if_request_locationuri_present_78
        if_request_locationuri_present_78 >> rail.Label(
            'Yes') >> put_location_schedule_for_user_79 >> \

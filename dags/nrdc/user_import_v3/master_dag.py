...
import itertools
from nrdc.user_import_v3.utils import custom_method
...
def create_dag(config):
    ...
    with rail.create_airflow_dag(
        dag_id=config.nrdc_userimport_master,
        ...
        foreach_query_list_userstobe_updated_32_39 = rail.ForEachOperator(
            ...
            start_task='declare_variable_40',
        ...
        query_list_togettheusercurrentcountifenabled_55 = rail.QueryCollectionOperator(
            ...
            # pylint: disable=line-too-long
            query="SELECT * FROM  userdata WHERE LOWER( userdata.emailnotification)=LOWER('{{ result('foreach_query_list_userstobe_updated_32_39').logonname }}') AND  userdata.userstatus='Enabled' AND userdata.type IN ('Lobbying Timesheet','C4','Delegate')",
        )
        ...
        #change - rail.load_all_records(document)
        ...
        def get_user_informations(category, task_name):
            user_profiles = rail.load_all_records(rail.result(task_name))
        ...
        query_list_togettheusercurrentcountifdisabled_62 = rail.QueryCollectionOperator(
            ...
            # pylint: disable=line-too-long
            query="SELECT * FROM  userdata WHERE LOWER(userdata.emailnotification)=LOWER('{{ result('foreach_query_list_userstobe_updated_32_39').logonname }}') AND  userdata.userstatus='Disabled' AND userdata.type IN ('Lobbying Timesheet','C4','Delegate')",
        )
        ...
        def is_current_user_1():
            ...
            return bool(int(current_user_count) == 1)
            ...
            c3_c4_data.append(
                {
                    ...
                    "leaveofabsence": rail.result('foreach_query_list_userstobe_updated_32_39')['leaveofabsence'],
        ...
        trigger_dag_run_live_nrdc_updating_c3_c4_valuesasync_69 = rail.TriggerDagRunForEachItemOperator(
            ...
            trigger_dag_id=config.nrdc_updating_c3_c4_values,
        ...
        if_declare_variable_40_value_equals_to_3_76 = rail.IfOperator(
            task_id='if_declare_variable_40_value_equals_to_3_76',
            test=lambda: int(rail.get_dag_run_var(
                rail.result('declare_variable_40')['name'])) == 3,
            yes_task="trigger_dag_run_live_nrdc_updating_c3_c4_valuesasync_77",
            no_task="if_declare_variable_40_value_equals_to_4_78",
        )
        ...
        if_declare_variable_40_value_equals_to_4_78 = rail.IfOperator(
            task_id='if_declare_variable_40_value_equals_to_4_78',
            # test="{{ result('declare_variable_40').value == 3  or result('declare_variable_40').value == 4 }}",
            # pylint: disable=line-too-long
            test=lambda: int(rail.get_dag_run_var(rail.result('declare_variable_40')['name'])) not in [1,2,3],
        ...
        def get_triggered_run_update_list():
            user_process_update_dag_runs = rail.get_dag_run_var('user_process_update_dag_runs')
            trigger_dag_run_name_list = ['trigger_dag_run_live_nrdc_updating_c3_c4_valuesasync_69', 'trigger_dag_run_live_nrdc_updating_c3_c4_valuesasync_71', 'trigger_dag_run_live_nrdc_updating_c3_c4_valuesasync_73', 'trigger_dag_run_live_nrdc_updating_c3_c4_valuesasync_75', 'trigger_dag_run_live_nrdc_updating_c3_c4_valuesasync_77']

            for trigger_name in trigger_dag_run_name_list:
                if rail.result(trigger_name) and rail.result(trigger_name)[0] not in user_process_update_dag_runs:
                    return rail.result(trigger_name)[0]
            return None
        ...
        insert_to_user_update_dag_run_list = rail.SetVariableOperator(
            ...
            # pylint: disable=line-too-long
            value=get_triggered_run_update_list
        )
        ...
        wait_for_completion_trigger_dag_run_live_nrdc_updating_c3_c4_valuesasync = rail.WaitForDagRunsSensor(
            ...
            execution_timeout=timedelta(days=14),
            dag_runs='{{ dag_run_var("user_process_update_dag_runs") | to_json }}'
        )
        ...
        if_users_available_to_create_82 = rail.IfOperator(
            ...
            yes_task="declare_list_dag_runs",
        ...
        foreach_query_list_userstobe_created_33_82 = rail.ForEachOperator(
            ...
            start_task='declare_variable_83',
        ...
        def get_location_uri():
            ...
            location_list = rail.result('location_list_info')
            location_info = list(
                filter(lambda x: x['name'].lower() == logon_name.lower(), location_list))
            location_uri = location_info[0]['uri'] if location_info else None
            return location_uri
            ...
            add_user_data.append(
                {
                    ...
                    "leaveofabsence": rail.result('foreach_query_list_userstobe_created_33_82')['leaveofabsence'],
        ...
        get_add_user_data = rail.PythonOperator(
            ...
            python_callable=lambda: get_add_user_details("C3 Only", rail.result('c3_c4_supervisors')['c3_supervisor'])
        )
        ...
        trigger_dag_run_live_nrdc_add_user_v2async_93 = rail.TriggerDagRunForEachItemOperator(
            ...
            retries=0,
            items=lambda: get_add_user_details("C3 Only", rail.result('c3_c4_supervisors')['c3_supervisor']),
            trigger_dag_id=config.nrdc_add_user_v2,
            execution_timeout=timedelta(days=14),
        ...
        trigger_dag_run_live_nrdc_add_user_v2async_95 = rail.TriggerDagRunForEachItemOperator(
            ...
            retries=0,
            items=lambda: get_add_user_details("C4", rail.result('c3_c4_supervisors')['c4_supervisor']),
            trigger_dag_id=config.nrdc_add_user_v2,
            execution_timeout=timedelta(days=14),
            conf=lambda dag_run, item: {
                "firstname": item['firstname'],
        ...
        trigger_dag_run_live_nrdc_add_user_v2async_99 = rail.TriggerDagRunForEachItemOperator(
            ...
            retries=0,
            items=lambda: get_add_user_details(
                "C4 and C3", f"{rail.result('c3_c4_supervisors')['c4_supervisor']}|{rail.result('c3_c4_supervisors')['c3_supervisor']}"),
            trigger_dag_id=config.nrdc_add_user_v2,
            execution_timeout=timedelta(days=14),
            conf=lambda dag_run, item: {
                "firstname": item['firstname'],
        ...
        trigger_dag_run_live_nrdc_add_user_v2async_101 = rail.TriggerDagRunForEachItemOperator(
            ...
            retries=0,
            items=lambda: get_add_user_details(
                "Delegate and 1", f"{rail.result('c3_c4_supervisors')['c4_supervisor']}|nosupervisor"),
            trigger_dag_id=config.nrdc_add_user_v2,
            execution_timeout=timedelta(days=14),
            conf=lambda dag_run, item: {
                "firstname": item['firstname'],
        ...
        trigger_dag_run_live_nrdc_add_user_v2async_103 = rail.TriggerDagRunForEachItemOperator(
            ...
            retries=0,
            items=lambda: get_add_user_details(
                "C3 and Delegate", f"{rail.result('c3_c4_supervisors')['c3_supervisor']}|nosupervisor"),
            trigger_dag_id=config.nrdc_add_user_v2,
            execution_timeout=timedelta(days=14),
            conf=lambda dag_run, item: {
                "firstname": item['firstname'],
        ...
        trigger_dag_run_live_nrdc_add_user_v2async_105 = rail.TriggerDagRunForEachItemOperator(
            ...
            retries=0,
            items=lambda: get_add_user_details(
                "Delegate and all", f"{rail.result('c3_c4_supervisors')['c4_supervisor']}|{rail.result('c3_c4_supervisors')['c3_supervisor']}"),
            trigger_dag_id=config.nrdc_add_user_v2,
            execution_timeout=timedelta(days=14),
            conf=lambda dag_run, item: {
                "firstname": item['firstname'],
        ...
        def get_triggered_run_list():
            user_process_dag_runs = rail.get_dag_run_var('user_process_dag_runs')
            trigger_dag_run_name_list = ['trigger_dag_run_live_nrdc_add_user_v2async_93', 'trigger_dag_run_live_nrdc_add_user_v2async_105', 'trigger_dag_run_live_nrdc_add_user_v2async_103', 'trigger_dag_run_live_nrdc_add_user_v2async_101', 'trigger_dag_run_live_nrdc_add_user_v2async_99', 'trigger_dag_run_live_nrdc_add_user_v2async_97', 'trigger_dag_run_live_nrdc_add_user_v2async_95']

            for trigger_name in trigger_dag_run_name_list:
                if rail.result(trigger_name) and rail.result(trigger_name)[0] not in user_process_dag_runs:
                    return rail.result(trigger_name)[0]
            return None
        ...
        wait_for_completion_trigger_dag_run_live_nrdc_add_user_v2async = rail.WaitForDagRunsSensor(
            ...
            execution_timeout=timedelta(days=14),
            dag_runs='{{ dag_run_var("user_process_dag_runs") | to_json }}'
        )
        ...
        send_import_complete_email = rail.EmailOperator(
            ...
            subject='{{ get_company_key() + " | Replicon User Import - " }} \
                ...
                {%- elif result("get_exception_logs", key="length") > 0 -%} \
        ...
        can_run_batch_task >> rail.Label(
            'No') >> c3_c4_supervisors >> log_today_4 >> get_time_for_file >> has_input_filename_ends_with_csv
        ...
        if_query_list_changedrecords_16_rows_greater_than_0_17 >> rail.Label(
            ...
            query_list_27 >> get_enabled_locations_29 >> location_list_info >> \
        ...
        report_has_data >> rail.Label(
            "Yes") >> load_report_data >> create_user_collection >> query_userdata >> declare_list_update_dag_runs >> query_report_user_has_data
        ...
        query_user_has_data >> rail.Label(
            'No') >> log_listsize_80
        query_user_has_data >> rail.Label(
            'Yes') >> foreach_query_list_userstobe_updated_32_39 >> declare_variable_40 >> declare_variable_41 >> \
        ...
        if_declare_variable_40_value_equals_to_2_74 >> rail.Label(
            'No') >> if_declare_variable_40_value_equals_to_3_76
        if_declare_variable_40_value_equals_to_3_76 >> rail.Label(
            'Yes') >> trigger_dag_run_live_nrdc_updating_c3_c4_valuesasync_77 >> \
            insert_to_user_update_dag_run_list >> foreach_query_list_userstobe_updated_32_39_end
        if_declare_variable_40_value_equals_to_3_76 >> rail.Label(
            'No') >> if_declare_variable_40_value_equals_to_4_78
        if_declare_variable_40_value_equals_to_4_78 >> rail.Label(
        ...
        if_users_available_to_create_82 >> rail.Label('Yes') >> declare_list_dag_runs >> foreach_query_list_userstobe_created_33_82 >> \
        declare_variable_83 >> log_location_uritoassign_85 >> \
        ...
        if_nrdc_user_import_logs_search_entries_108_entries_greater_than_0_109 >> rail.Label(
            'Yes') >> create_csv_lines_110 >> generate_downloadable_link >> get_errored_logs >> get_exception_logs \

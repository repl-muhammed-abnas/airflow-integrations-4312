    ...
    with rail.create_airflow_dag(
        ...
        nrdc_user_import_logs_add_entry_339 = rail.WriteLogOperator(
            ...
            properties={
                "user": "{{ dag_run.conf.firstname }}|{{ dag_run.conf.lastname }}|{{ dag_run.conf.emailaddress }}",
                "status": "Error",
                "details": "Error while creating the 1 or multiple user profiles. Error: {{ get_error_message() }}|{{ dag_run_ecid() }}",
                "action": "Add",
                "jobId": "{{ dag_run_ecid() }}"
            }
        )
        ...
        can_run_batch_task >> rail.Label('Yes') >> batch_task >> nrdc_user_import_logs_add_entry_339
        ...
        if_log_checkif_zara_aktheruserexisits_c4supervisot_68_present_271 >> rail.Label(
            'No') >> log_forlookuplogs_273 >> put_user2_lobby_timesheet_274 >> insert_to_list_275 >> if_request_locationuri_present_276
        ...
        if_d_uri_present_280 >> rail.Label(
            'Yes') >> log_forlookuplogs_281 >> log_t_y_p_e_lobby_timesheet_uri_282
        if_d_uri_present_280 >> rail.Label(
            'No') >> log_t_y_p_e_lobby_timesheet_uri_282 >> update_dropdown_value_283 >> \

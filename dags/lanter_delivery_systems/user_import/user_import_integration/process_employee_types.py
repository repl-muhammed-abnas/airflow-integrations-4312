...
from lanter_delivery_systems.user_import.user_import_integration.utils.response_filter import groups_filter
from lanter_delivery_systems.user_import.user_import_integration.utils.request_payload import get_add_employeetype_payload
...
def create_child_dag(config):
    with rail.create_airflow_dag(
        ...
        description='Lanter Delivery Systems User Import - Process Department',

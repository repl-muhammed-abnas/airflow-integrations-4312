...
def create_child_dag_wbs(config):
    with rail.create_airflow_dag(
        dag_id=config.processs_supervisor_dagid,
        description='Lanter Delivery Systems User Import - Process Supervisor',
        ...
        update_userlog_entries = rail.WriteLogOperator(
            ...
            properties=lambda item, dag_run: {
                ...
                'status': request_payload.get_supervisor_status(dag_run),
        ...
        is_supervisor_disabled >> rail.Label('No') >> is_new_user_supervisor_assignment

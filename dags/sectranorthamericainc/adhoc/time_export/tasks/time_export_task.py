import rail
from sectranorthamericainc.adhoc.time_export.utils import request_payload
from sectranorthamericainc.adhoc.time_export.utils.custom_methods import retrieve_export_uri
...
def time_data_export(
    ...
    with rail.TaskGroup(group_id=group_id):
        ...
        get_download_url >> download_export >> load_export >> catch_dataexport_error >> rail.Label("On Failure") >>\
            cancel_time_export >> fail_time_export

...
import rail
from sectranorthamericainc.adhoc.time_export.utils import custom_methods, request_payload
from sectranorthamericainc.adhoc.time_export.tasks.time_export_task import time_data_export
...
def create_main_dag(config):
    with rail.create_airflow_dag(
        ...
        get_logging_details = rail.PythonOperator(
            ...
            python_callable=lambda dag_run: custom_methods.get_time_export_name(config, dag_run)
        )

...
from sectranorthamericainc.adhoc.time_export.config import *
...
time_export_master_dag_id = f"sectranorthamericainc_time_export_master_{instance}_adhoc"
time_export_process_export_dag_id = f"sectranorthamericainc_time_export_process_users_per_timesheet_period_{instance}_adhoc"

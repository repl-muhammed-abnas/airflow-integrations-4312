...
import rail
from darkmattertechnologiesllc.user_sync_v1.utils.python_callable import get_all_group_data_from_replicon_filter
from darkmattertechnologiesllc.user_sync_v1.utils import request_payload


def create_child_dag(config):
    with rail.create_airflow_dag(
        dag_id=config.add_location_child_dagid,
        description=config.add_location_child_dagid,

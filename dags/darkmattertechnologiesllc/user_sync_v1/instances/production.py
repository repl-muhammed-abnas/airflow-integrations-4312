...
reference_filepath = '/Production/Import/User Sync/Reference/'
...
update_user_status_main_dagid = f"darkmattertechnologiesllc_usersync_user_status_update_master_{instance}_v1"
...
can_run_batch_task_var_name = f'darkmattertechnologiesllc_usersync_{instance}_v1_can_run_batch_task'
can_use_reference_file = f'darkmattertechnologiesllc_usersync_can_use_reference_file_{instance}_v1'

...
def create_dag(config):
    with rail.create_airflow_dag(
        dag_id=f'darkmattertechnologiesllc_usersync_process_groups_child_{config.instance}',
        description=f'darkmattertechnologiesllc_usersync_process_groups_child_{config.instance}',
        ...
        add_location_by_level = rail.TriggerDagRunForEachItemOperator(
            ...
            trigger_dag_id=f'darkmattertechnologiesllc_usersync_add_location_child_{config.instance}',
            conf=lambda item: {

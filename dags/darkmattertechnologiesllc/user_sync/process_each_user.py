...
import rail
from darkmattertechnologiesllc.user_sync.utils import request_payload, python_callable
from darkmattertechnologiesllc.user_sync.utils.request_payload import update_emp_date_for_disableuser

def create_dag(config):
    # pylint: disable=too-many-statements, line-too-long
    with rail.create_airflow_dag(
        dag_id=f'darkmattertechnologiesllc_usersync_process_each_user_child_{config.instance}',
        description=f'darkmattertechnologiesllc_usersync_process_each_user_child_{config.instance}',
        ...
        process_update_user = rail.TriggerDagRunOperator(
            ...
            trigger_dag_id=f'darkmattertechnologiesllc_usersync_update_user_child_{config.instance}',
        ...
        process_add_user = rail.TriggerDagRunOperator(
            ...
            trigger_dag_id=f'darkmattertechnologiesllc_usersync_add_user_child_{config.instance}',

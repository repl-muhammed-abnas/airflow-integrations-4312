...
def create_dag(config):
    ...
    with rail.create_airflow_dag(
        dag_id=f'darkmattertechnologiesllc_usersync_update_user_child_{config.instance}',
        description=f'darkmattertechnologiesllc_usersync_update_user_child_{config.instance}',

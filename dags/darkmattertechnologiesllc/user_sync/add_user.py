...
def create_dag(config):
    ...
    with rail.create_airflow_dag(
        dag_id=f'darkmattertechnologiesllc_usersync_add_user_child_{config.instance}',
        description=f'darkmattertechnologiesllc_usersync_add_user_child_{config.instance}',
        ...
        create_user >> supervisor_assignement_task >> log_adduser_success >> catch_and_log_error

...
def create_dag(config):
    ...
    with rail.create_airflow_dag(
        dag_id=f'darkmattertechnologiesllc_usersync_decrypting_files_{config.instance}',
        description=f'darkmattertechnologiesllc_usersync_decrypting_files_{config.instance}',
        ...
        upload_file_to_sftp = rail.SFTPUploadFileOperator(
            ...
            remote_filepath=config.input_filepath_master +  "/{{result('new_file_sensor') | file_name | replace('.csv.pgp','') }}" + ".csv"
        )

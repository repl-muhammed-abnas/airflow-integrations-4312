...
def create_child_dag(config):
    with rail.create_airflow_dag(
        ...
        description=f'Dark Matter Timeoff Sync Add Child {config.instance}',
        ...
        is_total_hours_positive = rail.IfOperator(
            ...
            test=lambda dag_run: float(dag_run.conf['total_units']) > 0.0,
        ...
        log_booking_add_successful = rail.WriteLogOperator(
            ...
            properties=lambda dag_run: {
                ...
                "status": "Success",
                "details": "Time Off {{ dag_run.conf.time_off_type }} is added successfully.",
            }
        )
        ...
        log_timeoff_is_not_valid = rail.WriteLogOperator(
            ...
            properties=lambda dag_run: {
                ...
                "time_off_date": dag_run.conf["time_off_date"],
                "status": "Skipped",
                "details": "Time Off {{ dag_run.conf.time_off_type }} is Invalid because total timeoff hours is {{ dag_run.conf.total_units }}.",
            }
        )

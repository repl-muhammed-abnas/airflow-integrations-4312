...
sftp_conn_id = 'sftp_darkmattertechnologiesllctrial01_649288'

input_filepath = '/Trial/Time off/Input'
log_filepath = '/Trial/Time off/Log'
archive_filepath = '/Trial/Time off/Archive'

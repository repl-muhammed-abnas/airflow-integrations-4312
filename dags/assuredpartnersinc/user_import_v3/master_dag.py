...
def create_dag(config):
    ...
    with rail.create_airflow_dag(
        ...
        if_delta_greater_than_deltavariance_38 = rail.IfOperator(
            ...
            no_task="trigger_dag_run_assured_partners_child_groups_update_v3_044",
        )
        ...
        if_delta_greater_than_deltavariance_38 >> rail.Label(
            'No') >> trigger_dag_run_assured_partners_child_groups_update_v3_044 >> wait_for_dag_run_assured_partners_child_groups_update \

...
def create_dag(config):
    ...
    with rail.create_airflow_dag(
        ...
        if_query_list_21_rows_greater_than_0_22 = rail.IfOperator(
            ...
            yes_task="trigger_dag_run_child_cost_center_add_v3_024",
            no_task="if_query_list_getallcostcentersnotin_replicon_20_rows_greater_than_0_27",
        )

        trigger_dag_run_child_cost_center_add_v3_024 = rail.TriggerDagRunForEachItemOperator(
            task_id='trigger_dag_run_child_cost_center_add_v3_024',
            retries=0,
        ...
        wait_dag_runs_child_cost_center_add = rail.WaitForDagRunsSensor(
            ...
            dag_runs="{{result('trigger_dag_run_child_cost_center_add_v3_024')}}",
            execution_timeout=timedelta(days=config.execution_timeout_days)
        )
        ...
        trigger_dag_run_child_cost_center_add_v3_033 = rail.TriggerDagRunForEachItemOperator(
            task_id='trigger_dag_run_child_cost_center_add_v3_033',
            retries=0,
        ...
        wait_for_completion_dag_run_child_cost_center_add_033 = rail.WaitForDagRunsSensor(
            ...
            execution_timeout=timedelta(days=config.execution_timeout_days),
            dag_runs='{{ result("trigger_dag_run_child_cost_center_add_v3_033") }}'
        )
        ...
        trigger_dag_run_child_department_add_v3_064 = rail.TriggerDagRunForEachItemOperator(
            task_id='trigger_dag_run_child_department_add_v3_064',
            retries=0,
        ...
        wait_for_completion_trigger_dag_run_child_department_add_064 = rail.WaitForDagRunsSensor(
            ...
            execution_timeout=timedelta(days=config.execution_timeout_days),
            dag_runs='{{ result("trigger_dag_run_child_department_add_v3_064") }}'
        )
        ...
        trigger_dag_run_assured_partners_child_location_add_v3_091 = rail.TriggerDagRunForEachItemOperator(
            task_id='trigger_dag_run_assured_partners_child_location_add_v3_091',
            retries=0,
        ...
        wait_for_completion_trigger_dag_run_assured_partners_child_location_add_v3_091 = rail.WaitForDagRunsSensor(
            task_id='wait_for_completion_trigger_dag_run_assured_partners_child_location_add_v3_091',
            execution_timeout=timedelta(days=config.execution_timeout_days),
            dag_runs='{{ result("trigger_dag_run_assured_partners_child_location_add_v3_091") }}'
        )
        ...
        if_query_list_getall_employee_typesnotin_replicon_105_rows_greater_than_0_112 = rail.IfOperator(
            ...
            yes_task="trigger_dag_run_child_employee_type_add_v3_116",
            no_task="get_all_divisions_123",
        )

        trigger_dag_run_child_employee_type_add_v3_116 = rail.TriggerDagRunForEachItemOperator(
            task_id='trigger_dag_run_child_employee_type_add_v3_116',
            retries=0,
        ...
        wait_for_completion_trigger_dag_run_child_employee_type_add_v3_116 = rail.WaitForDagRunsSensor(
            task_id='wait_for_completion_trigger_dag_run_child_employee_type_add_v3_116',
            execution_timeout=timedelta(days=config.execution_timeout_days),
            dag_runs='{{ result("trigger_dag_run_child_employee_type_add_v3_116") }}'
        )
        ...
        if_query_list_21_rows_greater_than_0_22 >> rail.Label('Yes') >> trigger_dag_run_child_cost_center_add_v3_024 \
        ...
        if_query_list_getallcostcentersnotin_replicon_20_rows_greater_than_0_27 >> rail.Label(
            ...
            >> trigger_dag_run_child_cost_center_add_v3_033 >> wait_for_completion_dag_run_child_cost_center_add_033
        ...
        query_valid_departments_not_in_replicon >> trigger_dag_run_child_department_add_v3_064 \
        ...
        if_query_list_getalllocationsnotin_replicon_78_rows_greater_than_0_85 >> rail.Label('Yes') >> assured_partners_groups_table_add_entry_87 >> trigger_dag_run_assured_partners_child_location_add_v3_091 \
            >> wait_for_completion_trigger_dag_run_assured_partners_child_location_add_v3_091 >> get_employee_type_group_details_98
        ...
        if_query_list_getall_employee_typesnotin_replicon_105_rows_greater_than_0_112 >> rail.Label('Yes') >> trigger_dag_run_child_employee_type_add_v3_116 \
            >> wait_for_completion_trigger_dag_run_child_employee_type_add_v3_116 >> get_all_divisions_123

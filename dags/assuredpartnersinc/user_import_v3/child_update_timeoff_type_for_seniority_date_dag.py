...
def create_dag(config):
    ...
    with rail.create_airflow_dag(
        ...
        if_timeoff_name_equals_to_keenan_non_ca_h = rail.IfOperator(
            ...
            no_task="trigger_dag_run_rehire_transfer_user_timeoff_type_proration_assignment_keennan_h_neace_special_h_and_ap_ca_plan_h_v3_017",
        )
        ...
        trigger_dag_run_rehire_transfer_user_timeoff_type_proration_assignment_keennan_h_neace_special_h_and_ap_ca_plan_h_v3_017 = rail.TriggerDagRunOperator(
            task_id='trigger_dag_run_rehire_transfer_user_timeoff_type_proration_assignment_keennan_h_neace_special_h_and_ap_ca_plan_h_v3_017',
            retries=0,
        ...
        add_dag_run_to_wait_list_17 = rail.SetVariableOperator(
            ...
            name='wait_list',
            append=True,
            value="{{result('trigger_dag_run_rehire_transfer_user_timeoff_type_proration_assignment_keennan_h_neace_special_h_and_ap_ca_plan_h_v3_017')}}"
        )
        ...
        if_timeoff_name_equals_to_keenan_non_ca_h >> rail.Label(
            'No') >> trigger_dag_run_rehire_transfer_user_timeoff_type_proration_assignment_keennan_h_neace_special_h_and_ap_ca_plan_h_v3_017
        if_timeoff_name_equals_to_keenan_non_ca_h >> rail.Label(
        ...
        trigger_dag_run_rehire_transfer_user_timeoff_type_proration_assignment_keennan_h_neace_special_h_and_ap_ca_plan_h_v3_017 \

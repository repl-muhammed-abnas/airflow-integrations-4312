...
def create_dag(config):
    ...
    with rail.create_airflow_dag(
        dag_id=config.child_new_user_timeoff_type_proration_assignment_ap_pto_h_and_ahm_plan_h_and_seattle_plan_h_dag_id,
        description=f'Assured Partners User Import new user Timeoff Type proration assignment - AP PTO H and AHM Plan_H and Seattle Plan-H Child {config.instance}',
        ...
        catch_and_log_error = rail.SetVariableOperator(
            ...
            append=False,
            value="Error in Timeoff Assignment - AP PTO H and AHM Plan_H and Seattle Plan-H : {{get_error_message()}}"
        )

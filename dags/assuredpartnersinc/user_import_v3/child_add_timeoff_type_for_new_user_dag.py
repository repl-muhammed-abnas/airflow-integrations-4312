...
def create_dag(config):
    ...
    with rail.create_airflow_dag(
        ...
        if_log_p_t_o_type_54_equals_to_type1_55 = rail.IfOperator(
            ...
            yes_task="trigger_dag_run_child_new_user_timeoff_type_proration_assignment_ap_pto_h_and_ahm_plan_h_and_seattle_plan_h_v3_56",
            no_task="if_log_pto_type_54_equals_to_type2_57",
        )

        trigger_dag_run_child_new_user_timeoff_type_proration_assignment_ap_pto_h_and_ahm_plan_h_and_seattle_plan_h_v3_56 = rail.TriggerDagRunOperator(
            task_id='trigger_dag_run_child_new_user_timeoff_type_proration_assignment_ap_pto_h_and_ahm_plan_h_and_seattle_plan_h_v3_56',
            retries=0,
        ...
        insert_child_56_wait_list = rail.SetVariableOperator(
            ...
            name="{{result('create_child_triggered_list').name}}",
            append=True,
            value="{{result('trigger_dag_run_child_new_user_timeoff_type_proration_assignment_ap_pto_h_and_ahm_plan_h_and_seattle_plan_h_v3_56')}}"
        )
        ...
        if_foreach_1_name_equals_to_keenannoncah_58 = rail.IfOperator(
            ...
            yes_task="trigger_dag_run_child_new_user_timeoff_type_proration_assignment_keenan_non_ca_h_keenan_non_ca_ex_v3_59",
            no_task="trigger_dag_run_child_new_user_timeoff_type_proration_assignment_keennan_h_neace_special_h_and_ap_ca_plan_h_v3_61",
        )

        trigger_dag_run_child_new_user_timeoff_type_proration_assignment_keenan_non_ca_h_keenan_non_ca_ex_v3_59 = rail.TriggerDagRunOperator(
            task_id='trigger_dag_run_child_new_user_timeoff_type_proration_assignment_keenan_non_ca_h_keenan_non_ca_ex_v3_59',
            retries=0,
        ...
        insert_child_59_wait_list = rail.SetVariableOperator(
            ...
            name="{{result('create_child_triggered_list').name}}",
            append=True,
            value="{{result('trigger_dag_run_child_new_user_timeoff_type_proration_assignment_keenan_non_ca_h_keenan_non_ca_ex_v3_59')}}"
        )

        trigger_dag_run_child_new_user_timeoff_type_proration_assignment_keennan_h_neace_special_h_and_ap_ca_plan_h_v3_61 = rail.TriggerDagRunOperator(
            task_id='trigger_dag_run_child_new_user_timeoff_type_proration_assignment_keennan_h_neace_special_h_and_ap_ca_plan_h_v3_61',
            retries=0,
        ...
        insert_child_61_wait_list = rail.SetVariableOperator(
            ...
            name="{{result('create_child_triggered_list').name}}",
            append=True,
            value="{{result('trigger_dag_run_child_new_user_timeoff_type_proration_assignment_keennan_h_neace_special_h_and_ap_ca_plan_h_v3_61')}}"
        )
        ...
        if_log_p_t_o_type_54_equals_to_sickpto_62 = rail.IfOperator(
            ...
            yes_task="trigger_dag_run_child_new_user_timeoff_type_proration_assignment_sick_pay_p_v3_063",
            no_task="foreach_declare_list_6_40_end",
        )

        trigger_dag_run_child_new_user_timeoff_type_proration_assignment_sick_pay_p_v3_063 = rail.TriggerDagRunOperator(
            task_id='trigger_dag_run_child_new_user_timeoff_type_proration_assignment_sick_pay_p_v3_063',
            retries=0,
        ...
        insert_child_63_wait_list = rail.SetVariableOperator(
            ...
            name="{{result('create_child_triggered_list').name}}",
            append=True,
            value="{{result('trigger_dag_run_child_new_user_timeoff_type_proration_assignment_sick_pay_p_v3_063')}}"
        )
        ...
        if_log_p_t_o_type_54_equals_to_type1_55 >> rail.Label(
            'Yes') >> trigger_dag_run_child_new_user_timeoff_type_proration_assignment_ap_pto_h_and_ahm_plan_h_and_seattle_plan_h_v3_56 \
        ...
        if_foreach_1_name_equals_to_keenannoncah_58 >> rail.Label(
            'No') >> trigger_dag_run_child_new_user_timeoff_type_proration_assignment_keennan_h_neace_special_h_and_ap_ca_plan_h_v3_61 \
            >> insert_child_61_wait_list >> if_log_p_t_o_type_54_equals_to_sickpto_62
        if_foreach_1_name_equals_to_keenannoncah_58 >> rail.Label(
            'Yes') >> trigger_dag_run_child_new_user_timeoff_type_proration_assignment_keenan_non_ca_h_keenan_non_ca_ex_v3_59 \
            >> insert_child_59_wait_list >> if_log_p_t_o_type_54_equals_to_sickpto_62

        if_log_p_t_o_type_54_equals_to_sickpto_62 >> rail.Label(
            'No') >> foreach_declare_list_6_40_end
        if_log_p_t_o_type_54_equals_to_sickpto_62 >> rail.Label(
            'Yes') >> trigger_dag_run_child_new_user_timeoff_type_proration_assignment_sick_pay_p_v3_063 >> insert_child_63_wait_list >> foreach_declare_list_6_40_end

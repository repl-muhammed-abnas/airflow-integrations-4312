...
def create_dag(config):
    ...
    with rail.create_airflow_dag(
        dag_id=config.child_rehire_transfer_user_timeoff_type_proration_assignment_ap_pto_h_and_ahm_plan_h_and_seattle_plan_h_dag_id,
        description=f'Assured Partners User Import Rehire/Transfer User Timeoff Type Proration Assignment ap_pto-h ahm_plan-h and seattle_plan-h Child{config.instance}',
        ...
        def get_offset_to_consider_ap_pto_ahm_seattle(dag_run):
        ...
        log_relevant_historical_policies_and_offset_to_consider_and_effective_date = rail.PythonOperator(
            ...
            python_callable=lambda dag_run: {
                'relevant_historical_policies': python_callable.get_relevant_historical_policies(
                    rail.result('log_existing_timeoff_policy_21'), rail.result('log_combined_initial_tasks')['effective_date_derived']),
                'offset_to_consider': get_offset_to_consider_ap_pto_ahm_seattle(dag_run),
        ...
        log_modified_policysetschedule_88_91 = rail.PythonOperator(
            task_id='log_modified_policysetschedule_88_91',
        ...
        check_if_policy_not_added = rail.IfOperator(
            ...
            test=lambda: rail.result('log_modified_policysetschedule_88_91')[
                'policy_added_check'] != True,
            yes_task='log_modified_policysetschedule_88_91_if_offset_not_equals_offset_to_consider_128',
            no_task='log_modified_policysetschedule_with_historical_policies_132'
        )
        ...
        log_modified_policysetschedule_88_91_if_offset_not_equals_offset_to_consider_128 = rail.PythonOperator(
            task_id='log_modified_policysetschedule_88_91_if_offset_not_equals_offset_to_consider_128',
            python_callable=lambda dag_run:  get_modified_policysetschedule_2(rail.result('get_defaultpolicyfromgloballevel_15'), rail.result(
                ...
                'log_modified_policysetschedule_88_91')['modified_policysetschedule'], dag_run)
        )
        ...
        log_modified_policysetschedule_with_historical_policies_132 = rail.PythonOperator(
            task_id='log_modified_policysetschedule_with_historical_policies_132',
            python_callable=lambda:  add_historical_policies_to_final_policysetschedule(rail.result(
                'log_relevant_historical_policies_and_offset_to_consider_and_effective_date'), (rail.result(
                    'log_modified_policysetschedule_88_91_if_offset_not_equals_offset_to_consider_128') or rail.result(
                    'log_modified_policysetschedule_88_91')['modified_policysetschedule']))
        )
        ...
        log_final_policyset_145 = rail.PythonOperator(
            task_id='log_final_policyset_145',
            python_callable=lambda dag_run: add_extra_policy_lines_to_modified_policysetschedule(rail.result("get_all_scripts_time_off_balance_event_17"), rail.result(
                "log_relevant_historical_policies_and_offset_to_consider_and_effective_date"), rail.result("log_modified_policysetschedule_with_historical_policies_132"), dag_run)
        )
        ...
        assign_time_offpolicy_146 = rail.RepliconServiceOperator(
            ...
            data=lambda dag_run: {
                ...
                "policySetScheduleEntries": rail.result('log_final_policyset_145')
            }
        )
        ...
        catch_and_log_error = rail.PythonOperator(
            ...
            python_callable=lambda: rail.render_template(
                "Error in Rehire Transfer Timeoff Type Proration Assignment - AP PTO H and AHM Plan_H and Seattle Plan-H : {{get_error_message()}}")
        )
        ...
        log_combined_initial_tasks >> log_hoursday_5 >> get_defaultpolicyfromgloballevel_15 >> get_all_scripts_time_off_balance_event_17 \
            >> log_existing_timeoff_policy_21 >> log_relevant_historical_policies_and_offset_to_consider_and_effective_date \
            >> log_modified_policysetschedule_88_91 >> check_if_policy_not_added

        check_if_policy_not_added >> rail.Label(
            'No') >> log_modified_policysetschedule_with_historical_policies_132
        check_if_policy_not_added >> rail.Label(
            'Yes') >> log_modified_policysetschedule_88_91_if_offset_not_equals_offset_to_consider_128 >> log_modified_policysetschedule_with_historical_policies_132

        log_modified_policysetschedule_with_historical_policies_132 >> log_final_policyset_145 >> assign_time_offpolicy_146 >> catch_and_log_error >> final_response_from_dag

...
def create_dag(config):
    ...
    with rail.create_airflow_dag(
        ...
        wait_for_completion_trigger_dag_run_child_workflow_to_add_timeoff_type_for_new_user_099 = rail.WaitForDagRunsSensor(
            task_id='wait_for_completion_trigger_dag_run_child_workflow_to_add_timeoff_type_for_new_user_099',
            execution_timeout=timedelta(days=config.execution_timeout_days),
        ...
        if_hourly_rate_in_feed = rail.IfOperator(
            ...
            test=lambda dag_run: dag_run.conf['hourly_rate_amount'] is not null,
        ...
        if_log_valuefor_replicon_t_s_date_97_blank_98 >> rail.Label('Yes') >> trigger_dag_run_child_workflow_to_add_timeoff_type_for_new_user_99 \
            >> wait_for_completion_trigger_dag_run_child_workflow_to_add_timeoff_type_for_new_user_099 >> gather_response_from_dag_run_99 \

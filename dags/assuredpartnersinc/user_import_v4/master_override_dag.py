...
def create_dag(config):
    ...
    with rail.create_airflow_dag(
        ...
        if_delta_records_less_than_1 >> rail.Label(
            'No') >> log_delta_list_size_to_percentage >> trigger_dag_run_assured_partners_child_groups_update_044
        if_delta_records_less_than_1 >> rail.Label(
        ...
        trigger_dag_run_assured_partners_child_groups_update_044 >> wait_for_dag_run_assured_partners_child_groups_update \

...
def create_dag(config):
    ...
    with rail.create_airflow_dag(
        dag_id=f'mccarthy_project_import_process_new_projects_child_dag_{config.instance}',
        description=f'Mccarthy - Trigger Dags To Process New projects in Replicon Child {config.instance}',
        ...
        trigger_child_to_create_project=rail.TriggerDagRunOperator(
            ...
            trigger_dag_id=f'mccarthy_project_import_creating_projects_in_replicon_child_{config.instance}',

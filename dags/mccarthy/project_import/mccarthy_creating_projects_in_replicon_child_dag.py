...
def create_dag(config):
    ...
    with rail.create_airflow_dag(
        dag_id=f'mccarthy_project_import_creating_projects_in_replicon_child_{config.instance}',
        description=f'Mccarthy - Creating projects in Replicon Child {config.instance}',

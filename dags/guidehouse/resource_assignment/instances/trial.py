...
input_filepath = '/guidehouse/resource_assignment/Input'
archive_filepath = '/guidehouse/resource_assignment/Archive'
sftp_log_path = '/guidehouse/resource_assignment/Logs'

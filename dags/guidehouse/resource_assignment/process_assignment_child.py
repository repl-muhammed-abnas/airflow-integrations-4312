...
from guidehouse.resource_assignment.utils import request_payload, response_filter, custom_method
...
def create_assignment_processing_dags(config):
    ...
    for idx in range(0, config.ASSIGNMENT_BATCH_COUNT):
        ...
        with rail.create_airflow_dag(
            ...
            description='Guidehouse Process Project Resources - Polaris Bulk API',
            ...
            get_assignment_data_from_query = rail.QueryCollectionOperator(
                ...
                query_params={
                    'project_number': '{{ dag_run.conf.project_id }}'
                }
            )

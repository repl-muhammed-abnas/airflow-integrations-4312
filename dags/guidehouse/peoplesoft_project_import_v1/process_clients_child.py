...
from guidehouse.peoplesoft_project_import_v1.utils import custom_method, response_filter, request_payload
...
def create_client_child_dag(config):
    with rail.create_airflow_dag(
        ...
        check_clientcode_matches >> rail.Label("Yes") >> catch_and_log_errors

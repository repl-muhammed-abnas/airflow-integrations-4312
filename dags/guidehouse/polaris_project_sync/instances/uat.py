...
child_dag_id = f'guidehouseinc_costpoint_polaris_project_sync_child_{instance}'
replicon_endpoint_caller_dag_id = f'guidehouseinc_costpoint_polaris_replicon_endpoint_caller_{instance}'

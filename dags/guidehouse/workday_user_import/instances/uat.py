...
replicon_conn_id = 'guidehousesb_replicon_repliconint'
pgp_conn_id = 'guidehousesb2_replicon_pgp_conn_inbound'

# SFTP configuration
sftp_conn_id = 'sftp_guidehousesb2_678659_uat'
input_filepath = '/UAT/Inbound/Workday/Input'
archive_filepath = '/UAT/Inbound/Workday/Archive'
log_filepath = '/UAT/Inbound/Workday/Logs'

...
# SFTP details
sftp_remote_filepath = "/SIT/Outbound/DataLake Unapproved Time Export"
...
# Schedule
schedule_interval = emec_schedule_interval

# Company code
COMPANY_CODE = [EMEC_COMPANY_CODE_SET_1]
# Email recipients

import rail
from guidehouse.time_export.time_export_peoplesoft_india.utils.request_payload import (
    time_export_generate_request,
)
from guidehouse.time_export.time_export_peoplesoft_india.utils.custom_methods import (
    retrieve_export_uri,
)


def time_data_export(group_id, get_export_name, financial_system):
    ...
    with rail.TaskGroup(group_id=group_id):
        ...
        create_export = rail.RepliconServiceOperator(
            ...
            data=lambda dag_run: time_export_generate_request(dag_run,"time_export", financial_system),
        )

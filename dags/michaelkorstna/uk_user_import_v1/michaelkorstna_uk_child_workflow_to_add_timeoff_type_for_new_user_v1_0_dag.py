...
def create_dag(config):
    ...
    with rail.create_airflow_dag(
        dag_id=config.workflow_add_timeoff_child_dag_id,
        description=f'MichaelKorsTnA UK_Child Workflow to add timeoff type for new user (RIT-17599) {config.instance}',

...
def create_dag(config):
    ...
    with rail.create_airflow_dag(
        dag_id=f'michaelkorstna_uk_groups_update_child_{config.instance}',
        description=f'MichaelKorsTnA UK Child_groups update V1.0 {config.instance}',
        ...
        trigger_child_cost_center_add = rail.TriggerDagRunForEachItemOperator(
            ...
            trigger_dag_id=f'michaelkorstna_uk_user_import_cost_center_add_child_{config.instance}',
        ...
        trigger_child_department_add = rail.TriggerDagRunForEachItemOperator(
            ...
            trigger_dag_id=f'michaelkorstna_uk_user_import_department_add_child_{config.instance}',
            execution_timeout=timedelta(days=config.execution_timeout_days),
            conf={
        ...
        trigger_child_location_add = rail.TriggerDagRunForEachItemOperator(
            ...
            trigger_dag_id=f'michaelkorstna_uk_location_add_child_{config.instance}',
            execution_timeout=timedelta(days=config.execution_timeout_days),
            conf={
        ...
        trigger_child_employeetype_add = rail.TriggerDagRunForEachItemOperator(
            ...
            trigger_dag_id=f'michaelkorstna_uk_user_import_employee_type_add_child_{config.instance}',
            execution_timeout=timedelta(days=config.execution_timeout_days),
            conf={
        ...
        trigger_child_service_center_add = rail.TriggerDagRunForEachItemOperator(
            ...
            trigger_dag_id=f'michaelkorstna_uk_service_center_add_child_{config.instance}',
            execution_timeout=timedelta(days=config.execution_timeout_days),
            conf={

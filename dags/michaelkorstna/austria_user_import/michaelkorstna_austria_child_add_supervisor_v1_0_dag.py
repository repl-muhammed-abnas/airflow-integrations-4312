...
def create_dag(config):
    ...
    with rail.create_airflow_dag(
        dag_id=f'michaelkorstna_austria_user_import_add_supervisor_child_{config.instance}',
        description=f'MichaelKorsTnA Austria_Child_Add Supervisor V1.0 {config.instance}',
        ...
        adhoc_http_action_14 = rail.RepliconServiceOperator(
            task_id='adhoc_http_action_14',
        ...
        get_permissions_from_mapper = rail.PythonOperator(
            ...
            python_callable=lambda dag_run:  list({permission['value'] for permission in list(filter(lambda x: x["type"] == "Permission" and x[
                "identifier__1"] == "Supervisor" and x["country"] == dag_run.conf['country'], michael_kors_gmbh_user_sync_master_mapper_austria))})
        )

        adhoc_http_action_18 = rail.RepliconServiceOperator(
            task_id='adhoc_http_action_18',
        ...
        if_log_supervisor_permissiontobeassigned_17_not_contains_dataloggerlog_checkifthe_supervisor_permissionisassigned_19message_22 = rail.IfOperator(
            ...
            test=lambda: (rail.result('adhoc_http_action_18')['supervisorpermission'] not in rail.result('get_permissions_from_mapper')) or (rail.result(
                'adhoc_http_action_18')['userpermission'] not in rail.result('get_permissions_from_mapper')) or (rail.result(
                'adhoc_http_action_18')['schedulemanagementpermission'] not in rail.result('get_permissions_from_mapper')) or not (rail.result(
                'adhoc_http_action_18')['supervisorpermission']) or not (rail.result('adhoc_http_action_18')['userpermission']) or not (rail.result(
                'adhoc_http_action_18')['schedulemanagementpermission']),
        ...
        assign_permission_set_to_user_29 = rail.RepliconServiceOperator(
            ...
            data=lambda: {
                ...
                "permissionSetUri": rail.find_first_by_attr_and_get_attr(rail.result('adhoc_http_action_23'), 'name', (rail.result(
        ...
        if_log_getsupervisor_employee_type_10_not_equals_to_foreignsupervisor_11 >> rail.Label(
            'No') >> adhoc_http_action_14 >> if_log_getsupervisor_status_8_equals_to_true_15
        if_log_getsupervisor_status_8_equals_to_false_9 >> rail.Label(
            'No') >> if_log_getsupervisor_status_8_equals_to_true_15
        if_log_getsupervisor_status_8_equals_to_true_15 >> rail.Label(
            'Yes') >> get_permissions_from_mapper >> adhoc_http_action_18
        adhoc_http_action_18 >> if_log_supervisor_permissiontobeassigned_17_not_contains_dataloggerlog_checkifthe_supervisor_permissionisassigned_19message_22
        if_log_supervisor_permissiontobeassigned_17_not_contains_dataloggerlog_checkifthe_supervisor_permissionisassigned_19message_22 >> rail.Label(
            'Yes') >> adhoc_http_action_23 >> foreach_create_list_25_26 >> assign_permission_set_to_user_29 >> foreach_create_list_25_26_end

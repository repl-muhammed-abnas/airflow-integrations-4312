...
def create_dag(config):
    ...
    with rail.create_airflow_dag(
        dag_id=f'michaelkorstna_austria_user_import_department_add_child_{config.instance}',
        description=f'MichaelKorsTnA Child_department add V1.0 {config.instance}',

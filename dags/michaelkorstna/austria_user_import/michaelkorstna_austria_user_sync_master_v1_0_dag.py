...
def create_dag(config):
    ...
    with rail.create_airflow_dag(
        dag_id=f'michaelkorstna_austria_user_import_master_{config.instance}',
        description=f'MichaelKorsTnA Austria User Sync Master {config.instance}',
        ...
        trigger_child_disable_users = rail.TriggerDagRunOperator(
            ...
            retries=0,
            trigger_dag_id=f'michaelkorstna_austria_user_import_disable_users_child_{config.instance}',
        ...
        if_query_list_changedrecords_19_rows_less_than_1_20 = rail.IfOperator(
            ...
            no_task="query_list_getalltheusersfor_austria_25",
        )
        ...
        query_list_getalltheusersfor_austria_25 = rail.QueryCollectionOperator(
            task_id='query_list_getalltheusersfor_austria_25',
            query="""SELECT * FROM  changeddata WHERE  changeddata.Country = "Austria" """,
        )

        if_first_employee_id_blank_26 = rail.IfOperator(
            task_id='if_first_employee_id_blank_26',
            test='''{{ result('query_list_getalltheusersfor_austria_25','length') < 1 }}''',
        ...
        trigger_groups_update_child = rail.TriggerDagRunOperator(
            ...
            retries=0,
            trigger_dag_id=f'michaelkorstna_groups_update_child_{config.instance}',
            execution_timeout=timedelta(days=config.execution_timeout_days),
            conf=lambda :{
        ...
        foreach_query_list_getalltheusersfor_austria_25_44 = rail.ForEachOperator(
            task_id='foreach_query_list_getalltheusersfor_austria_25_44',
            items="{{ result('query_list_getalltheusersfor_austria_25') }}",
            start_task='if_foreach_query_list_getalltheusersfor_austria_25_44_employee_id_present_45',
            end_task='foreach_query_list_getalltheusersfor_austria_25_44_end'
        )

        if_foreach_query_list_getalltheusersfor_austria_25_44_employee_id_present_45 = rail.IfOperator(
            task_id='if_foreach_query_list_getalltheusersfor_austria_25_44_employee_id_present_45',
            test='''{{ result('foreach_query_list_getalltheusersfor_austria_25_44').Employee_ID | is_truthy }}''',
        ...
        invoke_custom_ruby_code_47 = rail.PythonOperator(
            ...
            python_callable=lambda: {
                "requireddepartment": rail.smartjoin_by_delim(("Michael Kors/" + str(rail.result(
                    'foreach_query_list_getalltheusersfor_austria_25_44')['Job_Family_Group']) + "/" + str(rail.result(
                    'foreach_query_list_getalltheusersfor_austria_25_44')['Job_Family'])).split("/"), "/"),
                "requiredcostcenter": rail.smartjoin_by_delim((str(rail.result(
                    'foreach_query_list_getalltheusersfor_austria_25_44')['Cost_Center_Hierarchy']) + "/" + str(rail.result(
                    'foreach_query_list_getalltheusersfor_austria_25_44')['CostCenter_ID'])).split("/"), "/"),
                "requiredlocation": rail.smartjoin_by_delim((str(rail.result(
                    'foreach_query_list_getalltheusersfor_austria_25_44')['Business_Organization']) + "/" + str(rail.result(
                    'foreach_query_list_getalltheusersfor_austria_25_44')['Location'])).split("/"), "/")
            }
        )
        ...
        def get_user_uri(response):
            matching_user = list(filter(
                lambda user: user['cells'][0]['textValue'] == rail.result(
                    'foreach_query_list_getalltheusersfor_austria_25_44')['Employee_ID'], response['rows']))
            return {
        ...
        search_users_51 = rail.RepliconServiceOperator(
            ...
            data=lambda: {
                ...
                "filterExpression": {
                    ...
                    "rightExpression": {
                        "value": {
                            "text": (rail.result('foreach_query_list_getalltheusersfor_austria_25_44')['Employee_ID']).strip()
                        }
                    }
                }
            },
        ...
        def get_add_update_user_payload(action):
            user = rail.result(
                'foreach_query_list_getalltheusersfor_austria_25_44')
            payload = {
        ...
        trigger_user_update_child = rail.TriggerDagRunOperator(
            ...
            retries=0,
            trigger_dag_id=f'michaelkorstna_austria_user_update_child_{config.instance}',
            execution_timeout=timedelta(days=config.execution_timeout_days),
        ...
        if_error_in_validation = rail.IfOperator(
            ...
            no_task='foreach_query_list_getalltheusersfor_austria_25_44_end'
        )
        ...
        michael_kors_gmbh_user_sync_logs_add_entry_58 = rail.WriteLogOperator(
            ...
            severity="Error",
            properties={
                "loginname": "{{result('foreach_query_list_getalltheusersfor_austria_25_44').Employee_ID}}",
                "action": "Validation",
                "status": "Error",
                ...
                "username": "{{ result('foreach_query_list_getalltheusersfor_austria_25_44').FirstName }} {{ result('foreach_query_list_getalltheusersfor_austria_25_44').LastName }}"
            }
        )
        ...
        foreach_query_list_getalltheusersfor_austria_25_44_end = rail.EmptyOperator(
            task_id='foreach_query_list_getalltheusersfor_austria_25_44_end',
        )
        ...
        trigger_child_add_foreign_supervisor = rail.TriggerDagRunOperator(
            ...
            retries=0,
            trigger_dag_id=f'michaelkorstna_austria_user_import_add_foreign_supervisor_child_{config.instance}',
            execution_timeout=timedelta(days=config.execution_timeout_days),
            conf={
        ...
        trigger_child_add_supervisor = rail.TriggerDagRunForEachItemOperator(
            ...
            trigger_dag_id=f'michaelkorstna_austria_user_import_add_supervisor_child_{config.instance}',
            execution_timeout=timedelta(days=config.execution_timeout_days),
            conf=lambda item: {
        ...
        if_request_inputlistsize_greater_than_0_8 = rail.IfOperator(
            ...
            #pylint: disable = line-too-long
            test="{{result('query_list_getalltheusersfor_austria_25','length') > 0 and result('michael_kors_gmbh_user_sync_logs_search_entries_7','length') == 0 }}",
            yes_task="stop_9",
        ...
        if_query_list_changedrecords_19_rows_less_than_1_20 >> rail.Label(
            'No') >> query_list_getalltheusersfor_austria_25 >> if_first_employee_id_blank_26
        ...
        create_child_triggered_list >> foreach_query_list_getalltheusersfor_austria_25_44
        foreach_query_list_getalltheusersfor_austria_25_44 >> if_foreach_query_list_getalltheusersfor_austria_25_44_employee_id_present_45
        if_foreach_query_list_getalltheusersfor_austria_25_44_employee_id_present_45 >> rail.Label(
        ...
        if_error_in_validation >> rail.Label(
            'Yes') >> michael_kors_gmbh_user_sync_logs_add_entry_58 >> foreach_query_list_getalltheusersfor_austria_25_44_end
        if_error_in_validation >> rail.Label(
            'No') >> foreach_query_list_getalltheusersfor_austria_25_44_end
        if_foreach_query_list_getalltheusersfor_austria_25_44_employee_id_present_45 >> rail.Label(
            'No') >> michael_kors_gmbh_user_sync_logs_add_entry_60 >> foreach_query_list_getalltheusersfor_austria_25_44_end
        foreach_query_list_getalltheusersfor_austria_25_44 >> foreach_query_list_getalltheusersfor_austria_25_44_end >> if_child_triggered
        ...
        if_request_inputlistsize_greater_than_0_8 >> rail.Label(
            'No') >> create_csv_lines_10 >> generate_download_link >> get_meta_data_for_logs >> send_mail_with_cshare_21 >> archive_old_referencefile

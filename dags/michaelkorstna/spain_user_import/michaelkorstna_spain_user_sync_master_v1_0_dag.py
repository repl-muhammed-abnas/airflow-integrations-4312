...
def create_dag(config):
    ...
    with rail.create_airflow_dag(
        dag_id=f'michaelkorstna_spain_user_import_master_{config.instance}',
        description=f'MichaelKorsTnA Spain User Sync Master {config.instance}',
        ...
        trigger_child_disable_users = rail.TriggerDagRunOperator(
            ...
            retries=0,
            trigger_dag_id=f'michaelkorstna_spain_user_import_disable_users_child_{config.instance}',
        ...
        trigger_groups_update_child = rail.TriggerDagRunOperator(
            ...
            retries=0,
            trigger_dag_id=f'michaelkorstna_spain_groups_update_child_{config.instance}',
            execution_timeout=timedelta(days=config.execution_timeout_days),
            conf=lambda :{
        ...
        trigger_user_update_child = rail.TriggerDagRunOperator(
            ...
            retries=0,
            trigger_dag_id=f'michaelkorstna_spain_user_update_child_{config.instance}',
            execution_timeout=timedelta(days=config.execution_timeout_days),
        ...
        trigger_child_add_foreign_supervisor = rail.TriggerDagRunOperator(
            ...
            retries=0,
            trigger_dag_id=f'michaelkorstna_spain_user_import_add_foreign_supervisor_child_{config.instance}',
            execution_timeout=timedelta(days=config.execution_timeout_days),
            conf={
        ...
        trigger_child_add_supervisor = rail.TriggerDagRunForEachItemOperator(
            ...
            trigger_dag_id=f'michaelkorstna_spain_user_import_add_supervisor_child_{config.instance}',
            execution_timeout=timedelta(days=config.execution_timeout_days),
            conf=lambda item: {

...
def create_dag(config):
    ...
    with rail.create_airflow_dag(
        dag_id=f'michaelkorstna_spain_user_import_add_user_child_{config.instance}',
        description=f'MichaelKorsTnA Spain_ Add V1.0 {config.instance}',
        ...
        trigger_child_add_timeoff_type_for_new_user = rail.TriggerDagRunOperator(
            ...
            retries=0,
            trigger_dag_id=f'michaelkorstna_spain_child_workflow_to_add_timeoff_type_for_new_user_child_{config.instance}',
        ...
        if_request_departmenturi_blank_12 >> rail.Label(
            'No') >> get_required_values_for_fields >> declare_variable_27 >> if_scheduledweeklyhours_and_location_present
        if_scheduledweeklyhours_and_location_present >> rail.Label(

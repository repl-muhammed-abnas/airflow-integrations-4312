...
def create_dag(config):
    ...
    with rail.create_airflow_dag(
        dag_id=f'michaelkorstna_spain_child_workflow_to_add_timeoff_type_for_new_user_child_{config.instance}',
        description=f'MichaelKorsTnA Spain_Child Workflow to add timeoff type for new user v1.0 {config.instance}',

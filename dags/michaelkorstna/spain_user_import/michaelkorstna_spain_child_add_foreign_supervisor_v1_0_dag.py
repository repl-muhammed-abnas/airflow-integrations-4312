...
def create_dag(config):
    ...
    with rail.create_airflow_dag(
        dag_id=f'michaelkorstna_spain_user_import_add_foreign_supervisor_child_{config.instance}',
        description=f'MichaelKorsTnA Spain_Child_Add Foreign Supervisor V1.0 {config.instance}',

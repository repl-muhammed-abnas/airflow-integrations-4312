...
def create_dag(config):
    ...
    with rail.create_airflow_dag(
        dag_id=f'michaelkorstna_spain_service_center_add_child_{config.instance}_{config.version}',
        description=f'MichaelKorsTnA Child_service center add {config.instance}_{config.version}',

...
def create_dag(config):
    ...
    with rail.create_airflow_dag(
        dag_id=f'michaelkorstna_spain_user_import_disable_users_child_{config.instance}_{config.version}',
        description=f'MichaelKorsTnA_Spain_disable users {config.instance}_{config.version}',
        ...
        query_list_getalltheuserswhoareenabledandhaveanenddateinpast_22 = rail.QueryCollectionOperator(
            ...
            query="""SELECT * FROM  enableduserdata WHERE  enableduserdata.daydiff > 0 AND  enableduserdata.country = "Spain" """,
        )
        ...
        if_first_payload_contains_nodata_17 >> rail.Label(
            'No') >> load_csv_create_list_from_csv_21 >> create_collection_create_list_from_csv_21
        create_collection_create_list_from_csv_21 >> query_list_getalltheuserswhoareenabledandhaveanenddateinpast_22 >> if_first_username_blank_23

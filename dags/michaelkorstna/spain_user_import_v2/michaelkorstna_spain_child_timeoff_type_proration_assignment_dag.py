...
def create_dag(config):
    ...
    with rail.create_airflow_dag(
        dag_id=f'michaelkorstna_spain_user_import_timeoff_type_proration_assignment_child_{config.instance}_{config.version}',
        description=f'MichaelKorsTnA Spain_Child Timeoff type Proration Assignment {config.instance}_{config.version}',

...
def create_dag(config):
    ...
    with rail.create_airflow_dag(
        dag_id=f'michaelkorstna_spain_user_import_cost_center_add_child_{config.instance}_{config.version}',
        description=f'MichaelKorsTnA Child_cost center add {config.instance}_{config.version}',

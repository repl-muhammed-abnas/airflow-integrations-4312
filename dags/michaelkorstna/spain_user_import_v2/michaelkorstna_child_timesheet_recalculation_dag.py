...
def create_dag(config):
    ...
    with rail.create_airflow_dag(
        dag_id=f'michaelkorstna_spain_user_import_timesheet_recalculation_child_{config.instance}_{config.version}',
        description=f'MichaelKorsTnA_Child timesheet recalculation {config.instance}_{config.version}',
        ...
        foreach_document_10 >> foreach_document_10_end >> log_to_sumo
        if_timesheet_data_present >> rail.Label('No') >> log_to_sumo

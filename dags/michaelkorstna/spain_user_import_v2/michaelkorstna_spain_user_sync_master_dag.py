...
def create_dag(config):
    ...
    with rail.create_airflow_dag(
        dag_id=f'michaelkorstna_spain_user_import_master_{config.instance}_{config.version}',
        description=f'MichaelKorsTnA Spain User Sync Master {config.instance}_{config.version}',
        ...
        trigger_child_disable_users = rail.TriggerDagRunOperator(
            ...
            retries=0,
            trigger_dag_id=f'michaelkorstna_spain_user_import_disable_users_child_{config.instance}_{config.version}',
        ...
        if_query_list_changedrecords_19_rows_less_than_1_20 = rail.IfOperator(
            ...
            no_task="query_list_getalltheusersfor_spain_25",
        )
        ...
        query_list_getalltheusersfor_spain_25 = rail.QueryCollectionOperator(
            task_id='query_list_getalltheusersfor_spain_25',
            query="""SELECT * FROM  changeddata WHERE  changeddata.Country = "Spain" """,
        )

        if_first_employee_id_blank_26 = rail.IfOperator(
            task_id='if_first_employee_id_blank_26',
            test='''{{ result('query_list_getalltheusersfor_spain_25','length') < 1 }}''',
        ...
        if_query_list_changedrecords_19_rows_greater_than_0_30 = rail.IfOperator(
            ...
            yes_task="get_schedule_assignment_current_report_details",
            no_task="log_to_sumo",
        )

        get_schedule_assignment_current_report_details = rail.RepliconReportDetailsOperator(
            task_id = 'get_schedule_assignment_current_report_details',
            report_name=config.schedule_assignment_current
        )

        run_schedule_assignment_report = rail.run_report2(
            group_id='run_schedule_assignment_report',
            report_params={
                "reportParameters": [
                    {
                        "reportUri": "{{ result('get_schedule_assignment_current_report_details').uri }}",
                        "filterValues": [],
        ...
        load_schedule_assignment_report_csv = rail.LoadCSVFileOperator(
            task_id = 'load_schedule_assignment_report_csv',
            document="{{(result('run_schedule_assignment_report.get_report_result') | load_json_artifact).reportGenerationResults[0]}}"
        )

        trigger_groups_update_child = rail.TriggerDagRunOperator(
            task_id='trigger_groups_update_child',
            retries=0,
            trigger_dag_id=f'michaelkorstna_spain_groups_update_child_{config.instance}_{config.version}',
            execution_timeout=timedelta(days=config.execution_timeout_days),
            conf=lambda :{
        ...
        _adhoc_http_action_42 = rail.RepliconServiceOperator(
            ...
            data_handler=lambda response: {
                ...
                "cba": rail.find_first_by_attr_and_get_attr(response,'displayText',
                    'CBA','uri','') if response and response[0]['displayText'] else ''
            }
        )
        ...
        foreach_query_list_getalltheusersfor_spain_25_44 = rail.ForEachOperator(
            task_id='foreach_query_list_getalltheusersfor_spain_25_44',
            items="{{ result('query_list_getalltheusersfor_spain_25') }}",
            start_task='if_foreach_query_list_getalltheusersfor_spain_25_44_employee_id_present_45',
            end_task='foreach_query_list_getalltheusersfor_spain_25_44_end'
        )

        if_foreach_query_list_getalltheusersfor_spain_25_44_employee_id_present_45 = rail.IfOperator(
            task_id='if_foreach_query_list_getalltheusersfor_spain_25_44_employee_id_present_45',
            test='''{{ result('foreach_query_list_getalltheusersfor_spain_25_44').Employee_ID | is_truthy }}''',
        ...
        invoke_custom_ruby_code_47 = rail.PythonOperator(
            ...
            python_callable=lambda: {
                "requireddepartment": rail.smartjoin_by_delim(("Michael Kors/" + str(rail.result(
                    'foreach_query_list_getalltheusersfor_spain_25_44')['Job_Family_Group']) + "/" + str(rail.result(
                    'foreach_query_list_getalltheusersfor_spain_25_44')['Job_Family'])).split("/"), "/"),
                "requiredcostcenter": rail.smartjoin_by_delim((str(rail.result(
                    'foreach_query_list_getalltheusersfor_spain_25_44')['Cost_Center_Hierarchy']) + "/" + str(rail.result(
                    'foreach_query_list_getalltheusersfor_spain_25_44')['CostCenter_ID'])).split("/"), "/"),
                "requiredlocation": rail.smartjoin_by_delim((str(rail.result(
                    'foreach_query_list_getalltheusersfor_spain_25_44')['Business_Organization']) + "/" + str(rail.result(
                    'foreach_query_list_getalltheusersfor_spain_25_44')['Location'])).split("/"), "/")
            }
        )
        ...
        def get_user_uri(response):
            matching_user = list(filter(
                lambda user: user['cells'][0]['textValue'] == (rail.result(
                    'foreach_query_list_getalltheusersfor_spain_25_44')['Employee_ID']).strip(), response['rows']))
            return {
        ...
        search_users_51 = rail.RepliconServiceOperator(
            ...
            data=lambda: {
                ...
                "filterExpression": {
                    ...
                    "rightExpression": {
                        "value": {
                            "text": (rail.result('foreach_query_list_getalltheusersfor_spain_25_44')['Employee_ID']).strip()
                        }
                    }
                }
            },
        ...
        def get_add_update_user_payload(action):
            user = rail.result(
                'foreach_query_list_getalltheusersfor_spain_25_44')
            current_schedule_assignment = rail.load_all_records(rail.result('load_schedule_assignment_report_csv'))
            payload = {
                ...
                "cbauri": rail.result('_adhoc_http_action_42')['cba'],
            }
            if action == 'Update':
                payload.update({'useruri': rail.result('search_users_51')['uri'],
                                "currentschedule": rail.find_first_by_attr_and_get_attr(current_schedule_assignment,
                                    'column0',user['Employee_ID'],'column1','')})
            return payload

        trigger_user_update_child = rail.TriggerDagRunOperator(
            task_id='trigger_user_update_child',
            retries=0,
            trigger_dag_id=f'michaelkorstna_spain_user_update_child_{config.instance}_{config.version}',
            execution_timeout=timedelta(days=config.execution_timeout_days),
        ...
        trigger_add_user_child = rail.TriggerDagRunOperator(
            ...
            retries=0,
            trigger_dag_id=f'michaelkorstna_spain_user_import_add_user_child_{config.instance}_{config.version}',
            execution_timeout=timedelta(days=config.execution_timeout_days),
        ...
        if_error_in_validation = rail.IfOperator(
            ...
            no_task='foreach_query_list_getalltheusersfor_spain_25_44_end'
        )
        ...
        michael_kors_gmbh_user_sync_logs_add_entry_58 = rail.WriteLogOperator(
            ...
            severity="Error",
            properties={
                "loginname": "{{result('foreach_query_list_getalltheusersfor_spain_25_44').Employee_ID}}",
                "action": "Validation",
                "status": "Error",
                ...
                "username": "{{ result('foreach_query_list_getalltheusersfor_spain_25_44').FirstName }} {{ result('foreach_query_list_getalltheusersfor_spain_25_44').LastName }}"
            }
        )
        ...
        foreach_query_list_getalltheusersfor_spain_25_44_end = rail.EmptyOperator(
            task_id='foreach_query_list_getalltheusersfor_spain_25_44_end',
        )
        ...
        trigger_child_add_foreign_supervisor = rail.TriggerDagRunOperator(
            ...
            retries=0,
            trigger_dag_id=f'michaelkorstna_spain_user_import_add_foreign_supervisor_child_{config.instance}_{config.version}',
            execution_timeout=timedelta(days=config.execution_timeout_days),
            conf={
        ...
        trigger_child_add_supervisor = rail.TriggerDagRunForEachItemOperator(
            ...
            trigger_dag_id=f'michaelkorstna_spain_user_import_add_supervisor_child_{config.instance}_{config.version}',
            execution_timeout=timedelta(days=config.execution_timeout_days),
            conf=lambda item: {
        ...
        if_request_inputlistsize_greater_than_0_8 = rail.IfOperator(
            ...
            #pylint: disable = line-too-long
            test="{{result('query_list_getalltheusersfor_spain_25','length') > 0 and result('michael_kors_gmbh_user_sync_logs_search_entries_7','length') == 0 }}",
            yes_task="stop_9",
        ...
        trigger_disable_users_for_spain_child = rail.TriggerDagRunOperator(
            task_id = 'trigger_disable_users_for_spain_child',
            retries=0,
            trigger_dag_id=f'michaelkorstna_spain_user_import_disable_users_child_{config.instance}_{config.version}',
            execution_timeout=timedelta(days=config.execution_timeout_days),
        )

        wait_for_spain_disable_users = rail.WaitForDagRunsSensor(
            task_id='wait_for_spain_disable_users',
            execution_timeout=timedelta(days=config.execution_timeout_days),
            dag_runs="{{result('trigger_disable_users_for_spain_child')}}"
        ...
        if_query_list_changedrecords_19_rows_less_than_1_20 >> rail.Label(
            'No') >> query_list_getalltheusersfor_spain_25 >> if_first_employee_id_blank_26
        ...
        if_query_list_changedrecords_19_rows_greater_than_0_30 >> rail.Label(
            'Yes') >> get_schedule_assignment_current_report_details >> run_schedule_assignment_report >> load_schedule_assignment_report_csv
        load_schedule_assignment_report_csv >> trigger_groups_update_child >> wait_for_groups_update_child >> get_cost_center_details_33
        get_cost_center_details_33 >> get_department_group_details_34
        ...
        create_child_triggered_list >> foreach_query_list_getalltheusersfor_spain_25_44
        foreach_query_list_getalltheusersfor_spain_25_44 >> if_foreach_query_list_getalltheusersfor_spain_25_44_employee_id_present_45
        if_foreach_query_list_getalltheusersfor_spain_25_44_employee_id_present_45 >> rail.Label(
        ...
        if_error_in_validation >> rail.Label(
            'Yes') >> michael_kors_gmbh_user_sync_logs_add_entry_58 >> foreach_query_list_getalltheusersfor_spain_25_44_end
        if_error_in_validation >> rail.Label(
            'No') >> foreach_query_list_getalltheusersfor_spain_25_44_end
        if_foreach_query_list_getalltheusersfor_spain_25_44_employee_id_present_45 >> rail.Label(
            'No') >> michael_kors_gmbh_user_sync_logs_add_entry_60 >> foreach_query_list_getalltheusersfor_spain_25_44_end
        foreach_query_list_getalltheusersfor_spain_25_44 >> foreach_query_list_getalltheusersfor_spain_25_44_end >> if_child_triggered
        ...
        send_mail_with_cshare_21 >> trigger_disable_users_for_spain_child >> wait_for_spain_disable_users >> archive_old_referencefile

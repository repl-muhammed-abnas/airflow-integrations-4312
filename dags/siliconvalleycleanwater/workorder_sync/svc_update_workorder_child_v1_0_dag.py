...
def create_dag(config):
    ...
    with rail.create_airflow_dag(
        dag_id=f'siliconvalleycleanwater_workorder_sync_svc_update_workorder_child_v1_0_{config.instance}',
        description=f'SVC_Update_workorder_Child - V1.0 {config.instance}',
        ...
        insert_to_list_25 = rail.SetVariableOperator(
            ...
            value={
                ...
                "tag": null,
                "numericValue": null,
                "textValue": "{{ dag_run.conf.euquipmentvalue }}",
                "fileValue": null,
                "jsonValue": null
            }
        )

        log_o_e_ftoassign_26 = rail.PythonOperator(
            task_id='log_o_e_ftoassign_26',
        ...
        create_project_or_apply_modifications_28 = rail.RepliconServiceOperator(
            ...
            data=lambda: {
                ...
                "modifications": {
                    ...
                    "objectExtensionFieldsToApply": rail.result('log_o_e_ftoassign_26')
                },
        ...
        update_allow_time_entry_against_tasks_only_31 = rail.RepliconServiceOperator(
            task_id='update_allow_time_entry_against_tasks_only_31',
        ...
        foreach_request_32 = rail.ForEachOperator(
            ...
            start_task='if_foreach_request_32_resourceuri_present_33',
            end_task='foreach_request_32_end'
        )

        if_foreach_request_32_resourceuri_present_33 = rail.IfOperator(
            task_id='if_foreach_request_32_resourceuri_present_33',
            test='''{{ result('foreach_request_32').resourceuri | is_truthy }}''',
            yes_task="assign_user_to_project_34",
            no_task="svc_workorder_logs_add_entry_35",
        )

        assign_user_to_project_34 = rail.RepliconServiceOperator(
            task_id='assign_user_to_project_34',
            ...
            data={
                ...
                "userUris":  ["{{ result('foreach_request_32').resourceuri }}"],
                "projectTeamMemberAssignmentOptionUri": "urn:replicon:project-team-member-assignment-option:assign"
            }
        )

        svc_workorder_logs_add_entry_35 = rail.WriteLogOperator(
            task_id='svc_workorder_logs_add_entry_35',
            ...
            properties={
                ...
                "umrequestedbyid30": "{{ result('foreach_request_32').resourcename if result('foreach_request_32').resourceuri  else '' }}",
        ...
        catch_and_log_error = rail.WriteLogOperator(
            ...
            severity="Exception",
            properties={
                "soserviceordernumber": "{{ dag_run.conf.projectnumber |sn }}",
                "soserviceorderdescription": "{{ dag_run.conf.projectname |sn}}",
                "soserviceorderstatus": "{{ dag_run.conf.Status |sn }}",
                "umrequestedbyid30": "",
                "sorequestedd_and_sodatecompletedate": "{{ dag_run.conf.startdate }} and {{ dag_run.conf.enddate }}",
                "project_level_oef's": '''umPhysicalLocation   -  "{{dag_run.conf.physicallocationvalue|sn}}", soRequestID - "{{dag_run.conf.requestidvalue|sn}}", Equipment Position - "{{dag_run.conf.euquipmentvalue|sn}}"''',
                "status": "Error",
        ...
        if_request_equipmenturi_present_24 >> rail.Label(
            'Yes') >> insert_to_list_25 >> log_o_e_ftoassign_26
        if_request_equipmenturi_present_24 >> rail.Label(
            'No') >> log_o_e_ftoassign_26 >> create_project_or_apply_modifications_28 >> update_allow_time_entry_against_tasks_only_31 >> foreach_request_32 >> if_foreach_request_32_resourceuri_present_33
        if_foreach_request_32_resourceuri_present_33 >> rail.Label(
            'Yes') >> assign_user_to_project_34 >> svc_workorder_logs_add_entry_35 >> foreach_request_32_end
        if_foreach_request_32_resourceuri_present_33 >> rail.Label(
            'No') >> svc_workorder_logs_add_entry_35 >> foreach_request_32_end
        foreach_request_32 >> foreach_request_32_end >> finish >> catch_and_log_error >> log_to_sumo

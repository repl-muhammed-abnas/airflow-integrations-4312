...
def create_child_dag(config):
    with rail.create_airflow_dag(
        dag_id=f'vialtopartners_schedule_correction_child_dag_{config.dag_id_postfix}',
        ...
        has_valid_scheduletype = rail.IfOperator(
            ...
            yes_task='puts_impleschedule_pattern',
            no_task='log_error'
        )
        ...
        log_schedule_correction_success = rail.WriteLogOperator(
            task_id='log_schedule_correction_success',
            message='Schedule has been corrected',
            properties={
                'schedulename': scheduletype,
                'employeeid': "NA",
                'status': 'Success',
        ...
        has_valid_scheduletype >> rail.Label("YES") >> puts_impleschedule_pattern \
            >> log_schedule_correction_success >> catch_and_log_errors

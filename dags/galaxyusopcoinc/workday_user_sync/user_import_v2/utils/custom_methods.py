...
from galaxyusopcoinc.workday_user_sync.user_import_v2 import config
from galaxyusopcoinc.workday_user_sync.user_import_v2.mapper.user_import_location_master_mapper_v7 import MAPPER_TO_USE_FOR_COUNTRY_TRIAL as trial_mapper
from galaxyusopcoinc.workday_user_sync.user_import_v2.mapper.user_import_location_master_mapper_v7 import MAPPER_TO_USE_FOR_COUNTRY_UAT as uat_mapper
# Note:  this needs to be updated when deployed to PROD
from galaxyusopcoinc.workday_user_sync.user_import_v2.mapper.user_import_location_master_mapper_v7 import MAPPER_TO_USE_FOR_COUNTRY_PROD as production_mapper
...
def get_derived_values_mapper_row(mapper_row):
    if not mapper_row:
        return {
...
def get_policy_to_assign(dag_run):
    ...
    if not data:
        return None
    res = previous_policies + list(map(lambda item: {

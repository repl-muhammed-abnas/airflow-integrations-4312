import datetime
import rail
from galaxyusopcoinc.workday_user_sync.user_schedule_v4.utils.python_callable_method import schedule_all_blank_zero, schedule_is_blank
                    ...
                    "replacementScheduleEntries": [
                        {
                            ...
                            "effectiveDate": null if sch_type else get_new_effective_date()
                        }
                    ],
                    "endDate": null
                }

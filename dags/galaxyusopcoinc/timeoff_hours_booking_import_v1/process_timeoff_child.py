...
import rail
from galaxyusopcoinc.timeoff_hours_booking_import_v1.utils import request_payload, response_filter
from galaxyusopcoinc.timeoff_hours_booking_import_v1.tasks.update_timeoff_booking import update_timeoff_booking
from galaxyusopcoinc.timeoff_hours_booking_import_v1.tasks.add_timeoff_booking import add_timeoff_booking
...
def create_child_dag(config):
    with rail.create_airflow_dag(
        ...
        is_timeoff_booking_available = rail.IfOperator(
            ...
            test='{{ result("get_time_off_booking_details") | is_truthy }}',

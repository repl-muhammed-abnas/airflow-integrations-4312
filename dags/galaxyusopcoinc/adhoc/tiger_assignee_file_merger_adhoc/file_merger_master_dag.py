...
from galaxyusopcoinc.adhoc.tiger_assignee_file_merger_adhoc.utils import custom_methods
null = None
...
def create_dag(config):
    ...
    with rail.create_airflow_dag(
        dag_id=f'vialtopartners_tiger_assignee_file_merger_master_{config.instance}_adhoc',
        ...
        process_reading_files = rail.TriggerDagRunForEachItemOperator(
            ...
            trigger_dag_id=f'vialtopartners_tiger_assignee_file_merger_child_{config.instance}_adhoc',
            conf={
        ...
        process_split_csv_batch = rail.TriggerDagRunForEachItemOperator(
            ...
            execution_timeout=timedelta(days=config.execution_timeout_days),
            trigger_dag_id=f'vialtopartners_tiger_assignee_file_merger_split_csv_batch_child_{config.instance}_adhoc',

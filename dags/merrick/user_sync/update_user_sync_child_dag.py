...
import rail
from merrick.user_sync.utils.mapper_helpers import as_name_list
...
def create_dag(config):
    with rail.create_airflow_dag(
        ...
        description=f'merrick_update_user_sync_{config.instance}',
                        ...
                        "projectRoleAssignmentSchedulesToPut": [
                            {
                                "projectRoles": [
                                    {
                                        "projectRole": {
                                            "uri": projectrole['disciplineroleuri']
                                        },
                                        "isPrimary": "true"
                                    }
                                ] if projectrole['disciplineroleuri'] else [],
                                "effectiveDate": {

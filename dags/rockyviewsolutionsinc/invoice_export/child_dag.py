...
from rockyviewsolutionsinc.invoice_export import request_payload
...
def create_child_dag(config):
    with rail.create_airflow_dag(
        ...
        search_items_qbo >> search_taxcodes_qbo >> get_invoice_items >> create_invoice_with_multiline_item >> update_invoice_sync_status >> \

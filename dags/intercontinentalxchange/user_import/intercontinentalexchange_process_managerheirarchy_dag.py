...
def create_dag(config):
    ...
    with rail.create_airflow_dag(
        dag_id=f'intercontinentalexchange_process_managerheirarchy_{config.instance}',
        description=f'intercontinentalexchange_Process_ManagerHeirarchy {config.instance}',
        ...
        report_has_data_24 >> rail.Label('No') >> log_to_sumo
        if_generate_report_24_payload_starts_with_nodata_25 >> rail.Label(
            'Yes') >> stop_26 >> log_to_sumo
        if_generate_report_24_payload_starts_with_nodata_25 >> rail.Label(
        ...
        if_output_loggers_greater_than_0_51 >> rail.Label(
            ...
            upload_uploadnewreference_64 >> finish >> log_to_sumo

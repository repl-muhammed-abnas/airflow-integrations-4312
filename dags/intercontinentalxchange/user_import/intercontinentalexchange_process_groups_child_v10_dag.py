...
def create_dag(config):
    ...
    with rail.create_airflow_dag(
        dag_id=f'intercontinentalexchange_process_groups_child_v10_{config.instance}',
        description=f'IntercontinentalExchange - Process groups - Child V1.0 {config.instance}',

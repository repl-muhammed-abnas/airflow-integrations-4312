...
def create_dag(config):
    ...
    with rail.create_airflow_dag(
        dag_id=f'intercontinentalexchange_groups_check_location_{config.instance}',
        description=f'IntercontinentalExchange_Groups_Check - Location {config.instance}',
        ...
        foreach_query_list_checkfornewdropdownvalues_12_14 >> foreach_query_list_checkfornewdropdownvalues_12_14_end >> log_to_sumo
        if_query_list_checkfornewdropdownvalues_12_rows_greater_than_0_13 >> rail.Label(
            'No') >> log_to_sumo
        if_request_grouptype_equals_to_location_4 >> rail.Label(
            'No') >> catch_16 >> stop_18 >> log_to_sumo

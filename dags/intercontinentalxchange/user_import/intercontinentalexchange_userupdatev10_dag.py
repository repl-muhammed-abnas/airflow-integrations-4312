...
def create_dag(config):
    ...
    with rail.create_airflow_dag(
        dag_id=f'intercontinentalexchange_userupdatev10_{config.instance}',
        description=f'IntercontinentalExchange_User Update V1.0 {config.instance}',
        ...
        if_request_timezoneuri_not_equals_to_datarestbulk_get_users3_4responsedfirsttimezoneuri_73 = rail.IfOperator(
            ...
            test='''{{ dag_run.conf.timezoneuri != result('bulk_get_users3_4').timeZone.uri }}''',
        ...
        if_request_holidaycalendaruri_present_75 = rail.IfOperator(
            ...
            test='''{{ dag_run.conf.holidaycalendaruri | is_truthy  and dag_run.conf.holidaycalendaruri != result('bulk_get_users3_4').holidayCalendar.uri }}''',
        ...
        if_userdetails_isenabled_is_not_true_7 >> rail.Label(
            'Yes') >> intercontinentalexchange_user_import_logs_add_entry_8 >> log_to_sumo
        if_userdetails_isenabled_is_not_true_7 >> rail.Label(
        ...
        if_output_adminmodified_equals_to_yes_13 >> rail.Label(
            'Yes') >> intercontinentalexchange_user_import_logs_add_entry_14 >> log_to_sumo
        if_output_adminmodified_equals_to_yes_13 >> rail.Label(
        ...
        if_request_line_manager_blank_109 >> rail.Label(
            'No') >> log_exceptions_111 >> intercontinentalexchange_user_import_logs_add_entry_111 >> intercontinentalexchange_user_import_logs_add_entry_113 >> log_to_sumo

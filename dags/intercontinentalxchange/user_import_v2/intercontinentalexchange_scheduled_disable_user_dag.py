...
def create_dag(config):
    ...
    with rail.create_airflow_dag(
        dag_id=f'intercontinentalexchange_scheduleddisable_user_v2_{config.instance}',
        description=f'IntercontinentalExchange_scheduled disable_user v2.0 {config.instance}',

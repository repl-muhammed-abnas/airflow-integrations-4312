...
def create_dag(config):
    ...
    with rail.create_airflow_dag(
        dag_id=f'intercontinentalexchange_child_adduser_v2_{config.instance}',
        description=f'IntercontinentalExchange_Child_Add User_V2 {config.instance}',
        ...
        if_timeoff_template_uri_present = rail.IfOperator(
            ...
            yes_task="insert_to_list_timeoff_policy_uri",
            no_task="if_request_timesheettemplate_present_46",
        )

        insert_to_list_timeoff_policy_uri = rail.SetVariableOperator(
            task_id='insert_to_list_timeoff_policy_uri',
            append=True,
        ...
        if_login_name_textvalue_present_5 >> rail.Label(
            'Yes') >> intercontinentalexchange_user_import_logs_add_entry_6 >> finish
        if_login_name_textvalue_present_5 >> rail.Label(
        ...
        if_request_week_hours_present_42 >> rail.Label(
            'No') >> declare_list_45 >> if_timeoff_template_uri_present
        if_timeoff_template_uri_present >> rail.Label(
            'Yes') >> insert_to_list_timeoff_policy_uri >> if_request_timesheettemplate_present_46
        if_timeoff_template_uri_present >> rail.Label(
            'No') >> if_request_timesheettemplate_present_46
        ...
        if_request_line_manager_present_66 >> rail.Label(
            ...
            intercontinentalexchange_user_import_logs_add_entry_94 >> finish

...
from ttecholdingsinc.user_sync_v1.utils.request_payload import get_location_payload
from ttecholdingsinc.user_sync_v1.utils.response_filter import filter_group_data, groups_filter, get_all_drop_down_options_filter
...
def get_user_prereqs_task_group():
    ...
    with rail.TaskGroup(group_id='get_user_prereqs', prefix_group_id=False) as get_user_prereqs:
        ...
        get_all_updated_servicecenter_grps = rail.RepliconServiceOperator(
            task_id="get_all_updated_servicecenter_grps",
        ...
        dummy_get_user_prereqs >> [get_all_locations, get_updated_departments, get_all_updated_servicecenter_grps, get_all_employee_types,
            get_all_permission_set, get_timeoff_approval_paths, get_all_payrule_scripts, get_all_policy_sets, get_all_timezones,

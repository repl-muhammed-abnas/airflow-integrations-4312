...
from ttecholdingsinc.schedule_creation.task.create_schedule import create_schedule_task
from ttecholdingsinc.schedule_creation.task.update_schedule import update_schedule_task
...
def create_dag(config):
    with rail.create_airflow_dag(
        ...
        is_shift_available >> rail.Label(
            "Yes") >> empty_task_for_create >> create_schedule >> log_success >> catch_and_log_errors

        is_shift_available >> rail.Label(
            "No") >> empty_task_for_update >> update_schedule >> log_success >> catch_and_log_errors

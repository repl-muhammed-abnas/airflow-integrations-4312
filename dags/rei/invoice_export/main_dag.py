...
from rei.invoice_export.utils.request_payload import get_queuedforsync_invoice


# pylint:disable = too-many-statements
def create_main_dag(config):
    with rail.create_airflow_dag(
        dag_id=f"{config.company_key}_quickbooks_online_invoice_export_master_{config.instance}",
        ...
        log_dagrun_details_to_table = rail.PostDagRunDetailsToRepliconOperator(
            ...
            integration_type=f'{config.company_key}_quickbooks_online_invoice_export_master_{config.instance}'
        )

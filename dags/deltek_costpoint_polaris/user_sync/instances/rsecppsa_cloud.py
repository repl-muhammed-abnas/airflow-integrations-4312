...
from deltek_costpoint_polaris.user_sync.instances.mapper.user_mapper import user_mapper
region = 'us-east-1'
...
last_run_date_var_name = f'{instance}_deltek_costpoint_user_sync_last_run_date'
last_run_date_inital_sync_var_name = f'{instance}_deltek_costpoint_inital_sync_last_run_date'
get_data_in_chunk_var_name = f'{instance}_deltek_costpoint_user_sync_get_data_in_chunk'
time_zone = 'UTC'

...
time_zone = 'America/Denver'  # was 'US/Eastern'
...
enable_wbs_boundary_sync = True #True: Sync WBS up to boundary level defined below for projects that have changed since last sync
wbs_sync_boundary_level = 2
multi_plc_subtask_mode = False #False 1st PLC for user/task is synced #True: Task for PLC created

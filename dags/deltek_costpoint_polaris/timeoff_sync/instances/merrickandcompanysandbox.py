...
instance = "Merrickandcompanysandbox"
...
sql_query = """SELECT t.EMPL_ID AS USER_ID
            ...
            FROM [UATTE].[TETRAN].[TS] t                      -- 3 tables on timesheet - TS, TS_LINE, TS_CELL
            INNER JOIN [UATTE].[TETRAN].[TS_LINE] tl          -- TS_LINE is where pay type info is
            ...
            INNER JOIN [UATTE].[TETRAN].[TS_CELL] tc          -- TS_CELL is where entered hours are
            ...
            INNER JOIN [UATTE].[TETRAN].[LEAVE_TYPE] lt       -- Leave types
            ...
            FROM [UATTE].[TETRAN].[WORK_SCHEDULE_DATE] wsd
            LEFT OUTER JOIN [UATTE].[TETRAN].[EMPL] e

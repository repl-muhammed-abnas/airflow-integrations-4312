...
def create_dag(config):
    with rail.create_airflow_dag(
        dag_id=f'deltek_costpoint_polaris_connectivity_check_{config.instance}',
        description=f'deltek_costpoint_polaris_connectivity_check_{config.instance}',
        ...
        catch_and_log_error = rail.WriteLogOperator(
            ...
            severity="Error",
            properties={
                "entity": "costpoint_polaris_connectivity_check",
                "action": "Probe",
                "status": "Error",

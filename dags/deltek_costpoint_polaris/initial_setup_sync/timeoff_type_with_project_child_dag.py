...
def create_dag(config):
    with rail.create_airflow_dag(
        dag_id=f'deltek_costpoint_timeoff_type_with_project_code_child_{config.instance}',
        description=f'deltek_costpoint_timeoff_type_with_project_code_child_{config.instance}',
                        ...
                        if (len(modified_timeofftypes) == 0 or
                            ...
                            modified_timeofftypes.append({
                                ...
                                timeofftype['row']['data'].get(
                                    'LV_TYPE_CD'),
                                "timeofftype_code": timeofftype['row']['data'].get('EXPNS_PROJ_ID'),
                                "description": timeofftype['row']['data'].get('EXPNS_ACCT_ID')
                                })

"""QA instance for UKG Pro → Maconomy Employee Sync.

Local-qa fallback so the DAGs parse without integration-platform-api committing
...
company_key = "airflowqasandboxuseast1"

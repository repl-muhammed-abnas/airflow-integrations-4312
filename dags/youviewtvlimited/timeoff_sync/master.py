...
from youviewtvlimited.timeoff_sync.utils import custom_methods
from youviewtvlimited.timeoff_sync.utils import response_filters
from youviewtvlimited.timeoff_sync.utils import request_payload
from youviewtvlimited.timeoff_sync.tasks.send_logs import get_send_logs
    ...
    with rail.create_airflow_dag(
        ...
        get_absense_time_off_type = rail.RepliconServiceOperator(
            ...
            data_handler=lambda response, dag_run: rail.find_first_by_attr_and_get_attr(
                response, 'displayText', "Absence", 'uri')
        )
        ...
        book_timeoff = rail.TriggerDagRunForEachItemOperator(
            ...
            conf=lambda item: {
                "booking_data": item,
                "get_absense_time_off_type": rail.result('get_absense_time_off_type'),

...
from ce_procore_integration.util_dags.instances.alliedpartner import wbs_code_creator_dag_id
...
sync_budget = False  # because deployed in PC → CE
sync_contract = False  # because deployed in PC → CE

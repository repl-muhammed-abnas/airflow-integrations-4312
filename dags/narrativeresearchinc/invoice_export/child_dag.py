...
def create_child_dag(config):
    with rail.create_airflow_dag(
        ...
        get_invoice_replicon = rail.RepliconServiceOperator(
            task_id='get_invoice_replicon',
            endpoint='/services/InvoiceService2.svc/GetInvoiceDetails',
            replicon_conn_id='{{ dag_run.conf.replicon_conn_id }}',
            data=request_payload.get_invoice_details_request
        )
        ...
        search_customer >> get_invoice_replicon >> parse_qbo_customer >> is_customer_not_present
        ...
        search_items_qbo >> search_taxcodes_qbo  >> get_invoice_items >> \
             create_invoice_with_multiline_item >> update_invoice_sync_status >> update_invoice_external_system_number >> update_invoice_sync_note

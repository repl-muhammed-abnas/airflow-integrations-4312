...
from narrativeresearchinc.invoice_export.request_payload import get_queuedforsync_invoice
from narrativeresearchinc.invoice_export import request_payload
null = None
...
def create_main_dag(config):
    with rail.create_airflow_dag(
        ...
        log_dagrun_details_to_table = rail.PostDagRunDetailsToRepliconOperator(
            ...
            integration_type=f'invoice_{config.company_key}_quickbooks_online_invoice_export_{config.instance}'
        )

import rail
from dxctechnology.timeentry_autosubmission.utils import python_callable_method
from dxctechnology.timeentry_autosubmission.utils import request_payload
...
def create_dag(config):
    with rail.create_airflow_dag(
        ...
        get_timeEntry_revision_groups = rail.RepliconServiceOperator(
            task_id='get_timeEntry_revision_groups',
        ...
        get_timeEntry_revision_groups >> add_multi_day_entries_data >> \

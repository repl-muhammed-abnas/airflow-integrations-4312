...
def create_child_dag(config):
    with rail.create_airflow_dag(
        dag_id=f'adhoc_dxctechnology_australia_payrolldata_export_es_child_v1_{config.instance}',
        description=f'Adhoc DXC_Australia_PayrollData_Export_ES_Child V1 {config.instance}',
        ...
        create_payroll_download_batch = rail.RepliconServiceOperator(
            ...
            data=lambda: request_payload.get_adhoc_create_payroll_download_batch_payload(

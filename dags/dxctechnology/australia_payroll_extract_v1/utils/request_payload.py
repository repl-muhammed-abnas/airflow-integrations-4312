...
import json
import rail
from dxctechnology.australia_payroll_extract_v1.mapper.time_off_balance_mapper import Time_off_mappper, Active_user_lsl_Timeoffs
from dxctechnology.australia_payroll_extract_v1.mapper.sell_back_mapper import SELL_BACK_MAPPER
...
def get_adhoc_create_payroll_download_batch_payload(duration_days,cut_off_date):
    conf = rail.get_current_context()['dag_run'].conf
    null = None
    pay_group_names = rail.result("get_pay_groups_data")
    employee_type_uris = get_child_hierarchy_data(rail.result('get_contractor_employee_type_child_hierarchy_data'

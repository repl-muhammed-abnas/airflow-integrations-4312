...
def create_child_dag(config):
    with rail.create_airflow_dag(
        dag_id=f'dxctechnology_australia_payrolldata_export_gsap_child_v1_{config.instance}',
        description=f'DXC_Australia_PayrollData_Export_GSAP_Child V1 {config.instance}',
        ...
        process_absence_taken = rail.TriggerDagRunOperator(
            ...
            retries=0,
            trigger_dag_id=f'dxctechnology_australia_payrolldata_export_absence_taken_child_v1_{config.instance}',

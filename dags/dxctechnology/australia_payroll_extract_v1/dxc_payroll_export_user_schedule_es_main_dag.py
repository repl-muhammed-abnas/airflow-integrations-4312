...
def create_main_dag(config):
    with rail.create_airflow_dag(
        dag_id=f"dxctechnology_australia_payrollexport_es_user_schedule_master_dag_v1_{config.instance}",
        description=f"DXC_AUS_PayrollExport_ES_User_Schedule_Master V1 {config.instance}",

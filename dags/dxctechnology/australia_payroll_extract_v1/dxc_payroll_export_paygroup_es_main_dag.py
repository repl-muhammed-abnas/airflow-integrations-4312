...
from dxctechnology.australia_payroll_extract_v1.mapper.company_code_mapper_usles_uscsc import COMPANY_CODE_MAP_ES


def create_main_dag(config):
    with rail.create_airflow_dag(
        dag_id=f"dxctechnology_australia_payrollexport_es_master_dag_v1_{config.instance}",
        description=f"DXC_AUS_PayrollExport_ES_Master V1 {config.instance}",
        ...
        process_payrolldata_export = rail.TriggerDagRunForEachItemOperator(
            ...
            trigger_dag_id=f'dxctechnology_australia_payrolldata_export_es_child_v1_{config.instance}',

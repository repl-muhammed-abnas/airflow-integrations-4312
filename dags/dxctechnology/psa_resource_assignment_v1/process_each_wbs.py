...
def create_attribute_1_process_wbs_child_dag(config):
    ...
    with rail.create_airflow_dag(
        dag_id=f'dxctechnology_psa_resource_process_wbs_{config.dag_id_postfix}_v1',
        ...
        process_each_child_wbs = rail.TriggerDagRunForEachItemOperator(
            ...
            trigger_dag_id=f'dxctechnology_psa_resource_process_child_wbs_{config.dag_id_postfix}_v1',

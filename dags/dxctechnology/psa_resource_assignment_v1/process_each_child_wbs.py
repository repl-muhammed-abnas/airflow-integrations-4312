...
from dxctechnology.psa_resource_assignment_v1.utils import response_filter
...
def create_attribute_1_process_child_wbs_dag(config):
    ...
    with rail.create_airflow_dag(
        dag_id=f'dxctechnology_psa_resource_process_child_wbs_{config.dag_id_postfix}_v1',
        description=f'DXC PSA Resource Child - PSA Child Resource Assignment {config.dag_id_postfix} V1',

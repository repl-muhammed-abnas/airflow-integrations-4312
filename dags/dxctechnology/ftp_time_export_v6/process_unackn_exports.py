...
def create_child_dag(config):
    with rail.create_airflow_dag(
        dag_id=f'dxctechnology_ftp_export_child_v6_process_all_unackn_export_{config.instance}',
        description=f'DXC_FTP_Export_Automation Client Child V6.0 {config.instance}',

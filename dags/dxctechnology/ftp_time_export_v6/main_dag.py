...
from dxctechnology.ftp_time_export_v6.utils import request_payload
from dxctechnology.ftp_time_export_v6.utils import response_filter
...
def create_dag(config):
    with rail.create_airflow_dag(
        dag_id=f'dxctechnology_time_export_ftp_v6_{config.instance}',
        description='Export time data for FTP V6',
        ...
        process_all_unackn_exports = rail.TriggerDagRunForEachItemOperator(
            ...
            trigger_dag_id=f'dxctechnology_ftp_export_child_v6_process_all_unackn_export_{config.instance}',
            conf=lambda item: {

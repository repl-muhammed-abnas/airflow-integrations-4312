...
def create_dag(config):
    ...
    with rail.create_airflow_dag(
        dag_id=f'dxctechnology_india_earned_leave_export_daily_export_child_{config.instance}_v1',
        ...
        insert_to_list_65 = rail.SetVariableOperator(
            ...
            value=lambda:  list(map(lambda item: {
                ...
                "BETRG": null,
                "WAERS": null,
                "PayCodeHours": item['balance'] if item['balance'] else "",
                "ZEINH": null,
                "VTKEN": null,
                "BWGRL": null,
                "AUFKZ": null,
        ...
        send_mail_sendemailafterpayrollexport_90 = rail.EmailOperator(
            ...
            <p>For any queries, please reach out to https://support.deltek.com <br /><br />Regards, <br />Deltek Inc.</p> ''',

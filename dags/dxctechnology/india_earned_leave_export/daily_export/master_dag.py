...
def create_dag(config):
    ...
    with rail.create_airflow_dag(
        dag_id=f'dxctechnology_india_earned_leave_export_daily_export_master_{config.instance}',
        ...
        trigger_child_dag_run_18 = rail.TriggerDagRunForEachItemOperator(
            ...
            retries=0,
            items=[1],
            trigger_dag_id=f'dxctechnology_india_earned_leave_export_daily_export_child_{config.instance}',

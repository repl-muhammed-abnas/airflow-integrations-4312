...
def create_dag(config):
    ...
    with rail.create_airflow_dag(
        dag_id=f'dxctechnology_cwf_time_export_c1_compass_master_{config.instance}_v7',
        description=f'DXCTechnology_CWF Time export - Master v7 {config.instance}',
        ...
        process_c1_time_export = rail.TriggerDagRunOperator(
            ...
            retries=0,
            trigger_dag_id=f'dxctechnology_cwf_time_export_c1_child_{config.instance}_v7',
        ...
        process_compass_time_export = rail.TriggerDagRunOperator(
            ...
            retries=0,
            trigger_dag_id=f'dxctechnology_cwf_time_export_compass_child_{config.instance}_v7',
            execution_timeout=timedelta(days=14),
        ...
        process_gsap_time_export = rail.TriggerDagRunOperator(
            ...
            retries=0,
            trigger_dag_id=f'dxctechnology_cwf_time_export_gsap_child_{config.instance}_v7',
            execution_timeout=timedelta(days=14),
            # pylint: disable=line-too-long
        ...
        process_psa_time_export = rail.TriggerDagRunOperator(
            ...
            retries=0,
            trigger_dag_id=f'dxctechnology_cwf_time_export_psa_child_{config.instance}_v7',
        ...
        process_psa_f142d_time_export = rail.TriggerDagRunOperator(
            ...
            retries=0,
            trigger_dag_id=f'dxctechnology_cwf_time_export_psa_f142d_child_{config.instance}_v7',
            execution_timeout=timedelta(days=config.execution_timeout_days),
            conf=lambda: request_payload.get_psa_time_export_conf(rail.result(
                "current_export_name"), rail.result("get_data_For_all_past_time_exports"))
        )

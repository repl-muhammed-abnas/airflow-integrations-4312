...
field_glass_sftp_conn_id = 'rsftp-useast_for_testing'
field_glass_output_filepath = '/Trial/Export/FGCWF'

gsap_sftp_conn_id = 'rsftp-useast_for_testing'
gsap_output_filepath = '/Trial/Export/GSAPCWF'
gsap_http_conn_id = 'http_conn_id'

psa_sftp_conn_id = 'rsftp-useast_for_testing'
psa_output_filepath = '/Trial/Export/CWFPSA'

c1_sftp_conn_id = 'rsftp-useast_for_testing'
c1_output_filepath = '/Trial/Export/C1CWF'

compass_http_conn_id = 'http_conn_id'
c1_http_conn_id = 'http_conn_id'

compass_sftp_conn_id = 'rsftp-useast_for_testing'
compass_output_filepath = '/Trial/Export/COMPASSCWF'

...
def create_dag(config):
    ...
    with rail.create_airflow_dag(
        dag_id=f'dxctechnology_cwf_time_export_psa_child_{config.instance}_v7',
        description=f'DXCTechnology_PSA WF39 Child for C1 Reg and Compass Reg v7 {config.instance}',

...
def create_dag(config):
    with rail.create_airflow_dag(
        dag_id=f'dxctechnology_time_export_ftp_pta_{config.instance}',
        ...
        rename_export = rail.RepliconServiceOperator(
            ...
            data={'target': {
                'uri': '{{ result(\'time_data_export.get_export_uri\') }}'}, 'name': ''+getExportName()+'_Nodata'},
        )
    ...
    Deltek Inc.
        ...
        filtered_export_has_data >> rail.Label('Yes') >> translate_csv >> create_export_data_collection >> query_export_data >> \
            generate_xml_time_data >> upload_time_data >> get_actual_end_time >> log_to_sumo >> send_success_email >> send_time_data_to_sftp

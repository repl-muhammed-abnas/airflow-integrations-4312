...
input_filepath = '/Production/Inbound/COMPASSIWODetails/PJ1/Input'
log_filepath = '/Production/Inbound/COMPASSIWODetails/PJ1/Logs'
archive_filepath = '/Production/Inbound/COMPASSIWODetails/PJ1/Archive'

...
import pendulum
import rail
from dxctechnology.gsap_iwo_resource_assignment.utils.python_callable_method import get_process_unique_wbs_conf_reprocess
from dxctechnology.gsap_iwo_resource_assignment.task.trigger_parallel_dagrun_aycn import trigger_parallel_dagrun_async
null = None
...
def create_reprocess_dag(config):
    ...
    with rail.create_airflow_dag(
        dag_id=f'dxctechnology_gsap_iwo_resource_assignment_reprocess_batch_{config.instance}',

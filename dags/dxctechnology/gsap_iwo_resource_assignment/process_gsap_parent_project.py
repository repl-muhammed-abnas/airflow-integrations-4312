...
def create_attribute_1_create_task_child_dag(config):
    ...
    with rail.create_airflow_dag(
        dag_id=f'dxctechnology_gsab_iwo_resource_gsap_assignment_{config.dag_id_postfix}',
        ...
        assign_resource_task_level = rail.TriggerDagRunForEachItemOperator(
            ...
            trigger_dag_id=f'dxctechnology_gsab_iwo_resource_assign_resource_task_{config.dag_id_postfix}',

import rail
from dxctechnology.wf39_psa_resource_assignment_v1.utils import python_callable_method
from dxctechnology.wf39_psa_resource_assignment_v1.utils import response_filter
from dxctechnology.wf39_psa_resource_assignment_v1.utils import request_payload
# pylint: disable=too-many-statements


def create_dag(config):
    with rail.create_airflow_dag(
        dag_id=f'dxctechnology_wf39_psa_resource_assignment_process_each_record_child_{config.instance}_v1',
        description=f'DXC_WF39 PSA Resource Assignment Automation Child V1 {config.instance}',

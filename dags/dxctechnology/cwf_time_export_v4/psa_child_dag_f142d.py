...
def create_dag(config):
    ...
    with rail.create_airflow_dag(
        dag_id=f'dxctechnology_cwf_time_export_psa_f142d_child_{config.instance}_v4',
        description=f'DXCTechnology_PSA F142D Child fro C1 IWO, Compass IWO, GSAP REG and GSAP IWO V4 {config.instance}',

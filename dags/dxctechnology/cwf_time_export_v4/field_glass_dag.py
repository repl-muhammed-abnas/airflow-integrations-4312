...
import json
import rail
from dxctechnology.cwf_time_export_v4.mapper.location import location_mapper
from dxctechnology.cwf_time_export_v4.task.field_glass_compass_task import get_compass_task
from dxctechnology.cwf_time_export_v4.task.c1_task import get_c1_task
from dxctechnology.cwf_time_export_v4.task.gsap_task import get_gsap_task
...
def create_dag(config):
    ...
    with rail.create_airflow_dag(
        dag_id=f'dxctechnology_cwf_time_export_field_glass_{config.instance}_v4',

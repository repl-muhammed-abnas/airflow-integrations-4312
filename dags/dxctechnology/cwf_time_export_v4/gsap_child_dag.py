...
def create_dag(config):
    ...
    with rail.create_airflow_dag(
        dag_id=f'dxctechnology_cwf_time_export_gsap_child_{config.instance}_v4',
        description=f'DXCTechnology_CWF Time export - GSAP V4 {config.instance}',
        ...
        def map_row(item):
            return {
                ...
                "Attendance_Absence_Type": (item['timetypeauscode'] if item['timetypeauscode'] else item['attendancetypecode'] if
                    item['attendancetypecode'] in ['2087', '2850'] else '2082') if item['companycodecode'] in ['3001', '3124', '1602', '3118'] else '1010',
                "Status": 30,

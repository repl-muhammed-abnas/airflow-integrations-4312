...
from dxctechnology.c1_leanstaffing_assignment.currency_map import CURRENCY_MAP
    ...
    with rail.create_airflow_dag(
        ...
        can_send_result = rail.IfOperator(
            ...
            test=lambda: Variable.get(
                f"dxctechnology_c1_leanstaffing_export_send_downstream{dag_id_postfix}").lower() == 'true',
        ...
        send_export_complete_email = rail.EmailOperator(
            ...
            html_content="email_export_complete.html",
            params={

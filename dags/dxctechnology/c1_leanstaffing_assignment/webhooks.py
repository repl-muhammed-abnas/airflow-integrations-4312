...
def create_dag(config):
    ...
    with rail.create_airflow_dag(
        dag_id=f'dxctechnology_c1_leanstaffassignment_webhooks{dag_id_postfix}',
        ...
        webhook_conf=[
            rail.WebhookConf(
                hmac_secret_var=f'dxctechnology_c1_leanstaffing_webhook{dag_id_postfix}_teamratemodified_secret'),
            rail.WebhookConf(
                hmac_secret_var=f'dxctechnology_c1_leanstaffing_webhook{dag_id_postfix}_teamdatesmodified_secret'),
            rail.WebhookConf(
                hmac_secret_var=f'dxctechnology_c1_leanstaffing_webhook{dag_id_postfix}_teammodified_secret'),
        ]
    ) as dag:
        ...
        get_webhook_log = rail.CreateLogOperator(
            ...
            tenant_wide_name="c1_leanstaffassignment_webhooks",
        ...
        was_triggered_by_replicon >> rail.Label("No") >> is_valid_webhookevent >> rail.Label("Yes") >> load_project >> \
            does_project_exist >> rail.Label("Yes") >> is_not_opporutunity_wbs_type >> \

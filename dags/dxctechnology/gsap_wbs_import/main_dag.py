...
from os import path
import rail
from dxctechnology.gsap_wbs_import.utils import request_payload
from dxctechnology.gsap_wbs_import.utils import response_filter
from dxctechnology.gsap_wbs_import.tasks.run_base_report import run_base_report
...
def create_main_dag(config):
    with rail.create_airflow_dag(
        dag_id=f'dxctechnology_gsap_wbs_import_master_{config.instance}',
        ...
        parse_xml = rail.LoadXMLFileOperator(
            ...
            xsd_document='./dags/dxctechnology/gsap_wbs_import/xml_schema/input_schema.xsd'
        )
        ...
        process_project_types = rail.TriggerDagRunForEachItemOperator(
            ...
            trigger_dag_id=f'dxctechnology_gsap_wbs_import_child_process_project_type_{config.instance}',
        ...
        process_clients = rail.trigger_parallel_dagrun(
            ...
            trigger_dag_id=f'dxctechnology_gsap_wbs_import_child_process_client_{config.instance}',
            execution_timeout=timedelta(
                days=config.child_wait_execution_timeout_days),
            conf={
        ...
        process_wbs_item = rail.trigger_parallel_dagrun(
            ...
            trigger_dag_id=f'dxctechnology_gsap_wbs_import_child_process_projects_{config.instance}',
            execution_timeout=timedelta(
                days=config.child_wait_execution_timeout_days),
        ...
        process_iwo_element = rail.TriggerDagRunForEachItemOperator(
            ...
            trigger_dag_id=f'dxctechnology_gsap_wbs_import_child_process_iwo_element_{config.instance}',
            execution_timeout=timedelta(
                days=config.child_wait_execution_timeout_days),
        ...
        process_log_generation = rail.TriggerDagRunOperator(
            ...
            trigger_dag_id=f'dxctechnology_gsap_wbs_import_child_process_log_generation_{config.instance}',
            conf=lambda dag_run:{
        ...
        get_all_object_extension_fields >> [get_oef_drop_down_values_project_type, get_oef_drop_down_values_gsap_project_type,
            get_oef_drop_down_values_item_category,
        ...
        process_wbs_item >> query_distinct_parents >> has_parents >> rail.Label(
        ...
        dummy_process_log_generation >> get_process_each_wbs_task_ids >> gather_each_wbs_logs >> process_log_generation

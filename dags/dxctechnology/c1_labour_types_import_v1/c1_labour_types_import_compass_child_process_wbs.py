...
def create_child_dag(config):
    ...
    with rail.create_airflow_dag(
        dag_id=f'dxctechnology_c1_labour_types_compass_child_process_wbs{dag_id_postfix}_v1',
        ...
        def get_division_names():
            ...
            if not isinstance(value, list):
                ...
                raise Exception(
                    f"The variable `{config.division_variable}` is not in correct format. Excepted `list` got {type(value)}. Found Variable Value: `{value}`")
            if len(value) <= 0:
                raise Exception(
                    f"Variable {config.division_variable} does not have any values present")
            return value
        ...
        billing_rates_to_assign_list = rail.CreateCollectionOperator(
            ...
            name="billing_rates_to_assign_list",
        ...
        query_billing_rates_to_assign_validated = rail.QueryCollectionOperator(
            ...
            name="query_billing_rates_to_assign_validated",
        ...
        add_projectbillingratesassign_to_labour_types_blob_compass = rail.CreateCollectionOperator(
            ...
            name='add_projectbillingratesassign_to_labour_types_blob_compass',
        ...
        add_projectbillingratesassign_to_labour_types_blob_compass_2 = rail.CreateCollectionOperator(
            ...
            name="add_projectbillingratesassign_to_labour_types_blob_compass_2",
            source=lambda: rail.result(
        ...
        join_new_existing_records_to_labour_type_blob_compass = rail.QueryCollectionOperator(
            ...
            name="join_new_existing_records_to_labour_type_blob_compass",
        ...
        has_billing_rates_not_assigned_to_project_compass = rail.IfOperator(
            ...
            no_task='has_billing_rates_already_assigned_to_project_compass'
        )
        ...
        view_dagrun_config >> get_billing_rates_to_asssign_compass >> get_project_info_from_project_service >> is_project_not_exists
        ...
        has_billing_rates_for_project_compass >> rail.Label(
            'Yes') >> has_billing_rates_not_assigned_to_project_compass
        ...
        has_billing_rates_not_assigned_to_project_compass >> rail.Label(
            'No') >> has_billing_rates_already_assigned_to_project_compass

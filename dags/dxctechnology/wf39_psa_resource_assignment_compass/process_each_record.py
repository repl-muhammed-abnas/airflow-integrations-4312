import rail
from dxctechnology.wf39_psa_resource_assignment_compass.utils import python_callable_method
from dxctechnology.wf39_psa_resource_assignment_compass.utils import response_filter
...
def create_dag(config):
    with rail.create_airflow_dag(
        dag_id=f'dxctechnology_wf39_psa_resource_assignment_compass_process_each_record_child_{config.instance}',
        ...
        log_user_date_range_exception = rail.WriteLogOperator(
            ...
            message=python_callable_method.get_message,
            properties={
                'employeeid': '{{dag_run.conf.user}}',
                'wbs': '{{dag_run.conf.wbselement}}',
                'billingtype': null,
        ...
        log_success_bilingtype = rail.WriteLogOperator(
            ...
            properties=python_callable_method.successPayload
        )
        ...
        is_user_compass >> rail.Label(
            "No") >> log_user_not_compass >> catch_and_log_errors

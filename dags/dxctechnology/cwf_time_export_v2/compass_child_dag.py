...
from dxctechnology.cwf_time_export_v2.task.compass_task import get_compass_task
...
def create_dag(config):
    with rail.create_airflow_dag(
        dag_id=f'dxctechnology_cwf_time_export_compass_child_v2_{config.instance}',
        description=f'DXCTechnology_CWF Time export - Compass V2 {config.instance}',

...
def create_main_dag(config):
    ...
    with rail.create_airflow_dag(
        dag_id=f'dxctechnology_wf39_psa_resource_assignment_import_master_{config.instance}_v2',
        description=f'DXC_WF39 PSA Resource Assignment Master V2 - SFTP {config.instance}',
        ...
        process_billing_rate_for_each_wbs_item = rail.TriggerDagRunForEachItemOperator(
            ...
            trigger_dag_id=f'dxctechnology_wf39_psa_resource_assignment_process_distinct_wbs_item_child_{config.instance}_v2',

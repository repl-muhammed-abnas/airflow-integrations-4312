...
def create_child_dag(config):
    ...
    with rail.create_airflow_dag(
        dag_id=f'dxctechnology_c1_labour_types_process_distinct_wbs_item{dag_id_postfix}',
        ...
        process_compass_child = rail.TriggerDagRunForEachItemOperator(
            ...
            trigger_dag_id=f'dxctechnology_c1_labour_types_compass_child_process_wbs{dag_id_postfix}',
        ...
        has_billing_rates_for_project = rail.IfOperator(
            ...
            yes_task=['has_billing_rates_not_assigned_to_project',
                      'has_billing_rates_already_assigned_to_project'],
        ...
        query_billing_rates_for_wbs >> get_assignable_billing_rates >> \
        ...
        has_json_value_for_wbs >> rail.Label(
            "Yes") >> write_existing_blob_records >> [existing_blob_records,
                                                      write_new_blob_records] >> new_blob_records >> check_new_blob_records >> md5_check

...
def create_main_dag(config):
    ...
    with rail.create_airflow_dag(
        dag_id=f'dxctechnology_c1_labour_types_import_master{dag_id_postfix}',
        ...
        create_billing_rates = rail.TriggerDagRunForEachItemOperator(
            ...
            trigger_dag_id=f'dxctechnology_c1_labour_types_child_create_billing_rate{dag_id_postfix}',
            conf=lambda item: {
        ...
        process_billing_rate_for_each_wbs_item = rail.TriggerDagRunForEachItemOperator(
            ...
            execution_timeout=timedelta(days=config.execution_timeout_days),
            trigger_dag_id=f'dxctechnology_c1_labour_types_process_distinct_wbs_item{dag_id_postfix}',
        ...
        query_distinct_projects >> get_all_filter_definitions >> get_all_columns >> process_billing_rate_for_each_wbs_item >> \

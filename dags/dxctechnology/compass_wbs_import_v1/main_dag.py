...
import rail
from dxctechnology.compass_wbs_import_v1.get_active_project_prereqs import get_active_project_prereqs

#config : https://github.com/replicon/airflow-integrations/blob/main/dags/dxctechnology/compass_wbs_import_v1/config.py

def create_main_airflow_dag(config):
    with rail.create_airflow_dag(
        dag_id=config.main_dagid,
        description='COMPASS_WBS_Automation Master V3.0 - SFTP - P01',
        ...
        parse_xml = rail.LoadXMLFileOperator(
            ...
            xsd_document='./dags/dxctechnology/compass_wbs_import_v1/input_schema.xsd'
        )

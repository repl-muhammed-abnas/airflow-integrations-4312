...
input_filepath = '/Production/Inbound/COMPASSIWODetails/P01/Input'
log_filepath = '/Production/Inbound/COMPASSIWODetails/P01/Logs'
archive_filepath = '/Production/Inbound/COMPASSIWODetails/P01/Archive'

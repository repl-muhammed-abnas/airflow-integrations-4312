    ...
    with rail.create_airflow_dag(
        ...
        log_to_sumo = rail.DagRunLogToSumoOperator(
            ...
            extra_info={
                ...
                # 'processed': 'Yes' if bool(rail.result('put_dxc_compass_wbs_labourtype_details')) else 'No',
                # 'details': 'Processed Successfully' if bool(rail.result('put_dxc_compass_wbs_labourtype_details')) else 'Processed Failed'
            }
        )

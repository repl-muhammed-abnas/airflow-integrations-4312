...
def get_create_payroll_download_batch_prev_month_payload(
        startDate, endDate, divisionUris, fileFormatScriptUri):
    return {
        "columnUris": [],
        "sort": [],
...
def get_create_approved_payrun_batch_payload(startDate, endDate, divisionUris):
    return {
        "columnUris": [],
        "filterExpression": {
            "leftExpression": {
...
def get_create_payrun_download_batch_payload(fileFormatScriptUri, payRunUri):
    return {
        "columnUris": [],
        "sort": [],
        "filterExpression": {

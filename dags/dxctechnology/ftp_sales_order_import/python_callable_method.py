...
def get_user_details():
    ...
    check_user='get_user_on_empid_both' if dag_run_conf['Coprojectmanager'] != null else 'get_user_on_empid_single'
    return {
        ...
        'comanageremployeegroup': rail.find_first_by_attr_and_get_attr(rail.result(check_user),'employeeid',dag_run_conf['Coprojectmanager'],'fullpath',null),

...
def create_child_dag(config):
    with rail.create_airflow_dag(
        dag_id=f'dxctechnology_wf39_psa_resource_assignment_compass_process_distinct_wbs_item_child_{config.instance}_v1',
        ...
        process_each_wbs_item = rail.TriggerDagRunForEachItemOperator(
            ...
            trigger_dag_id=f'dxctechnology_wf39_psa_resource_assignment_compass_process_each_record_child_{config.instance}_v1',

...
def create_child_dag(config):
    with rail.create_airflow_dag(
        dag_id=f'dxctechnology_wf39_psa_resource_assignment_compass_create_billing_rate_child_{config.instance}_v1',
        description=f'DXC_WF39 PSA Resource Assignment create billing rate_V1 {config.instance}',

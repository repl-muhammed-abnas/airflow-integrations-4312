...
def create_main_dag(config):
    ...
    with rail.create_airflow_dag(
        dag_id=f'dxctechnology_wf39_psa_resource_assignment_compass_import_master_{config.instance}_v1',
        description=f'DXC_WF39 PSA Resource Assignment Master Compass V1.0 - SFTP {config.instance}',
        ...
        create_billing_rates = rail.TriggerDagRunForEachItemOperator(
            ...
            trigger_dag_id=f'dxctechnology_wf39_psa_resource_assignment_compass_create_billing_rate_child_{config.instance}_v1',
            conf=lambda item: {
                'name': item['role']
            }
        )
        ...
        process_billing_rate_for_each_wbs_item = rail.TriggerDagRunForEachItemOperator(
            ...
            execution_timeout=timedelta(days=config.execution_timeout_days),
            trigger_dag_id=f'dxctechnology_wf39_psa_resource_assignment_compass_process_distinct_wbs_item_child_{config.instance}_v1',

...
def create_child_inactive_airflow_dag(config):
    with rail.create_airflow_dag(
        ...
        description='DXC_COMPASS_WBS_Automation Child - Inactive Projects Processing',
        ...
        create_log >> get_project >> project_exists_in_wts >> rail.Label('Yes') >> is_in_progress_in_wts >> rail.Label(

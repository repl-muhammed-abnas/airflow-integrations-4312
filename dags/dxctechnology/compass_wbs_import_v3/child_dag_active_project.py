...
from dxctechnology.compass_wbs_import_v3.utils import response_filter
from dxctechnology.compass_wbs_import_v3.tasks.ensure_user_has_permissions import ensure_user_has_permissions
from dxctechnology.compass_wbs_import_v3.tasks.validate_persons_responsible import validate_persons_responsible
    ...
    with rail.create_airflow_dag(
        ...
        process_child_projects = rail.TriggerDagRunForEachItemOperator(
            ...
            conf=lambda item,dag_run:{
                ...
                'tmwbsindicatordefinitionuri': dag_run.conf['tmwbsindicatordefinitionuri'],
                'tmwbsindicator': dag_run.conf["tmwbsindicator"],
                'tm_x_flaguri':dag_run.conf['tm_x_flaguri']
            }
        )
        ...
        create_log >> has_company_code >> rail.Label(

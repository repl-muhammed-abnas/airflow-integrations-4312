...
def create_attribute_1_master_dag(config):
    ...
    with rail.create_airflow_dag(
        dag_id=f'dxctechnology_psa_resource_assignment_master_{config.dag_id_postfix}',
        ...
        process_each_wbs_attribute = rail.trigger_parallel_dagrun(
            ...
            trigger_dag_id=f'dxctechnology_psa_resource_process_wbs_{config.dag_id_postfix}',
        ...
        render_logs_csv = rail.WriteCSVFileOperator(
            ...
            header=[
                ...
                'Replicon_Job__ID'],
            row=[
                '{{ item.properties | attr_or_default("empid", "") }}',
        ...
        download_file >> decrypt_file >> load_psa_resource_data >> create_psa_resource_data_collection >> has_psa_resource_data
        ...
        generate_output_log >> get_errored_logs >> get_exception_logs >> get_success_logs >> render_logs_csv \

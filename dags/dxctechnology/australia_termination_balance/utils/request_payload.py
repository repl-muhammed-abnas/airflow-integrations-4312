...
import rail
from dxctechnology.australia_termination_balance.mapper.time_off_balance_mapper import Time_off_mappper, Disabled_user_timeoffs
...
def get_run_us_user_report_payload(dag_run,report_data):
    get_specific_report_details = rail.result('get_user_report_details')
    filter_values = []

    if report_data:
        users_list = ['215404', '224372', '228273', '119714', '95148']

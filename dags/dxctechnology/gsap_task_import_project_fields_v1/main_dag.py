...
from os import path
import rail
from dxctechnology.gsap_task_import_project_fields_v1.utils import request_payload, response_filter
from dxctechnology.gsap_task_import_project_fields_v1.task.get_system_level_attribute import get_system_level_attribute
...
def create_dag(config):
    with rail.create_airflow_dag(
        ...
        parse_xml = rail.LoadXMLFileOperator(
            ...
            xsd_document='./dags/dxctechnology/gsap_task_import_project_fields_v1/xsdschema/input_schema.xsd'
        )

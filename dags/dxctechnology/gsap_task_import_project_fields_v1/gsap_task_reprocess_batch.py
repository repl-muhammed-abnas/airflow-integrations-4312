...
import pendulum
import rail
from dxctechnology.gsap_task_import_project_fields.utils.python_callable_method import get_process_unique_wbs_conf_reprocess
from dxctechnology.gsap_task_import_project_fields_v1.task.trigger_parallel_dagrun_async import trigger_parallel_dagrun_async
null = None
...
def create_reprocess_dag(config):
    ...
    with rail.create_airflow_dag(
        dag_id=f'dxctechnology_gsap_project_field_task_import_reprocess_batch_v1_{config.instance}',

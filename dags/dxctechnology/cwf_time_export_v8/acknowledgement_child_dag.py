...
def create_dag(config):
    with rail.create_airflow_dag(
        dag_id=f'dxctechnology_acknowledgement_not_received_notification_{config.instance}_v8',
        description=f'DXCTechnology_CWF Time export Acknowledgement Notification Not Received v8 {config.instance}',

...
import pendulum
import rail
from dxctechnology.compass_wbs_file_merger_v1.utils import python_callable_method
from dxctechnology.compass_wbs_file_merger_v1.utils import custom_method
...
def create_dag(config):
    ...
    with rail.create_airflow_dag(
        dag_id=f'dxctechnology_compass_wbs_file_merger_master_{config.dag_id_postfix}_v1',
        description=f'DXCtechnology Compass Wbs file merger master V1.0 {config.dag_id_postfix}_v1',
        ...
        process_reading_files = rail.TriggerDagRunForEachItemOperator(
            ...
            trigger_dag_id=f'dxctechnology_compass_wbs_file_merger_child_{config.dag_id_postfix}_v1',
            conf={

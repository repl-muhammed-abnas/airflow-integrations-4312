...
replicon_conn_id = 'dxctechnology_replicon_autosubmissionloa'
sftp_conn_id = "sftp_dxctechnology_628172LOA"

tenant_email = 'dxcintegrationlogsreplicon@deltek.com'
internal_logs_email = '{{ var.value.dagrun_internal_log_email }}'
alert_email = '{{ var.value.dagrun_failure_alert_email }}'

sftp_upload_path = '/Production/TimesheetAutoSubmissionLOA/Logs/'

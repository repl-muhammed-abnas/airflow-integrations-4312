...
def create_dag(config):
    with rail.create_airflow_dag(
        dag_id=config.gsap_child_dag_id,
        description=f'DxcTechnology TimeSheet Auto Submission LOA Each Month GSAP Child {config.instance}',
                ...
                "reportParameters": [
                    {
                        ...
                        "filterValues": get_filters(dag_run,'gsap_company_code_uri_values'),
        ...
        process_timesheet_autosubmission_child = rail.TriggerDagRunForEachItemOperator(
            ...
            trigger_dag_id=config.process_gsap_timesheet_dag_id,

...
import rail
from dxctechnology.c1_wbs_import_v8.utils import python_callable_method
from dxctechnology.c1_wbs_import_v8.utils import response_filter
...
def create_main_dag(config):
    with rail.create_airflow_dag(
        ...
        parse_xml = rail.LoadXMLFileOperator(
            ...
            xsd_document='./dags/dxctechnology/c1_wbs_import_v8/xml_schema/input_schema.xsd'
        )

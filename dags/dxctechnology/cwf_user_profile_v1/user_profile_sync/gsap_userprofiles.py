...
def create_process_userprofile_child_dag(config):
    with rail.create_airflow_dag(
        dag_id=config.gsap_process_userprofiles_dagid,
        description=f'DXC_Fieldglass GSAP UserProfiles_Child {config.instance}',
        ...
        update_user_employeeid, wait_for_update_user_employeeid = process_updateuser_task_group(
            config.execution_timeout_days, config.gsap_update_userprofiles_dagid, 'emp_id')
        ...
        update_user_loginname, wait_for_update_user_loginname = process_updateuser_task_group(
            config.execution_timeout_days, config.gsap_update_userprofiles_dagid, 'login_name')
        ...
        add_userprofile_child_dag = rail.TriggerDagRunForEachItemOperator(
            ...
            execution_timeout=timedelta(
                days=config.execution_timeout_days),
            trigger_dag_id=config.gsap_add_userprofiles_dagid,

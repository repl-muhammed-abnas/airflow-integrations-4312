...
import rail
from dxctechnology.cwf_user_profile_v1.user_profile_sync.utils.python_callable_method import get_activities_to_update, \
    log_supervisor, compose_supervisor_details
from dxctechnology.cwf_user_profile_v1.user_profile_sync.utils.request_payload import get_data_for_supervisor_payload, get_today_date
from dxctechnology.cwf_user_profile_v1.user_profile_sync.utils.response_filter import map_supervisor_list_data, get_missing_permissions


def process_supervisor_assignment_task_group(execution_timeout_days, should_update_supervisor, is_update_user=False):
    ...
    return (assign_supervisor, log_supervisor_check, get_update_activities_payload) if is_update_user else (
        assign_supervisor, log_supervisor_check)

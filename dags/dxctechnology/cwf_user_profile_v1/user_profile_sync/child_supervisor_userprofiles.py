...
from dxctechnology.cwf_user_profile_v1.user_profile_sync.utils.response_filter import get_missing_permissions, map_supervisor_list_data
from dxctechnology.cwf_user_profile_v1.user_profile_sync.utils.python_callable_method import compose_supervisor_details, add_supervisorcheck_user_log
...
def create_supervisor_userprofile_child_dag(config):
    with rail.create_airflow_dag(
        dag_id=config.cwf_supervisor_userprofiles_dagid,

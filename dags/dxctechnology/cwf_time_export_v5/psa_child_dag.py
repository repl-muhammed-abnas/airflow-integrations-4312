...
from dxctechnology.cwf_time_export_v5.utils import response_filter
...
def create_dag(config):
    ...
    with rail.create_airflow_dag(
        dag_id=f'dxctechnology_cwf_time_export_psa_child_{config.instance}_v5',
        description=f'DXCTechnology_PSA WF39 Child for C1 Reg and Compass Reg V5 {config.instance}',
        ...
        process_acknowledgement_not_received = rail.TriggerDagRunForEachItemOperator(
            ...
            trigger_dag_id=f'dxctechnology_acknowledgement_not_received_notification_{config.instance}_v5',

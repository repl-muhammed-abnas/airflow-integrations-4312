...
def create_main_dag(config):
    with rail.create_airflow_dag(
        dag_id=f"dxctechnology_australia_payrollexport_active_user_master_dag_{config.instance}",
        description=f"DXC_AUS_PayrollExport_Active_User_Master {config.instance}",

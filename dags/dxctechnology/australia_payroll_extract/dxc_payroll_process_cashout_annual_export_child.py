...
def create_child_dag(config):
    with rail.create_airflow_dag(
        dag_id=f'dxctechnology_australia_payrolldata_export_sellback_child_{config.instance}',
        description=f'DXC_Australia_PayrollData_Export_SellBack_Child {config.instance}',
        ...
        final_sell_back_balance_data_to_csv = rail.WriteCSVFileOperator(
            ...
            "ENDDA","OBJPS","SPRPS","SEQNR","EXTRA","QCTYP","STYPE","WAERS","QTYPE","SRULE","NUMBR",
            "AMONT","WGTYP", "QUONR", "DOCSY", "DOCNR", "NOPAY", "COMAL"],
        ...
        create_log >> get_file_name >> process_start_time >> process_start_time_ymd_format >> process_start_time_hms_format >> \
            get_all_timeOffTypes >> get_all_enabled_divisions >> get_sell_back_balance_report_details >> load_sell_back_balance_report

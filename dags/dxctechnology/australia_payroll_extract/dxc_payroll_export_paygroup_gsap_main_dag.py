...
from dxctechnology.australia_payroll_extract.mapper.company_code_mapper_usles_uscsc import COMPANY_CODE_MAP_GSAP


def create_main_dag(config):
    with rail.create_airflow_dag(
        dag_id=f"dxctechnology_australia_payrollexport_gsap_master_dag_{config.instance}",
        description=f"DXC_AUS_PayrollExport_GSAP_Master {config.instance}",
        ...
        process_payrolldata_export = rail.TriggerDagRunForEachItemOperator(
            ...
            trigger_dag_id=f'dxctechnology_australia_payrolldata_export_gsap_child_{config.instance}',

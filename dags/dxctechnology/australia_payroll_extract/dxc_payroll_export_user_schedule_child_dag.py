...
def create_child_dag(config):
    with rail.create_airflow_dag(
        dag_id=f'dxctechnology_australia_payrolldata_export_user_schedule_child_{config.instance}',
        description=f'DXC_Australia_PayrollData_Export_User_Schedule_Child {config.instance}',

...
sftp_conn_id = 'sftp_dxctechnology_payrollexport'
secondary_sftp_conn_id = 'sftp_dxctechnology_useast_prod'
...
output_filepath = '/in'
log_filepath = '/in'
secondary_filepath = '/DXC/outbound/prod/payrollexport/Portugal/'

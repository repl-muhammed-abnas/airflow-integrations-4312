...
from dxctechnology.cwf_time_export.task.field_glass_compass_task import get_compass_task
from dxctechnology.cwf_time_export.task.c1_task import get_c1_task
...
def create_dag(config):
    ...
    with rail.create_airflow_dag(
        dag_id=f'dxctechnology_cwf_time_export_field_glass_{config.instance}',
        description=f'DXCTechnology_CWF Time - Fieldglass report export V2.0 {config.instance}',

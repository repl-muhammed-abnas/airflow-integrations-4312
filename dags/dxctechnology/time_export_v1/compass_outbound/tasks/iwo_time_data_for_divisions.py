import rail
from dxctechnology.time_export_v1.compass_outbound.utils import custom_methods

#pylint: disable=too-many-arguments


def get_iwo_time_data_for_divisions(code, task_type):
    with rail.TaskGroup(group_id=f'iwo_time_data_for_{task_type}', prefix_group_id=False) as create_time_dataset:
        ...
        final_data = rail.CreateCollectionOperator(
            ...
            source=lambda: custom_methods.get_each_company_final_iwo_data(rail.result(f"query_{task_type}_data"),

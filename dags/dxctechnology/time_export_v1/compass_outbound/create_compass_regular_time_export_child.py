...
from dxctechnology.time_export_v1.compass_outbound.tasks.reg_time_data_for_divisions import get_reg_time_data_for_divisions
    ...
    with rail.create_airflow_dag(
        ...
        query_filter_time_export_data = rail.QueryCollectionOperator(
            ...
            query="""SELECT * FROM finaltimedata
                ...
                OR (
                    companycodecode = 'COMPASS'
                    AND timeofftypename = "[IND] Leave without pay"
                    AND onleave = "0"
                )
        ...
        if_final_timedata_has_data >> rail.Label("Yes") >> get_effectively_enabled_compass_divisions >> get_all_divisions_with_description >> get_timeoff_types_to_exclude_in_export \

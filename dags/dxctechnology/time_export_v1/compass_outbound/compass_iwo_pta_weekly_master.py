...
def create_main_dag(config):
    with rail.create_airflow_dag(
        dag_id=config.compass_iwo_time_export_pta_weekly_master_dagid,
        description=f"DXC - Compass IWO Time Export PTA Weekly Master - {config.instance}",
        ...
        get_all_gsap_c1_divisions = rail.RepliconServicePageOperator(
            task_id="get_all_gsap_c1_divisions",
            endpoint="/services/DivisionListService1.svc/GetData",
            data=request_payload.get_gsap_c1_divisions_payload,
        ...
        get_filter_data_for_compass_iwo_time_export = rail.PythonOperator(
            task_id='get_filter_data_for_compass_iwo_time_export',
            python_callable=custom_methods.filter_data_for_compass_iwo_pta_weekly_time_export,
            op_args=[config]
        )
        ...
        get_past_time_exports_data_for_compass = rail.RepliconServiceOperator(
            ...
            data=lambda: request_payload.get_past_time_export_data_payload("IWOP-CP",
                rail.result("get_filter_data_for_compass_iwo_time_export")),
        ...
        create_timedata_exportbatch = rail.RepliconServiceOperator(
            ...
            data=request_payload.create_compass_iwo_time_export_payload
        )
        ...
        update_cancelled_timedataexport_name = rail.RepliconServiceOperator(
            ...
            data={
                ...
                "name": 'CP_cancel_{{ dag_run_ecid() }}_IWOPTA',
            }
        )
        ...
        process_gsap_iwo_time_export = rail.TriggerDagRunOperator(
            ...
            conf=lambda: {
                'downloadurl': null,
                'fileformaturi': rail.result('get_filter_data_for_compass_iwo_time_export')['fileformaturi'],
                'hoursfileformaturi': rail.result('get_filter_data_for_compass_iwo_time_export')['hoursfileformaturi'],
                ...
                'lasttwbuniqueindentifier': rail.result('get_past_time_exports_data_for_compass')[0]['timeexport'] + "|GS",
        ...
        process_c1_iwo_time_export = rail.TriggerDagRunOperator(
            ...
            conf=lambda: {
                ...
                'lasttwbuniqueindentifier': rail.result('get_past_time_exports_data_for_compass')[0]['timeexport'] + "|C1",
                'twblist': rail.result('get_past_time_exports_data_for_compass'),
                'type': "IWO",
                'process_start_time': rail.result('get_process_starttime')
            }
        ...
        get_process_starttime >> get_all_gsap_c1_divisions >> get_all_filter_definitions \
            >> get_time_download_script >> get_employeetype_groups >> get_oef_details \
                >> get_oef_drop_down_values_project_type >> get_filter_data_for_compass_iwo_time_export \

...
def create_main_dag(config):
    with rail.create_airflow_dag(
        dag_id=config.compass_iwo_time_export_master_dagid,
        description=f"DXC - Compass IWO Time Export Master - {config.instance}",
        ...
        get_filter_data_for_compass_iwo_time_export = rail.PythonOperator(
            ...
            python_callable=custom_methods.filter_data_for_compass_iwo_time_export,
            op_args=[config]
        )
        ...
        get_past_time_exports_data_for_compass = rail.RepliconServiceOperator(
            ...
            data=lambda: request_payload.get_past_time_export_data_payload("IWO-CP",
        ...
        update_cancelled_timedataexport_name = rail.RepliconServiceOperator(
            ...
            data={
                ...
                "name": 'CP_cancel_{{ dag_run_ecid() }}_IWO',
            }
        )

...
def create_main_dag(config):
    ...
    with rail.create_airflow_dag(
        dag_id=config.gsap_iwo_time_export_master_dagid,
        description=f"DXC - GSAP IWO Time Export Master - {config.instance}",
        ...
        get_filter_data_for_gsap_iwo_time_export = rail.PythonOperator(
            ...
            python_callable=custom_methods.filter_data_for_gsap_iwo_time_export,
            op_args=[config]
        )
        ...
        get_past_time_exports_data_for_GSAP = rail.RepliconServiceOperator(
            ...
            data=lambda: request_payload.get_past_time_export_data_payload("IWO-GS", rail.result("get_filter_data_for_gsap_iwo_time_export")),
        ...
        update_cancelled_timedataexport_name = rail.RepliconServiceOperator(
            ...
            data={
                ...
                "name": 'GS_cancel_{{ dag_run_ecid() }}_IWO',
            }
        )

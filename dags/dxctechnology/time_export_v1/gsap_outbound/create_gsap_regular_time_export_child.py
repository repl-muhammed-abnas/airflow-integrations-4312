...
def create_child_dag(config):
    ...
    with rail.create_airflow_dag(
        dag_id=config.gsap_regular_create_time_export_child_dagid,
        description=f"DXC - GSAP Regular Time Export Create GSAP Regular Time export child - {config.instance}",
        ...
        get_query_to_filter_time_export_data = rail.PythonOperator(
            ...
            python_callable=custom_methods.get_query_to_filter_reg_time_export_data
        )
        ...
        final_export_data = rail.QueryCollectionOperator(
            ...
            query="SELECT * FROM filtered_time_export_data UNION ALL SELECT * FROM ineligible_and_reversals",
        ...
        write_final_data_for_processing_csv = rail.WriteCSVFileOperator(
            ...
            row=custom_methods.get_write_final_regular_data_for_processing_csv
        )
        ...
        upload_gsap_regular_file_to_sftp = rail.SFTPUploadFileOperator(
            task_id='upload_gsap_regular_file_to_sftp',
        ...
        is_sftp_upload_failed = rail.IfOperator(
            ...
            test='{{ get_task_state("upload_gsap_regular_file_to_sftp").lower() == "failed" }}',
        ...
        query_filter_time_export_data >> query_ineligible_and_reversals >> final_export_data >> if_filtered_timedata_has_data
        ...
        log_no_data_var >> get_data_existence_var >> create_document_gsap_xml >> upload_gsap_regular_file_to_sftp \
            >> check_any_failures

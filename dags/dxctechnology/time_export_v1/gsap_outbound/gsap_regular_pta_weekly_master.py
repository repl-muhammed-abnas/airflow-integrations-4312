...
def create_main_dag(config):
    ...
    with rail.create_airflow_dag(
        dag_id=config.gsap_regular_time_export_pta_weekly_master_dagid,
        description=f"DXC - GSAP Regular Time Export PTA Weekly Master - {config.instance}",
        ...
        get_filter_data_for_gsap_reg_time_export = rail.PythonOperator(
            ...
            python_callable=custom_methods.filter_data_for_gsap_reg_pta_weekly_time_export,
            op_args=[config]
        )
        ...
        get_past_time_exports_data_for_GSAP = rail.RepliconServiceOperator(
            ...
            data=lambda: request_payload.get_past_time_export_data_payload("REGP-GS", rail.result("get_filter_data_for_gsap_reg_time_export")),
        ...
        update_cancelled_timedataexport_name = rail.RepliconServiceOperator(
            ...
            data={
                ...
                "name": 'GS_cancel_{{ dag_run_ecid() }}_RegPTA',
            }
        )

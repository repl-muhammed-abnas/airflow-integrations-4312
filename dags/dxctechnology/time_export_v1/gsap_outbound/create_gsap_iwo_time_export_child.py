...
import pendulum
from dxctechnology.time_export_v1.gsap_outbound.utils import request_payload, custom_methods
...
def create_child_dag(config):
    ...
    with rail.create_airflow_dag(
        ...
        if_collections_have_data >> rail.Label("Yes") >> get_timeoff_types_to_export
        if_collections_have_data >> rail.Label("No") >> empty_final_data >> log_no_data_var

        get_timeoff_types_to_export >> get_query_to_filter_time_export_data >> query_filter_time_export_data \
            >> query_ineligible_and_reversals >> query_iwo_reversals >> final_export_data >> if_filtered_timedata_has_data
        ...
        if_no_data >> rail.Label("No") >> send_gsap_export_complete_email >> dag_run_log_to_sumo >> batch_end

...
def get_specific_payload(response, locations_company_codes_mapper, key):
    wanted = {entry[key] for entry in locations_company_codes_mapper}
    return [data for data in response if data["displayText"] in wanted]

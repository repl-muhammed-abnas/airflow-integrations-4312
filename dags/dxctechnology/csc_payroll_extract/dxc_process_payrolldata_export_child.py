...
from dxctechnology.csc_payroll_extract import response_filter


def create_child_dag(config):
    with rail.create_airflow_dag(
        dag_id=f'dxctechnology_lcsc_location_company_codewise_payrolldata_export_child_{config.instance}',

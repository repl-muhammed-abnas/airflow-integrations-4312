...
import rail
from dxctechnology.c1_wbs_import_v2.utils import python_callable_method
from dxctechnology.c1_wbs_import_v2.utils import response_filter
from dxctechnology.c1_wbs_import_v2.utils import request_payload
...
def create_main_dag(config):
    with rail.create_airflow_dag(
        dag_id=f'dxctechnology_c1_wbs_import_master_v2_{config.instance}',
        description=f'DXC_C1_WBS_Automation Master V2 - SFTP {config.instance}',
        ...
        parse_xml = rail.LoadXMLFileOperator(
            ...
            xsd_document='./dags/dxctechnology/c1_wbs_import_v2/xml_schema/input_schema.xsd'
        )

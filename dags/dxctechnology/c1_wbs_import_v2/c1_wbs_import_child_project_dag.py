...
from dxctechnology.c1_wbs_import_v2.tasks import field_config
...
def create_child_dag(config):
    with rail.create_airflow_dag(
        dag_id=f'dxctechnology_c1_wbs_import_child_project_v2_{config.instance}',
        description=f'DXC_C1 WBS Automation Child V2 {config.instance}',
        ...
        can_update_psa_flag = rail.IfOperator(
            ...
            test='{{ dag_run.conf.ProjectType == "RP" and dag_run.conf.ProjectIdentifier == "Velocity Only" }}',
        ...
        is_project_exist >> rail.Label(
            "Yes") >> get_all_project_task >> get_all_attribute_1_project_dependant_fields\
                >> get_all_attribute_2_project_dependant_fields >> get_project_info_based_on_wbs_element
        ...
        can_update_time_tracking_oef >> rail.Label(
            "No") >> update_russia_udf
        update_russia_udf >> can_update_project_identifier >> rail.Label(

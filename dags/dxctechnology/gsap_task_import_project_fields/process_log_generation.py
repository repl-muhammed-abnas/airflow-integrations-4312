...
from dxctechnology.gsap_task_import_project_fields.utils.python_callable_method import do_format_wbs_logs

# pylint: disable=too-many-statements
def create_child_dag_wbs(config):
    with rail.create_airflow_dag(
        dag_id=f'dxctechnology_gsap_project_field_task_import_child_process_log_generation_{config.instance}',

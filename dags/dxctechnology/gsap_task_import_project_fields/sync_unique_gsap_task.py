...
def create_dag(config):
    with rail.create_airflow_dag(
        dag_id=f'dxctechnology_gsap_project_field_task_import_add_gsap_task_{config.instance}',
        ...
        log_attribute_already_exist = rail.WriteLogOperator(
            ...
            log = "{{dag_run.conf.master_dag_log}}",
            message="Task already exits",
            properties={
                'Level': "System",
                'wbs': "NA",

...
from dxctechnology.gsap_task_import_project_fields.task.trigger_parallel_dagrun_async import trigger_parallel_dagrun_async
...
def create_iwo_details_wbs_update_reprocess_batch(config):
    ...
    with rail.create_airflow_dag(
        dag_id=f'dxctechnology_gsap_project_field_task_import_reprocess_batch_{config.instance}',

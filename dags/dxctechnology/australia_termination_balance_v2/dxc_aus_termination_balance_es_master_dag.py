...
def create_main_dag(config):
    with rail.create_airflow_dag(
        dag_id=f"dxctechnology_aus_termination_balance_es_master_dag_{config.instance}_v2",
        description=f"DXC - AUS_termination_balance_ES_Master - {config.instance} V2",

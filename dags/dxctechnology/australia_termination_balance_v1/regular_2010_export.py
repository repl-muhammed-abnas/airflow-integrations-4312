...
def create_child_dag(config):
    with rail.create_airflow_dag(
        dag_id=f'dxctechnology_australia_terminated_export_regular_child_{config.instance}_v1',
        description=f'DXC_Australia_PayrollData_Export_ES_Child V1 {config.instance}',
        ...
        process_absence_taken = rail.TriggerDagRunOperator(
            ...
            retries=0,
            trigger_dag_id=f'dxctechnology_australia_terminated_export_absence_taken_child_{config.instance}_v1',
            execution_timeout=timedelta(days=config.execution_timeout_days),
            conf=request_payload.process_absence_taken_conf
        )
        ...
        create_log >> process_start_time >> process_start_time_ymd_format >> process_start_time_hms_format >> \
            logging_job_start_time >> get_file_name
        get_file_name >> query_list_in_final_absence_payroll_collection >> has_absence_item_data

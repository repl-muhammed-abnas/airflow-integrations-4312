...
def create_dag(config):
    ...
    with rail.create_airflow_dag(
        dag_id=f'dxctechnology_cwf_time_export_c1_compass_master_{config.instance}_v3',
        description=f'DXCTechnology_CWF Time export - Master V3 {config.instance}',
        ...
        process_c1_time_export = rail.TriggerDagRunOperator(
            ...
            retries=0,
            trigger_dag_id=f'dxctechnology_cwf_time_export_c1_child_{config.instance}_v3',
        ...
        process_compass_time_export = rail.TriggerDagRunOperator(
            ...
            retries=0,
            trigger_dag_id=f'dxctechnology_cwf_time_export_compass_child_{config.instance}_v3',
            execution_timeout=timedelta(days=14),
        ...
        process_gsap_time_export = rail.TriggerDagRunOperator(
            ...
            retries=0,
            trigger_dag_id=f'dxctechnology_cwf_time_export_gsap_child_{config.instance}_v3',
            execution_timeout=timedelta(days=14),
            # pylint: disable=line-too-long
        ...
        marktimedataexport_as_complete >> rail.Label('on success') >> process_c1_time_export >> \
            process_compass_time_export >> process_gsap_time_export

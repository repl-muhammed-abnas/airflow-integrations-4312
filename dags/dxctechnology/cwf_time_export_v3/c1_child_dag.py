...
def create_dag(config):
    ...
    with rail.create_airflow_dag(
        dag_id=f'dxctechnology_cwf_time_export_c1_child_{config.instance}_v3',
        description=f'DXCTechnology_CWF Time export - C1 V3 {config.instance}',
        ...
        def map_row(item):
            ...
            return {
                ...
                (item['c1cwfalternateid'] if ("Agency" in item['employeetypename']) else (item['perner'] if
                item['iwoindicator'] and item['iwoindicator'] == "C1" else item['employeeid'])),

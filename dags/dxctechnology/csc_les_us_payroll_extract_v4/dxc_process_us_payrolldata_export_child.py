...
from dxctechnology.csc_les_us_payroll_extract_v4 import response_filter


def create_child_dag(config):
    with rail.create_airflow_dag(
        dag_id=f'dxctechnology_lcsc_location_company_codewise_usa_payrolldata_export_child_v4_{config.instance}',
        description=f'DXC_Location_Company_Codewise_PayrollData_Export_Child - v4.0{config.instance}',

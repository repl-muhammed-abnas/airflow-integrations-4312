...
from dxctechnology.workday_user_import.user_import.common_utils.request_payload import get_todays_minus_specified_days_date_in_json
from dxctechnology.workday_user_import.user_import_usa_csc.utils import request_payload, custom_methods
from dxctechnology.workday_user_import.user_import_usa_csc.tasks.supervisor_assignment import assign_supervisor
...
def create_update_user_dag(config):
    with rail.create_airflow_dag(
        ...
        is_parent_company_c1_and_empgrpcode_not_equal_3 = rail.IfOperator(
            ...
            test=lambda dag_run: dag_run.conf['file_data']['parent_company'] =="C1",
        ...
        process_update_user_timeoff_assignment_us_les = rail.EmptyOperator(
        ...
        can_update_user >> rail.Label("No") >> log_user_processing_exception >> rail.Label("No") >> catch_and_log_error
        ...
        process_update_user_timeoff_assignment_us_csc >> wait_for_timeoff_assignment_us_csc >> log_user_completion >> rail.Label("No") >> catch_and_log_error
        process_update_user_timeoff_assignment_us_les >> log_user_completion

...
def create_add_user_timeoff_assignment_dag(config):
    with rail.create_airflow_dag(
        ...
        is_wait_required =  rail.IfOperator(
            ...
            test=lambda: rail.result("trigger_vacation_accrued_timeoff_assignment") or rail.result("trigger_us_holiday_timeoff_assignment")
        ...
        wait_for_timeoff_triggers = rail.WaitForDagRunsSensor(
            ...
            dag_runs="""{{ result('trigger_vacation_accrued_timeoff_assignment') or result('trigger_us_holiday_timeoff_assignment') or result('trigger_us_sick_non_california_timeoff_assignment')}}""",
        ...
        timeoff_name_is_sick_time >> rail.Label("Yes") >> trigger_us_sick_non_california_timeoff_assignment >> timeoff_name_is_es_holiday

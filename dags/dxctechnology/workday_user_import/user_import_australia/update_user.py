...
def create_dag(config):
    with rail.create_airflow_dag(
        ...
        is_user_disabled_and_replicon_field_false >> rail.Label("Yes") >> dummy_is_user_disabled_and_replicon_field_false_yes_task >> can_update_user_end_date_2 >> rail.Label("Yes")\
            >> update_user_end_date_3 >> log_disabled_user_106 >> rail.Label("No") >> catch_and_log_error
        ...
        is_user_for_disable >> rail.Label("No") >> is_already_disable_for_long_leave >> rail.Label("Yes") >> log_disable_for_long_leave >> rail.Label("No") >> catch_and_log_error
        ...
        has_any_timeoffs_to_process >> rail.Label("No") >> add_for_supervisor_assignment >> log_user_completion >> rail.Label("On Error") >> catch_and_log_error
        has_any_timeoffs_to_process >> rail.Label("Yes") >> process_timeoff_assignment >> wait_for_process_timeoff_assignment >> add_for_supervisor_assignment

...
def create_dag(config):
    with rail.create_airflow_dag(
        dag_id=config.workday_user_import_australia_users_aus_lsl_protata_timeoff_assignment_child_dag,
        ...
        def get_policy_to_assign_callable(dag_run, add_new_policy_line=False):
            ...
            for _policy in default_policy_for_timeoff:

...
from dxctechnology.workday_user_import.user_import_global.utils.response_filter import get_effective_grp_membership_data_handler
...
def create_dag(config):
    with rail.create_airflow_dag(
        ...
        def has_any_exception_callable(dag_run):
            if ((not rail.result("get_data_access_scope_to_assign")) or (not rail.result("get_data_access_scope_to_assign2")) or (not rail.result("get_data_access_scope_to_assign3"))):
                return False

...
from dxctechnology.workday_user_import.user_import_usa_les.utils import request_payload, custom_methods
from dxctechnology.workday_user_import.user_import_usa_les.tasks.supervisor_assignment import assign_supervisor
...
def create_update_user_dag(config):
    ...
    with rail.create_airflow_dag(
        ...
        is_user_already_disabled_and_on_leave >> rail.Label("Yes") >> log_is_user_already_disabled_and_on_leave >> rail.Label("No") >> catch_and_log_error
        ...
        end_supervisor_assignment >> process_update_user_timeoff_assignment >> wait_for_timeoff_assignment >> log_user_completion >> rail.Label("No") >> catch_and_log_error

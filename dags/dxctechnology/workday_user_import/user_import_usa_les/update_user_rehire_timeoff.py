...
def create_update_rehire_dag(config):
    with rail.create_airflow_dag(
        dag_id=config.workday_user_import_usa_les_users_update_user_rehire_timeoff_process_child_dag,
...
rail.for_each_instance(create_update_rehire_dag)

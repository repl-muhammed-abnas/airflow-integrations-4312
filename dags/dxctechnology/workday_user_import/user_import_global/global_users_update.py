...
from dxctechnology.workday_user_import.user_import_global.utils import custom_methods
from dxctechnology.workday_user_import.user_import_global.utils.request_payload import prepare_update_user_payload_callable
...
def create_dag(config):
    with rail.create_airflow_dag(
        dag_id=config.workday_user_import_global_users_update_user_child_dag,
        ...
        trigger_timeoff_update_for_user = rail.TriggerDagRunOperator(
            ...
            trigger_dag_id=config.workday_user_import_global_users_update_user_timeoff_process_child_dag,
            conf=lambda dag_run: {
                "file_name": dag_run.conf["master_file_name"],
                "user_uri": dag_run.conf["user_uri"],
                "user_log": dag_run.conf['user_log'],

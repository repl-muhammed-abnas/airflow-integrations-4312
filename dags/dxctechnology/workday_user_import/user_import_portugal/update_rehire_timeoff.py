...
def create_dag(config):
    with rail.create_airflow_dag(
        ...
        def get_policy_to_assign_callable(dag_run):
            ...
            current_timeoff_policies = (loads(dag_run.conf['current_timeoff_policies']) if isinstance(dag_run.conf['current_timeoff_policies'], str) else dag_run.conf['current_timeoff_policies']) if dag_run.conf['current_timeoff_policies'] else []

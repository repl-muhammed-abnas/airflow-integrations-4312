...
import rail
from dxctechnology.workday_user_import.disable_user.utils.data_handler import get_user_timeoff_type_policy_summary_data_handler
...
def create_child_dag(config):
    ...
    for idx in range(config.process_disable_user_dag_count):
        ...
        with rail.create_airflow_dag(
            ...
            #! This dag code is available under dxctechnology\workday_user_import\user_import\generic_dags
            ...
            validate_employee_type >> rail.Label("Process disable") >> disable_user_login \

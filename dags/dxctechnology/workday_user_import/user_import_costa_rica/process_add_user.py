...
from dxctechnology.workday_user_import.user_import_costa_rica.utils import request_payload, custom_methods
from dxctechnology.workday_user_import.user_import_costa_rica.tasks.supervisor_assignment import assign_supervisor

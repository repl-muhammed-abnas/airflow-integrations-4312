...
tertiary_pgp_conn_id = 'pgp_dxctechnology_replicon_USADPPayroll'
tertiary_sftp_conn_id = 'sftp_dxtechnology_628172_USADPPayroll'
tertiary_encrypted_filepath = '/payroll/output/'
tertiary_log_filepath = '/payroll/logs/'

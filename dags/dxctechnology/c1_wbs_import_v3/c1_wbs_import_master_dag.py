...
import rail
from dxctechnology.c1_wbs_import_v3.utils import python_callable_method
from dxctechnology.c1_wbs_import_v3.utils import response_filter
...
def create_main_dag(config):
    with rail.create_airflow_dag(
        ...
        parse_xml = rail.LoadXMLFileOperator(
            ...
            xsd_document='./dags/dxctechnology/c1_wbs_import_v3/xml_schema/input_schema.xsd'
        )
        ...
        get_details_from_xml >> create_project_collection >> \
            ...
            get_rusia_custom_field_dropdown_options >> get_gsap_company_codes >> get_all_object_extension_field_projects

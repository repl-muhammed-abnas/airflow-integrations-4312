...
import rail
from dxctechnology.c1_wbs_import_v9.utils import python_callable_method
from dxctechnology.c1_wbs_import_v9.utils import response_filter
from dxctechnology.c1_wbs_import_v9.utils import request_payload

# config : https://github.com/replicon/airflow-integrations/blob/main/dags/dxctechnology/c1_wbs_import_v9/config.py
...
def create_main_dag(config):
    with rail.create_airflow_dag(
        ...
        parse_xml = rail.LoadXMLFileOperator(
            ...
            xsd_document='./dags/dxctechnology/c1_wbs_import_v9/xml_schema/input_schema.xsd'
        )

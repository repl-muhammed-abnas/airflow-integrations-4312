    ...
    with rail.TaskGroup(group_id='send_logs', prefix_group_id=False):
        ...
        render_logs_csv = rail.WriteCSVFileOperator(
            ...
            header=[
                ...
                'Function: GSAP Task Master inbound'],
            ...
            footer=[
                ...
                'Number of Records with Exception: {{ result("get_logged_exceptions", key="length") }}',
                'Number of Records Skipped: {{result("get_logged_skipped", key="length")}}',
                ''],
        )
        ...
        send_import_complete_email = rail.EmailOperator(
            ...
            bcc="{%- if result('get_logged_errors', 'length') == 0 -%}\
                ...
                {%- else -%}\
                    "+config.alert_email+"\
                {%- endif -%}",
            subject='{{ get_company_key() + " | Replicon task assignment sync for GSAP Task - " }} \

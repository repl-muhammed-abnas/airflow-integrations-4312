...
def create_dag(config):
    with rail.create_airflow_dag(
        dag_id=f'dxctechnology_c1_iwo_leanstaffing_process_each_record_{config.instance}',
        ...
        c1_lean_staffing_c1_automation_child = rail.TriggerDagRunForEachItemOperator(
            ...
            trigger_dag_id=f'dxctechnology_c1_iwo_leanstaffing_automation_child_{config.instance}',

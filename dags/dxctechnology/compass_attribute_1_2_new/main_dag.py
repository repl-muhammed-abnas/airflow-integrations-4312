...
from dxctechnology.compass_attribute_1_2_new.task.get_system_level_attribute import get_system_level_attribute
# pylint: disable=too-many-statements


def create_dag(config):
    with rail.create_airflow_dag(
        dag_id=f'dxctechnology_compass_attribute_1_2_master_new_{config.instance}_{config.sub_erp}_{config.attribute}',
        ...
        sync_unique_atrribute_system_level = rail.TriggerDagRunForEachItemOperator(
            ...
            trigger_dag_id=f'dxctechnology_child_sync_attribute_system_level_{config.instance}_{config.sub_erp}_{config.attribute}',
            conf=lambda item: {
        ...
        sync_attribute_1_2_file = rail.TriggerDagRunForEachItemOperator(
            ...
            execution_timeout=timedelta(days=config.execution_timeout_days),
            trigger_dag_id=f'dxctechnology_child_sync_attributes_1_2_file_{config.instance}_{config.sub_erp}_{config.attribute}',

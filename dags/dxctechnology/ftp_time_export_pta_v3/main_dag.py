...
from dxctechnology.ftp_time_export_pta_v3.utils import request_payload
from dxctechnology.ftp_time_export_pta_v3.utils import response_filter
from dxctechnology.ftp_time_export_pta_v3.utils import custom_method
...
def create_dag(config):
    with rail.create_airflow_dag(
        dag_id=f'dxctechnology_time_export_ftp_pta_v3_{config.instance}',
        ...
        process_all_unackn_exports = rail.TriggerDagRunForEachItemOperator(
            ...
            trigger_dag_id=f'dxctechnology_ftp_pta_child_v3_process_all_unackn_export_{config.instance}',
            conf=lambda item: {

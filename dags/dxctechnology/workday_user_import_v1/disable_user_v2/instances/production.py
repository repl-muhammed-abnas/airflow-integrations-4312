...
from dxctechnology.workday_user_import_v1.disable_user_v2.config import *

instance = "production"
version = '_v2' # _v1,_v2,_v3 etc.

environment = "production"

company_key = "dxctechnology"
replicon_conn_id = "dxctechnology_replicon_x.replicon.workday5"
...
# this is used in all the user import update dags so if any new version is deployed we have to update the same in all user import instance files

...
from dxctechnology.workday_user_import_v1.user_import.common_utils.custom_methods import get_date_to_use_for_no_accrual, convert_json_date_to_date
from dxctechnology.workday_user_import_v1.user_import.common_utils import request_payload as gbl_request_payload
from dxctechnology.workday_user_import_v1.user_import_costa_rica_v2.utils import custom_methods
from dxctechnology.workday_user_import_v1.user_import.common_utils.request_payload import get_json_date_from_date_str
from dxctechnology.workday_user_import_v1.user_import_costa_rica_v2.mappers.costa_rica_specific_timeoffs import should_preserve_timeoff
null = None
...
def create_update_user_timeoff_assignment_dag(config):
    with rail.create_airflow_dag(
        ...
        assign_timeoff_to_user = rail.RepliconServiceOperator(
            ...
            data=lambda dag_run :{
                "userUri": dag_run.conf['user_uri'],
                "timeOffTypeUris": rail.result("get_mapper_timeoff_types_uri")
            }
        )

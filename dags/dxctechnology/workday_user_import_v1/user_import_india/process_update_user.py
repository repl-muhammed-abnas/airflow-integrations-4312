...
def create_update_user_dag(config):
    with rail.create_airflow_dag(
        ...
        should_disable_user >> rail.Label('Yes') >> update_user_end_date_53 >> is_end_date_less_than_today >> rail.Label("No") >> update_user
        ...
        check_for_is_ia_update >> rail.Label('Yes') >> is_log_for_ia_exception_applicable >> rail.Label('Yes') >> log_ia_exception >> should_trigger_delete_time_and_timeoff
        ...
        wait_for_update_user_timeoff_assignment >> log_user_completion >> should_trigger_delete_time_and_timeoff >> rail.Label("Yes") >> trigger_cleanup_for_disabled_user >> wait_for_trigger_cleanup_for_disabled_user >> catch_and_log_error

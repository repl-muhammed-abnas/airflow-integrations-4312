...
from dxctechnology.workday_user_import_v1.user_import_usa_csc_v2.utils import request_payload, custom_methods
from dxctechnology.workday_user_import_v1.user_import_usa_csc_v2.tasks.supervisor_assignment import assign_supervisor
...
def create_update_user_dag(config):
    with rail.create_airflow_dag(
        ...
        def has_any_user_exception_callable(dag_run):
            if dag_run.conf['file_data']['is_ia'] and dag_run.conf['file_data']['is_ia'] != "users_value" and dag_run.conf['file_data']['parent_company']== "COMPASS":

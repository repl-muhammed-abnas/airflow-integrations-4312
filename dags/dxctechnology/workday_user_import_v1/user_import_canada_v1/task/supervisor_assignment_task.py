...
from dxctechnology.workday_user_import_v1.user_import_canada_v1.utils.custom_methods import is_profile_enabled
...
def assign_supervisor(group_id, caller):
    with rail.TaskGroup(group_id=group_id, prefix_group_id=False):
        ...
        assign_end_user_permission = rail.RepliconServiceOperator(
            ...
            data=lambda dag_run: {
                "userUri": rail.result('get_supervisor_details')['user_uri'],
                "permissionSetUri": dag_run.conf['user_permission_sets']['end_user_permission'].get('uri')
            }
        )

...
def create_dag(config):
    with rail.create_airflow_dag(
        dag_id=config.workday_user_import_portugal_users_update_user_rehire_timeoff_process_child_dag,
        ...
        def get_policy_to_assign_callable(dag_run):
            ...
            current_timeoff_policies = (loads(dag_run.conf['current_timeoff_policies']) if isinstance(dag_run.conf['current_timeoff_policies'], str) else dag_run.conf['current_timeoff_policies']) if dag_run.conf.get('current_timeoff_policies') else []

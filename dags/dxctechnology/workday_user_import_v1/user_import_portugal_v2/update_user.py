...
def create_update_user_dag(config):
    ...
    with rail.create_airflow_dag(
        ...
        can_update_user_start_date >> rail.Label("Yes") >> update_user_start_date2 >> should_disable_user >> rail.Label("Yes") >> update_user_end_date_5\
            ...
            >> disable_user_login_5 >> trigger_process_timeoff_policies >> wait_for_process_timeoff_policies >> log_disabled_user_22
        ...
        end_supervisor_update >> trigger_timeoff_update_for_user >> wait_for_user_timeoff_update_completion >> log_user_completion >> should_trigger_delete_time_and_timeoff >> rail.Label("Yes") >> trigger_cleanup_for_disabled_user >> wait_for_trigger_cleanup_for_disabled_user >> catch_and_log_error

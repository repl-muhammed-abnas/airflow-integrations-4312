...
from dxctechnology.workday_user_import_v1.user_import_philippines.utils.response_filter import get_effective_grp_membership_data_handler
from dxctechnology.workday_user_import_v1.user_import_philippines.utils.request_payload import get_todays_date_for_timezone_in_json
...
def create_update_user_dag(config):
    ...
    for batch_index in range(1, config.DAG_BATCH_COUNT + 1):
        ...
        with rail.create_airflow_dag(
            ...
            can_update_user_end_date_42 >> rail.Label("No") >> log_disabled_user_44 >> catch_and_log_error
            ...
            wait_for_process_timeoff_policies_19 >> log_disabled_user_20 >> catch_and_log_error
            ...
            trigger_process_timeoff_policies_no_accrual_29 >> wait_for_process_timeoff_policies_29 >> log_disabled_user_30 >> catch_and_log_error
            ...
            log_disabled_user_39 >> catch_and_log_error
            ...
            trigger_process_timeoff_policies_no_accrual_58 >> wait_for_process_timeoff_policies_58 >> log_disabled_user_59 >> catch_and_log_error
            ...
            current_assigned_udf_values >> get_time_entry_approval_path_name >> get_user_assigned_policy  >> prepare_update_payload >> can_process_user >> rail.Label("Yes") >> update_user >> can_update_timesheet_template\
                >> rail.Label("No") >> dummy_process_supervisor
            can_update_timesheet_template >> rail.Label("Yes") >> update_timesheet_template_with_effective_date >> dummy_process_supervisor
            can_process_user >> rail.Label("No") >> log_ia_exception >> catch_and_log_error
            ...
            log_user_completion >> catch_and_log_error

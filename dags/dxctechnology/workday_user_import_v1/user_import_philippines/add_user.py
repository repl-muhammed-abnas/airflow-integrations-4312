...
from dxctechnology.workday_user_import_v1.user_import_philippines.utils import request_payload, custom_methods
from dxctechnology.workday_user_import_v1.user_import_philippines.tasks.supervisor_assignment import assign_supervisor
...
def create_add_user_dag(config):
    ...
    for batch_index in range(1, config.DAG_BATCH_COUNT + 1):
        ...
        with rail.create_airflow_dag(
            ...
            create_user >>  remove_timeoffs >> update_product_assignment

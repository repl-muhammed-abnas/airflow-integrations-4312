...
from dxctechnology.workday_user_import_v1.user_import_philippines.config import *
from dxctechnology.workday_user_import_v1.user_import_philippines.mapper import (activities_mapper,
...
from dxctechnology.workday_user_import_v1.user_import_philippines.mappers.master_mapper import MAPPER
...
input_file_path = "/Production/Input/PHL"
...
version:str = "" # _v1, _v2, etc. can be added here when creating a new version for the philippines
instance_version = f"_{instance}{version if version else ''}_batch" # Batching names for Trial and SB/SB2 will be corrected in the new version
...
## philippines
max_active_run_process_each_users_philippines = 15
max_active_run_add_user_philippines = 15
max_active_run_add_user_timeoff_assignemnt_philippines = 15
max_active_run_update_user_timeoff_assignment_philippines = 15
max_active_run_update_user_philippines = 15
max_active_run_rehire_user_timeoff_assignement_philippines = 15
...
workday_user_import_ia_zero_timeoff_assignment_child_dag = f"dxctechnology_workday_user_import_philippines_ia_zero_timeoff_assignment_child{instance_version}"
workday_user_import_ia_one_timeoff_assignment_child_dag = f"dxctechnology_workday_user_import_philippines_ia_one_timeoff_assignment_child{instance_version}"

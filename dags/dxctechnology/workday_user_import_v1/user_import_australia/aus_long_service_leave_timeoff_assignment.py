...
from dxctechnology.workday_user_import_v1.user_import_australia.utils.response_filter import get_transactions_history_aus_prorata_accrual_timeoff_data_handler
                    ...
                    policy_to_assign.append(
                        {
                            ...
                            "policySet": get_updated_policy_line(_policy_set['policy'])
                        }
                    )
                    continue

...
from dxctechnology.workday_user_import_v1.user_import_philippines_v2.config import *
from dxctechnology.workday_user_import_v1.user_import_philippines_v2.mapper import (activities_mapper,
...
from dxctechnology.workday_user_import_v1.user_import_philippines_v2.mappers.master_mapper import MAPPER
...
version:str = "_v2" # _v1, _v2, etc. can be added here when creating a new version for the philippines
...
## philippines
max_active_run_process_each_users_philippines = 5
max_active_run_add_user_philippines = 5
max_active_run_add_user_timeoff_assignemnt_philippines = 5
max_active_run_update_user_timeoff_assignment_philippines = 5
max_active_run_update_user_philippines = 5
max_active_run_rehire_user_timeoff_assignement_philippines = 5
...
delete_future_entries_child_dag_id = f"dxctechnology_workday_user_sync_delete_future_entries_child_production_{delete_future_entries_child_version}"

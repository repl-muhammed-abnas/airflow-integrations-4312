...
SUPPORTED_REGIONS: FrozenSet[str] = frozenset([
    ...
    DXC_INDIA, DXC_PHILIPPINES, DXC_PORTUGAL, DXC_UKI, DXC_USA_CSC, DXC_USA_LES,
])
...
_HUNGARY_LIKE = frozenset({DXC_HUNGARY, DXC_PHILIPPINES, DXC_UKI})
...
_UDF_CONFIG: Dict[str, FrozenSet[str]] = {
    ...
    "Personnel Area Code": _GLOBAL_LIKE | {DXC_AUSTRALIA},
    "Personnel Area Description": _GLOBAL_LIKE | {DXC_AUSTRALIA},
    "IA PERNER ID": _ALL,

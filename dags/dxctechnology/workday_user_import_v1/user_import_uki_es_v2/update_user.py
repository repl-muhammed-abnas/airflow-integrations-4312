...
from dxctechnology.workday_user_import_v1.user_import_uki_es_v2.utils.custom_methods import (get_effective_grp_membership_data_handler)
from dxctechnology.workday_user_import_v1.user_import_uki_es_v2.utils.request_payload import (get_todays_date_for_timezone_in_json)
...
def create_update_user_dag(config):
    ...
    for batch_index in range(1, config.DAG_BATCH_COUNT + 1):
        ...
        with rail.create_airflow_dag(
            dag_id = f"{config.workday_user_import_uki_es_update_user_dag}{prefix}",
            description = "DXC Technology Workday User Sync UK&I CSC Update User",
            company_key=config.company_key,
            replicon_conn_id=config.replicon_conn_id,
            max_active_runs = config.max_active_run_update_user_uki_es
        ) as dag:
            ...
            has_no_direct_reports_for_user = rail.IfOperator(
                ...
                yes_task="is_division_uki_es",
                no_task="is_user_already_disabled_41"
            )

            # UK&I CSC specific: Check if division is CSC (GSAP-C1 or FTP)
            is_division_uki_es = rail.IfOperator(
                task_id = "is_division_uki_es",
                test=custom_methods.is_division_uki_es_test,
            ...
            update_user_end_date_15 = rail.RepliconServiceOperator(
                ...
                data=request_payload.get_user_end_date_update_payload_uki_es
            )
            ...
            trigger_process_timeoff_policies_no_accrual_19 = rail.TriggerDagRunForEachItemOperator(
                ...
                trigger_dag_id=lambda dag_run: custom_methods.get_trigger_dag_id(
                    config.workday_user_import_uki_es_process_time_off_accrual_dag,
            ...
            user_does_not_have_admin_and_payroll_permission = rail.IfOperator(
                ...
                test=custom_methods.user_does_not_have_admin_and_payroll_permission_test_uki_es,
            ...
            can_update_user_end_date_25 = rail.IfOperator(
                ...
                test=custom_methods.can_update_user_end_date_test_uki_es,
            ...
            is_user_already_disabled_41 = rail.IfOperator(
                ...
                test=custom_methods.is_user_already_disabled_test_uki_es,
            ...
            is_user_rehire = rail.IfOperator(
                ...
                test=custom_methods.is_user_rehire_test_uki_es,
            ...
            update_user_start_date_48 = rail.RepliconServiceOperator(
                ...
                endpoint="/services/UserService1.svc/UpdateEmploymentDateRange",
                data=request_payload.update_user_start_date_remove_end_date_uki_es
            )

            can_update_user_start_date = rail.IfOperator(
                task_id = "can_update_user_start_date",
                test= custom_methods.can_update_user_start_date_test_uki_es,
            ...
            should_disable_user = rail.IfOperator(
                ...
                test=custom_methods.should_disabled_user_test_uki_es,
            ...
            is_end_date_less_than_today = rail.IfOperator(
                ...
                test=custom_methods.is_end_date_less_than_today_test_uki_es,
            ...
            prepare_update_payload = rail.PythonOperator(
                ...
                python_callable=lambda dag_run: request_payload.get_update_user_payload_uki_es(dag_run, config)
            )
            ...
            update_timesheet_template_with_effective_date = rail.RepliconServiceOperator(
                ...
                endpoint = "/services/ImportService1.svc/ApplyUserModifications3",
                data = lambda dag_run: request_payload.get_update_timesheet_template_update_payload_uki_es(dag_run, "update")
            )
            ...
            update_notification_preference = rail.RepliconServiceOperator(
                ...
                data=lambda dag_run: request_payload.get_notification_preference_to_assign_payload_uki_es(dag_run, "update")
            )
            ...
            trigger_rehire_timeoff_assignment = rail.TriggerDagRunForEachItemOperator(
                ...
                trigger_dag_id=lambda dag_run: custom_methods.get_trigger_dag_id(
                    config.workday_user_import_uki_es_user_rehire_timeoff_process_dag,
                    config.DAG_BATCH_COUNT,
                    item_index=(custom_methods.get_item_index(dag_run, config.DAG_BATCH_COUNT))
                ),
            ...
            process_timeoffs = rail.TriggerDagRunForEachItemOperator(
                    ...
                    trigger_dag_id=lambda dag_run, item: custom_methods.get_trigger_dag_id(
                        config.workday_user_import_uki_es_update_user_timeoff_assignment_dag,
                        config.DAG_BATCH_COUNT,
                        item_index=(custom_methods.get_item_index(dag_run, config.DAG_BATCH_COUNT))
                    ),
                    conf=lambda dag_run, item: {
            ...
            has_no_direct_reports_for_user >> rail.Label('Yes') >> is_division_uki_es

            is_division_uki_es >> rail.Label('Yes') >> is_termination_date_present >> rail.Label('Yes') >> update_user_end_date_15
            ...
            is_division_uki_es >> rail.Label('No') >> disable_user_login_33 >> can_update_user_end_date_34

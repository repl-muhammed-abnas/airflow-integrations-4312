...
from dxctechnology.workday_user_import_v1.user_import_global.utils import custom_methods, request_payload


# Non- Canada 
def create_dag(config):
    with rail.create_airflow_dag(
        dag_id=config.workday_user_import_global_users_add_user_timeoff_process_child_dag,
        ...
        for_each_non_special_timeoff = rail.ForEachOperator(
            ...
            items=lambda: [timeoff for timeoff in rail.result("map_mapper_replicon_timeoff", "non_special_timeoffs") if timeoff['uri']],
        ...
        for_each_non_special_timeoff >> empty_process_special_timeoff >> catch_and_log_error

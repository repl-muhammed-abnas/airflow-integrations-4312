...
from dxctechnology.workday_user_import_v1.user_import_hungary_v1.config import *
from dxctechnology.workday_user_import_v1.user_import_hungary_v1.mapper import (activities_mapper,
    timeoff_mapper, authentication_and_product, company_code_mapper, hun_general_mapper_v1)

# Define master mapper if missing
from dxctechnology.workday_user_import_v1.user_import_hungary_v1.mappers.master_mapper import MAPPER
...
GENERAL_MAPPER = hun_general_mapper_v1.MAPPER_DATA
...
version: str = "_v1"  # _v1, _v2, etc. can be added here when creating a new version for the hungary

...
from dxctechnology.workday_user_import_v1.user_import_philippines_v1.config import *
from dxctechnology.workday_user_import_v1.user_import_philippines_v1.mapper import (activities_mapper,
...
from dxctechnology.workday_user_import_v1.user_import_philippines_v1.mappers.master_mapper import MAPPER
...
replicon_conn_id = "replicon_dxctrial01_x.workday_5"
sftp_connection_id = "sftp_useast2"

input_file_path = "/WD/Input/PHL"
...
version:str = "_v1" # _v1, _v2, etc. can be added here when creating a new version for the philippines
...
delete_future_entries_child_dag_id = f"dxctechnology_workday_user_sync_delete_future_entries_child_{instance_version}"

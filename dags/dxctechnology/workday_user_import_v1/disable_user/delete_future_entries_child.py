...
from dxctechnology.workday_user_import_v1.disable_user.utils.custom_methods import prepare_timeoff_uris_func, INPUT_DATE_FORMAT
from dxctechnology.workday_user_import_v1.disable_user.utils import request_payload, data_handler
null = None
...
def create_child_dag(config):
    with rail.create_airflow_dag(
        ...
        # STEP 18: Get all future time offs
        ...
        # STEP 19: Check if there are any future time offs to delete
        ...
        # STEP 20: Prepare time off URIs for update and deletion
        ...
        # STEP 21: Check if there are timeoffs to update
        ...
        # STEP 21.1: Create batch for reopening timeoffs that need updating
        ...
        # STEP 21.2: Execute and wait for timeoff reopen batch
        ...
        # STEP 21.3: Update each timeoff with new date range using PutAndSubmitTimeOff 
        ...
        # STEP 23: Check if there are timeoffs to delete
        ...
        # STEP 25: Get current timesheet for user's end date
        ...
        # STEP 26: Check if current timesheet exists
        ...
        # STEP 27: Get current timesheet status
        ...
        # STEP 28: Check if current timesheet needs submission
        ...
        # STEP 29: Submit current timesheet
        ...
        check_future_time_entries_exist >> rail.Label("No") >> get_future_timeoffs >> check_future_timeoffs_exist
        ...
        check_approved_time_entries_need_reopening >> rail.Label("No") >> prepare_time_entry_uris >> bulk_delete_time_entries >> get_future_timeoffs

...
from dxctechnology.workday_user_import_v1.user_import_uki_csc_v2.utils.custom_methods import (
...
from dxctechnology.workday_user_import_v1.user_import_uki_csc_v2.utils.request_payload import (
...
def create_dag(config):
    ...
    for batch_index in range(1, config.DAG_BATCH_COUNT + 1):
        ...
        with rail.create_airflow_dag(
            dag_id=f"{config.workday_user_import_uki_csc_process_time_off_accrual_dag}{prefix}",
            ...
            get_annual_bought_sold_leave_balance_summary = rail.RepliconServiceCallForEachItemOperator(
                ...
                data = lambda dag_run, item: {
                        ...
                        "asOfDate": dag_run.conf['user_end_date_json_proration']
                    },
            ...
            def calculate_required_balance(dag_run):
                ...
                termination_date = dag_run.conf['user_end_date_json_proration']

...
from dxctechnology.workday_user_import_v1.user_import_uki_csc_v2.mapper.company_code_mapper import CSC_COMPANY_CODES
...
def get_user_assignments(user_data, CSC_ASSIGNMENT_MAPPER):

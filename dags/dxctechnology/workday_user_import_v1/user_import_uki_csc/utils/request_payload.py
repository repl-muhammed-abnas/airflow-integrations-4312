...
from dxctechnology.workday_user_import_v1.user_import_uki_csc.utils.date_utils import _get_effective_date_based_on_work_week
...
def _get_object_extension_fields_to_update_payload(dag_run, current_oef_fields_values):
...
def get_update_user_payload_uki_csc(dag_run, config):
    ...
    payload = {
        ...
        "modifications": {
            ...
            "objectExtensionFieldsToApply": _get_object_extension_fields_to_update_payload(dag_run, current_oef_values),

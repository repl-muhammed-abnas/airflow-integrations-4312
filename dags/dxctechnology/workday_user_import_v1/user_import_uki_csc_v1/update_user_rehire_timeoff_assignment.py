...
def create_dag(config):
    ...
    for batch_index in range(1, config.DAG_BATCH_COUNT + 1):
        ...
        with rail.create_airflow_dag(
            dag_id=f"{config.workday_user_import_uki_csc_user_rehire_timeoff_process_dag}{prefix}",
            description="UK&I CSC User Rehire Timeoff Assignment Process",
            ...
            def get_policy_to_assign_callable(dag_run):
                ...
                if not default_policy_for_timeoff:
                    return []

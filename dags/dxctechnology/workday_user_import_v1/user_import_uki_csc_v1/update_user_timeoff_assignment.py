...
from dxctechnology.workday_user_import_v1.user_import_uki_csc_v1.utils.request_payload import INPUT_DATE_FORMAT, get_replicon_date
...
def create_update_user_timeoff_assignment_dag(config):
    ...
    for batch_index in range(1, config.DAG_BATCH_COUNT + 1):
        ...
        with rail.create_airflow_dag(
            dag_id = f"{config.workday_user_import_uki_csc_update_user_timeoff_assignment_dag}{prefix}",
            ...
            trigger_ia_one_timeoff_assignment = rail.TriggerDagRunForEachItemOperator(
                ...
                items=[1],
                trigger_dag_id=config.workday_user_import_uki_csc_ia_one_timeoff_assignment_child_dag,
            ...
            trigger_ia_zero_timeoff_assignment = rail.TriggerDagRunForEachItemOperator(
                ...
                items=[1],
                trigger_dag_id=config.workday_user_import_uki_csc_ia_zero_timeoff_assignment_child_dag,

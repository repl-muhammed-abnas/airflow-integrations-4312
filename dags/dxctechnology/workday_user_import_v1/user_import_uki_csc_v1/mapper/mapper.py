...
from dxctechnology.workday_user_import_v1.user_import_uki_csc_v1.mapper.csc_assignment_mapper_v2 import CSC_ASSIGNMENT_MAPPER
from dxctechnology.workday_user_import_v1.user_import_uki_csc_v1.mapper.company_code_mapper import CSC_COMPANY_CODES
...
def get_user_assignments(user_data):
    for _, assignment in enumerate(CSC_ASSIGNMENT_MAPPER):
...
def validate_company_code(company_code):
    return str(company_code) in CSC_COMPANY_CODES

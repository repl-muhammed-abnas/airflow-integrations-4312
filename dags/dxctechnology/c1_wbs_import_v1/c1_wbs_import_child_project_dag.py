...
from dxctechnology.c1_wbs_import_v1 import field_config
...
def create_child_dag(config):
    ...
    with rail.create_airflow_dag(
        dag_id=f'dxctechnology_c1_wbs_import_child_project_v1{dag_id_postfix}',
        description=f'DXC_C1 WBS Automation Child V1 - B1 {config.instance}',

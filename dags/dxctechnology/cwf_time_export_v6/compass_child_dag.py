...
from dxctechnology.cwf_time_export_v6.task.compass_task import get_compass_task
...
def create_dag(config):
    with rail.create_airflow_dag(
        dag_id=f'dxctechnology_cwf_time_export_compass_child_{config.instance}_v6',
        description=f'DXCTechnology_CWF Time export - Compass v6 {config.instance}',

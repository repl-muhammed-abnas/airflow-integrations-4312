...
# config :
# https://github.com/replicon/airflow-integrations/blob/main/dags/cwf_user_profile/disable_user/config.py


def create_disable_user_main_dag(config):
    with rail.create_airflow_dag(
        dag_id=f'dxctechnology_cwf_userprofiles_disable_master_{config.instance}',
        ...
        disable_user_child = rail.TriggerDagRunForEachItemOperator(
            ...
            trigger_dag_id=f'dxctechnology_cwf_userprofiles_disable_child_{config.instance}',

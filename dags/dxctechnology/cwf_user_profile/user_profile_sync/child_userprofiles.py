...
from dxctechnology.cwf_user_profile.user_profile_sync.utils.request_payload import validate_email, get_search_user_param, get_adduser_updateuser_conf
from dxctechnology.cwf_user_profile.user_profile_sync.utils.response_filter import map_user_details
from dxctechnology.cwf_user_profile.user_profile_sync.task.process_updateuser import process_updateuser_task_group
...
def create_process_userprofile_child_dag(config):
    with rail.create_airflow_dag(
        dag_id=f'dxctechnology_cwf_userprofiles_child_{config.instance}',
        ...
        add_userprofile_child_dag = rail.TriggerDagRunForEachItemOperator(
            ...
            execution_timeout=timedelta(
                days=config.execution_timeout_days),
            trigger_dag_id=f'dxctechnology_cwf_userprofiles_add_child_{config.instance}',

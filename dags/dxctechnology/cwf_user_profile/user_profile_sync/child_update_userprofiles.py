...
from dxctechnology.cwf_user_profile.user_profile_sync.utils import python_callable_method
...
def create_update_userprofile_child_dag(config):
    with rail.create_airflow_dag(
        dag_id=f'dxctechnology_cwf_userprofiles_update_child_{config.instance}',
        ...
        (get_data_for_supervisor, update_supervisor_over_date_range, log_supervisor_check,
         get_update_activities_payload) = process_supervisor_assignment_task_group(

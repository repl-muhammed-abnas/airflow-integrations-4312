...
def create_child_dag(config):
    with rail.create_airflow_dag(
        dag_id=f'dxctechnology_australia_payrolldata_export_es_child_v2_{config.instance}',
        description=f'DXC_Australia_PayrollData_Export_ES_Child V2 {config.instance}',

...
from dxctechnology.australia_payroll_extract_v2.mapper.time_off_balance_mapper import Time_off_mappper, Active_user_lsl_Timeoffs
from dxctechnology.australia_payroll_extract_v2.mapper.sell_back_mapper import SELL_BACK_MAPPER
...
def companycode_from_es_mapper(export, mapper):
    date_filter = python_callable_method.check_2010_infotype()['date']

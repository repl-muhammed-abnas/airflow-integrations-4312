...
def create_child_dag(config):
    with rail.create_airflow_dag(
        dag_id=f'dxctechnology_australia_payrolldata_export_user_schedule_child_v2_{config.instance}',
        description=f'DXC_Australia_PayrollData_Export_User_Schedule_Child V2 {config.instance}',
        ...
        process_each_user_based_empid= rail.trigger_parallel_dagrun(
            ...
            trigger_dag_id=f'dxctechnology_australia_payroll_export_process_each_user_child_v2_{config.instance}',
            execution_timeout=timedelta(days=config.execution_timeout_days),
            conf={

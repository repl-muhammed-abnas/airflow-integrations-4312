...
def create_iwo_details_wbs_update_child_dag(config):
    ...
    with rail.create_airflow_dag(
        ...
        is_parent_details_present >> rail.Label(
            'Yes') >> build_parent_details_oef >> get_parent_project_details >> build_all_oef >> update_oef_fields >> is_tasks_list_present
        is_parent_details_present >> rail.Label(
            'No') >> log_parent_details_blank >> get_parent_project_details >> build_all_oef
        ...
        does_tasks_list_to_be_created >> rail.Label(
            'Yes') >> get_all_unique_levels >> process_task_by_level >> wait_for_process_tasks_by_level >> is_time_entry_allowed
        does_tasks_list_to_be_created >> rail.Label(
            'No') >> get_details_for_parentproject_billing_rates

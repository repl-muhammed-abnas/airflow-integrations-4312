...
from dxctechnology.csc_les_us_payroll_extract_v3 import master_dag_task_group
from dxctechnology.csc_les_us_payroll_extract_v3.mapper.company_code_mapper_usles_uscsc import COMPANY_CODE_MAP_US


def create_main_dag(config):
    with rail.create_airflow_dag(
        dag_id=f"dxctechnology_lcsc_les_us_payrollexport_19_15_master_dag_v3_{config.instance}",
        ...
        process_payrolldata_export = rail.TriggerDagRunForEachItemOperator(
            ...
            trigger_dag_id=f'dxctechnology_lcsc_location_company_codewise_usa_payrolldata_export_child_v3_{config.instance}',

...
from dxctechnology.gsap_wbs_import_v2.tasks.run_base_report import run_base_report
...
def create_main_dag(config):
    with rail.create_airflow_dag(
        dag_id=f'dxctechnology_gsap_wbs_import_master_{config.instance}_v2',
        ...
        parse_xml = rail.LoadXMLFileOperator(
            ...
            xsd_document='./dags/dxctechnology/gsap_wbs_import_v2/xml_schema/input_schema.xsd'
        )
        ...
        process_project_types = rail.TriggerDagRunForEachItemOperator(
            ...
            trigger_dag_id=f'dxctechnology_gsap_wbs_import_child_process_project_type_{config.instance}_v2',
        ...
        process_clients = rail.trigger_parallel_dagrun(
            ...
            trigger_dag_id=f'dxctechnology_gsap_wbs_import_child_process_client_{config.instance}_v2',
            execution_timeout=timedelta(
                days=config.child_wait_execution_timeout_days),
            conf={
        ...
        process_wbs_item = rail.trigger_parallel_dagrun(
            ...
            trigger_dag_id=f'dxctechnology_gsap_wbs_import_child_process_projects_{config.instance}_v2',
            execution_timeout=timedelta(
                days=config.child_wait_execution_timeout_days),
        ...
        process_iwo_element = rail.TriggerDagRunForEachItemOperator(
            ...
            trigger_dag_id=f'dxctechnology_gsap_wbs_import_child_process_iwo_element_{config.instance}_v2',
            execution_timeout=timedelta(
                days=config.child_wait_execution_timeout_days),
        ...
        process_log_generation = rail.TriggerDagRunOperator(
            ...
            trigger_dag_id=f'dxctechnology_gsap_wbs_import_child_process_log_generation_{config.instance}_v2',
            conf=lambda dag_run:{

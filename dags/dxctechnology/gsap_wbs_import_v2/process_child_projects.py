...
def create_child_dag_wbs(config):
    with rail.create_airflow_dag(
        dag_id=f'dxctechnology_gsap_wbs_import_child_process_child_projects_{config.instance}_v2',
        ...
        process_task_by_level = rail.TriggerDagRunForEachItemOperator(
            ...
            trigger_dag_id=f'dxctechnology_gsap_wbs_import_child_process_task_by_level_{config.instance}_v2',

...
def create_main_airflow_dag(config):
    with rail.create_airflow_dag(
        dag_id = f'dxctechnology_gsap_task_adhoc_put_task_{config.instance}_batch2',
        ...
        process_tasks = rail.trigger_parallel_dagrun(
            ...
            trigger_dag_id=f'dxctechnology_gsap_task_adhoc_put_task_child_{config.instance}_batch2',

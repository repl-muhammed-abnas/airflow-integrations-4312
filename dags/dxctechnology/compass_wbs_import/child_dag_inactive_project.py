...
def create_child_inactive_airflow_dag(config):
    with rail.create_airflow_dag(
        dag_id=f'dxctechnology_compass_wbs_import_child_inactive_project_{config.instance}',
        description=f'DXC_COMPASS_WBS_Automation Child V2.0 - Inactive Projects Processing {config.instance}',

    ...
    with rail.TaskGroup(group_id='get_active_project_prereqs', prefix_group_id=False):
        ...
        def convert_project_oefs(resp):
            ...
            return {
                ...
                'projecttype': get_oef("Project Type"),
        ...
        get_projecttype_values = get_oef_values('projecttype')
        ...
        get_project_oefs >> [
            ...
            get_projecttype_values]
        [get_divisions_company_codes, get_departments, get_permission_sets, get_employee_types, get_timetrackingrequired_values,
        get_globalflag_values, get_iwoindicator_values, get_projecttype_values] >> active_projects_prereqs_loaded

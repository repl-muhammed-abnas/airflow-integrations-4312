...
from dxctechnology.compass_iwo_details_v3.task.generate_report_batch import report_batch
...
def create_iwo_details_master_dag(config):
    ...
    with rail.create_airflow_dag(
        ...
        parse_xml = rail.LoadXMLFileOperator(
            ...
            xsd_document='./dags/dxctechnology/compass_iwo_details_v3/xsdschema/input_schema.xsd'
        )

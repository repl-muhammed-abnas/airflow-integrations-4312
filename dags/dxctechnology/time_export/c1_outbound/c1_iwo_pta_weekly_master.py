...
def create_main_dag(config):
    ...
    with rail.create_airflow_dag(
        dag_id=config.c1_iwo_time_export_pta_weekly_master_dagid,
        description=f"DXC - C1 IWO Time Export PTA Weekly Master - {config.instance}",
        ...
        get_filter_data_for_c1_iwo_time_export = rail.PythonOperator(
            ...
            python_callable=custom_methods.filter_data_for_c1_iwo_pta_weekly_time_export,
            op_args=[config]
        )
        ...
        get_data_for_all_past_time_exports_for_C1 = rail.RepliconServiceOperator(
            ...
            data=lambda: request_payload.get_all_past_time_export_data_payload("IWOP-C1",
                rail.result("get_filter_data_for_c1_iwo_time_export")),
        ...
        update_cancelled_timedataexport_name = rail.RepliconServiceOperator(
            ...
            data={
                ...
                "name": 'C1_cancel_{{ dag_run_ecid() }}_IWOPTA',
            }
        )
        ...
        batch_end >> rail.Label('on success') >> process_gsap_iwo_time_export \
            >> process_c1_iwo_time_export \
                >> process_compass_iwo_time_export >> process_psa_iwo_time_export

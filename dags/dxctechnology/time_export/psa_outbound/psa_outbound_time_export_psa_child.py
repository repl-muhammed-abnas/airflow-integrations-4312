...
import pendulum
from dxctechnology.time_export.psa_outbound.utils import request_payload, response_filters, custom_methods
...
def create_child_dag(config):
    ...
    with rail.create_airflow_dag(
        ...
        if_filtered_psa_timedata_has_data = rail.IfOperator(
            ...
            test=lambda: rail.result("query_filter_psa_time_export_data", key="length") > 0,
        ...
        if_final_timedata_has_data >> rail.Label("Yes") >> get_psa_cost_center >> get_psa_cost_center_child_hierarchy \
        ...
        if_filtered_timedata_has_data >> rail.Label("Yes") >> query_merge_gsap_c1_compass_time_export_data \
            >> query_filter_psa_time_export_data >> if_filtered_psa_timedata_has_data
        ...
        is_sftp_upload_or_update_ack_failed >> rail.Label("No") >> fail_dag
        ...
        if_no_data >> rail.Label("No") >> send_psa_export_complete_email >> dag_run_log_to_sumo

...
def create_child_dag(config):
    ...
    with rail.create_airflow_dag(
        ...
        if_filtered_timedata_has_data = rail.IfOperator(
            ...
            test=lambda: rail.result("query_filter_c1_reg_iwo_time_export_data", key="length") > 0 or
                rail.result("query_filter_compass_reg_iwo_time_export_data", key="length") > 0,
        ...
        if_final_timedata_has_data >> rail.Label("Yes") >> get_psa_org_unit \
            >> get_psa_org_unit_child_hierarchy >> get_query_to_filter_time_export_data >> query_filter_c1_reg_iwo_time_export_data \
                >> query_filter_compass_reg_iwo_time_export_data >> if_filtered_timedata_has_data

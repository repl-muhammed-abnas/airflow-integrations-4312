...
def create_dag(config):
    with rail.create_airflow_dag(
        dag_id=f'dxctechnology_compass_wbs_file_merger_child_{config.dag_id_postfix}',
        description=f'DXCtechnology Compass wbs file merger child v1.0 {config.dag_id_postfix}',
        ...
        parse_xml = rail.LoadXMLFileOperator(
            ...
            xsd_document="./dags/dxctechnology/compass_wbs_file_merger/xml_schema/input_schema.xsd"
        )

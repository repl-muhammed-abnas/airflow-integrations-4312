...
from dxctechnology.australia_payroll_extract_v3.mapper.company_code_mapper_usles_uscsc import COMPANY_CODE_MAP_GSAP


def create_main_dag(config):
    with rail.create_airflow_dag(
        dag_id=f"dxctechnology_australia_payrollexport_gsap_2010_2001_0015_master_dag_v3_{config.instance}",
        description=f"DXC_AUS_PayrollExport_GSAP_Master V3 {config.instance}",
        ...
        process_payrolldata_export = rail.TriggerDagRunForEachItemOperator(
            ...
            trigger_dag_id=f'dxctechnology_australia_payrolldata_export_gsap_child_v3_{config.instance}',

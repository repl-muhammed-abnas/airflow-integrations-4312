...
def create_child_dag(config):
    with rail.create_airflow_dag(
        dag_id=f'dxctechnology_australia_payrolldata_export_absence_taken_child_v3_{config.instance}',
        description=f'DXC_Australia_PayrollData_Export_Absence_taken_Child V3 {config.instance}',

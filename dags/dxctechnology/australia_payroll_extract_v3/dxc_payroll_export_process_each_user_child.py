...
def create_child_dag(config):
    with rail.create_airflow_dag(
        dag_id=f'dxctechnology_australia_payroll_export_process_each_user_child_v3_{config.instance}',
        description=f'DXC_Australia_PayrollData_Export_Process_Each_User_Child V3 {config.instance}',

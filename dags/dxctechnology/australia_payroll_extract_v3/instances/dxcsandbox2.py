...
from dxctechnology.australia_payroll_extract_v3.config import *
from dxctechnology.australia_payroll_extract_v3.mapper.absence_taken_mapper import TimeOffMapper
from dxctechnology.australia_payroll_extract_v3.mapper.absence_taken_mapper import ABSENCE_TAKEN_MAPPER
...
sftp_conn_id = 'dxcsandbox2_ADP_LCSC_LES_US_export_SFTP'
pgp_conn_id = 'pgp_dxctechnology_adp_les_lcsc'
secondary_sftp_conn_id = 'sftp-dxcsandbox2_auspayroll-628172'
secondary_encrypted_sftp_conn_id = 'sftp-dxcsandbox2_auspayroll-628172_AUSPayroll'
...
schedule_interval_es = '0 7 */1 * *'
schedule_interval_es_weekly = '30 13 * * MON'
schedule_interval_es_0007_weekly = '0 15 * * MON'
schedule_interval_gsap = '0 13 * * FRI'
schedule_interval_active_users = '0 13 */1 * *'

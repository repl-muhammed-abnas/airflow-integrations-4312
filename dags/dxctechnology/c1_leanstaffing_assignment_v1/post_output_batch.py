...
def create_dag(config):
    with rail.create_airflow_dag(
        dag_id=f'dxctechnology_c1_leanstaffassignment_post_output_{config.instance}_v1',
        description=f'DXC C1 Leanstaff Assignment - Post Output Batch {config.instance} v1',

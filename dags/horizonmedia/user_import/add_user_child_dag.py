...
def create_dag(config):
    ...
    with rail.create_airflow_dag(
        dag_id=f'horizonmedia_user_import_add_user_child_{config.instance}',
        ...
        if_request_manager_optionuri_present_111 >> rail.Label(
            'No') >> log_customfield_values_113 >> log_displayname_114 >> create_user_115 >> if_request_scheduledweeklyhours_present_116

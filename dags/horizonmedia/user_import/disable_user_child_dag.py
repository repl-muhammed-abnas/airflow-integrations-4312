...
def create_dag(config):
    ...
    with rail.create_airflow_dag(
        dag_id=f'horizonmedia_user_import_disable_user_child_{config.instance}',
        ...
        if_request_termination_date_present_3 >> rail.Label(
            'Yes') >> apply_user_modifications2_updateenddate_5 >> disable_login_disable_login_6 >> put_user_notification_preferences_7 >> update_dropdown_value_workerstatus_8 >> horizonmedia_user_import_logs_add_entry_9 >> finish
        if_request_termination_date_present_3 >> rail.Label(
            'No') >> finish

...
def create_dag(config):
    ...
    with rail.create_airflow_dag(
        dag_id=f'horizonmedia_user_import_update_user_child_{config.instance}',
        ...
        declare_list_2 >> create_log >> bulk_get_users3_4 >> get_effective_user_group_membership_5 >> declare_variable_6 >> date_split_today_7 >> date_split_startdate_11 >> if_userdetails_isenabled_is_not_true_12

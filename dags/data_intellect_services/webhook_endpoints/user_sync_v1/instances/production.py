...
data_intellect_hmac_shared_secret_user_create = f"dataintellect_user_sync_hmac_shared_secret_user_create_{instance}_v1"
data_intellect_hmac_shared_secret_user_update = f"dataintellect_user_sync_hmac_shared_secret_user_update_{instance}_v1"

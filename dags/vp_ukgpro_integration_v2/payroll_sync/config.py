...
# Employee validation
# Default ON for production safety. Override per run via
# dag_run.conf['config']['validate_employees_in_ukgpro'] = False,
# or set an instance-level override in the per-customer instance file.
validate_employees_in_ukgpro = True

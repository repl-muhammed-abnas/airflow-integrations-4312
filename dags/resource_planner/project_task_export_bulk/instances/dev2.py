...
from resource_planner.project_task_export_bulk.config import *
...
# Project-task endpoint writes to rp_source_time_codes, so the dummy override
# must also be a table with that schema.
rp_api_target_table = 'dummy_rp_source_time_codes'

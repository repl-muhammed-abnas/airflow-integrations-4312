# Shared configuration for resource_planner_project_task_export_delta DAG
...
project_uri_for_delta_report_name = "Resource Planner Project URI Audit Report"
...
email_failure_subject_prefix = "[RP Project Task Export Delta]"
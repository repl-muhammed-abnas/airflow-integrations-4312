...
sftp_input_filepath = '/Production/Project Import/Input'
sftp_archive_filepath = '/Production/Project Import/Archive'

tenant_email = "lydia.tuch@lead3r.com,billing@lead3r.com,accounting@lead3r.com,ena.park@huddl3.group,lucas.reichart@huddl3.group,stephanie.clark@ptsadvance.com,victoria.alejos@ptsadvance.com,brandy.knox@lead3r.com,olivia.satow@lead3r.com"

...
def create_child_dag_wbs(config):
    ...
    with rail.create_airflow_dag(
        ...
        create_timesheet_batch >> approve_timesheet >> create_timesheet_batch_retries >> approve_timesheet_retries >> get_ts_success_or_fail_count >> finish >> log_to_sumo >> ts_approval_logs_entry

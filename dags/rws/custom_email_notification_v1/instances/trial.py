...
can_run_batch_task_master = f'rws_send_email_notification_{instance}_can_run_batch_task_v1'
can_run_batch_task_child = f'rws_send_individual_custom_email_{instance}_can_run_batch_task_v1'

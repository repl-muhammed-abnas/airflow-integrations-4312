...
import rail
from rws.custom_email_notification.utils import request_payload
...
def create_dag(config):
    ...
    with rail.create_airflow_dag(
        ...
        load_query_data >> get_email_body >> send_email >> send_push_notification >> is_error_in_notification_present

...
import rail
from rws.custom_email_notification.utils import python_callable_method
from airflow.models import Variable
from rws.custom_email_notification.mappers import timezone_mapper
null=None

def create_dag(config):
    # pylint: disable=too-many-statements
    with rail.create_airflow_dag(
        dag_id=f'rws_check_time_for_approver_and_send_notification_child_{config.instance}',

...
from pwcglobal.user_import_v7.task.update_country import get_update_country
from pwcglobal.user_import_v7.task.update_timesheet_period import get_update_timesheet_period
from pwcglobal.user_import_v7.task.update_supervisor import get_update_supervisor
from pwcglobal.user_import_v7.task.update_timesheet_template import get_update_timesheet_template
from pwcglobal.user_import_v7.task.update_custom_field import get_update_custom_field
from pwcglobal.user_import_v7.task.update_timeoff_policy import get_update_timeoff_policy
from pwcglobal.user_import_v7.task.update_ftepercent_blob import update_ftepercent_blob
from pwcglobal.user_import_v7.task.assign_default_toil_to_policy import add_toil_default_policy
...
def create_dag(config):
    ...
    with rail.create_airflow_dag(
        ...
        is_descope_event = rail.IfOperator(
            task_id='is_descope_event',
            test=lambda: bool(request_payload.get_conf().get('is_descope_event')),
            yes_task='is_user_already_disabled',
            no_task='get_assigned_policysets_for_user',
        )
        ...
        bulk_get_user3 >> is_descope_event
        is_descope_event >> rail.Label('No') >> get_assigned_policysets_for_user >> get_assigned_permissionsets >>\
            is_start_date_changed
        is_descope_event >> rail.Label('Yes') >> is_user_already_disabled
        ...
        is_user_already_disabled >> rail.Label(
            'Yes') >> log_user_already_disabled >> catch_and_log_errors

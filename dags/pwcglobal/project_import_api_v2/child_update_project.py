...
def create_child_update_project_dag(config):
    with rail.create_airflow_dag(
        dag_id=f'pwc_project_import_child_update_project_b1_{config.instance}_v2',
        ...
        can_run_batch_task = rail.IfOperator(
            ...
            yes_task='batch_task',
            no_task='bulk_get_project_team_members'
        )
        ...
        can_run_batch_task >> rail.Label('No') >> bulk_get_project_team_members
        ...
        get_success_logs >> get_exception_logs >> \
            log_exception_for_update_project >> catch_and_log_errors >> log_dagrun_to_sumo

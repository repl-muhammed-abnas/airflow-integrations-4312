...
def create_dag(config):
    ...
    with rail.create_airflow_dag(
        dag_id=config.zero_hour_logic_master_dag_id,
        description=config.zero_hour_logic_master_dag_id,
        ...
        recalculate_timesheets = rail.TriggerDagRunForEachItemOperator(
            ...
            trigger_dag_id=f'{config.zero_hours_recalculate_tiemsheet_dag_id}',
        )
        ...
        process_timesheet = rail.TriggerDagRunForEachItemOperator(
            ...
            batch_size=25,
            execution_timeout=timedelta(days=config.execution_timeout_days),
            trigger_dag_id=f'{config.zero_hour_logic_child_dag_id}',
        )

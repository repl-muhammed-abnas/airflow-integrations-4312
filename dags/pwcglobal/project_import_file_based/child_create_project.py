...
import rail
from pwcglobal.project_import_file_based.task.get_team_members_project_manager import get_team_members_project_managers
from pwcglobal.project_import_file_based.task.add_user_permission_policy import get_add_permission_policy
from pwcglobal.project_import_file_based.task.child_dag_exception_logs import log_exception_field_task
from pwcglobal.project_import_file_based import request_payload
from pwcglobal.project_import_file_based import custom_method
from pwcglobal.project_import_file_based import response_filter
from pwcglobal.project_import_file_based import python_callable_method
...
def create_child_add_project_dag(config):
    with rail.create_airflow_dag(
        dag_id=f'pwc_project_import_child_create_project_flat_file_based_{config.instance}',

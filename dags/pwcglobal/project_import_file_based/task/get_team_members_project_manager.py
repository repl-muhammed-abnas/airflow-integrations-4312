...
import rail
from pwcglobal.project_import_file_based import request_payload, python_callable_method, response_filter


def get_team_members_project_managers():
    with rail.TaskGroup(group_id='get_team_members_project_managers', prefix_group_id=False) as get_user_uris:
        ...
        validate_legal_entity >> rail.Label(
            "Yes") >> get_user_list >> is_users_list_present

...
import rail
from pwcglobal.custom_import_for_teammanager_permission_v1.utils import request_payload
from pwcglobal.custom_import_for_teammanager_permission_v1.utils.request_payload import get_invalid_record
...
def create_dag(config):
    ...
    with rail.create_airflow_dag(
        ...
        current_run_sup_org_logs = rail.CreateLogOperator(
            task_id='current_run_sup_org_logs'
        )
        ...
        process_user_for_permission_for_supervisory_org = rail.trigger_parallel_dagrun(
            ...
            conf=lambda item: {
                **item,
                **{
                    'current_run_sup_org_log': rail.result('current_run_sup_org_logs'),
        ...
        if_csv_has_data >> rail.Label('Yes') >> create_custom_import_sup_org_logs >> current_run_sup_org_logs >> query_invalid_records >> has_invalid_records

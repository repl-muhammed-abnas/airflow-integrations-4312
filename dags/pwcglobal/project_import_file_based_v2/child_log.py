...
import rail
from pwcglobal.project_import_file_based_v2.custom_method import do_format_logs
...
def create_child_process_log_pregeneration(config):
    with rail.create_airflow_dag(
        dag_id=f'pwc_project_import_child_log_flat_file_based_{config.instance}_v2',

...
import rail
from pwcglobal.project_import_file_based_v2.task.get_team_members_project_manager import get_team_members_project_managers
from pwcglobal.project_import_file_based_v2.task.add_user_permission_policy import get_add_permission_policy
from pwcglobal.project_import_file_based_v2.task.child_dag_exception_logs import log_exception_field_task
from pwcglobal.project_import_file_based_v2 import request_payload
from pwcglobal.project_import_file_based_v2 import custom_method
from pwcglobal.project_import_file_based_v2 import response_filter
from pwcglobal.project_import_file_based_v2 import python_callable_method


# config :
# https://github.com/replicon/airflow-integrations/blob/main/dags/pwcglobal/project_import_file_based_v2/config.py


# pylint:disable = too-many-statements
def create_child_add_project_dag(config):
    with rail.create_airflow_dag(
        dag_id=f'pwc_project_import_child_create_project_flat_file_based_{config.instance}_v2',
        ...
        def should_update_client_test(dag_run):
        ...
        should_update_client = rail.IfOperator(
            ...
            test=should_update_client_test,

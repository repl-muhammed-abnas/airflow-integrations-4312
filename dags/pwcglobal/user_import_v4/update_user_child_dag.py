...
from pwcglobal.user_import_v4.task.update_country import get_update_country
from pwcglobal.user_import_v4.task.update_timesheet_period import get_update_timesheet_period
from pwcglobal.user_import_v4.task.update_supervisor import get_update_supervisor
from pwcglobal.user_import_v4.task.update_timesheet_template import get_update_timesheet_template
from pwcglobal.user_import_v4.task.update_custom_field import get_update_custom_field
from pwcglobal.user_import_v4.task.update_timeoff_policy import get_update_timeoff_policy
from pwcglobal.user_import_v4.task.update_ftepercent_blob import update_ftepercent_blob
from pwcglobal.user_import_v4.task.assign_default_toil_to_policy import add_toil_default_policy
    ...
    with rail.create_airflow_dag(
        ...
        def is_current_payrule_matching(pay_rule_schedule, expected_uri):
            ...
            Args:
                ...
                expected_uri (str): The expected pay rule URI to compare (e.g., get_conf()["payruleuri"]).
        ...
        if_new_payrules_for_user = rail.IfOperator(
            ...
            test=lambda dag_run: not is_current_payrule_matching(rail.result(
                "bulk_get_user3")["payRuleScriptSchedule"], dag_run.conf["payruleuri"]),

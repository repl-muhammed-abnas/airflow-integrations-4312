...
company_key = 'pwcqa'
replicon_conn_id = 'pwcglobalqa-replicon-eu.automation'

sftp_conn_id = 'pwcglobalqa-MFT-STG-replicon'

input_filepath = '/PwCGBL_RepliconGlobal_STG/QA/Inbound/Project/SDC/LAN'
log_filepath = '/PwCGBL_RepliconGlobal_STG/QA/Inbound/Project/_logs'
archive_filepath = '/PwCGBL_RepliconGlobal_STG/QA/Inbound/Project/SDC/LAN/_archive'

tenant_email = 'sdc_xb_rm_team@pwc.com,xb_innovation_automation_team@pwc.com,us_repliconqaextintegrationalerts@pwc.com'

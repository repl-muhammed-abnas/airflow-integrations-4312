...
import rail
from pwcglobal.project_import_api_v6.mapper.pwc_sender_based_details import sender_details
...
def is_assignment_required(charge_code, confidential_flag, internal_person_role_type, role_types):
    if charge_code.startswith("NL"):
        if confidential_flag == "true" and internal_person_role_type.endswith("Member"):
            return "No"

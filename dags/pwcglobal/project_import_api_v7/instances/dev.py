...
from pwcglobal.project_import_api_v7.config import *
from pwcglobal.project_import_api_v7.mapper.pwc_global_access_scope_mapper_dev import access_scope_mapper_dev

...
from pwcglobal.project_import_api_v5.config import *
from pwcglobal.project_import_api_v5.mapper.pwc_global_access_scope_mapper_qa import access_scope_mapper_qa

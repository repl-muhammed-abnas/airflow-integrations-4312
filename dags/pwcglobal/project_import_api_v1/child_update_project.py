...
import rail
from pwcglobal.project_import_api_v1.task.get_team_members_project_manager import get_team_members_project_managers
from pwcglobal.project_import_api_v1.task.add_user_permission_policy import get_add_permission_policy
from pwcglobal.project_import_api_v1.task.child_dag_exception_logs import log_exception_field_task
from pwcglobal.project_import_api_v1 import request_payload
from pwcglobal.project_import_api_v1 import custom_method
from pwcglobal.project_import_api_v1 import python_callable_method
from pwcglobal.project_import_api_v1 import response_filter
...
def create_child_update_project_dag(config):
    with rail.create_airflow_dag(
        dag_id=f'pwc_project_import_child_update_project_b1_{config.instance}_v1',

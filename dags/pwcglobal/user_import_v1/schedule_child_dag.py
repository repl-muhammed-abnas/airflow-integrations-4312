...
def create_dag(config):
    with rail.create_airflow_dag(
        dag_id=f'pwcglobal_user_import_schedule_child_{config.instance}_v1',
        description=f'PwCGlobal_User_Import_Child_Office Schedule Add {config.instance} V1',
        ...
        has_valid_scheduletype >> rail.Label('no') >> log_error >> catch_and_log_errors

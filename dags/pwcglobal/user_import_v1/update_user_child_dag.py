...
from pwcglobal.user_import_v1.task.update_country import get_update_country
from pwcglobal.user_import_v1.task.update_timesheet_period import get_update_timesheet_period
from pwcglobal.user_import_v1.task.update_supervisor import get_update_supervisor
from pwcglobal.user_import_v1.task.update_timesheet_template import get_update_timesheet_template
from pwcglobal.user_import_v1.task.update_custom_field import get_update_custom_field
from pwcglobal.user_import_v1.task.update_timeoff_policy import get_update_timeoff_policy


def create_dag(config):
    # pylint: disable=too-many-statements
    with rail.create_airflow_dag(
        dag_id=f'pwcglobal_user_import_update_user_child_{config.instance}_v1',
        description=f'PwCGlobal_User_Import_Child_User Update {config.instance} V1',

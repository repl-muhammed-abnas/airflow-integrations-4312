import rail
from pwcglobal.user_import_v1 import config
...
def get_update_timesheet_template():
    ...
    with rail.TaskGroup(group_id='update_timesheet_template_task', prefix_group_id=False) as update_timesheet_template_task:
        ...
        is_timesheet_template_changed = rail.IfOperator(
            ...
            test=lambda: request_payload.get_conf()['timesheettemplate'] and
            request_payload.get_conf()['timesheettemplateuri'] and
            (request_payload.get_conf()['timesheettemplate'] !=
             (rail.result('bulk_get_user3')[
                 'timesheetTemplate'] or {}).get('name', None)),

...
import rail
from pwcglobal.time_export_v3.task.main_dag_task import main_dag_task_group
...
def create_main_airflow_dag(config):
    ...
    with rail.create_airflow_dag(
        dag_id=f'pwc_time_export_master{dag_id_postfix}_v3',
        description=f'Timeexport Master V5.0 {dag_id_postfix} API posting',
    ...
    if config.enable_uatmain_dag:
        ...
        with rail.create_airflow_dag(
            dag_id=f'pwc_time_export_master{dag_id_postfix2}_v3',
            description=f'Timeexport Master V5.0 {dag_id_postfix2} API posting',
            company_key=config.company_key,
            replicon_conn_id=config.replicon_conn_id,

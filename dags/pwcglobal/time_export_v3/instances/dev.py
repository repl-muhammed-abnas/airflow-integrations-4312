...
from pwcglobal.time_export_v3.mappers.location_dag_mapper_dev import location_dag_mapper_dev
from pwcglobal.time_export_v3.mappers.api_endpoints_details_dev import api_details
from pwcglobal.time_export_v3.mappers.timeofftype_chargecode_mapper import timeofftype_chargecode
...
time_extract_mapper = f'pwc_time_extract_mapper_{instance}_v2'

...
def create_main_absense_data_dag(config):
    ...
    with rail.create_airflow_dag(
        dag_id=f'pwc_timesheetprepopulation_main_child_{config.instance}_v2',
        ...
        def get_process_timeentry_trigger_id(item):
            ...
            if modulo == 0:
                return f'pwc_timesheetprepopulation_child_{config.instance}_v2'
            return f"pwc_timesheetprepopulation_child_{config.instance}_batch_{str(modulo)}_v2"

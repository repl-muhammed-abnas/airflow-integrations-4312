...
input_filepath = '/PwCGBL_RepliconGlobal_STG/QA/Inbound/Staff/Local/JP/Sup_Org'
log_filepath = '/PwCGBL_RepliconGlobal_STG/QA/Inbound/Staff/Local/JP/_logs'
archive_filepath = '/PwCGBL_RepliconGlobal_STG/QA/Inbound/Staff/Local/JP/_archive'

tenant_email = 'bartosz.polawski@pwc.com,us_repliconqaextintegrationalerts@pwc.com'

import rail
from pwcglobal.distance_data_extract.fiscal_export import request_payload

def create_child_dag(config):

    with rail.create_airflow_dag(
        dag_id=f'{config.instance}_process_previous_fiscal_year_extract_upload_file_Child_dag',
        description=f' Process previous Fiscal year extract upload file {config.instance}',
        ...
        expected_report_columns = "TransactionDate,TimeEntryID,PartyID,ResourceGrade,LegalEntityPartyID,WorkDayId,TimesheetStartDate,TimesheetEndDate,Mileage,ChargeCode,WorkItemType"

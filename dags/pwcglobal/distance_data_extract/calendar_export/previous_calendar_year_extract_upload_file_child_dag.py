import rail
from pwcglobal.distance_data_extract.calendar_export import request_payload

def create_child_dag(config):

    with rail.create_airflow_dag(
        dag_id=f'{config.instance}_process_previous_calendar_year_extract_upload_file_Child_dag',
        description=f' Process previous calendar year extract upload file {config.instance}',

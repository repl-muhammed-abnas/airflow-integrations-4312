...
from pwcglobal.distance_data_extract.calendar_export_v2.config import *
...
output_file_path = "/PwCGBL_RepliconGlobal_STG/DEV/Outbound/Time/S4/NL/distance/"
alternate_file_path = "/PwCGBL_RepliconGlobal_STG/DEV/Outbound/Time/S4/NLMetis/"
log_file_path = '/PwCGBL_RepliconGlobal_STG/DEV/Outbound/Time/_logs/'
...
main_dag_id = f"pwcglobal_previous_calendar_year_distance_data_extract_report_for_netherlands_{instance}{version}"
upload_file_child_dag_id = f"pwcglobal_process_previous_calendar_year_extract_upload_file_child_dag_{instance}{version}"

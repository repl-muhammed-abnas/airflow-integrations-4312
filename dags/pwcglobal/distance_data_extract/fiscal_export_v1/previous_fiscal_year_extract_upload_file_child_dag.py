import rail
from pwcglobal.distance_data_extract.fiscal_export_v1 import request_payload

def create_child_dag(config):

    with rail.create_airflow_dag(
        dag_id=f'pwcglobal_process_previous_fiscal_year_extract_upload_file_child_dag_{config.instance}_v1',
        description=f'PwC - Process previous Fiscal year extract upload file {config.instance} V1',
        ...
        expected_report_columns = "TransactionDate,TimeEntryID,PartyID,ResourceGrade,LegalEntityPartyID,WorkDayId,TimesheetStartDate,TimesheetEndDate,Mileage,ChargeCode,WorkItemType,Comments,Distance"

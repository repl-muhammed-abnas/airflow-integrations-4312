...
def create_dag(config):
    ...
    with rail.create_airflow_dag(
        dag_id=f'pwcglobal_user_import_master_{config.instance}',
        description=f'PwCGlobal - User Import_Master_Process XML input file {config.instance}',
        ...
        log_invalid_users = rail.WriteLogOperator(
            ...
            properties={
                ...
                'status': 'Exception',
                'message': 'User not created due to following reason/s: GUID is not present.',
        ...
        process_new_scheduels = rail.TriggerDagRunForEachItemOperator(
            ...
            trigger_dag_id=f'{config.schedule_dag_id}_{config.instance}',
            conf={
        ...
        process_new_locations = rail.TriggerDagRunForEachItemOperator(
            ...
            trigger_dag_id=f'{config.location_dag_id}_{config.instance}',
            conf={
        ...
        trigger_parallel_dagrun = rail.trigger_parallel_dagrun(
            ...
            execution_timeout=timedelta(days=config.execution_timeout_days),
            trigger_dag_id=f'{config.user_dag_id}_{config.instance}',
        ...
        process_supervisor = rail.TriggerDagRunForEachItemOperator(
            ...
            trigger_dag_id=f'{config.supervisor_dag_id}_{config.instance}',
            conf={
        ...
        create_user_collection >> query_valid_users >> has_valid_users >> rail.Label('Yes') >> query_distinct_schedule >> \
            [query_distinct_country, get_all_office_schedule, get_all_location, get_all_division,
             ...
             get_all_timezones, get_all_timeofftypes, get_all_permissionset, get_all_customfields] >> has_profilestatus_customfield
        ...
        load_master_log >> format_logs >> get_errored_logs >> get_exception_logs >> \
            ...
            generate_download_link >> send_import_complete_email >> log_to_sumo

    ...
    with rail.TaskGroup(group_id='update_timesheet_period', prefix_group_id=False) as update_timesheet_period:
        ...
        is_timesheetperiod_changed = rail.IfOperator(
            ...
            (not request_payload.get_current_schedule(
                rail.result(get_current_timesheetperiod_schedule.task_id)) or request_payload.get_current_schedule(
                rail.result(get_current_timesheetperiod_schedule.task_id))['timesheetPeriod']['displayText'] !=
             request_payload.get_conf()['timesheetperiodtype']),

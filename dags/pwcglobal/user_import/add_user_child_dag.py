...
from pwcglobal.user_import.task.update_user_setting import get_update_user_setting
from pwcglobal.user_import.task.put_table_view_setting import get_put_table_view_setting
from pwcglobal.user_import.task.update_supervisor import get_update_supervisor


def create_dag(config):
    with rail.create_airflow_dag(
        dag_id=f'pwcglobal_user_import_add_user_child_{config.instance}',
        description=f'PwCGlobal_User_Import_Child_User Add {config.instance}',

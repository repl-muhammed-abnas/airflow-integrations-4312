...
from pwcglobal.absense_data_pre_population.task.hours_quantity_check import get_hours_quantity_check
from pwcglobal.absense_data_pre_population.task.build_oef_values import get_build_oef_values
from pwcglobal.absense_data_pre_population.task.put_timeentry import get_put_time_entry
from pwcglobal.absense_data_pre_population.task.update_or_delete_timeentry import get_update_or_delete_time_entry
...
def create_child_pre_population_project_dag(config):
    ...
    for idx in range(0, config.TIME_ENTRY_BATCH_COUNT):
        ...
        with rail.create_airflow_dag(
            dag_id=f'pwc_timesheetprepopulation_child_{config.instance}{get_postfix}',
            ...
            is_timesheet_status_open = rail.IfOperator(
                ...
                yes_task='log_timesheet_status_not_open',
                no_task='is_transactiondate_present'
            )

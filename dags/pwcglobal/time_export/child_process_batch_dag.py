...
import rail
from pwcglobal.time_export.request_payload import get_current_past_period_conf
...
def create_child_process_batch_dag(config):
    ...
    for location in config.location_codes:
        ...
        with rail.create_airflow_dag(
            dag_id=f'pwc_time_export_user_batch_child_{location}_{config.instance}',
            ...
            trigger_current_past_period_imports = rail.TriggerDagRunForEachItemOperator(
                ...
                trigger_dag_id=f'pwc_time_export_child_current_past_period_{location}_{config.instance}',

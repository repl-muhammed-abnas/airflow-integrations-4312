...
def create_dag(config):
    ...
    with rail.create_airflow_dag(
        dag_id=f'pwcglobal_user_import_master_{config.instance}_v3',
        description=f'PwCGlobal - User Import_Master_Process XML input file {config.instance} V3',
        ...
        process_new_scheduels = rail.TriggerDagRunForEachItemOperator(
            ...
            trigger_dag_id=f'{config.schedule_dag_id}_{config.instance}_v3',
            conf={
        ...
        process_new_locations = rail.TriggerDagRunForEachItemOperator(
            ...
            trigger_dag_id=f'{config.location_dag_id}_{config.instance}_v3',
            conf={
        ...
        trigger_parallel_dagrun = rail.trigger_parallel_dagrun(
            ...
            execution_timeout=timedelta(days=config.execution_timeout_days),
            trigger_dag_id=f'{config.user_dag_id}_{config.instance}_v3',
        ...
        process_supervisor = rail.TriggerDagRunForEachItemOperator(
            ...
            trigger_dag_id=f'{config.supervisor_dag_id}_{config.instance}_v3',
            conf={

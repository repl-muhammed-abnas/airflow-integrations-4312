...
def get_timesheet_start_date():
    timesheetstartdate = rail.result("get_current_timesheet_period") or rail.result("get_past_timesheet_period")
...
def get_existing_records():
    existing_records = rail.load_all_records(rail.result("query_unique_existing_records"))
    if existing_records:
...
def get_update_time_off_req(config):
    ...
    if get_conf()['toiltimeofftypeuri'] and \
        ...
        time_off_types.append(get_toil_time_off_uri(rail.result("get_user_location_uri"),config))
    return {
        "userUri": get_conf()["useruri"],

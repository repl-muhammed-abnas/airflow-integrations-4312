...
from pwcglobal.user_import_v5.utils.validate_field import validate_field_add, validate_field_update
from pwcglobal.user_import_v5.task.search_user import get_search_user_task

# config : https://github.com/replicon/airflow-integrations/blob/main/dags/pwcglobal/user_import_v5/config.py


def create_dag(config):
    with rail.create_airflow_dag(
        dag_id=config.process_user_dag_id,
        description=f'PwCGlobal_User_Import Process User',
        ...
        add_user_validate_fields = rail.PythonOperator(
            ...
            python_callable=validate_field_add
        )
        ...
        update_user_validate_fields = rail.PythonOperator(
            ...
            python_callable=validate_field_update
        )

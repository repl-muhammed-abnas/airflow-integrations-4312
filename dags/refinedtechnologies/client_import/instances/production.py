...
company_key = 'RefinedTechnologiesIncafmig'

replicon_conn_id = "refinedtechnologies_replicon_admin"
...
last_sync_time_variable = 'standard_refinedtechnologiesinc_client_import_last_sync_time'

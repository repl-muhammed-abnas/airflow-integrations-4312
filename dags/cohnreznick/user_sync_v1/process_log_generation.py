...
from cohnreznick.user_sync_v1.utils.python_callable_methods import do_format_logs
...
def create_child_dag(config):
    with rail.create_airflow_dag(
        ...
        description='Cohnreznick User Sync - Process Log Generation',
        ...
        render_logs_csv = rail.WriteCSVFileOperator(
            ...
            row=[   '{{ item | attr_or_default("employeeid", "") }}',
                    '{{ item | attr_or_default("employeenumber", "") }}',

...
def create_dag(config):
    ...
    with rail.create_airflow_dag(
        dag_id=f'nttdatabc_seniority_udf_update_master_{config.instance}',
        ...
        query_distinct_timesheets=rail.QueryCollectionOperator(
            ...
            query="""SELECT DISTINCT  inputdatatimesheetapproved.timesheeturi FROM  inputdatatimesheetapproved""",
        )
        ...
        process_each_distinct_timesheet = rail.TriggerDagRunForEachItemOperator(
            ...
            trigger_dag_id=f'nttdatabc_seniority_udf_update_process_distinct_timesheets_{config.instance}',

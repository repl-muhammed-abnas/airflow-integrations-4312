...
def create_dag(config):
    ...
    with rail.create_airflow_dag(
        dag_id=f'nttdatabc_seniority_udf_update_process_distinct_timesheets_{config.instance}',
        ...
        query_details_of_timesheet_from_employee_approved_timesheets=rail.QueryCollectionOperator(
            ...
            query="""SELECT * FROM  inputdatatimesheetapproved WHERE
                    ...
                    inputdatatimesheetapproved.activity = 'Null' AND  inputdatatimesheetapproved.timeofftype = 'Null' AND
                    inputdatatimesheetapproved.timeoffhours > 0""",
        )
        ...
        query_details_of_timesheet_from_employee_pay_code=rail.QueryCollectionOperator(
            ...
            query="""SELECT * FROM  inputdatapaycodehours WHERE
                    ...
                    ( inputdatapaycodehours.paycodecode = 'REG')""",
        )
        ...
        trigger_child_dag=rail.TriggerDagRunOperator(
            ...
            retries=0,
            trigger_dag_id=f'nttdatabc_seniority_udf_update_child_{config.instance}',

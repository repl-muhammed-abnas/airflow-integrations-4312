...
def create_dag(config):
    ...
    with rail.create_airflow_dag(
        dag_id=f'nttdatabc_seniority_udf_update_child_{config.instance}_v2',
        ...
        trigger_subchild_dag=rail.TriggerDagRunOperator(
            ...
            retries=0,
            trigger_dag_id=f'nttdatabc_seniority_udf_update_subchild_{config.instance}_v2',
        ...
        get_final_seniority_value_for_specific_user =rail.SetVariableOperator(
            ...
            value=lambda dag_run: ( 0 if rail.result('get_seniority_custom_field_value')['text'] == '' else
        ...
        if_there_are_final_hours >> rail.Label(
            'Yes') >> get_seniority_custom_field_value >> create_final_senority_variable >> if_employee_is_specific

...
def create_dag(config):
    ...
    with rail.create_airflow_dag(
        dag_id=f'nttdatabc_seniority_udf_update_process_distinct_timesheets_{config.instance}_v2',
        ...
        trigger_child_dag=rail.TriggerDagRunOperator(
            ...
            retries=0,
            trigger_dag_id=f'nttdatabc_seniority_udf_update_child_{config.instance}_v2',

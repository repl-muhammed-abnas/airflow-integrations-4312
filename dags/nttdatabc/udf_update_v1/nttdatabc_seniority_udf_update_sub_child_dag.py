...
def create_dag(config):
    ...
    with rail.create_airflow_dag(
        dag_id=f'nttdatabc_seniority_udf_update_subchild_{config.instance}_v1',
        ...
        add_success_log_entry = rail.WriteLogOperator(
            ...
            properties=lambda dag_run: {
                ...
                "timesheetperiod": dag_run.conf['timesheetperiod'],
                "totalhours": dag_run.conf['totalhours'],
                "finalvalue": rail.result('log_final_seniority_value') if dag_run.conf['employeetype'] in ['Hourly','Auxiliary Hourly'] else '',
                "approvalstatus": dag_run.conf['approvalstatus'],
                "status": "Success",
        ...
        if_totalhours_greaterthan_0 >> rail.Label('Yes') >> get_seniority_custom_field_value >> create_final_senority_variable >> if_employeetype_is_hourly

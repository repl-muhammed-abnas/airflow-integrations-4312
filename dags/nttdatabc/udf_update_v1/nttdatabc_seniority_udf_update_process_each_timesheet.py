...
def create_dag(config):
    ...
    with rail.create_airflow_dag(
        dag_id=f'nttdatabc_seniority_udf_update_process_distinct_timesheets_{config.instance}_v1',
        ...
        query_details_of_timesheet_from_employee_approved_timesheets=rail.QueryCollectionOperator(
            ...
            query="""SELECT * FROM  inputdatatimesheetapproved WHERE
                    ...
                    inputdatatimesheetapproved.employeetype = 'Auxiliary Hourly')""",
        )
        ...
        trigger_child_dag=rail.TriggerDagRunOperator(
            ...
            retries=0,
            trigger_dag_id=f'nttdatabc_seniority_udf_update_child_{config.instance}_v1',

...
from victoriashipyards.auto_shift_assignment.weekly_update.utils import request_payload

def create_dag(config):
    # pylint: disable=too-many-statements
    with rail.create_airflow_dag(
        dag_id=f'victoriashipyards_weekly_shift_assignment_master_{config.instance}',
        description=f'victoriashipyards_Weekly shift assignment_master {config.instance}',
        ...
        process_shifts = rail.TriggerDagRunForEachItemOperator(
            ...
            trigger_dag_id=f'victoriashipyards_weekly_shift_assignment_per_existing_user_V3.0_{config.instance}',
        ...
        log_number_of_users_data_to_sumo = rail.DagRunLogToSumoOperator(
            ...
            extra_info={
                ...
                'Users Processed' : '{{ result("get_userdata_to_process","length")}}'
            }
        )
        ...
        has_userdata_to_process >> rail.Label("Yes") >> process_shifts >> log_number_of_users_data_to_sumo

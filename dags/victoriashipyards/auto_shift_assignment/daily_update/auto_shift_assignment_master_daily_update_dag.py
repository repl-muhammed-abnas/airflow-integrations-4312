...
from victoriashipyards.auto_shift_assignment.daily_update.utils import request_payload

def create_dag(config):
    # pylint: disable=too-many-statements
    with rail.create_airflow_dag(
        dag_id=config.shift_assignment_daily_master_dagid,
        description=f'victoriashipyards Automatic Shift Update Master_prod {config.instance}',
        ...
        process_shifts = rail.TriggerDagRunForEachItemOperator(
            ...
            trigger_dag_id=f'victoriashipyards_default_shift_assignment_daily_update_V3.0_{config.instance}',

...
from victoriashipyards.auto_shift_assignment.daily_update.utils import request_payload, python_callable_method


def create_dag(config):
    with rail.create_airflow_dag(
        dag_id=config.shift_assignment_daily_child_dagid,
        description=f'victoriashipyards_Default shift assignment_daily update  V3.0 {config.instance}',

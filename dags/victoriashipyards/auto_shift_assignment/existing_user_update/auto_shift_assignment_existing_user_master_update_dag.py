...
from victoriashipyards.auto_shift_assignment.existing_user_update.utils import request_payload

def create_dag(config):
    # pylint: disable=too-many-statements
    with rail.create_airflow_dag(
        dag_id=f'victoriashipyards_existing_user_shift_assignment_master_{config.instance}',
        description=f'victoriashipyards_assign shift to existing users_master {config.instance}',
        ...
        process_shifts = rail.TriggerDagRunForEachItemOperator(
            ...
            trigger_dag_id=f'victoriashipyards_default_shift_assignment_per_existing_user_V3.0_{config.instance}',

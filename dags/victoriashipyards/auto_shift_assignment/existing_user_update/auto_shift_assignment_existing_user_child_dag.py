...
from victoriashipyards.auto_shift_assignment.existing_user_update.utils import request_payload, python_callable_method


def create_dag(config):
    with rail.create_airflow_dag(
        dag_id=f'victoriashipyards_default_shift_assignment_per_existing_user_V3.0_{config.instance}',
        description=f'victoriashipyards_Default shift assignment_per existing user V3.0{config.instance}',

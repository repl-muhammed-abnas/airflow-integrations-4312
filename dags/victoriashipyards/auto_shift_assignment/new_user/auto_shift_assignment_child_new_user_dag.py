...
from victoriashipyards.auto_shift_assignment.new_user.utils import request_payload, python_callable_method

def create_dag(config):
    with rail.create_airflow_dag(
        dag_id=f'victoriashipyards_default_shift_assignment_per_new_user_V3.0_{config.instance}',
        description=f'victoriashipyards_Default shift assignment_per new user V3.0 {config.instance}',

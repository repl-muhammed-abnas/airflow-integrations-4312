...
from victoriashipyards.timesheet_auto_submission.tasks import recalculated_timesheets_report_batch
from victoriashipyards.timesheet_auto_submission.tasks import timesheets_report_batch
...
def create_dag(config):
    with rail.create_airflow_dag(
        dag_id=f"victoriashipyards_timesheet_auto_submission_time_punch_master_dag_{config.instance}",
        ...
        recalculate_timesheet = rail.TriggerDagRunForEachItemOperator(
            ...
            trigger_dag_id=f'victoriashipyards_recalculate_timesheets_child_dag_{config.instance}',
        )

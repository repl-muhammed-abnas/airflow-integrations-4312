...
def create_main_airflow_dag(config):
    with rail.create_airflow_dag(
        dag_id=f'bccss_report_to_sftp_task_actual_billable_hours_master_{config.instance}',
        ...
        process_report_to_sftp(config, config.extract_report_name_task_billable_hours,
                         config.extract_report_task_billable_hour_file_name)

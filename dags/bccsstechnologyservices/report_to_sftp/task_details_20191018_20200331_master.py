...
def create_main_airflow_dag(config):
    with rail.create_airflow_dag(
        dag_id=f'bccss_report_to_sftp_task_details_20191018_20200331_master_{config.instance}',
        ...
        process_report_to_sftp(config, config.extract_report_name_task_details,
                         config.extract_report_task_details_file_name)

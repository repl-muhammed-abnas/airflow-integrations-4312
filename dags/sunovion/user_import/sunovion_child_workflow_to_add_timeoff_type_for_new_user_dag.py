...
def create_dag(config):
    ...
    with rail.create_airflow_dag(
        dag_id=f'sunovion_user_import_workflow_to_add_timeoff_type_for_new_user_child_{config.instance}',
        description=f'Sunovion_Child Workflow to add timeoff type for new user {config.instance}',

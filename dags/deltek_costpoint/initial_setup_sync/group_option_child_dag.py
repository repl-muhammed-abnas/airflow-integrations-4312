...
def create_dag(config):
    with rail.create_airflow_dag(
        ...
        can_run_batch_task = rail.IfOperator(
            ...
            yes_task='batch_task',
            no_task='get_modified_servicecenter_countries_from_costpoint'
        )

        batch_task = rail.BatchTaskRunOperator(
            task_id='batch_task',
            start_task='get_modified_servicecenter_countries_from_costpoint',
                    ...
                    for grp in company_countries['document']['rows']:
                        if config.group_hierarchy_sync == "HIERARCHICAL" and lvl_no and taxable_entity_name:
                            modified_groups.append({
                                    ...
                                    "group_lvl_no": grp['row']['data'].get(lvl_no),
                                    "group_taxable_entity_name": grp['row']['data'].get(taxable_entity_name)
                                })
        ...
        if_costpoint_servicecente_present = rail.IfOperator(
            ...
            no_task="get_modified_labor_location_from_costpoint",
        )
        ...
        get_modified_labor_location_from_costpoint = rail.DeltekCostPointServiceOperator(
            ...
            data=lambda dag_run: {
                "filter": {
                    "id": "replicon_exp_labor_location",
                    "where": [
                        {
                            "rsWhere": {
        ...
        if_costpoint_location_present = rail.IfOperator(
            ...
            no_task="get_modified_division_organisations_from_costpoint",
        )
        ...
        if_costpoint_division_present = rail.IfOperator(
            ...
            no_task="get_modified_costcenter_accounts_from_costpoint",
        )
        ...
        if_costpoint_costcenter_present = rail.IfOperator(
            ...
            no_task="get_modified_dept_glc_from_costpoint",
        )
        ...
        can_run_batch_task >> rail.Label(
            'No') >> get_modified_servicecenter_countries_from_costpoint >> get_modified_servicecenter_countries >> if_costpoint_servicecente_present
        if_costpoint_servicecente_present >> rail.Label(
            'No') >> get_modified_labor_location_from_costpoint
        if_costpoint_servicecente_present >> rail.Label('Yes') >> get_all_service_centers >> create_servicecenter_or_applymodifications >> \
            get_modified_labor_location_from_costpoint >> get_modified_labor_location >> if_costpoint_location_present
        if_costpoint_location_present >> rail.Label(
            'No') >> get_modified_division_organisations_from_costpoint
        if_costpoint_location_present >> rail.Label('Yes') >> get_all_locations >> create_location_or_applymodifications >> \
            get_modified_division_organisations_from_costpoint >> get_modified_division_organisations >> if_costpoint_division_present
        if_costpoint_division_present >> rail.Label(
            'No') >> get_modified_costcenter_accounts_from_costpoint
        ...
        if_division_sync_error >> rail.Label('Yes') >> log_division_sync_error >> get_modified_costcenter_accounts_from_costpoint
        if_division_sync_error >> rail.Label('No') >> get_modified_costcenter_accounts_from_costpoint
        get_modified_costcenter_accounts_from_costpoint >> get_modified_costcenter_accounts >> if_costpoint_costcenter_present
        if_costpoint_costcenter_present >> rail.Label(
            'No') >> get_modified_dept_glc_from_costpoint
        if_costpoint_costcenter_present >> rail.Label('Yes') >> get_all_cost_centers >> create_costcenter_or_applymodifications >> \
            get_modified_dept_glc_from_costpoint >> get_modified_dept_glc >> if_costpoint_department_present

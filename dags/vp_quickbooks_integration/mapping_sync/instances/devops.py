"""Instance configuration for VantagePoint-QuickBooks Mapping Sync — Devops environment."""
# pylint: disable=invalid-name,unused-import
from vp_quickbooks_integration.mapping_sync.config import (
...
# Email notifications
tenant_email = '{{ var.value.vp_quickbooks_devops_email }}'
...
# via Airflow Variable `vp_qbo_mapping_sync_schedule_interval_devops`
# (see main_dag.py).

"""Instance configuration for VantagePoint-QuickBooks Mapping Sync — QA environment."""
...
# Email notifications
tenant_email = '{{ var.value.vp_quickbooks_qa_email }}'
...
# via Airflow Variable `vp_qbo_mapping_sync_schedule_interval_qa`
# (see main_dag.py).

"""Instance configuration for VantagePoint-QuickBooks Mapping Sync — dev environment."""
...
# Email notifications
tenant_email = '{{ var.value.vp_quickbooks_dev_email }}'
...
# via Airflow Variable `vp_qbo_mapping_sync_schedule_interval_dev`
# (see main_dag.py).
